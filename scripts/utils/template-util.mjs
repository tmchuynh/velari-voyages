...
} from "./description-utils.mjs";
import {
  foodNouns,
  foodAdjectives,
} from "scripts/create-restaurant-testimonials-files.mjs";

export const crewMemberBioTemplates = {
  Captain: [
...
export const defaultCrewMemberBioTemplate = [
...
const specialty =
  cityDesc.specialties[Math.floor(Math.random() * cityDesc.specialties.length)];
...
export const restaurantMenuCategoryDescriptionTemplates = {
  "Signature Dishes": [
...
export const restaurantMenuCategoryDescriptionDefaultTemplates = [
...
export const restaurantMainCourseTemplates = [
...
export const restaurantDessertMenuTemplates = [
...
export const restaurantDrinksMenuTemplates = [
...
export const restaurantCocktailTemplates = [
...
const atmosphereAdj =
  atmosphereAdjectives[Math.floor(Math.random() * atmosphereAdjectives.length)];

export const restaurantTestimonialsTemplate = [
