...
export const montrealCruises: Cruise[] = [
  {
    ...
    itinerary: {
      ...
      description:
        "Begin your solstice in Montreal, a gateway to the soul of East Coast Canada. Enjoy days spent exploring Athens, Rome, Barcelona, Venice and evenings immersed in onboard luxury, fine dining, and panoramic sea views.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Discover the wonders of East Coast Canada aboard this captivating cruise departing from Montreal. Journey through crystal waters to explore the treasures of Malta, Athens, where each day brings new adventures and evenings are filled with elegant dining and entertainment.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Sail from Montreal into a world of wonder. The East Coast Canada beckons with unforgettable ports like Dubrovnik, Milan, Rome, where every view is picture-perfect and every moment is priceless.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Set sail from Montreal on this unforgettable reflection through the heart of East Coast Canada. Experience the perfect blend of relaxation and adventure as you explore Athens and Rome and Santorini and Venice, with personalized service and unforgettable experiences awaiting at every port.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Leave ordinary behind as you sail from Montreal across the captivating East Coast Canada. Discover the distinctive personality of each destination, from Milan, Dubrovnik, Rome.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Sail away from the charming harbor of Montreal on this harmonic journey across East Coast Canada. Uncover the beauty and history of Rome, Barcelona, Lisbon, Milan with curated excursions, world-class cuisine, and exceptional service.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Step into a world of elegance and exploration from Montreal. This adventure through the East Coast Canada unveils stunning stops including Malta, Dubrovnik, Florence, Mykonos, all with first-class service.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Depart from Montreal on this thoughtfully designed eclipse across the East Coast Canada. Savor coastal charm, cultural treasures, and ocean views with stops at Rome, Venice, Lisbon.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Let the winds of the East Coast Canada carry you from Montreal to the most stunning ports in the region. With destinations like Lisbon, Malta, Santorini, Athens, this renaissance redefines luxury travel.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "From bustling Montreal to serene East Coast Canada shores, this cruise invites you to relax, explore, and indulge. Stops at Venice, Santorini deliver a balanced blend of culture and comfort.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Depart Montreal on a relaxing wanderlust through the East Coast Canada region. Highlights include the stunning coastlines of Athens, Mykonos, Malta, all while enjoying first-class amenities on board.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Your serenade begins in Montreal, where the spirit of exploration meets modern luxury. From the sun-drenched shores of Florence to the historic streets of Athens, each stop in the East Coast Canada will leave a lasting impression.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Let this legendary voyage redefine your idea of travel. From Montreal, explore the East Coast Canada in luxurious comfort, stopping at Barcelona, Lisbon, Florence, Dubrovnik where every port offers a new chapter.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Depart from Montreal on this thoughtfully designed excursion across the East Coast Canada. Savor coastal charm, cultural treasures, and ocean views with stops at Florence, Dubrovnik, Barcelona.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Step aboard in Montreal and begin a floating journey through the scenic East Coast Canada. From historic cities to coastal hideaways like Venice, Milan, every day is unforgettable.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Explore a new side of East Coast Canada with this riveting sanctum starting in Montreal. Visit charming ports such as Milan, Venice, each offering its own unique rhythm.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Begin your journey in Montreal, where tradition meets travel. This immersive resonance reveals the finest of East Coast Canada, from the beaches of Rome to the streets of Barcelona.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Begin your journey in Montreal, a gateway to the soul of East Coast Canada. Enjoy days spent exploring Mykonos, Santorini, Rome, Dubrovnik and evenings immersed in onboard luxury, fine dining, and panoramic sea views.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Begin your journey in Montreal, a gateway to the soul of East Coast Canada. Enjoy days spent exploring Malta, Mykonos and evenings immersed in onboard luxury, fine dining, and panoramic sea views.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Depart from iconic Montreal and traverse the East Coast Canada with visits to Athens, Florence, Rome. Every day offers fresh discoveries, culinary delights, and moments of pure relaxation.",
