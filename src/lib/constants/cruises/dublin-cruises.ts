...
export const dublinCruises: Cruise[] = [
  {
    ...
    itinerary: {
      ...
      description:
        "Begin a captivating whisper through the Northern Europe, departing Dublin. With visits to Stockholm, Amsterdam, Kiel, each day brings a new adventure and deeper connection to the region.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Savor each moment of this timeless escape through Northern Europe, starting in Dublin. Visit renowned locations like Berlin, Copenhagen, where adventure and relaxation intertwine.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Step into a world of elegance and exploration from Dublin. This oasis through the Northern Europe unveils stunning stops including Copenhagen, Helsinki, all with first-class service.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Sail from Dublin into a world of wonder. The Northern Europe beckons with unforgettable ports like London, Helsinki, where every view is picture-perfect and every moment is priceless.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Set sail from Dublin on this sun-drenched escape through the heart of Northern Europe. Experience the perfect blend of relaxation and adventure as you explore Oslo and Tallinn and Kiel, with personalized service and unforgettable experiences awaiting at every port.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "From the lively departure port of Dublin, this curated legacy showcases the finest of Northern Europe. With visits to Southampton, Helsinki, Stockholm, Berlin, you’ll experience a tapestry of flavors, sights, and unforgettable moments both onboard and ashore.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Step into a world of elegance and exploration from Dublin. This wanderlust through the Northern Europe unveils stunning stops including Amsterdam, Stockholm, Southampton, all with first-class service.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Set sail from Dublin on this midnight currents through the heart of Northern Europe. Experience the perfect blend of relaxation and adventure as you explore Southampton and Kiel, with personalized service and unforgettable experiences awaiting at every port.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Set sail from Dublin for a voyage like no other. From the picturesque landscapes of Copenhagen to the lively ambiance of Oslo, this oceanic cruise will redefine your view of Northern Europe.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Leave ordinary behind as you sail from Dublin across the captivating Northern Europe. Discover the distinctive personality of each destination, from Tallinn, Berlin.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Unwind and explore on this embrace through Northern Europe, departing from Dublin. With every stop—from Southampton to Oslo—you’ll collect memories that last a lifetime.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "This captivating cruise from Dublin is your ticket to the captivating charm of the Northern Europe. Discover the delights of St. Petersburg, Helsinki with enriching excursions and award-winning service.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Experience the elegance of the seas on this riveting zenith through Northern Europe, starting from the illustrious port of Dublin. From Tallinn, Kiel to Berlin, each destination offers its own story, culture, and breathtaking views.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "This extraordinary odyssey from Dublin offers the ultimate Northern Europe exploration. Immerse yourself in the rich cultures and stunning landscapes of Helsinki, Tallinn and Amsterdam, creating memories that will last a lifetime.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Your journey through the Northern Europe begins in Dublin, where elegance meets adventure. Explore the shores of St. Petersburg, London, Tallinn, with curated excursions and luxurious onboard amenities.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Your discovery begins in Dublin, where every sunset on the Northern Europe horizon promises another day of discovery—from St. Petersburg, Amsterdam, Tallinn, Kiel to hidden ports of charm.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Start in the vibrant city of Dublin and venture into the iconic Northern Europe. Discover authentic local cultures, cuisine, and coastal wonders in Berlin, Copenhagen, Southampton.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "This handpicked enigma begins in Dublin and travels through Northern Europe's iconic waterscapes. Discover Berlin, Southampton, London, Amsterdam as each day brings new stories and every night offers elegant repose.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Sail from Dublin into a world of wonder. The Northern Europe beckons with unforgettable ports like Amsterdam, Southampton, where every view is picture-perfect and every moment is priceless.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "From the lively departure port of Dublin, this curated sanctum showcases the finest of Northern Europe. With visits to London, Copenhagen, you’ll experience a tapestry of flavors, sights, and unforgettable moments both onboard and ashore.",
