...
export const dubrovnikCruises: Cruise[] = [
{
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Unwind and explore on this saga through Mediterranean, departing from Dubrovnik. With every stop—from Florence to Malta—you’ll collect memories that last a lifetime.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Let the waves lead you from Dubrovnik on this extraordinary retreat. Traverse the iconic waters of Mediterranean and discover the beauty of Rome, Lisbon, Barcelona.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Discover the wonders of Mediterranean aboard this secluded cruise departing from Dubrovnik. Journey through crystal waters to explore the treasures of Venice, Athens, Malta, Mykonos, where each day brings new adventures and evenings are filled with elegant dining and entertainment.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Enjoy seamless luxury on this moonlit journey beginning in Dubrovnik. Visit breathtaking Mediterranean locales such as Santorini, Malta, Athens on this unforgettable itinerary.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "This handpicked sojourn begins in Dubrovnik and travels through Mediterranean's iconic waterscapes. Discover Santorini, Athens as each day brings new stories and every night offers elegant repose.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Let this horizon-kissed voyage redefine your idea of travel. From Dubrovnik, explore the Mediterranean in luxurious comfort, stopping at Florence, Rome where every port offers a new chapter.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Board in Dubrovnik for a hand-crafted retreat through the breathtaking Mediterranean. Highlights include sun-drenched beaches, historic ports, and immersive culture in Santorini, Barcelona, Mykonos.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Leave stress behind with this curated reflection from Dubrovnik. Sail across the best of Mediterranean and explore treasures like Rome, Santorini, Milan, Lisbon with comfort and style.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Enjoy seamless luxury on this whispering mirage beginning in Dubrovnik. Visit breathtaking Mediterranean locales such as Malta, Athens on this unforgettable itinerary.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Join us in Dubrovnik for a mythos of a lifetime. Sail across the serene waters of Mediterranean, stopping at ports like Milan, Venice, Rome where timeless traditions meet modern luxuries.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Board in Dubrovnik for a hand-crafted frontier through the breathtaking Mediterranean. Highlights include sun-drenched beaches, historic ports, and immersive culture in Lisbon, Florence, Barcelona.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Experience the elegance of the seas on this pearlescent sojourn through Mediterranean, starting from the illustrious port of Dubrovnik. From Athens, Barcelona, Santorini to Venice, each destination offers its own story, culture, and breathtaking views.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Cruise into cultural richness aboard this unforgettable symphony departing Dubrovnik. Savor local cuisine and uncover regional beauty from Athens to Barcelona.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Embark on an unforgettable elevation from the vibrant port of Dubrovnik, where you'll discover hidden gems and iconic landmarks across the Mediterranean region. With stops at Venice, Lisbon, this journey combines cultural immersion with breathtaking scenery.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Experience the elegance of the seas on this verdant whisper through Mediterranean, starting from the illustrious port of Dubrovnik. From Barcelona to Malta, each destination offers its own story, culture, and breathtaking views.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "A voyage of contrasts awaits from Dubrovnik. Discover the historical and natural richness of Mediterranean as you cruise to spectacular destinations like Santorini, Mykonos.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Embark from Dubrovnik and traverse the Mediterranean in style. Whether it’s the energy of Rome or the calm of Mykonos, each destination reveals a new side of paradise.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Start in the vibrant city of Dubrovnik and venture into the iconic Mediterranean. Discover authentic local cultures, cuisine, and coastal wonders in Malta, Milan, Barcelona.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Begin your eclipse in Dubrovnik, a gateway to the soul of Mediterranean. Enjoy days spent exploring Florence, Barcelona, Venice and evenings immersed in onboard luxury, fine dining, and panoramic sea views.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Let the waves lead you from Dubrovnik on this harmonic sanctuary. Traverse the iconic waters of Mediterranean and discover the beauty of Rome, Mykonos, Barcelona.",
