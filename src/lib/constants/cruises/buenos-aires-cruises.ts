...
export const buenosAiresCruises: Cruise[] = [
{
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Start in the vibrant city of Buenos Aires and venture into the iconic South America. Discover authentic local cultures, cuisine, and coastal wonders in Santiago, Rio de Janeiro, Montevideo.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Sail from Buenos Aires into a world of wonder. The South America beckons with unforgettable ports like Santiago, Lima, Cartagena, where every view is picture-perfect and every moment is priceless.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "From bustling Buenos Aires to serene South America shores, this cruise invites you to relax, explore, and indulge. Stops at Montevideo, Lima, Santiago deliver a balanced blend of culture and comfort.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Set sail from historic Buenos Aires for a modern escape into the South America. Savor gourmet cuisine, cultural treasures, and beautiful coastlines with stops in Rio de Janeiro, Lima, Montevideo, Santiago.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Experience coastal elegance on this quest from Buenos Aires, where the journey through South America includes stops in Cartagena, Montevideo, each more enchanting than the last.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Escape into the calm waters of South America with this majestic journey from Buenos Aires. Explore vibrant markets, sun-soaked beaches, and architectural marvels at Rio de Janeiro, Lima.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Let this charming voyage redefine your idea of travel. From Buenos Aires, explore the South America in luxurious comfort, stopping at Montevideo, Santiago where every port offers a new chapter.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Depart from Buenos Aires on this thoughtfully designed reunion across the South America. Savor coastal charm, cultural treasures, and ocean views with stops at Lima, Santiago.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Let the waves lead you from Buenos Aires on this pearlescent horizon. Traverse the iconic waters of South America and discover the beauty of Rio de Janeiro, Montevideo.",
      distance: "699 nautical miles",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Depart from the iconic port of Buenos Aires and sail through the enchanting South America. Explore vibrant destinations like Lima, Montevideo, each offering its own unique charm and local flair.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "An escape like no other begins in Buenos Aires, where your excursion launches into the heart of South America. Discover the magic of Rio de Janeiro, Montevideo, Cartagena with style and sophistication.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Savor each moment of this lavish escape through South America, starting in Buenos Aires. Visit renowned locations like Cartagena, Lima, Rio de Janeiro, where adventure and relaxation intertwine.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Discover the wonders of South America aboard this infinite cruise departing from Buenos Aires. Journey through crystal waters to explore the treasures of Cartagena, Lima, where each day brings new adventures and evenings are filled with elegant dining and entertainment.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Set sail from historic Buenos Aires for a modern escape into the South America. Savor gourmet cuisine, cultural treasures, and beautiful coastlines with stops in Rio de Janeiro, Santiago, Lima.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "This inspiring oasis departs from Buenos Aires, navigating the diverse landscapes and vibrant cities of South America. Must-see stops include Rio de Janeiro, Cartagena, Montevideo, Lima.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "This enchanting sanctum begins in Buenos Aires and ventures deep into the heart of South America. Wander through colorful markets, historic streets, and serene coastlines at Cartagena, Lima.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Set course from Buenos Aires for an inspiring pristine journey across South America. Whether exploring ancient ruins in Santiago or soaking up coastal views in Rio de Janeiro, every day offers a perfect mix of discovery and relaxation.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Depart from Buenos Aires on this thoughtfully designed sanctum across the South America. Savor coastal charm, cultural treasures, and ocean views with stops at Santiago, Cartagena, Rio de Janeiro.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Join us in Buenos Aires for a odyssey of a lifetime. Sail across the serene waters of South America, stopping at ports like Montevideo, Lima, Cartagena, Santiago where timeless traditions meet modern luxuries.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Let this exquisite voyage redefine your idea of travel. From Buenos Aires, explore the South America in luxurious comfort, stopping at Lima, Montevideo, Cartagena where every port offers a new chapter.",
