...
export const helsinkiCruises: Cruise[] = [
  {
    ...
    itinerary: {
      ...
      description:
        "From the lively departure port of Helsinki, this curated infinite showcases the finest of Northern Europe. With visits to Southampton, St. Petersburg, you’ll experience a tapestry of flavors, sights, and unforgettable moments both onboard and ashore.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "This horizon-kissed odyssey begins in Helsinki and ventures deep into the heart of Northern Europe. Wander through colorful markets, historic streets, and serene coastlines at Amsterdam, Berlin, Tallinn.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "This hand-selected tranquil cruise offers a true taste of Northern Europe. Depart from Helsinki and explore ports like Southampton, Berlin, St. Petersburg, each telling a story through food, music, and tradition.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Unwind and explore on this quest through Northern Europe, departing from Helsinki. With every stop—from St. Petersburg to Oslo—you’ll collect memories that last a lifetime.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Step aboard in Helsinki and begin a transcendent journey through the scenic Northern Europe. From historic cities to coastal hideaways like Southampton, St. Petersburg, Copenhagen, every day is unforgettable.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Set course from Helsinki for an inspiring serene journey across Northern Europe. Whether exploring ancient ruins in Kiel or soaking up coastal views in London, every day offers a perfect mix of discovery and relaxation.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "An unforgettable currents awaits as you cruise from Helsinki across Northern Europe. Dive into history, flavor, and culture with stops including Dublin, London, Stockholm, St. Petersburg.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "From bustling Helsinki to serene Northern Europe shores, this cruise invites you to relax, explore, and indulge. Stops at Dublin, St. Petersburg deliver a balanced blend of culture and comfort.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "This handpicked tide begins in Helsinki and travels through Northern Europe's iconic waterscapes. Discover Southampton, Tallinn, Copenhagen as each day brings new stories and every night offers elegant repose.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Board in Helsinki for a hand-crafted realm through the breathtaking Northern Europe. Highlights include sun-drenched beaches, historic ports, and immersive culture in Southampton, Oslo, Amsterdam.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "From bustling Helsinki to serene Northern Europe shores, this cruise invites you to relax, explore, and indulge. Stops at Oslo, London deliver a balanced blend of culture and comfort.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Depart from Helsinki on this thoughtfully designed pulse across the Northern Europe. Savor coastal charm, cultural treasures, and ocean views with stops at Berlin, St. Petersburg, London, Stockholm.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Depart from the iconic port of Helsinki and sail through the enchanting Northern Europe. Explore vibrant destinations like Stockholm, Amsterdam, London, each offering its own unique charm and local flair.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "This midnight cruise from Helsinki is your ticket to the captivating charm of the Northern Europe. Discover the delights of Berlin, Stockholm with enriching excursions and award-winning service.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Set sail from Helsinki for a voyage like no other. From the picturesque landscapes of Stockholm to the lively ambiance of Berlin, this lavish cruise will redefine your view of Northern Europe.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Enjoy seamless luxury on this moonlit reverie beginning in Helsinki. Visit breathtaking Northern Europe locales such as Amsterdam, Kiel on this unforgettable itinerary.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Sail away from Helsinki into the beautiful expanse of Northern Europe. Along the way, enjoy rich cultural experiences in Copenhagen, Kiel, Southampton, Oslo, where history, nature, and cuisine collide.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Explore a new side of Northern Europe with this opulent escape starting in Helsinki. Visit charming ports such as Berlin, St. Petersburg, each offering its own unique rhythm.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Begin your journey in Helsinki, where tradition meets travel. This immersive embrace reveals the finest of Northern Europe, from the beaches of Oslo to the streets of Southampton.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Board in Helsinki for a hand-crafted oasis through the breathtaking Northern Europe. Highlights include sun-drenched beaches, historic ports, and immersive culture in Stockholm, St. Petersburg, Copenhagen, Berlin.",
