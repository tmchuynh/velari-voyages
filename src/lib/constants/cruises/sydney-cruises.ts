...
export const sydneyCruises: Cruise[] = [
{
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "This frontier takes you beyond the ordinary, starting in Sydney. With breathtaking stops in Singapore, Auckland, Shanghai, your cruise delivers immersive moments and unforgettable vistas.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Experience the elegance of the seas on this enchanting exploration through Asia Pacific, starting from the illustrious port of Sydney. From Shanghai to Tokyo, each destination offers its own story, culture, and breathtaking views.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "This midnight discovery begins in Sydney and ventures deep into the heart of Asia Pacific. Wander through colorful markets, historic streets, and serene coastlines at Bangkok, Yokohama, Ho Chi Minh City, Auckland.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Embark on an unforgettable reflection from the vibrant port of Sydney, where you'll discover hidden gems and iconic landmarks across the Asia Pacific region. With stops at Singapore, Hong Kong, Kyoto, Tokyo, this journey combines cultural immersion with breathtaking scenery.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Explore a new side of Asia Pacific with this sun-drenched eclipse starting in Sydney. Visit charming ports such as Kyoto, Bangkok, Yokohama, Bali, each offering its own unique rhythm.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Escape the everyday with this enchanting journey through Asia Pacific, departing from Sydney. You'll visit Singapore, Bali, Bangkok, where every stop is a new adventure.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Step aboard in Sydney and begin a verdant journey through the scenic Asia Pacific. From historic cities to coastal hideaways like Kyoto, Auckland, Shanghai, every day is unforgettable.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Embark on an unforgettable tide from the vibrant port of Sydney, where you'll discover hidden gems and iconic landmarks across the Asia Pacific region. With stops at Hong Kong, Ho Chi Minh City, Bangkok, this journey combines cultural immersion with breathtaking scenery.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Discover the wonders of Asia Pacific aboard this celestial cruise departing from Sydney. Journey through crystal waters to explore the treasures of Bali, Shanghai, where each day brings new adventures and evenings are filled with elegant dining and entertainment.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Let this epic voyage redefine your idea of travel. From Sydney, explore the Asia Pacific in luxurious comfort, stopping at Tokyo, Melbourne, Shanghai where every port offers a new chapter.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Depart from iconic Sydney and traverse the Asia Pacific with visits to Hong Kong, Bali, Singapore, Ho Chi Minh City. Every day offers fresh discoveries, culinary delights, and moments of pure relaxation.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Sail away from Sydney into the beautiful expanse of Asia Pacific. Along the way, enjoy rich cultural experiences in Bangkok, Auckland, where history, nature, and cuisine collide.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "This hand-selected panoramic cruise offers a true taste of Asia Pacific. Depart from Sydney and explore ports like Melbourne, Auckland, each telling a story through food, music, and tradition.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Step aboard in Sydney and begin a verdant journey through the scenic Asia Pacific. From historic cities to coastal hideaways like Singapore, Kyoto, every day is unforgettable.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Let the waves lead you from Sydney on this charming enigma. Traverse the iconic waters of Asia Pacific and discover the beauty of Hong Kong, Yokohama, Singapore.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Discover the wonders of Asia Pacific aboard this starlit cruise departing from Sydney. Journey through crystal waters to explore the treasures of Tokyo, Kyoto, Bangkok, where each day brings new adventures and evenings are filled with elegant dining and entertainment.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "An escape like no other begins in Sydney, where your whisper launches into the heart of Asia Pacific. Discover the magic of Ho Chi Minh City, Melbourne with style and sophistication.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Your renaissance begins in Sydney, where every sunset on the Asia Pacific horizon promises another day of discovery—from Tokyo, Auckland, Hong Kong, Bangkok to hidden ports of charm.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Cruise into cultural richness aboard this mystical pulse departing Sydney. Savor local cuisine and uncover regional beauty from Singapore to Kyoto.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Board in Sydney for a hand-crafted whisper through the breathtaking Asia Pacific. Highlights include sun-drenched beaches, historic ports, and immersive culture in Melbourne, Kyoto, Singapore.",
