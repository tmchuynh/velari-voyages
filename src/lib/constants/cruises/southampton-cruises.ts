...
export const southamptonCruises: Cruise[] = [
{
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Depart from Southampton on this thoughtfully designed mythos across the Northern Europe. Savor coastal charm, cultural treasures, and ocean views with stops at Amsterdam, Oslo, Kiel, London.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Escape the everyday with this azure journey through Northern Europe, departing from Southampton. You'll visit Copenhagen, Oslo, Amsterdam, where every stop is a new adventure.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "An unforgettable sanctum awaits as you cruise from Southampton across Northern Europe. Dive into history, flavor, and culture with stops including Helsinki, Amsterdam, Tallinn.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Let the spirit of exploration guide your mystical journey from Southampton. This cruise offers a balanced mix of luxury and adventure, visiting stunning locales like Oslo, Stockholm.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Sail into splendor from Southampton on a pristine voyage through Northern Europe. Let each stop—from St. Petersburg to Dublin—reveal the unique flavors and colors of the region.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Experience the elegance of the seas on this heavenly symphony through Northern Europe, starting from the illustrious port of Southampton. From Berlin, Dublin, Copenhagen to Helsinki, each destination offers its own story, culture, and breathtaking views.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Savor each moment of this gilded escape through Northern Europe, starting in Southampton. Visit renowned locations like Tallinn, Amsterdam, Kiel, where adventure and relaxation intertwine.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Start in the vibrant city of Southampton and venture into the iconic Northern Europe. Discover authentic local cultures, cuisine, and coastal wonders in Amsterdam, St. Petersburg, Berlin, Oslo.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "This handpicked elevation begins in Southampton and travels through Northern Europe's iconic waterscapes. Discover Berlin, St. Petersburg, Helsinki as each day brings new stories and every night offers elegant repose.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Set sail from Southampton for a voyage like no other. From the picturesque landscapes of Tallinn to the lively ambiance of Berlin, this spectacular cruise will redefine your view of Northern Europe.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Set sail from Southampton for a voyage like no other. From the picturesque landscapes of Tallinn to the lively ambiance of Stockholm, this infinite cruise will redefine your view of Northern Europe.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Sail away from Southampton into the beautiful expanse of Northern Europe. Along the way, enjoy rich cultural experiences in St. Petersburg, Berlin, Stockholm, Kiel, where history, nature, and cuisine collide.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "An unforgettable saga awaits as you cruise from Southampton across Northern Europe. Dive into history, flavor, and culture with stops including Kiel, Dublin, Copenhagen, Helsinki.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Launch into adventure from Southampton and sail deep into the heart of the Northern Europe. With ports of call like Stockholm, Copenhagen, expect a voyage filled with scenic wonders and luxurious comforts.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Begin your symphony in Southampton, a gateway to the soul of Northern Europe. Enjoy days spent exploring Tallinn, Helsinki and evenings immersed in onboard luxury, fine dining, and panoramic sea views.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Let the spirit of exploration guide your radiant journey from Southampton. This cruise offers a balanced mix of luxury and adventure, visiting stunning locales like Copenhagen, Kiel.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Leave stress behind with this curated zenith from Southampton. Sail across the best of Northern Europe and explore treasures like Dublin, Oslo with comfort and style.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Let the winds of the Northern Europe carry you from Southampton to the most stunning ports in the region. With destinations like London, St. Petersburg, Berlin, Helsinki, this renaissance redefines luxury travel.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Your journey through the Northern Europe begins in Southampton, where elegance meets adventure. Explore the shores of Amsterdam, Helsinki, London, with curated excursions and luxurious onboard amenities.",
      distance: "514 nautical miles",
      totalDuration: "11 days",
      timeAtSea: [
  {
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "An unforgettable voyage awaits as you cruise from Southampton across Northern Europe. Dive into history, flavor, and culture with stops including Oslo, Berlin, Dublin.",
