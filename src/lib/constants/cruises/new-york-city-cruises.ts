...
export const newYorkCityCruises: Cruise[] = [
  {
    ...
    itinerary: {
      ...
      description:
        "Set sail from historic New York City for a modern escape into the East Coast USA. Savor gourmet cuisine, cultural treasures, and beautiful coastlines with stops in Malta, Barcelona, Rome.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "An unforgettable expedition awaits as you cruise from New York City across East Coast USA. Dive into history, flavor, and culture with stops including Florence, Santorini.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Enjoy seamless luxury on this celestial frontier beginning in New York City. Visit breathtaking East Coast USA locales such as Venice, Dubrovnik, Florence, Athens on this unforgettable itinerary.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Leave ordinary behind as you sail from New York City across the captivating East Coast USA. Discover the distinctive personality of each destination, from Barcelona, Venice, Florence, Santorini.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Embark on an unforgettable pilgrimage from the vibrant port of New York City, where you'll discover hidden gems and iconic landmarks across the East Coast USA region. With stops at Lisbon, Barcelona, Dubrovnik, this journey combines cultural immersion with breathtaking scenery.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "From bustling New York City to serene East Coast USA shores, this cruise invites you to relax, explore, and indulge. Stops at Rome, Lisbon, Mykonos deliver a balanced blend of culture and comfort.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "This handpicked discovery begins in New York City and travels through East Coast USA's iconic waterscapes. Discover Milan, Venice, Lisbon as each day brings new stories and every night offers elegant repose.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Set sail from New York City for a voyage like no other. From the picturesque landscapes of Mykonos to the lively ambiance of Dubrovnik, this midnight cruise will redefine your view of East Coast USA.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Let the waves lead you from New York City on this serene quest. Traverse the iconic waters of East Coast USA and discover the beauty of Venice, Dubrovnik, Rome.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Savor each moment of this moonlit escape through East Coast USA, starting in New York City. Visit renowned locations like Barcelona, Rome, Lisbon, where adventure and relaxation intertwine.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Savor each moment of this legendary escape through East Coast USA, starting in New York City. Visit renowned locations like Athens, Dubrovnik, Venice, where adventure and relaxation intertwine.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Board in New York City for a hand-crafted expedition through the breathtaking East Coast USA. Highlights include sun-drenched beaches, historic ports, and immersive culture in Santorini, Florence, Mykonos, Barcelona.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Experience the elegance of the seas on this mystical embrace through East Coast USA, starting from the illustrious port of New York City. From Lisbon, Milan, Barcelona to Athens, each destination offers its own story, culture, and breathtaking views.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "This inspiring enigma departs from New York City, navigating the diverse landscapes and vibrant cities of East Coast USA. Must-see stops include Mykonos, Santorini, Florence, Lisbon.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Begin your journey in New York City, where tradition meets travel. This immersive infinite reveals the finest of East Coast USA, from the beaches of Milan to the streets of Venice.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "A voyage of contrasts awaits from New York City. Discover the historical and natural richness of East Coast USA as you cruise to spectacular destinations like Mykonos, Milan, Malta.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Enjoy seamless luxury on this radiance-drenched discovery beginning in New York City. Visit breathtaking East Coast USA locales such as Florence, Athens, Dubrovnik on this unforgettable itinerary.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Your currents begins in New York City, where the spirit of exploration meets modern luxury. From the sun-drenched shores of Lisbon to the historic streets of Milan, each stop in the East Coast USA will leave a lasting impression.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Sail into splendor from New York City on a idyllic voyage through East Coast USA. Let each stop—from Rome to Santorini—reveal the unique flavors and colors of the region.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "This tide-washed frontier begins in New York City and ventures deep into the heart of East Coast USA. Wander through colorful markets, historic streets, and serene coastlines at Lisbon, Dubrovnik.",
