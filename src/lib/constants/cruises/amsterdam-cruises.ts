...
export const amsterdamCruises: Cruise[] = [
{
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Board in Amsterdam for a hand-crafted exploration through the breathtaking Northern Europe. Highlights include sun-drenched beaches, historic ports, and immersive culture in Southampton, St. Petersburg, Kiel, London.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Depart from Amsterdam on this thoughtfully designed enigma across the Northern Europe. Savor coastal charm, cultural treasures, and ocean views with stops at Tallinn, Berlin.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Sail into splendor from Amsterdam on a charming voyage through Northern Europe. Let each stop—from Helsinki to London—reveal the unique flavors and colors of the region.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Cruise into cultural richness aboard this eternal escape departing Amsterdam. Savor local cuisine and uncover regional beauty from Oslo to Southampton.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Set course from Amsterdam for an inspiring extraordinary journey across Northern Europe. Whether exploring ancient ruins in Helsinki or soaking up coastal views in London, every day offers a perfect mix of discovery and relaxation.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Set sail from Amsterdam for a voyage like no other. From the picturesque landscapes of Berlin to the lively ambiance of London, this forbidden cruise will redefine your view of Northern Europe.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Step into a world of elegance and exploration from Amsterdam. This reflection through the Northern Europe unveils stunning stops including St. Petersburg, Southampton, all with first-class service.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "This handpicked reflection begins in Amsterdam and travels through Northern Europe's iconic waterscapes. Discover Tallinn, Copenhagen, Berlin as each day brings new stories and every night offers elegant repose.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "From bustling Amsterdam to serene Northern Europe shores, this cruise invites you to relax, explore, and indulge. Stops at Tallinn, London deliver a balanced blend of culture and comfort.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Depart from the iconic port of Amsterdam and sail through the enchanting Northern Europe. Explore vibrant destinations like Tallinn, Berlin, Southampton, Helsinki, each offering its own unique charm and local flair.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Set sail from Amsterdam for a voyage like no other. From the picturesque landscapes of Southampton to the lively ambiance of Dublin, this transcendent cruise will redefine your view of Northern Europe.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Experience the elegance of the seas on this sun-drenched serenade through Northern Europe, starting from the illustrious port of Amsterdam. From Stockholm, Tallinn, Dublin to Copenhagen, each destination offers its own story, culture, and breathtaking views.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Sail from Amsterdam into a world of wonder. The Northern Europe beckons with unforgettable ports like Helsinki, Copenhagen, Southampton, Dublin, where every view is picture-perfect and every moment is priceless.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Your journey through the Northern Europe begins in Amsterdam, where elegance meets adventure. Explore the shores of Copenhagen, Tallinn, Helsinki, with curated excursions and luxurious onboard amenities.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "This extraordinary serenade from Amsterdam offers the ultimate Northern Europe exploration. Immerse yourself in the rich cultures and stunning landscapes of Tallinn, Helsinki, London and Copenhagen, creating memories that will last a lifetime.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Escape to sea from Amsterdam on a exquisite voyage exploring the magic of Northern Europe. Visit unforgettable locales like London, Tallinn, where each stop inspires awe.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Savor each moment of this riveting escape through Northern Europe, starting in Amsterdam. Visit renowned locations like London, Dublin, Stockholm, where adventure and relaxation intertwine.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Enjoy seamless luxury on this spectacular pulse beginning in Amsterdam. Visit breathtaking Northern Europe locales such as Kiel, Helsinki, Southampton on this unforgettable itinerary.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Leave stress behind with this curated renaissance from Amsterdam. Sail across the best of Northern Europe and explore treasures like Copenhagen, Berlin, Dublin with comfort and style.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "This luminous mythos begins in Amsterdam and ventures deep into the heart of Northern Europe. Wander through colorful markets, historic streets, and serene coastlines at Dublin, Southampton.",
