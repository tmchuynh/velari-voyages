...
export const singaporeCruises: Cruise[] = [
  {
    ...
    itinerary: {
      ...
      description:
        "Set sail from Singapore on this tide-washed requiem through the heart of Asia Pacific. Experience the perfect blend of relaxation and adventure as you explore Shanghai and Bangkok, with personalized service and unforgettable experiences awaiting at every port.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Start in the vibrant city of Singapore and venture into the iconic Asia Pacific. Discover authentic local cultures, cuisine, and coastal wonders in Bali, Yokohama.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Board in Singapore for a hand-crafted mystique through the breathtaking Asia Pacific. Highlights include sun-drenched beaches, historic ports, and immersive culture in Auckland, Yokohama, Tokyo, Bangkok.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "This inspiring oasis departs from Singapore, navigating the diverse landscapes and vibrant cities of Asia Pacific. Must-see stops include Tokyo, Sydney, Yokohama.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "An unforgettable oasis awaits as you cruise from Singapore across Asia Pacific. Dive into history, flavor, and culture with stops including Hong Kong, Melbourne.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "This inspiring passage departs from Singapore, navigating the diverse landscapes and vibrant cities of Asia Pacific. Must-see stops include Yokohama, Shanghai, Ho Chi Minh City.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Begin your realm in Singapore, a gateway to the soul of Asia Pacific. Enjoy days spent exploring Ho Chi Minh City, Bali, Kyoto and evenings immersed in onboard luxury, fine dining, and panoramic sea views.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Enjoy seamless luxury on this ornate reverie beginning in Singapore. Visit breathtaking Asia Pacific locales such as Bangkok, Melbourne on this unforgettable itinerary.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Launch into adventure from Singapore and sail deep into the heart of the Asia Pacific. With ports of call like Tokyo, Hong Kong, Melbourne, Sydney, expect a voyage filled with scenic wonders and luxurious comforts.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Sail away from the charming harbor of Singapore on this hidden journey across Asia Pacific. Uncover the beauty and history of Auckland, Yokohama, Ho Chi Minh City with curated excursions, world-class cuisine, and exceptional service.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Escape the everyday with this immersive journey through Asia Pacific, departing from Singapore. You'll visit Auckland, Melbourne, where every stop is a new adventure.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "An escape like no other begins in Singapore, where your retreat launches into the heart of Asia Pacific. Discover the magic of Bali, Auckland, Bangkok, Kyoto with style and sophistication.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Your sanctuary begins in Singapore, where every sunset on the Asia Pacific horizon promises another day of discovery—from Melbourne, Yokohama, Shanghai, Sydney to hidden ports of charm.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Experience the elegance of the seas on this exquisite resonance through Asia Pacific, starting from the illustrious port of Singapore. From Bali, Melbourne to Kyoto, each destination offers its own story, culture, and breathtaking views.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Set course from Singapore for an inspiring starlit journey across Asia Pacific. Whether exploring ancient ruins in Melbourne or soaking up coastal views in Kyoto, every day offers a perfect mix of discovery and relaxation.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Explore a new side of Asia Pacific with this golden journey starting in Singapore. Visit charming ports such as Hong Kong, Melbourne, Kyoto, each offering its own unique rhythm.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "This verdant reflection begins in Singapore and ventures deep into the heart of Asia Pacific. Wander through colorful markets, historic streets, and serene coastlines at Bali, Tokyo, Bangkok.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Sail from Singapore into a world of wonder. The Asia Pacific beckons with unforgettable ports like Bangkok, Tokyo, Shanghai, where every view is picture-perfect and every moment is priceless.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Start in the vibrant city of Singapore and venture into the iconic Asia Pacific. Discover authentic local cultures, cuisine, and coastal wonders in Melbourne, Bali, Ho Chi Minh City.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "This mythic cruise from Singapore is your ticket to the captivating charm of the Asia Pacific. Discover the delights of Bali, Tokyo, Bangkok, Melbourne with enriching excursions and award-winning service.",
