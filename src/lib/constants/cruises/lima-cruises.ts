...
export const limaCruises: Cruise[] = [
{
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Enjoy seamless luxury on this celestial infinite beginning in Lima. Visit breathtaking South America locales such as Montevideo, Santiago on this unforgettable itinerary.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Sail away from Lima into the beautiful expanse of South America. Along the way, enjoy rich cultural experiences in Buenos Aires, Montevideo, where history, nature, and cuisine collide.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Step aboard in Lima and begin a timeless journey through the scenic South America. From historic cities to coastal hideaways like Montevideo, Buenos Aires, Cartagena, every day is unforgettable.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Set course from Lima for an inspiring heavenly journey across South America. Whether exploring ancient ruins in Rio de Janeiro or soaking up coastal views in Buenos Aires, every day offers a perfect mix of discovery and relaxation.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Depart from the iconic port of Lima and sail through the enchanting South America. Explore vibrant destinations like Montevideo, Rio de Janeiro, Buenos Aires, each offering its own unique charm and local flair.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Explore a new side of South America with this luxurious odyssey starting in Lima. Visit charming ports such as Montevideo, Rio de Janeiro, each offering its own unique rhythm.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Experience coastal elegance on this enigma from Lima, where the journey through South America includes stops in Cartagena, Rio de Janeiro, each more enchanting than the last.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Experience coastal elegance on this whisper from Lima, where the journey through South America includes stops in Buenos Aires, Rio de Janeiro, Cartagena, Montevideo, each more enchanting than the last.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Begin a captivating tide through the South America, departing Lima. With visits to Montevideo, Rio de Janeiro, each day brings a new adventure and deeper connection to the region.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Let the waves lead you from Lima on this opulent zenith. Traverse the iconic waters of South America and discover the beauty of Montevideo, Buenos Aires.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "An unforgettable reflection awaits as you cruise from Lima across South America. Dive into history, flavor, and culture with stops including Cartagena, Santiago, Montevideo, Rio de Janeiro.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "From bustling Lima to serene South America shores, this cruise invites you to relax, explore, and indulge. Stops at Buenos Aires, Rio de Janeiro, Santiago, Cartagena deliver a balanced blend of culture and comfort.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Let the waves lead you from Lima on this serene elevation. Traverse the iconic waters of South America and discover the beauty of Montevideo, Rio de Janeiro, Santiago, Buenos Aires.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Your journey through the South America begins in Lima, where elegance meets adventure. Explore the shores of Rio de Janeiro, Montevideo, Santiago, Buenos Aires, with curated excursions and luxurious onboard amenities.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Unwind and explore on this reunion through South America, departing from Lima. With every stop—from Rio de Janeiro to Buenos Aires—you’ll collect memories that last a lifetime.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "This hidden wanderlust begins in Lima and ventures deep into the heart of South America. Wander through colorful markets, historic streets, and serene coastlines at Buenos Aires, Santiago, Cartagena.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Experience coastal elegance on this odyssey from Lima, where the journey through South America includes stops in Cartagena, Rio de Janeiro, Montevideo, each more enchanting than the last.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Experience the elegance of the seas on this majestic arcadia through South America, starting from the illustrious port of Lima. From Montevideo to Rio de Janeiro, each destination offers its own story, culture, and breathtaking views.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Step aboard in Lima and begin a starlit journey through the scenic South America. From historic cities to coastal hideaways like Cartagena, Santiago, Rio de Janeiro, every day is unforgettable.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Let the winds of the South America carry you from Lima to the most stunning ports in the region. With destinations like Buenos Aires, Cartagena, this horizon redefines luxury travel.",
