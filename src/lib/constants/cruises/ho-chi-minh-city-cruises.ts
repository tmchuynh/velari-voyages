...
export const hoChiMinhCityCruises: Cruise[] = [
{
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Sail away from the charming harbor of Ho Chi Minh City on this starlit journey across Asia Pacific. Uncover the beauty and history of Sydney, Hong Kong with curated excursions, world-class cuisine, and exceptional service.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Begin an epic retreat from Ho Chi Minh City, where the seas meet culture. Visit the remarkable ports of Bangkok, Shanghai, Hong Kong while indulging in fine dining, entertainment, and unmatched hospitality.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Step aboard in Ho Chi Minh City and begin a floating journey through the scenic Asia Pacific. From historic cities to coastal hideaways like Yokohama, Singapore, Bali, every day is unforgettable.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Depart Ho Chi Minh City on a relaxing adventure through the Asia Pacific region. Highlights include the stunning coastlines of Bangkok, Yokohama, all while enjoying first-class amenities on board.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "This handpicked expedition begins in Ho Chi Minh City and travels through Asia Pacific's iconic waterscapes. Discover Yokohama, Hong Kong as each day brings new stories and every night offers elegant repose.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Your awakening begins in Ho Chi Minh City, where the spirit of exploration meets modern luxury. From the sun-drenched shores of Auckland to the historic streets of Shanghai, each stop in the Asia Pacific will leave a lasting impression.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Set sail from Ho Chi Minh City on this luminous tranquility through the heart of Asia Pacific. Experience the perfect blend of relaxation and adventure as you explore Yokohama and Singapore and Auckland and Sydney, with personalized service and unforgettable experiences awaiting at every port.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "An escape like no other begins in Ho Chi Minh City, where your odyssey launches into the heart of Asia Pacific. Discover the magic of Shanghai, Sydney with style and sophistication.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Unwind and explore on this eclipse through Asia Pacific, departing from Ho Chi Minh City. With every stop—from Sydney to Melbourne—you’ll collect memories that last a lifetime.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Depart from iconic Ho Chi Minh City and traverse the Asia Pacific with visits to Sydney, Tokyo, Hong Kong, Yokohama. Every day offers fresh discoveries, culinary delights, and moments of pure relaxation.",
      distance: "1196 nautical miles",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Cruise into cultural richness aboard this epic solstice departing Ho Chi Minh City. Savor local cuisine and uncover regional beauty from Bali to Sydney.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Sail away from Ho Chi Minh City into the beautiful expanse of Asia Pacific. Along the way, enjoy rich cultural experiences in Auckland, Sydney, where history, nature, and cuisine collide.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "This handpicked retreat begins in Ho Chi Minh City and travels through Asia Pacific's iconic waterscapes. Discover Auckland, Melbourne, Hong Kong as each day brings new stories and every night offers elegant repose.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Savor each moment of this hidden escape through Asia Pacific, starting in Ho Chi Minh City. Visit renowned locations like Bali, Tokyo, Auckland, where adventure and relaxation intertwine.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "This inspiring voyage departs from Ho Chi Minh City, navigating the diverse landscapes and vibrant cities of Asia Pacific. Must-see stops include Sydney, Yokohama, Tokyo, Auckland.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Join us in Ho Chi Minh City for a reverie of a lifetime. Sail across the serene waters of Asia Pacific, stopping at ports like Auckland, Hong Kong, Kyoto where timeless traditions meet modern luxuries.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "From the lively departure port of Ho Chi Minh City, this curated frontier showcases the finest of Asia Pacific. With visits to Hong Kong, Tokyo, Kyoto, Bangkok, you’ll experience a tapestry of flavors, sights, and unforgettable moments both onboard and ashore.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Step into a world of elegance and exploration from Ho Chi Minh City. This symphony through the Asia Pacific unveils stunning stops including Bali, Auckland, Singapore, all with first-class service.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Sail into splendor from Ho Chi Minh City on a captivating voyage through Asia Pacific. Let each stop—from Sydney to Melbourne—reveal the unique flavors and colors of the region.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "This forbidden cruise from Ho Chi Minh City is your ticket to the captivating charm of the Asia Pacific. Discover the delights of Singapore, Yokohama, Sydney with enriching excursions and award-winning service.",
