...
export const romeCruises: Cruise[] = [
{
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Let the winds of the Mediterranean carry you from Rome to the most stunning ports in the region. With destinations like Mykonos, Lisbon, this tranquility redefines luxury travel.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Join us in Rome for a reunion of a lifetime. Sail across the serene waters of Mediterranean, stopping at ports like Dubrovnik, Barcelona, Mykonos, Malta where timeless traditions meet modern luxuries.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Unwind and explore on this journey through Mediterranean, departing from Rome. With every stop—from Athens to Dubrovnik—you’ll collect memories that last a lifetime.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Join us in Rome for a eclipse of a lifetime. Sail across the serene waters of Mediterranean, stopping at ports like Santorini, Dubrovnik where timeless traditions meet modern luxuries.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Your renaissance begins in Rome, where the spirit of exploration meets modern luxury. From the sun-drenched shores of Barcelona to the historic streets of Lisbon, each stop in the Mediterranean will leave a lasting impression.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Explore a new side of Mediterranean with this exquisite infinite starting in Rome. Visit charming ports such as Malta, Lisbon, Mykonos, each offering its own unique rhythm.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Let the winds of the Mediterranean carry you from Rome to the most stunning ports in the region. With destinations like Mykonos, Dubrovnik, Athens, this enigma redefines luxury travel.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Join us in Rome for a reunion of a lifetime. Sail across the serene waters of Mediterranean, stopping at ports like Venice, Malta where timeless traditions meet modern luxuries.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Cruise into cultural richness aboard this alluring tranquility departing Rome. Savor local cuisine and uncover regional beauty from Santorini to Athens.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Depart from iconic Rome and traverse the Mediterranean with visits to Florence, Mykonos, Lisbon. Every day offers fresh discoveries, culinary delights, and moments of pure relaxation.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Join us in Rome for a enigma of a lifetime. Sail across the serene waters of Mediterranean, stopping at ports like Malta, Santorini, Dubrovnik where timeless traditions meet modern luxuries.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "From bustling Rome to serene Mediterranean shores, this cruise invites you to relax, explore, and indulge. Stops at Florence, Mykonos, Milan, Venice deliver a balanced blend of culture and comfort.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Sail away from the charming harbor of Rome on this whispering journey across Mediterranean. Uncover the beauty and history of Santorini, Barcelona, Lisbon with curated excursions, world-class cuisine, and exceptional service.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Sail into splendor from Rome on a golden voyage through Mediterranean. Let each stop—from Athens to Malta—reveal the unique flavors and colors of the region.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Set course from Rome for an inspiring legendary journey across Mediterranean. Whether exploring ancient ruins in Milan or soaking up coastal views in Athens, every day offers a perfect mix of discovery and relaxation.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Sail away from Rome into the beautiful expanse of Mediterranean. Along the way, enjoy rich cultural experiences in Mykonos, Athens, Malta, where history, nature, and cuisine collide.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Let this golden voyage redefine your idea of travel. From Rome, explore the Mediterranean in luxurious comfort, stopping at Dubrovnik, Athens, Venice, Florence where every port offers a new chapter.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Enjoy seamless luxury on this moonlit mirage beginning in Rome. Visit breathtaking Mediterranean locales such as Milan, Athens, Mykonos, Venice on this unforgettable itinerary.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Depart Rome on a relaxing excursion through the Mediterranean region. Highlights include the stunning coastlines of Milan, Mykonos, Malta, all while enjoying first-class amenities on board.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Step into a world of elegance and exploration from Rome. This symphony through the Mediterranean unveils stunning stops including Santorini, Mykonos, all with first-class service.",
