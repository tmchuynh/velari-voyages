...
export const ketchikanCruises: Cruise[] = [
  {
    ...
    itinerary: {
      ...
      description:
        "Step into a world of elegance and exploration from Ketchikan. This embrace through the Alaska unveils stunning stops including Juneau, Skagway, Glacier Bay, Vancouver, all with first-class service.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Sail into splendor from Ketchikan on a enchanting voyage through Alaska. Let each stop—from Glacier Bay to Skagway—reveal the unique flavors and colors of the region.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Set sail from historic Ketchikan for a modern escape into the Alaska. Savor gourmet cuisine, cultural treasures, and beautiful coastlines with stops in Skagway, Seattle.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Unwind and explore on this arcadia through Alaska, departing from Ketchikan. With every stop—from Juneau to Victoria—you’ll collect memories that last a lifetime.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Embark on an unforgettable adventure from the vibrant port of Ketchikan, where you'll discover hidden gems and iconic landmarks across the Alaska region. With stops at Victoria, Vancouver, this journey combines cultural immersion with breathtaking scenery.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Embark on an unforgettable reverie from the vibrant port of Ketchikan, where you'll discover hidden gems and iconic landmarks across the Alaska region. With stops at Glacier Bay, Juneau, Victoria, Seattle, this journey combines cultural immersion with breathtaking scenery.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Unwind and explore on this eclipse through Alaska, departing from Ketchikan. With every stop—from Seattle to Vancouver—you’ll collect memories that last a lifetime.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Join us in Ketchikan for a sanctuary of a lifetime. Sail across the serene waters of Alaska, stopping at ports like Sitka, Skagway where timeless traditions meet modern luxuries.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Embark from Ketchikan and traverse the Alaska in style. Whether it’s the energy of Glacier Bay or the calm of Seattle, each destination reveals a new side of paradise.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Sail from Ketchikan into a world of wonder. The Alaska beckons with unforgettable ports like Vancouver, Seattle, Victoria, where every view is picture-perfect and every moment is priceless.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Let the winds of the Alaska carry you from Ketchikan to the most stunning ports in the region. With destinations like Sitka, Vancouver, this wanderlust redefines luxury travel.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Leave stress behind with this curated panorama from Ketchikan. Sail across the best of Alaska and explore treasures like Glacier Bay, Victoria, Vancouver with comfort and style.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Your embrace begins in Ketchikan, where the spirit of exploration meets modern luxury. From the sun-drenched shores of Victoria to the historic streets of Sitka, each stop in the Alaska will leave a lasting impression.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Set sail from historic Ketchikan for a modern escape into the Alaska. Savor gourmet cuisine, cultural treasures, and beautiful coastlines with stops in Glacier Bay, Victoria, Juneau, Sitka.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Experience the elegance of the seas on this luminous mystique through Alaska, starting from the illustrious port of Ketchikan. From Seattle, Skagway to Victoria, each destination offers its own story, culture, and breathtaking views.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Embark from Ketchikan and traverse the Alaska in style. Whether it’s the energy of Juneau or the calm of Vancouver, each destination reveals a new side of paradise.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Sail from Ketchikan into a world of wonder. The Alaska beckons with unforgettable ports like Skagway, Sitka, where every view is picture-perfect and every moment is priceless.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Your sanctum begins in Ketchikan, where every sunset on the Alaska horizon promises another day of discovery—from Victoria, Juneau, Sitka to hidden ports of charm.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "This escape takes you beyond the ordinary, starting in Ketchikan. With breathtaking stops in Glacier Bay, Seattle, Victoria, your cruise delivers immersive moments and unforgettable vistas.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Begin your arcadia in Ketchikan, a gateway to the soul of Alaska. Enjoy days spent exploring Sitka, Skagway, Victoria, Juneau and evenings immersed in onboard luxury, fine dining, and panoramic sea views.",
