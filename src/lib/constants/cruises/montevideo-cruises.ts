...
export const montevideoCruises: Cruise[] = [
{
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Launch into adventure from Montevideo and sail deep into the heart of the South America. With ports of call like Lima, Buenos Aires, Rio de Janeiro, Santiago, expect a voyage filled with scenic wonders and luxurious comforts.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Board in Montevideo for a hand-crafted drift through the breathtaking South America. Highlights include sun-drenched beaches, historic ports, and immersive culture in Lima, Buenos Aires, Cartagena, Rio de Janeiro.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Leave ordinary behind as you sail from Montevideo across the captivating South America. Discover the distinctive personality of each destination, from Buenos Aires, Rio de Janeiro.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Embark from Montevideo and traverse the South America in style. Whether it’s the energy of Rio de Janeiro or the calm of Cartagena, each destination reveals a new side of paradise.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Embark on an unforgettable wanderlust from the vibrant port of Montevideo, where you'll discover hidden gems and iconic landmarks across the South America region. With stops at Rio de Janeiro, Santiago, this journey combines cultural immersion with breathtaking scenery.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Start in the vibrant city of Montevideo and venture into the iconic South America. Discover authentic local cultures, cuisine, and coastal wonders in Santiago, Lima, Cartagena.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Depart from iconic Montevideo and traverse the South America with visits to Buenos Aires, Cartagena. Every day offers fresh discoveries, culinary delights, and moments of pure relaxation.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Explore a new side of South America with this golden quest starting in Montevideo. Visit charming ports such as Buenos Aires, Cartagena, Lima, each offering its own unique rhythm.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Explore a new side of South America with this forbidden saga starting in Montevideo. Visit charming ports such as Cartagena, Santiago, Buenos Aires, each offering its own unique rhythm.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Join us in Montevideo for a adventure of a lifetime. Sail across the serene waters of South America, stopping at ports like Buenos Aires, Rio de Janeiro, Lima where timeless traditions meet modern luxuries.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Escape the everyday with this secret journey through South America, departing from Montevideo. You'll visit Santiago, Lima, where every stop is a new adventure.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Embark on an unforgettable oasis from the vibrant port of Montevideo, where you'll discover hidden gems and iconic landmarks across the South America region. With stops at Buenos Aires, Cartagena, this journey combines cultural immersion with breathtaking scenery.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Start in the vibrant city of Montevideo and venture into the iconic South America. Discover authentic local cultures, cuisine, and coastal wonders in Lima, Santiago, Rio de Janeiro.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Let the waves lead you from Montevideo on this infinite odyssey. Traverse the iconic waters of South America and discover the beauty of Santiago, Buenos Aires, Rio de Janeiro, Cartagena.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Launch into adventure from Montevideo and sail deep into the heart of the South America. With ports of call like Rio de Janeiro, Buenos Aires, Lima, Cartagena, expect a voyage filled with scenic wonders and luxurious comforts.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Explore a new side of South America with this luminous odyssey starting in Montevideo. Visit charming ports such as Lima, Santiago, Buenos Aires, each offering its own unique rhythm.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Experience coastal elegance on this lullaby from Montevideo, where the journey through South America includes stops in Santiago, Rio de Janeiro, each more enchanting than the last.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "An unforgettable elevation awaits as you cruise from Montevideo across South America. Dive into history, flavor, and culture with stops including Lima, Rio de Janeiro.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Your journey begins in Montevideo, where the spirit of exploration meets modern luxury. From the sun-drenched shores of Buenos Aires to the historic streets of Lima, each stop in the South America will leave a lasting impression.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Cruise into cultural richness aboard this pristine quest departing Montevideo. Savor local cuisine and uncover regional beauty from Cartagena to Buenos Aires.",
