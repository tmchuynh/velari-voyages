...
export const veniceCruises: Cruise[] = [
{
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Launch into adventure from Venice and sail deep into the heart of the Mediterranean. With ports of call like Athens, Florence, expect a voyage filled with scenic wonders and luxurious comforts.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Sail into splendor from Venice on a eternal voyage through Mediterranean. Let each stop—from Dubrovnik to Rome—reveal the unique flavors and colors of the region.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Escape into the calm waters of Mediterranean with this verdant journey from Venice. Explore vibrant markets, sun-soaked beaches, and architectural marvels at Lisbon, Dubrovnik.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Launch into adventure from Venice and sail deep into the heart of the Mediterranean. With ports of call like Rome, Athens, expect a voyage filled with scenic wonders and luxurious comforts.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Depart from iconic Venice and traverse the Mediterranean with visits to Rome, Mykonos, Santorini, Lisbon. Every day offers fresh discoveries, culinary delights, and moments of pure relaxation.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Experience coastal elegance on this tide from Venice, where the journey through Mediterranean includes stops in Lisbon, Athens, Barcelona, each more enchanting than the last.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Let this unforgettable voyage redefine your idea of travel. From Venice, explore the Mediterranean in luxurious comfort, stopping at Florence, Santorini, Rome, Mykonos where every port offers a new chapter.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Set sail from historic Venice for a modern escape into the Mediterranean. Savor gourmet cuisine, cultural treasures, and beautiful coastlines with stops in Dubrovnik, Florence, Athens.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Embark from Venice and traverse the Mediterranean in style. Whether it’s the energy of Rome or the calm of Dubrovnik, each destination reveals a new side of paradise.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Experience coastal elegance on this embrace from Venice, where the journey through Mediterranean includes stops in Athens, Rome, Florence, each more enchanting than the last.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Sail away from Venice into the beautiful expanse of Mediterranean. Along the way, enjoy rich cultural experiences in Malta, Florence, Mykonos, Lisbon, where history, nature, and cuisine collide.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Let the spirit of exploration guide your mystical journey from Venice. This cruise offers a balanced mix of luxury and adventure, visiting stunning locales like Athens, Florence, Barcelona.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Embark from Venice and traverse the Mediterranean in style. Whether it’s the energy of Barcelona or the calm of Milan, each destination reveals a new side of paradise.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Set sail from Venice on this extraordinary eclipse through the heart of Mediterranean. Experience the perfect blend of relaxation and adventure as you explore Santorini and Malta and Lisbon and Milan, with personalized service and unforgettable experiences awaiting at every port.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Sail away from Venice into the beautiful expanse of Mediterranean. Along the way, enjoy rich cultural experiences in Barcelona, Florence, where history, nature, and cuisine collide.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "This heavenly zenith begins in Venice and ventures deep into the heart of Mediterranean. Wander through colorful markets, historic streets, and serene coastlines at Rome, Florence, Barcelona, Lisbon.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Let the waves lead you from Venice on this spectacular symphony. Traverse the iconic waters of Mediterranean and discover the beauty of Mykonos, Milan, Florence, Malta.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Sail into splendor from Venice on a panoramic voyage through Mediterranean. Let each stop—from Athens to Dubrovnik—reveal the unique flavors and colors of the region.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Let the waves lead you from Venice on this midnight odyssey. Traverse the iconic waters of Mediterranean and discover the beauty of Rome, Athens.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "From bustling Venice to serene Mediterranean shores, this cruise invites you to relax, explore, and indulge. Stops at Malta, Athens, Rome deliver a balanced blend of culture and comfort.",
