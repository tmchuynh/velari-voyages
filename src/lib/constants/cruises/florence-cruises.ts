...
export const florenceCruises: Cruise[] = [
{
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "This infinite cruise from Florence is your ticket to the captivating charm of the Mediterranean. Discover the delights of Athens, Rome with enriching excursions and award-winning service.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Escape to sea from Florence on a serene voyage exploring the magic of Mediterranean. Visit unforgettable locales like Rome, Milan, Athens, where each stop inspires awe.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Experience coastal elegance on this odyssey from Florence, where the journey through Mediterranean includes stops in Santorini, Lisbon, Dubrovnik, Venice, each more enchanting than the last.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Your journey through the Mediterranean begins in Florence, where elegance meets adventure. Explore the shores of Barcelona, Mykonos, Venice, with curated excursions and luxurious onboard amenities.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Set course from Florence for an inspiring secluded journey across Mediterranean. Whether exploring ancient ruins in Malta or soaking up coastal views in Rome, every day offers a perfect mix of discovery and relaxation.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Set sail from Florence on this breathtaking exploration through the heart of Mediterranean. Experience the perfect blend of relaxation and adventure as you explore Dubrovnik and Milan and Malta and Rome, with personalized service and unforgettable experiences awaiting at every port.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Board in Florence for a hand-crafted reunion through the breathtaking Mediterranean. Highlights include sun-drenched beaches, historic ports, and immersive culture in Santorini, Malta, Athens, Milan.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "This extraordinary adventure from Florence offers the ultimate Mediterranean exploration. Immerse yourself in the rich cultures and stunning landscapes of Malta, Santorini and Barcelona, creating memories that will last a lifetime.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "This inspiring tide departs from Florence, navigating the diverse landscapes and vibrant cities of Mediterranean. Must-see stops include Mykonos, Venice, Rome.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "A voyage of contrasts awaits from Florence. Discover the historical and natural richness of Mediterranean as you cruise to spectacular destinations like Lisbon, Athens.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "This radiant cruise from Florence is your ticket to the captivating charm of the Mediterranean. Discover the delights of Lisbon, Dubrovnik, Athens, Milan with enriching excursions and award-winning service.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Set sail from Florence on this spectacular tide through the heart of Mediterranean. Experience the perfect blend of relaxation and adventure as you explore Malta and Dubrovnik and Santorini, with personalized service and unforgettable experiences awaiting at every port.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Begin a captivating excursion through the Mediterranean, departing Florence. With visits to Venice, Mykonos, Lisbon, each day brings a new adventure and deeper connection to the region.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Escape the everyday with this lavish journey through Mediterranean, departing from Florence. You'll visit Dubrovnik, Athens, Lisbon, Barcelona, where every stop is a new adventure.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "An escape like no other begins in Florence, where your legacy launches into the heart of Mediterranean. Discover the magic of Lisbon, Milan, Malta with style and sophistication.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Board in Florence for a hand-crafted oasis through the breathtaking Mediterranean. Highlights include sun-drenched beaches, historic ports, and immersive culture in Malta, Lisbon, Dubrovnik.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Sail into splendor from Florence on a secret voyage through Mediterranean. Let each stop—from Malta to Venice—reveal the unique flavors and colors of the region.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Begin a captivating oasis through the Mediterranean, departing Florence. With visits to Mykonos, Rome, Malta, Lisbon, each day brings a new adventure and deeper connection to the region.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "A voyage of contrasts awaits from Florence. Discover the historical and natural richness of Mediterranean as you cruise to spectacular destinations like Milan, Santorini, Mykonos, Athens.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Depart from the iconic port of Florence and sail through the enchanting Mediterranean. Explore vibrant destinations like Lisbon, Mykonos, Rome, each offering its own unique charm and local flair.",
