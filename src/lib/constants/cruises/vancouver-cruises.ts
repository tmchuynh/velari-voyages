...
export const vancouverCruises: Cruise[] = [
  {
    ...
    itinerary: {
      ...
      description:
        "Depart from iconic Vancouver and traverse the Alaska with visits to Skagway, Ketchikan, Juneau. Every day offers fresh discoveries, culinary delights, and moments of pure relaxation.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Embark on an unforgettable pulse from the vibrant port of Vancouver, where you'll discover hidden gems and iconic landmarks across the Alaska region. With stops at Seattle, Victoria, this journey combines cultural immersion with breathtaking scenery.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "An escape like no other begins in Vancouver, where your sanctuary launches into the heart of Alaska. Discover the magic of Seattle, Juneau with style and sophistication.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Join us in Vancouver for a expedition of a lifetime. Sail across the serene waters of Alaska, stopping at ports like Seattle, Victoria, Ketchikan where timeless traditions meet modern luxuries.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Begin an epic sojourn from Vancouver, where the seas meet culture. Visit the remarkable ports of Juneau, Ketchikan while indulging in fine dining, entertainment, and unmatched hospitality.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Set course from Vancouver for an inspiring awe-inspiring journey across Alaska. Whether exploring ancient ruins in Skagway or soaking up coastal views in Victoria, every day offers a perfect mix of discovery and relaxation.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Sail into splendor from Vancouver on a midnight voyage through Alaska. Let each stop—from Sitka to Glacier Bay—reveal the unique flavors and colors of the region.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Cruise into cultural richness aboard this celestial sanctum departing Vancouver. Savor local cuisine and uncover regional beauty from Victoria to Seattle.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Let the spirit of exploration guide your mystical journey from Vancouver. This cruise offers a balanced mix of luxury and adventure, visiting stunning locales like Seattle, Victoria.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Depart Vancouver on a relaxing discovery through the Alaska region. Highlights include the stunning coastlines of Sitka, Glacier Bay, Seattle, all while enjoying first-class amenities on board.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Start in the vibrant city of Vancouver and venture into the iconic Alaska. Discover authentic local cultures, cuisine, and coastal wonders in Seattle, Skagway, Ketchikan, Glacier Bay.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Sail from Vancouver into a world of wonder. The Alaska beckons with unforgettable ports like Glacier Bay, Seattle, where every view is picture-perfect and every moment is priceless.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Your journey begins in Vancouver, where every sunset on the Alaska horizon promises another day of discovery—from Juneau, Victoria, Skagway, Glacier Bay to hidden ports of charm.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Set off on a awakening from Vancouver that captures the essence of Alaska. Discover cultural gems and culinary delights across Ketchikan, Seattle, Sitka, Skagway.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Escape the everyday with this midnight journey through Alaska, departing from Vancouver. You'll visit Sitka, Skagway, where every stop is a new adventure.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Escape the everyday with this heavenly journey through Alaska, departing from Vancouver. You'll visit Skagway, Ketchikan, Glacier Bay, where every stop is a new adventure.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "This secluded cruise from Vancouver is your ticket to the captivating charm of the Alaska. Discover the delights of Sitka, Juneau, Victoria, Ketchikan with enriching excursions and award-winning service.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Step aboard in Vancouver and begin a transcendent journey through the scenic Alaska. From historic cities to coastal hideaways like Glacier Bay, Victoria, every day is unforgettable.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Launch into adventure from Vancouver and sail deep into the heart of the Alaska. With ports of call like Juneau, Glacier Bay, expect a voyage filled with scenic wonders and luxurious comforts.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Begin your journey in Vancouver, where tradition meets travel. This immersive awakening reveals the finest of Alaska, from the beaches of Seattle to the streets of Ketchikan.",
