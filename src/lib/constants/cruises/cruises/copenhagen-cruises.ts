...
export const copenhagenCruises: Cruise[] = [
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Sail into splendor from Copenhagen on a harmonic voyage through Northern Europe. Let each stop—from Dublin to Kiel—reveal the unique flavors and colors of the region.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Begin an epic serenade from Copenhagen, where the seas meet culture. Visit the remarkable ports of Amsterdam, Stockholm while indulging in fine dining, entertainment, and unmatched hospitality.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Sail away from the charming harbor of Copenhagen on this tide-washed journey across Northern Europe. Uncover the beauty and history of Helsinki, Tallinn, Oslo with curated excursions, world-class cuisine, and exceptional service.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Begin an epic awakening from Copenhagen, where the seas meet culture. Visit the remarkable ports of Tallinn, Oslo, Helsinki while indulging in fine dining, entertainment, and unmatched hospitality.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Start in the vibrant city of Copenhagen and venture into the iconic Northern Europe. Discover authentic local cultures, cuisine, and coastal wonders in Dublin, Stockholm.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "This handpicked adventure begins in Copenhagen and travels through Northern Europe's iconic waterscapes. Discover Oslo, Tallinn as each day brings new stories and every night offers elegant repose.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Escape to sea from Copenhagen on a ornate voyage exploring the magic of Northern Europe. Visit unforgettable locales like Kiel, Tallinn, where each stop inspires awe.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Enjoy seamless luxury on this spectacular labyrinth beginning in Copenhagen. Visit breathtaking Northern Europe locales such as Oslo, Stockholm, London, Helsinki on this unforgettable itinerary.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "An unforgettable adventure awaits as you cruise from Copenhagen across Northern Europe. Dive into history, flavor, and culture with stops including Amsterdam, Helsinki, Berlin, St. Petersburg.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Step aboard in Copenhagen and begin a heavenly journey through the scenic Northern Europe. From historic cities to coastal hideaways like London, Amsterdam, every day is unforgettable.",
