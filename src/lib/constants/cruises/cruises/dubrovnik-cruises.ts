...
export const dubrovnikCruises: Cruise[] = [
  {
    ...
    itinerary: {
      ...
      description:
        "Sail from Dubrovnik into a world of wonder. The Mediterranean beckons with unforgettable ports like Barcelona, Mykonos, Lisbon, where every view is picture-perfect and every moment is priceless.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Step aboard in Dubrovnik and begin a spectacular journey through the scenic Mediterranean. From historic cities to coastal hideaways like Rome, Malta, Venice, every day is unforgettable.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Sail from Dubrovnik into a world of wonder. The Mediterranean beckons with unforgettable ports like Athens, Mykonos, where every view is picture-perfect and every moment is priceless.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Sail away from Dubrovnik into the beautiful expanse of Mediterranean. Along the way, enjoy rich cultural experiences in Malta, Athens, Barcelona, Mykonos, where history, nature, and cuisine collide.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Experience the elegance of the seas on this mythic solstice through Mediterranean, starting from the illustrious port of Dubrovnik. From Malta, Venice to Barcelona, each destination offers its own story, culture, and breathtaking views.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Escape to sea from Dubrovnik on a heavenly voyage exploring the magic of Mediterranean. Visit unforgettable locales like Malta, Milan, Venice, Santorini, where each stop inspires awe.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Your solstice begins in Dubrovnik, where the spirit of exploration meets modern luxury. From the sun-drenched shores of Santorini to the historic streets of Barcelona, each stop in the Mediterranean will leave a lasting impression.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Discover the wonders of Mediterranean aboard this enchanting cruise departing from Dubrovnik. Journey through crystal waters to explore the treasures of Florence, Lisbon, Malta, where each day brings new adventures and evenings are filled with elegant dining and entertainment.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Your sanctum begins in Dubrovnik, where the spirit of exploration meets modern luxury. From the sun-drenched shores of Athens to the historic streets of Florence, each stop in the Mediterranean will leave a lasting impression.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "An unforgettable oasis awaits as you cruise from Dubrovnik across Mediterranean. Dive into history, flavor, and culture with stops including Rome, Barcelona.",
