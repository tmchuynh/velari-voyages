...
export const roatanCruises: Cruise[] = [
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Step into a world of elegance and exploration from Roatan. This retreat through the Caribbean unveils stunning stops including Philipsburg, St. Thomas, Roatán, Nassau, all with first-class service.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Explore a new side of Caribbean with this harmonic quest starting in Roatan. Visit charming ports such as St. Thomas, Roatán, George Town, Nassau, each offering its own unique rhythm.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "From the lively departure port of Roatan, this curated awakening showcases the finest of Caribbean. With visits to San Juan, Tampa, you’ll experience a tapestry of flavors, sights, and unforgettable moments both onboard and ashore.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Begin a captivating escape through the Caribbean, departing Roatan. With visits to Nassau, San Juan, Miami, each day brings a new adventure and deeper connection to the region.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "This secret tranquility begins in Roatan and ventures deep into the heart of Caribbean. Wander through colorful markets, historic streets, and serene coastlines at Tampa, Nassau, Philipsburg.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Experience coastal elegance on this tide from Roatan, where the journey through Caribbean includes stops in Miami, Cozumel, Roatán, Bermuda, each more enchanting than the last.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "From the lively departure port of Roatan, this curated exploration showcases the finest of Caribbean. With visits to Roatán, Miami, you’ll experience a tapestry of flavors, sights, and unforgettable moments both onboard and ashore.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "An unforgettable sojourn awaits as you cruise from Roatan across Caribbean. Dive into history, flavor, and culture with stops including George Town, Bermuda, St. Thomas, Roatán.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Discover the wonders of Caribbean aboard this breathtaking cruise departing from Roatan. Journey through crystal waters to explore the treasures of St. Thomas, Cozumel, Tampa, where each day brings new adventures and evenings are filled with elegant dining and entertainment.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Start in the vibrant city of Roatan and venture into the iconic Caribbean. Discover authentic local cultures, cuisine, and coastal wonders in San Juan, George Town, St. Thomas, Tampa.",
