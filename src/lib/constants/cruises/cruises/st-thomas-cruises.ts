...
export const stThomasCruises: Cruise[] = [
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Let this secret voyage redefine your idea of travel. From St Thomas, explore the Caribbean in luxurious comfort, stopping at George Town, Fort Lauderdale, Philipsburg where every port offers a new chapter.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Let the spirit of exploration guide your pearlescent journey from St Thomas. This cruise offers a balanced mix of luxury and adventure, visiting stunning locales like Cozumel, Roatán, San Juan, Miami.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Begin an epic lullaby from St Thomas, where the seas meet culture. Visit the remarkable ports of Cozumel, Bermuda, San Juan, Nassau while indulging in fine dining, entertainment, and unmatched hospitality.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Let the waves lead you from St Thomas on this opulent mythos. Traverse the iconic waters of Caribbean and discover the beauty of Roatán, George Town, San Juan.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Let the winds of the Caribbean carry you from St Thomas to the most stunning ports in the region. With destinations like George Town, Bermuda, this sojourn redefines luxury travel.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Embark from St Thomas and traverse the Caribbean in style. Whether it’s the energy of St. Thomas or the calm of Fort Lauderdale, each destination reveals a new side of paradise.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Embark on an unforgettable odyssey from the vibrant port of St Thomas, where you'll discover hidden gems and iconic landmarks across the Caribbean region. With stops at Roatán, George Town, Miami, Philipsburg, this journey combines cultural immersion with breathtaking scenery.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Leave stress behind with this curated discovery from St Thomas. Sail across the best of Caribbean and explore treasures like Roatán, Miami, Tampa, Philipsburg with comfort and style.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Your frontier begins in St Thomas, where the spirit of exploration meets modern luxury. From the sun-drenched shores of George Town to the historic streets of San Juan, each stop in the Caribbean will leave a lasting impression.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Begin a captivating mirage through the Caribbean, departing St Thomas. With visits to Bermuda, Tampa, Fort Lauderdale, Philipsburg, each day brings a new adventure and deeper connection to the region.",
