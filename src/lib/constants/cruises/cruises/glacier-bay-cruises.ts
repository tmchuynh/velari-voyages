...
export const glacierBayCruises: Cruise[] = [
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "This extraordinary quest from Glacier Bay offers the ultimate Alaska exploration. Immerse yourself in the rich cultures and stunning landscapes of Ketchikan, Vancouver, Juneau and Sitka, creating memories that will last a lifetime.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Set sail from Glacier Bay on this harmonic drift through the heart of Alaska. Experience the perfect blend of relaxation and adventure as you explore Seattle and Juneau and Sitka, with personalized service and unforgettable experiences awaiting at every port.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Embark from Glacier Bay and traverse the Alaska in style. Whether it’s the energy of Ketchikan or the calm of Victoria, each destination reveals a new side of paradise.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "This hand-selected exquisite cruise offers a true taste of Alaska. Depart from Glacier Bay and explore ports like Juneau, Sitka, each telling a story through food, music, and tradition.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Cruise into cultural richness aboard this legendary voyage departing Glacier Bay. Savor local cuisine and uncover regional beauty from Seattle to Ketchikan.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "This gilded oasis begins in Glacier Bay and ventures deep into the heart of Alaska. Wander through colorful markets, historic streets, and serene coastlines at Ketchikan, Juneau, Skagway.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Let the winds of the Alaska carry you from Glacier Bay to the most stunning ports in the region. With destinations like Seattle, Skagway, Ketchikan, Juneau, this requiem redefines luxury travel.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Let the waves lead you from Glacier Bay on this enchanting labyrinth. Traverse the iconic waters of Alaska and discover the beauty of Vancouver, Juneau, Seattle.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Discover the wonders of Alaska aboard this ornate cruise departing from Glacier Bay. Journey through crystal waters to explore the treasures of Ketchikan, Victoria, Sitka, where each day brings new adventures and evenings are filled with elegant dining and entertainment.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Depart from the iconic port of Glacier Bay and sail through the enchanting Alaska. Explore vibrant destinations like Ketchikan, Vancouver, each offering its own unique charm and local flair.",
