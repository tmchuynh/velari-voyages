...
export const galvestonCruises: Cruise[] = [
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "An escape like no other begins in Galveston, where your expedition launches into the heart of Caribbean. Discover the magic of Cozumel, Philipsburg, Fort Lauderdale with style and sophistication.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Cruise into cultural richness aboard this timeless realm departing Galveston. Savor local cuisine and uncover regional beauty from Fort Lauderdale to George Town.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Embark from Galveston and traverse the Caribbean in style. Whether it’s the energy of San Juan or the calm of Nassau, each destination reveals a new side of paradise.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Set sail from historic Galveston for a modern escape into the Caribbean. Savor gourmet cuisine, cultural treasures, and beautiful coastlines with stops in Roatán, San Juan, Cozumel.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Set sail from Galveston for a voyage like no other. From the picturesque landscapes of Philipsburg to the lively ambiance of Nassau, this lavish cruise will redefine your view of Caribbean.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Your expedition begins in Galveston, where every sunset on the Caribbean horizon promises another day of discovery—from Fort Lauderdale, Tampa to hidden ports of charm.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "This moonlit discovery begins in Galveston and ventures deep into the heart of Caribbean. Wander through colorful markets, historic streets, and serene coastlines at St. Thomas, Bermuda, Nassau, Philipsburg.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Escape to sea from Galveston on a immersive voyage exploring the magic of Caribbean. Visit unforgettable locales like Roatán, Fort Lauderdale, Tampa, Miami, where each stop inspires awe.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Escape to sea from Galveston on a dreamlike voyage exploring the magic of Caribbean. Visit unforgettable locales like Bermuda, Fort Lauderdale, where each stop inspires awe.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Set sail from Galveston on this moonlit reverie through the heart of Caribbean. Experience the perfect blend of relaxation and adventure as you explore Fort Lauderdale and San Juan, with personalized service and unforgettable experiences awaiting at every port.",
