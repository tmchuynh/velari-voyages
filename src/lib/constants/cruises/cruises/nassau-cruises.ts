...
export const nassauCruises: Cruise[] = [
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Experience the elegance of the seas on this celestial eclipse through Caribbean, starting from the illustrious port of Nassau. From Bermuda to Roatán, each destination offers its own story, culture, and breathtaking views.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "This radiant cruise from Nassau is your ticket to the captivating charm of the Caribbean. Discover the delights of Bermuda, George Town with enriching excursions and award-winning service.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Depart from the iconic port of Nassau and sail through the enchanting Caribbean. Explore vibrant destinations like George Town, Miami, San Juan, Fort Lauderdale, each offering its own unique charm and local flair.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "An unforgettable awakening awaits as you cruise from Nassau across Caribbean. Dive into history, flavor, and culture with stops including Miami, Cozumel, Bermuda.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Sail away from Nassau into the beautiful expanse of Caribbean. Along the way, enjoy rich cultural experiences in San Juan, George Town, Miami, where history, nature, and cuisine collide.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Embark from Nassau and traverse the Caribbean in style. Whether it’s the energy of Bermuda or the calm of Fort Lauderdale, each destination reveals a new side of paradise.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Join us in Nassau for a voyage of a lifetime. Sail across the serene waters of Caribbean, stopping at ports like Roatán, George Town, Fort Lauderdale where timeless traditions meet modern luxuries.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "This inspiring arcadia departs from Nassau, navigating the diverse landscapes and vibrant cities of Caribbean. Must-see stops include St. Thomas, Miami, Fort Lauderdale.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Escape the everyday with this luxurious journey through Caribbean, departing from Nassau. You'll visit San Juan, George Town, where every stop is a new adventure.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Let the winds of the Caribbean carry you from Nassau to the most stunning ports in the region. With destinations like Miami, St. Thomas, Tampa, Fort Lauderdale, this panorama redefines luxury travel.",
