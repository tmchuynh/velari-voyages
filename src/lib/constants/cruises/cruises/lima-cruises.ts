...
export const limaCruises: Cruise[] = [
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "This secret sanctum begins in Lima and ventures deep into the heart of South America. Wander through colorful markets, historic streets, and serene coastlines at Rio de Janeiro, Santiago.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Let this harmonic voyage redefine your idea of travel. From Lima, explore the South America in luxurious comfort, stopping at Montevideo, Rio de Janeiro, Buenos Aires where every port offers a new chapter.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "From the lively departure port of Lima, this curated legacy showcases the finest of South America. With visits to Santiago, Montevideo, you’ll experience a tapestry of flavors, sights, and unforgettable moments both onboard and ashore.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Escape the everyday with this refined journey through South America, departing from Lima. You'll visit Rio de Janeiro, Santiago, Montevideo, Cartagena, where every stop is a new adventure.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Set sail from Lima on this ornate reunion through the heart of South America. Experience the perfect blend of relaxation and adventure as you explore Cartagena and Rio de Janeiro and Santiago and Montevideo, with personalized service and unforgettable experiences awaiting at every port.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Experience coastal elegance on this elevation from Lima, where the journey through South America includes stops in Santiago, Rio de Janeiro, Buenos Aires, Montevideo, each more enchanting than the last.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Depart from iconic Lima and traverse the South America with visits to Santiago, Buenos Aires, Rio de Janeiro, Cartagena. Every day offers fresh discoveries, culinary delights, and moments of pure relaxation.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Depart from Lima on this thoughtfully designed pilgrimage across the South America. Savor coastal charm, cultural treasures, and ocean views with stops at Rio de Janeiro, Santiago, Cartagena.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Escape the everyday with this mythic journey through South America, departing from Lima. You'll visit Cartagena, Buenos Aires, Rio de Janeiro, Montevideo, where every stop is a new adventure.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Set sail from Lima for a voyage like no other. From the picturesque landscapes of Cartagena to the lively ambiance of Santiago, this horizon-kissed cruise will redefine your view of South America.",
