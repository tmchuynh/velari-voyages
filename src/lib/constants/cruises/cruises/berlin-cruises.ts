...
export const berlinCruises: Cruise[] = [
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "This extraordinary passage from Berlin offers the ultimate Northern Europe exploration. Immerse yourself in the rich cultures and stunning landscapes of Stockholm, Copenhagen and Amsterdam, creating memories that will last a lifetime.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Depart Berlin on a relaxing infinite through the Northern Europe region. Highlights include the stunning coastlines of London, Kiel, Oslo, Amsterdam, all while enjoying first-class amenities on board.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Your infinite begins in Berlin, where every sunset on the Northern Europe horizon promises another day of discovery—from Tallinn, Oslo, Helsinki to hidden ports of charm.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Let the winds of the Northern Europe carry you from Berlin to the most stunning ports in the region. With destinations like Dublin, London, Southampton, this resonance redefines luxury travel.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "This haven takes you beyond the ordinary, starting in Berlin. With breathtaking stops in Southampton, Tallinn, your cruise delivers immersive moments and unforgettable vistas.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Embark on an unforgettable currents from the vibrant port of Berlin, where you'll discover hidden gems and iconic landmarks across the Northern Europe region. With stops at Helsinki, Amsterdam, Southampton, this journey combines cultural immersion with breathtaking scenery.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Sail into splendor from Berlin on a tide-washed voyage through Northern Europe. Let each stop—from Helsinki to London—reveal the unique flavors and colors of the region.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Set sail from Berlin on this tide-washed voyage through the heart of Northern Europe. Experience the perfect blend of relaxation and adventure as you explore London and Helsinki, with personalized service and unforgettable experiences awaiting at every port.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Embark on an unforgettable elevation from the vibrant port of Berlin, where you'll discover hidden gems and iconic landmarks across the Northern Europe region. With stops at Southampton, Helsinki, this journey combines cultural immersion with breathtaking scenery.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Set sail from Berlin for a voyage like no other. From the picturesque landscapes of Amsterdam to the lively ambiance of Dublin, this mythic cruise will redefine your view of Northern Europe.",
