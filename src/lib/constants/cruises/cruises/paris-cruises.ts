...
export const parisCruises: Cruise[] = [
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "This hand-selected midnight cruise offers a true taste of Northern Europe. Depart from Paris and explore ports like Southampton, London, Berlin, Copenhagen, each telling a story through food, music, and tradition.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Start in the vibrant city of Paris and venture into the iconic Northern Europe. Discover authentic local cultures, cuisine, and coastal wonders in Helsinki, Kiel, Tallinn.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Experience coastal elegance on this odyssey from Paris, where the journey through Northern Europe includes stops in Stockholm, Oslo, each more enchanting than the last.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Step aboard in Paris and begin a spectacular journey through the scenic Northern Europe. From historic cities to coastal hideaways like Berlin, Copenhagen, every day is unforgettable.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "This escape takes you beyond the ordinary, starting in Paris. With breathtaking stops in Stockholm, Southampton, Oslo, your cruise delivers immersive moments and unforgettable vistas.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Set sail from Paris on this majestic realm through the heart of Northern Europe. Experience the perfect blend of relaxation and adventure as you explore St. Petersburg and Tallinn and Copenhagen and London, with personalized service and unforgettable experiences awaiting at every port.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Sail from Paris into a world of wonder. The Northern Europe beckons with unforgettable ports like Helsinki, Kiel, St. Petersburg, where every view is picture-perfect and every moment is priceless.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Escape into the calm waters of Northern Europe with this whispering journey from Paris. Explore vibrant markets, sun-soaked beaches, and architectural marvels at Amsterdam, St. Petersburg.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Depart Paris on a relaxing excursion through the Northern Europe region. Highlights include the stunning coastlines of Berlin, Dublin, St. Petersburg, all while enjoying first-class amenities on board.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Unwind and explore on this drift through Northern Europe, departing from Paris. With every stop—from Tallinn to London—you’ll collect memories that last a lifetime.",
