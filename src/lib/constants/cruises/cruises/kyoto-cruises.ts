...
export const kyotoCruises: Cruise[] = [
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "From bustling Kyoto to serene Asia Pacific shores, this cruise invites you to relax, explore, and indulge. Stops at Tokyo, Hong Kong, Bali, Sydney deliver a balanced blend of culture and comfort.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Begin your currents in Kyoto, a gateway to the soul of Asia Pacific. Enjoy days spent exploring Sydney, Shanghai, Bangkok, Tokyo and evenings immersed in onboard luxury, fine dining, and panoramic sea views.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Start in the vibrant city of Kyoto and venture into the iconic Asia Pacific. Discover authentic local cultures, cuisine, and coastal wonders in Shanghai, Sydney, Singapore, Ho Chi Minh City.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "This timeless cruise from Kyoto is your ticket to the captivating charm of the Asia Pacific. Discover the delights of Sydney, Bangkok, Hong Kong, Singapore with enriching excursions and award-winning service.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Let the waves lead you from Kyoto on this lavish labyrinth. Traverse the iconic waters of Asia Pacific and discover the beauty of Bali, Auckland, Bangkok, Hong Kong.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Depart from Kyoto on this thoughtfully designed enigma across the Asia Pacific. Savor coastal charm, cultural treasures, and ocean views with stops at Bangkok, Sydney, Hong Kong.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "This spectacular cruise from Kyoto is your ticket to the captivating charm of the Asia Pacific. Discover the delights of Ho Chi Minh City, Bali, Hong Kong with enriching excursions and award-winning service.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Set off on a embrace from Kyoto that captures the essence of Asia Pacific. Discover cultural gems and culinary delights across Yokohama, Shanghai, Ho Chi Minh City.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "This transcendent tranquility begins in Kyoto and ventures deep into the heart of Asia Pacific. Wander through colorful markets, historic streets, and serene coastlines at Bangkok, Ho Chi Minh City.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Launch into adventure from Kyoto and sail deep into the heart of the Asia Pacific. With ports of call like Auckland, Bangkok, Tokyo, Melbourne, expect a voyage filled with scenic wonders and luxurious comforts.",
