...
export const londonCruises: Cruise[] = [
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Begin an epic eclipse from London, where the seas meet culture. Visit the remarkable ports of Berlin, Kiel, Amsterdam while indulging in fine dining, entertainment, and unmatched hospitality.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Embark from London and traverse the Northern Europe in style. Whether it’s the energy of Dublin or the calm of Berlin, each destination reveals a new side of paradise.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Savor each moment of this exquisite escape through Northern Europe, starting in London. Visit renowned locations like Berlin, Southampton, St. Petersburg, Tallinn, where adventure and relaxation intertwine.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Leave ordinary behind as you sail from London across the captivating Northern Europe. Discover the distinctive personality of each destination, from Copenhagen, Amsterdam, Berlin.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Unwind and explore on this arcadia through Northern Europe, departing from London. With every stop—from Oslo to Amsterdam—you’ll collect memories that last a lifetime.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Let the waves lead you from London on this awe-inspiring awakening. Traverse the iconic waters of Northern Europe and discover the beauty of Oslo, St. Petersburg, Helsinki.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Step aboard in London and begin a starlit journey through the scenic Northern Europe. From historic cities to coastal hideaways like Copenhagen, Southampton, Kiel, every day is unforgettable.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "An escape like no other begins in London, where your awakening launches into the heart of Northern Europe. Discover the magic of Dublin, Stockholm, Amsterdam with style and sophistication.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "This breathtaking expedition begins in London and ventures deep into the heart of Northern Europe. Wander through colorful markets, historic streets, and serene coastlines at Copenhagen, Southampton, Dublin, Stockholm.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Escape to sea from London on a whispering voyage exploring the magic of Northern Europe. Visit unforgettable locales like Dublin, Amsterdam, where each stop inspires awe.",
