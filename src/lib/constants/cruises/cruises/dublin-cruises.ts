...
export const dublinCruises: Cruise[] = [
  {
    ...
    itinerary: {
      ...
      description:
        "Leave stress behind with this curated embrace from Dublin. Sail across the best of Northern Europe and explore treasures like Southampton, Berlin, Copenhagen with comfort and style.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Launch into adventure from Dublin and sail deep into the heart of the Northern Europe. With ports of call like Kiel, Copenhagen, London, Amsterdam, expect a voyage filled with scenic wonders and luxurious comforts.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Depart from iconic Dublin and traverse the Northern Europe with visits to Oslo, Tallinn, Stockholm, Helsinki. Every day offers fresh discoveries, culinary delights, and moments of pure relaxation.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Let this sublime voyage redefine your idea of travel. From Dublin, explore the Northern Europe in luxurious comfort, stopping at Helsinki, Copenhagen, Kiel where every port offers a new chapter.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Set off on a tranquility from Dublin that captures the essence of Northern Europe. Discover cultural gems and culinary delights across Berlin, Stockholm.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Experience coastal elegance on this requiem from Dublin, where the journey through Northern Europe includes stops in Oslo, Southampton, Copenhagen, each more enchanting than the last.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Step into a world of elegance and exploration from Dublin. This expedition through the Northern Europe unveils stunning stops including Amsterdam, Helsinki, Berlin, Kiel, all with first-class service.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Let this majestic voyage redefine your idea of travel. From Dublin, explore the Northern Europe in luxurious comfort, stopping at Southampton, Oslo where every port offers a new chapter.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Your embrace begins in Dublin, where the spirit of exploration meets modern luxury. From the sun-drenched shores of St. Petersburg to the historic streets of London, each stop in the Northern Europe will leave a lasting impression.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Embark on an unforgettable journey from the vibrant port of Dublin, where you'll discover hidden gems and iconic landmarks across the Northern Europe region. With stops at London, Stockholm, this journey combines cultural immersion with breathtaking scenery.",
