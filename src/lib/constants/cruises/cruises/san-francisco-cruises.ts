...
export const sanFranciscoCruises: Cruise[] = [
  {
    ...
    itinerary: {
      ...
      description:
        "Your frontier begins in San Francisco, where the spirit of exploration meets modern luxury. From the sun-drenched shores of Lisbon to the historic streets of Athens, each stop in the West Coast USA will leave a lasting impression.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "An escape like no other begins in San Francisco, where your journey launches into the heart of West Coast USA. Discover the magic of Dubrovnik, Santorini, Milan with style and sophistication.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Begin an epic awakening from San Francisco, where the seas meet culture. Visit the remarkable ports of Florence, Rome, Lisbon, Santorini while indulging in fine dining, entertainment, and unmatched hospitality.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Sail from San Francisco into a world of wonder. The West Coast USA beckons with unforgettable ports like Malta, Venice, where every view is picture-perfect and every moment is priceless.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Set sail from historic San Francisco for a modern escape into the West Coast USA. Savor gourmet cuisine, cultural treasures, and beautiful coastlines with stops in Lisbon, Venice, Athens.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Set sail from San Francisco for a voyage like no other. From the picturesque landscapes of Mykonos to the lively ambiance of Venice, this tide-washed cruise will redefine your view of West Coast USA.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "A voyage of contrasts awaits from San Francisco. Discover the historical and natural richness of West Coast USA as you cruise to spectacular destinations like Lisbon, Rome.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "This journey takes you beyond the ordinary, starting in San Francisco. With breathtaking stops in Venice, Milan, your cruise delivers immersive moments and unforgettable vistas.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Experience the elegance of the seas on this timeless escape through West Coast USA, starting from the illustrious port of San Francisco. From Milan to Barcelona, each destination offers its own story, culture, and breathtaking views.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Savor each moment of this radiant escape through West Coast USA, starting in San Francisco. Visit renowned locations like Milan, Malta, where adventure and relaxation intertwine.",
