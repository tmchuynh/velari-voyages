...
export const cartagenaCruises: Cruise[] = [
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Depart from the iconic port of Cartagena and sail through the enchanting Caribbean. Explore vibrant destinations like Bermuda, Miami, each offering its own unique charm and local flair.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Cruise into cultural richness aboard this transcendent elevation departing Cartagena. Savor local cuisine and uncover regional beauty from Cozumel to St. Thomas.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Set sail from historic Cartagena for a modern escape into the Caribbean. Savor gourmet cuisine, cultural treasures, and beautiful coastlines with stops in Roatán, Bermuda, Nassau, San Juan.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Step into a world of elegance and exploration from Cartagena. This voyage through the Caribbean unveils stunning stops including Tampa, Philipsburg, George Town, St. Thomas, all with first-class service.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "This saga takes you beyond the ordinary, starting in Cartagena. With breathtaking stops in Nassau, Fort Lauderdale, Philipsburg, George Town, your cruise delivers immersive moments and unforgettable vistas.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Enjoy seamless luxury on this mystical odyssey beginning in Cartagena. Visit breathtaking Caribbean locales such as Fort Lauderdale, Roatán on this unforgettable itinerary.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Embark on an unforgettable enigma from the vibrant port of Cartagena, where you'll discover hidden gems and iconic landmarks across the Caribbean region. With stops at Bermuda, Roatán, this journey combines cultural immersion with breathtaking scenery.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Board in Cartagena for a hand-crafted reverie through the breathtaking Caribbean. Highlights include sun-drenched beaches, historic ports, and immersive culture in Fort Lauderdale, Philipsburg.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "An unforgettable excursion awaits as you cruise from Cartagena across Caribbean. Dive into history, flavor, and culture with stops including Fort Lauderdale, Nassau, Miami.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Set sail from Cartagena on this awe-inspiring legacy through the heart of Caribbean. Experience the perfect blend of relaxation and adventure as you explore Cozumel and Bermuda and Fort Lauderdale, with personalized service and unforgettable experiences awaiting at every port.",
