...
export const milanCruises: Cruise[] = [
  {
    ...
    itinerary: {
      ...
      description:
        "Let the waves lead you from Milan on this gilded panorama. Traverse the iconic waters of Mediterranean and discover the beauty of Dubrovnik, Santorini.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Begin your journey in Milan, where tradition meets travel. This immersive sanctuary reveals the finest of Mediterranean, from the beaches of Mykonos to the streets of Dubrovnik.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "From bustling Milan to serene Mediterranean shores, this cruise invites you to relax, explore, and indulge. Stops at Florence, Dubrovnik deliver a balanced blend of culture and comfort.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "This extraordinary infinite from Milan offers the ultimate Mediterranean exploration. Immerse yourself in the rich cultures and stunning landscapes of Dubrovnik, Santorini, Mykonos and Malta, creating memories that will last a lifetime.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "This hand-selected pearlescent cruise offers a true taste of Mediterranean. Depart from Milan and explore ports like Athens, Rome, Lisbon, Santorini, each telling a story through food, music, and tradition.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "From bustling Milan to serene Mediterranean shores, this cruise invites you to relax, explore, and indulge. Stops at Florence, Rome deliver a balanced blend of culture and comfort.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Sail from Milan into a world of wonder. The Mediterranean beckons with unforgettable ports like Venice, Malta, where every view is picture-perfect and every moment is priceless.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Start in the vibrant city of Milan and venture into the iconic Mediterranean. Discover authentic local cultures, cuisine, and coastal wonders in Lisbon, Florence, Mykonos, Santorini.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Escape into the calm waters of Mediterranean with this crystalline journey from Milan. Explore vibrant markets, sun-soaked beaches, and architectural marvels at Lisbon, Mykonos.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Experience the elegance of the seas on this starlit mystique through Mediterranean, starting from the illustrious port of Milan. From Florence, Santorini, Venice to Dubrovnik, each destination offers its own story, culture, and breathtaking views.",
