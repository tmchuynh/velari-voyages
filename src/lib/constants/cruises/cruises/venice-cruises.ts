...
export const veniceCruises: Cruise[] = [
  {
    ...
    itinerary: {
      ...
      description:
        "Set off on a awakening from Venice that captures the essence of Mediterranean. Discover cultural gems and culinary delights across Mykonos, Malta, Rome, Milan.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "This whisper takes you beyond the ordinary, starting in Venice. With breathtaking stops in Dubrovnik, Barcelona, Santorini, your cruise delivers immersive moments and unforgettable vistas.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Experience the elegance of the seas on this exquisite discovery through Mediterranean, starting from the illustrious port of Venice. From Athens, Rome to Mykonos, each destination offers its own story, culture, and breathtaking views.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Your panorama begins in Venice, where every sunset on the Mediterranean horizon promises another day of discovery—from Santorini, Dubrovnik, Milan, Florence to hidden ports of charm.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Begin your journey in Venice, where tradition meets travel. This immersive legacy reveals the finest of Mediterranean, from the beaches of Santorini to the streets of Malta.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Step into a world of elegance and exploration from Venice. This odyssey through the Mediterranean unveils stunning stops including Barcelona, Florence, all with first-class service.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "This awe-inspiring discovery begins in Venice and ventures deep into the heart of Mediterranean. Wander through colorful markets, historic streets, and serene coastlines at Lisbon, Santorini, Athens.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Your infinite begins in Venice, where the spirit of exploration meets modern luxury. From the sun-drenched shores of Rome to the historic streets of Lisbon, each stop in the Mediterranean will leave a lasting impression.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Embark on an unforgettable arcadia from the vibrant port of Venice, where you'll discover hidden gems and iconic landmarks across the Mediterranean region. With stops at Santorini, Lisbon, Barcelona, this journey combines cultural immersion with breathtaking scenery.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Discover the wonders of Mediterranean aboard this midnight cruise departing from Venice. Journey through crystal waters to explore the treasures of Rome, Milan, Lisbon, where each day brings new adventures and evenings are filled with elegant dining and entertainment.",
