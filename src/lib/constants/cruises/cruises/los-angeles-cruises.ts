...
export const losAngelesCruises: Cruise[] = [
  {
    ...
    itinerary: {
      ...
      description:
        "Join us in Los Angeles for a symphony of a lifetime. Sail across the serene waters of West Coast USA, stopping at ports like Santorini, Barcelona where timeless traditions meet modern luxuries.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "An unforgettable pulse awaits as you cruise from Los Angeles across West Coast USA. Dive into history, flavor, and culture with stops including Mykonos, Milan, Florence.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Step into a world of elegance and exploration from Los Angeles. This pulse through the West Coast USA unveils stunning stops including Mykonos, Barcelona, all with first-class service.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "This transcendent cruise from Los Angeles is your ticket to the captivating charm of the West Coast USA. Discover the delights of Mykonos, Dubrovnik, Florence, Milan with enriching excursions and award-winning service.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Depart from the iconic port of Los Angeles and sail through the enchanting West Coast USA. Explore vibrant destinations like Barcelona, Lisbon, each offering its own unique charm and local flair.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Begin a captivating labyrinth through the West Coast USA, departing Los Angeles. With visits to Malta, Venice, Florence, Dubrovnik, each day brings a new adventure and deeper connection to the region.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Set course from Los Angeles for an inspiring heavenly journey across West Coast USA. Whether exploring ancient ruins in Athens or soaking up coastal views in Santorini, every day offers a perfect mix of discovery and relaxation.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Board in Los Angeles for a hand-crafted tranquility through the breathtaking West Coast USA. Highlights include sun-drenched beaches, historic ports, and immersive culture in Athens, Florence, Lisbon.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Embark on an unforgettable currents from the vibrant port of Los Angeles, where you'll discover hidden gems and iconic landmarks across the West Coast USA region. With stops at Venice, Athens, this journey combines cultural immersion with breathtaking scenery.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Depart from iconic Los Angeles and traverse the West Coast USA with visits to Milan, Rome. Every day offers fresh discoveries, culinary delights, and moments of pure relaxation.",
