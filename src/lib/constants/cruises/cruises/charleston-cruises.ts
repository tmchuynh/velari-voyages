...
export const charlestonCruises: Cruise[] = [
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Escape into the calm waters of East Coast USA with this riveting journey from Charleston. Explore vibrant markets, sun-soaked beaches, and architectural marvels at Lisbon, Santorini, Malta.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Set sail from Charleston for a voyage like no other. From the picturesque landscapes of Malta to the lively ambiance of Santorini, this breathtaking cruise will redefine your view of East Coast USA.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Cruise into cultural richness aboard this sun-drenched oasis departing Charleston. Savor local cuisine and uncover regional beauty from Florence to Milan.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Your journey through the East Coast USA begins in Charleston, where elegance meets adventure. Explore the shores of Mykonos, Malta, Rome, with curated excursions and luxurious onboard amenities.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Depart from iconic Charleston and traverse the East Coast USA with visits to Lisbon, Rome, Santorini, Barcelona. Every day offers fresh discoveries, culinary delights, and moments of pure relaxation.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Depart from Charleston on this thoughtfully designed exploration across the East Coast USA. Savor coastal charm, cultural treasures, and ocean views with stops at Malta, Lisbon.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Depart Charleston on a relaxing realm through the East Coast USA region. Highlights include the stunning coastlines of Venice, Mykonos, Lisbon, all while enjoying first-class amenities on board.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Cruise into cultural richness aboard this verdant sojourn departing Charleston. Savor local cuisine and uncover regional beauty from Lisbon to Athens.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Begin your journey in Charleston, where tradition meets travel. This immersive legacy reveals the finest of East Coast USA, from the beaches of Florence to the streets of Mykonos.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Sail into splendor from Charleston on a legendary voyage through East Coast USA. Let each stop—from Lisbon to Rome—reveal the unique flavors and colors of the region.",
