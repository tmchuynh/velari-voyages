...
export const buenosAiresCruises: Cruise[] = [
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "This realm takes you beyond the ordinary, starting in Buenos Aires. With breathtaking stops in Santiago, Montevideo, Rio de Janeiro, your cruise delivers immersive moments and unforgettable vistas.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Sail away from Buenos Aires into the beautiful expanse of South America. Along the way, enjoy rich cultural experiences in Santiago, Rio de Janeiro, Lima, where history, nature, and cuisine collide.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Your panorama begins in Buenos Aires, where the spirit of exploration meets modern luxury. From the sun-drenched shores of Santiago to the historic streets of Rio de Janeiro, each stop in the South America will leave a lasting impression.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Set sail from historic Buenos Aires for a modern escape into the South America. Savor gourmet cuisine, cultural treasures, and beautiful coastlines with stops in Montevideo, Cartagena, Lima.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Explore a new side of South America with this enchanting frontier starting in Buenos Aires. Visit charming ports such as Rio de Janeiro, Cartagena, Lima, Montevideo, each offering its own unique rhythm.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Sail into splendor from Buenos Aires on a midnight voyage through South America. Let each stop—from Rio de Janeiro to Santiago—reveal the unique flavors and colors of the region.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Discover the wonders of South America aboard this majestic cruise departing from Buenos Aires. Journey through crystal waters to explore the treasures of Lima, Santiago, where each day brings new adventures and evenings are filled with elegant dining and entertainment.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Let the winds of the South America carry you from Buenos Aires to the most stunning ports in the region. With destinations like Rio de Janeiro, Santiago, this retreat redefines luxury travel.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Embark on an unforgettable requiem from the vibrant port of Buenos Aires, where you'll discover hidden gems and iconic landmarks across the South America region. With stops at Lima, Santiago, Rio de Janeiro, Montevideo, this journey combines cultural immersion with breathtaking scenery.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Sail into splendor from Buenos Aires on a dreamlike voyage through South America. Let each stop—from Santiago to Lima—reveal the unique flavors and colors of the region.",
