...
export const capeTownCruises: Cruise[] = [
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Embark on an unforgettable saga from the vibrant port of Cape Town, where you'll discover hidden gems and iconic landmarks across the Africa region. With stops at , this journey combines cultural immersion with breathtaking scenery.",
      ...
      route: [
  {
    ...
    "coordinates": {
      ...
      description: "This extraordinary elevation from Cape Town offers the ultimate Africa exploration. Immerse yourself in the rich cultures and stunning landscapes of  and , creating memories that will last a lifetime.",
      ...
      route: [
  {
    ...
    "coordinates": {
      ...
      description: "Experience the elegance of the seas on this harmonic expedition through Africa, starting from the illustrious port of Cape Town. From  to , each destination offers its own story, culture, and breathtaking views.",
      ...
      route: [
  {
    ...
    "coordinates": {
      ...
      description: "Start in the vibrant city of Cape Town and venture into the iconic Africa. Discover authentic local cultures, cuisine, and coastal wonders in .",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Sail into splendor from Cape Town on a lavish voyage through Africa. Let each stop—from undefined to undefined—reveal the unique flavors and colors of the region.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Sail away from the charming harbor of Cape Town on this infinite journey across Africa. Uncover the beauty and history of  with curated excursions, world-class cuisine, and exceptional service.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Depart Cape Town on a relaxing awakening through the Africa region. Highlights include the stunning coastlines of , all while enjoying first-class amenities on board.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Sail away from the charming harbor of Cape Town on this charming journey across Africa. Uncover the beauty and history of  with curated excursions, world-class cuisine, and exceptional service.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "This hand-selected hidden cruise offers a true taste of Africa. Depart from Cape Town and explore ports like , each telling a story through food, music, and tradition.",
