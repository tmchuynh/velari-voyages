...
export const osloCruises: Cruise[] = [
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Join us in Oslo for a oasis of a lifetime. Sail across the serene waters of Northern Europe, stopping at ports like Kiel, Tallinn, Copenhagen where timeless traditions meet modern luxuries.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "From bustling Oslo to serene Northern Europe shores, this cruise invites you to relax, explore, and indulge. Stops at Kiel, Southampton, St. Petersburg deliver a balanced blend of culture and comfort.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Escape the everyday with this enchanting journey through Northern Europe, departing from Oslo. You'll visit Kiel, Tallinn, Helsinki, Copenhagen, where every stop is a new adventure.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Unwind and explore on this resonance through Northern Europe, departing from Oslo. With every stop—from Stockholm to Southampton—you’ll collect memories that last a lifetime.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Set off on a tide from Oslo that captures the essence of Northern Europe. Discover cultural gems and culinary delights across Dublin, Helsinki, London, Copenhagen.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Your journey through the Northern Europe begins in Oslo, where elegance meets adventure. Explore the shores of Stockholm, Kiel, with curated excursions and luxurious onboard amenities.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "This extraordinary passage from Oslo offers the ultimate Northern Europe exploration. Immerse yourself in the rich cultures and stunning landscapes of Stockholm and Berlin, creating memories that will last a lifetime.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Board in Oslo for a hand-crafted frontier through the breathtaking Northern Europe. Highlights include sun-drenched beaches, historic ports, and immersive culture in Amsterdam, Stockholm, Dublin, Southampton.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Begin an epic realm from Oslo, where the seas meet culture. Visit the remarkable ports of St. Petersburg, Southampton, Berlin while indulging in fine dining, entertainment, and unmatched hospitality.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Let the waves lead you from Oslo on this forbidden awakening. Traverse the iconic waters of Northern Europe and discover the beauty of Southampton, Amsterdam, Dublin.",
