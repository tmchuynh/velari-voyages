...
export const seattleCruises: Cruise[] = [
  {
    ...
    itinerary: {
      ...
      description:
        "An escape like no other begins in Seattle, where your awakening launches into the heart of Alaska. Discover the magic of Vancouver, Victoria with style and sophistication.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Sail away from Seattle into the beautiful expanse of Alaska. Along the way, enjoy rich cultural experiences in Glacier Bay, Ketchikan, Sitka, Victoria, where history, nature, and cuisine collide.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Begin a captivating wanderlust through the Alaska, departing Seattle. With visits to Skagway, Juneau, Vancouver, Glacier Bay, each day brings a new adventure and deeper connection to the region.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Savor each moment of this luminous escape through Alaska, starting in Seattle. Visit renowned locations like Skagway, Vancouver, Victoria, where adventure and relaxation intertwine.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Board in Seattle for a hand-crafted requiem through the breathtaking Alaska. Highlights include sun-drenched beaches, historic ports, and immersive culture in Juneau, Glacier Bay, Ketchikan, Victoria.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Embark on an unforgettable labyrinth from the vibrant port of Seattle, where you'll discover hidden gems and iconic landmarks across the Alaska region. With stops at Vancouver, Sitka, Glacier Bay, this journey combines cultural immersion with breathtaking scenery.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Join us in Seattle for a expedition of a lifetime. Sail across the serene waters of Alaska, stopping at ports like Vancouver, Victoria where timeless traditions meet modern luxuries.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Escape the everyday with this verdant journey through Alaska, departing from Seattle. You'll visit Glacier Bay, Ketchikan, where every stop is a new adventure.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Your zenith begins in Seattle, where the spirit of exploration meets modern luxury. From the sun-drenched shores of Victoria to the historic streets of Glacier Bay, each stop in the Alaska will leave a lasting impression.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Leave stress behind with this curated enigma from Seattle. Sail across the best of Alaska and explore treasures like Skagway, Victoria with comfort and style.",
