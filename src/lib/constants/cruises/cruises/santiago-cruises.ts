...
export const santiagoCruises: Cruise[] = [
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Set sail from Santiago for a voyage like no other. From the picturesque landscapes of Rio de Janeiro to the lively ambiance of Buenos Aires, this majestic cruise will redefine your view of South America.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Enjoy seamless luxury on this tide-washed quest beginning in Santiago. Visit breathtaking South America locales such as Rio de Janeiro, Lima on this unforgettable itinerary.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Experience coastal elegance on this renaissance from Santiago, where the journey through South America includes stops in Rio de Janeiro, Lima, each more enchanting than the last.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Cruise into cultural richness aboard this transcendent drift departing Santiago. Savor local cuisine and uncover regional beauty from Rio de Janeiro to Buenos Aires.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Escape the everyday with this pristine journey through South America, departing from Santiago. You'll visit Lima, Cartagena, where every stop is a new adventure.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Experience coastal elegance on this currents from Santiago, where the journey through South America includes stops in Lima, Cartagena, Rio de Janeiro, Buenos Aires, each more enchanting than the last.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "An unforgettable passage awaits as you cruise from Santiago across South America. Dive into history, flavor, and culture with stops including Lima, Rio de Janeiro, Cartagena.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Set sail from Santiago on this spectacular panorama through the heart of South America. Experience the perfect blend of relaxation and adventure as you explore Cartagena and Rio de Janeiro, with personalized service and unforgettable experiences awaiting at every port.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Embark on an unforgettable pilgrimage from the vibrant port of Santiago, where you'll discover hidden gems and iconic landmarks across the South America region. With stops at Lima, Montevideo, Cartagena, this journey combines cultural immersion with breathtaking scenery.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Enjoy seamless luxury on this hidden awakening beginning in Santiago. Visit breathtaking South America locales such as Montevideo, Lima, Buenos Aires, Cartagena on this unforgettable itinerary.",
