...
export const aucklandCruises: Cruise[] = [
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Set sail from Auckland for a voyage like no other. From the picturesque landscapes of Bali to the lively ambiance of Hong Kong, this floating cruise will redefine your view of Asia Pacific.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Leave ordinary behind as you sail from Auckland across the captivating Asia Pacific. Discover the distinctive personality of each destination, from Ho Chi Minh City, Bangkok.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Cruise into cultural richness aboard this immersive reunion departing Auckland. Savor local cuisine and uncover regional beauty from Bangkok to Melbourne.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Your resonance begins in Auckland, where every sunset on the Asia Pacific horizon promises another day of discovery—from Yokohama, Shanghai to hidden ports of charm.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "From bustling Auckland to serene Asia Pacific shores, this cruise invites you to relax, explore, and indulge. Stops at Melbourne, Sydney deliver a balanced blend of culture and comfort.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "A voyage of contrasts awaits from Auckland. Discover the historical and natural richness of Asia Pacific as you cruise to spectacular destinations like Shanghai, Kyoto, Tokyo.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Embark from Auckland and traverse the Asia Pacific in style. Whether it’s the energy of Singapore or the calm of Kyoto, each destination reveals a new side of paradise.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Escape into the calm waters of Asia Pacific with this luxurious journey from Auckland. Explore vibrant markets, sun-soaked beaches, and architectural marvels at Hong Kong, Ho Chi Minh City, Kyoto.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Embark from Auckland and traverse the Asia Pacific in style. Whether it’s the energy of Ho Chi Minh City or the calm of Sydney, each destination reveals a new side of paradise.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Sail into splendor from Auckland on a forbidden voyage through Asia Pacific. Let each stop—from Hong Kong to Bali—reveal the unique flavors and colors of the region.",
