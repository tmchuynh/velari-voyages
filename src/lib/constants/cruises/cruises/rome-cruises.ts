...
export const romeCruises: Cruise[] = [
  {
    ...
    itinerary: {
      ...
      description:
        "Unwind and explore on this realm through Mediterranean, departing from Rome. With every stop—from Malta to Venice—you’ll collect memories that last a lifetime.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Experience the elegance of the seas on this infinite wanderlust through Mediterranean, starting from the illustrious port of Rome. From Lisbon, Milan, Santorini to Athens, each destination offers its own story, culture, and breathtaking views.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Depart from iconic Rome and traverse the Mediterranean with visits to Mykonos, Lisbon, Dubrovnik. Every day offers fresh discoveries, culinary delights, and moments of pure relaxation.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Set off on a exploration from Rome that captures the essence of Mediterranean. Discover cultural gems and culinary delights across Athens, Venice, Malta, Santorini.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Sail into splendor from Rome on a starlit voyage through Mediterranean. Let each stop—from Florence to Athens—reveal the unique flavors and colors of the region.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Experience the elegance of the seas on this tranquil sanctum through Mediterranean, starting from the illustrious port of Rome. From Venice, Santorini, Lisbon to Malta, each destination offers its own story, culture, and breathtaking views.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Leave stress behind with this curated requiem from Rome. Sail across the best of Mediterranean and explore treasures like Lisbon, Barcelona, Milan, Malta with comfort and style.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "This handpicked wanderlust begins in Rome and travels through Mediterranean's iconic waterscapes. Discover Milan, Dubrovnik as each day brings new stories and every night offers elegant repose.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "This hand-selected epic cruise offers a true taste of Mediterranean. Depart from Rome and explore ports like Dubrovnik, Malta, each telling a story through food, music, and tradition.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "This hand-selected velvet cruise offers a true taste of Mediterranean. Depart from Rome and explore ports like Mykonos, Florence, Lisbon, each telling a story through food, music, and tradition.",
