...
export const juneauCruises: Cruise[] = [
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "This inspiring legacy departs from Juneau, navigating the diverse landscapes and vibrant cities of Alaska. Must-see stops include Victoria, Glacier Bay, Vancouver, Sitka.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Step aboard in Juneau and begin a hidden journey through the scenic Alaska. From historic cities to coastal hideaways like Victoria, Vancouver, every day is unforgettable.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Escape the everyday with this harmonic journey through Alaska, departing from Juneau. You'll visit Sitka, Glacier Bay, Vancouver, where every stop is a new adventure.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Embark from Juneau and traverse the Alaska in style. Whether it’s the energy of Skagway or the calm of Victoria, each destination reveals a new side of paradise.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Embark on an unforgettable labyrinth from the vibrant port of Juneau, where you'll discover hidden gems and iconic landmarks across the Alaska region. With stops at Seattle, Skagway, this journey combines cultural immersion with breathtaking scenery.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Sail into splendor from Juneau on a hidden voyage through Alaska. Let each stop—from Victoria to Vancouver—reveal the unique flavors and colors of the region.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "This currents takes you beyond the ordinary, starting in Juneau. With breathtaking stops in Sitka, Ketchikan, Seattle, your cruise delivers immersive moments and unforgettable vistas.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Step into a world of elegance and exploration from Juneau. This saga through the Alaska unveils stunning stops including Seattle, Glacier Bay, Vancouver, all with first-class service.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Your pulse begins in Juneau, where every sunset on the Alaska horizon promises another day of discovery—from Glacier Bay, Seattle, Vancouver to hidden ports of charm.",
