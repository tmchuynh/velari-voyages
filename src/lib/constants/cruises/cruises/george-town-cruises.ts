...
export const georgeTownCruises: Cruise[] = [
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Unwind and explore on this legacy through Caribbean, departing from George Town. With every stop—from Tampa to Fort Lauderdale—you’ll collect memories that last a lifetime.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "From the lively departure port of George Town, this curated odyssey showcases the finest of Caribbean. With visits to Miami, Roatán, Cozumel, you’ll experience a tapestry of flavors, sights, and unforgettable moments both onboard and ashore.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Leave stress behind with this curated tide from George Town. Sail across the best of Caribbean and explore treasures like Nassau, Cozumel with comfort and style.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Leave stress behind with this curated drift from George Town. Sail across the best of Caribbean and explore treasures like Fort Lauderdale, St. Thomas, San Juan with comfort and style.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Step aboard in George Town and begin a moonlit journey through the scenic Caribbean. From historic cities to coastal hideaways like Tampa, Fort Lauderdale, Roatán, every day is unforgettable.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Embark from George Town and traverse the Caribbean in style. Whether it’s the energy of Nassau or the calm of Miami, each destination reveals a new side of paradise.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Begin your journey in George Town, where tradition meets travel. This immersive wanderlust reveals the finest of Caribbean, from the beaches of St. Thomas to the streets of Fort Lauderdale.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Experience the elegance of the seas on this transcendent whisper through Caribbean, starting from the illustrious port of George Town. From Cozumel to San Juan, each destination offers its own story, culture, and breathtaking views.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Experience the elegance of the seas on this awe-inspiring arcadia through Caribbean, starting from the illustrious port of George Town. From Bermuda to Nassau, each destination offers its own story, culture, and breathtaking views.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Depart George Town on a relaxing elevation through the Caribbean region. Highlights include the stunning coastlines of Fort Lauderdale, St. Thomas, Bermuda, all while enjoying first-class amenities on board.",
