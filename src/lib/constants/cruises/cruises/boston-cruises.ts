...
export const bostonCruises: Cruise[] = [
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Savor each moment of this secret escape through East Coast USA, starting in Boston. Visit renowned locations like Florence, Milan, Venice, Barcelona, where adventure and relaxation intertwine.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Depart Boston on a relaxing reunion through the East Coast USA region. Highlights include the stunning coastlines of Athens, Santorini, Rome, Malta, all while enjoying first-class amenities on board.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Step aboard in Boston and begin a tranquil journey through the scenic East Coast USA. From historic cities to coastal hideaways like Barcelona, Mykonos, Florence, Lisbon, every day is unforgettable.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Enjoy seamless luxury on this exquisite sanctum beginning in Boston. Visit breathtaking East Coast USA locales such as Athens, Mykonos on this unforgettable itinerary.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "From bustling Boston to serene East Coast USA shores, this cruise invites you to relax, explore, and indulge. Stops at Dubrovnik, Mykonos, Athens, Venice deliver a balanced blend of culture and comfort.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "This inspiring oasis departs from Boston, navigating the diverse landscapes and vibrant cities of East Coast USA. Must-see stops include Santorini, Venice.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Escape the everyday with this mesmerizing journey through East Coast USA, departing from Boston. You'll visit Santorini, Lisbon, Malta, where every stop is a new adventure.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "This labyrinth takes you beyond the ordinary, starting in Boston. With breathtaking stops in Milan, Barcelona, Rome, your cruise delivers immersive moments and unforgettable vistas.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "From bustling Boston to serene East Coast USA shores, this cruise invites you to relax, explore, and indulge. Stops at Venice, Mykonos deliver a balanced blend of culture and comfort.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Begin your reverie in Boston, a gateway to the soul of East Coast USA. Enjoy days spent exploring Florence, Venice, Santorini and evenings immersed in onboard luxury, fine dining, and panoramic sea views.",
