...
export const melbourneCruises: Cruise[] = [
  {
    ...
    itinerary: {
      ...
      description:
        "Let this ornate voyage redefine your idea of travel. From Melbourne, explore the Asia Pacific in luxurious comfort, stopping at Shanghai, Singapore, Tokyo, Sydney where every port offers a new chapter.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Set off on a wanderlust from Melbourne that captures the essence of Asia Pacific. Discover cultural gems and culinary delights across Sydney, Ho Chi Minh City, Kyoto, Auckland.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Depart from the iconic port of Melbourne and sail through the enchanting Asia Pacific. Explore vibrant destinations like Auckland, Bali, Bangkok, each offering its own unique charm and local flair.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Depart Melbourne on a relaxing quest through the Asia Pacific region. Highlights include the stunning coastlines of Kyoto, Yokohama, Shanghai, all while enjoying first-class amenities on board.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Set off on a odyssey from Melbourne that captures the essence of Asia Pacific. Discover cultural gems and culinary delights across Bangkok, Sydney, Singapore, Auckland.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Experience coastal elegance on this pulse from Melbourne, where the journey through Asia Pacific includes stops in Kyoto, Bangkok, each more enchanting than the last.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "This extraordinary sojourn from Melbourne offers the ultimate Asia Pacific exploration. Immerse yourself in the rich cultures and stunning landscapes of Shanghai, Sydney and Bali, creating memories that will last a lifetime.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Let this refined voyage redefine your idea of travel. From Melbourne, explore the Asia Pacific in luxurious comfort, stopping at Ho Chi Minh City, Hong Kong, Bangkok where every port offers a new chapter.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Set off on a serenade from Melbourne that captures the essence of Asia Pacific. Discover cultural gems and culinary delights across Bangkok, Hong Kong, Singapore.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Launch into adventure from Melbourne and sail deep into the heart of the Asia Pacific. With ports of call like Auckland, Shanghai, expect a voyage filled with scenic wonders and luxurious comforts.",
