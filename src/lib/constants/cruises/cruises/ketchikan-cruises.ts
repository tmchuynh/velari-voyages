...
export const ketchikanCruises: Cruise[] = [
  {
    ...
    itinerary: {
      ...
      description:
        "Leave ordinary behind as you sail from Ketchikan across the captivating Alaska. Discover the distinctive personality of each destination, from Juneau, Glacier Bay, Sitka.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "This handpicked oasis begins in Ketchikan and travels through Alaska's iconic waterscapes. Discover Glacier Bay, Sitka, Victoria as each day brings new stories and every night offers elegant repose.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Escape into the calm waters of Alaska with this lavish journey from Ketchikan. Explore vibrant markets, sun-soaked beaches, and architectural marvels at Seattle, Vancouver.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Let this infinite voyage redefine your idea of travel. From Ketchikan, explore the Alaska in luxurious comfort, stopping at Vancouver, Glacier Bay, Victoria where every port offers a new chapter.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Set course from Ketchikan for an inspiring horizon-kissed journey across Alaska. Whether exploring ancient ruins in Seattle or soaking up coastal views in Skagway, every day offers a perfect mix of discovery and relaxation.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Let this gilded voyage redefine your idea of travel. From Ketchikan, explore the Alaska in luxurious comfort, stopping at Victoria, Seattle where every port offers a new chapter.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Let this timeless voyage redefine your idea of travel. From Ketchikan, explore the Alaska in luxurious comfort, stopping at Juneau, Skagway, Sitka where every port offers a new chapter.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Set course from Ketchikan for an inspiring secret journey across Alaska. Whether exploring ancient ruins in Skagway or soaking up coastal views in Juneau, every day offers a perfect mix of discovery and relaxation.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Start in the vibrant city of Ketchikan and venture into the iconic Alaska. Discover authentic local cultures, cuisine, and coastal wonders in Juneau, Seattle, Glacier Bay, Skagway.",
      distance: "832 nautical miles",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Set sail from Ketchikan on this floating discovery through the heart of Alaska. Experience the perfect blend of relaxation and adventure as you explore Juneau and Sitka and Seattle and Vancouver, with personalized service and unforgettable experiences awaiting at every port.",
