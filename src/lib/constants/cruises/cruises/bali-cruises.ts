...
export const baliCruises: Cruise[] = [
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Experience the elegance of the seas on this panoramic tide through Asia Pacific, starting from the illustrious port of Bali. From Tokyo, Sydney, Singapore to Melbourne, each destination offers its own story, culture, and breathtaking views.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Sail away from Bali into the beautiful expanse of Asia Pacific. Along the way, enjoy rich cultural experiences in Hong Kong, Kyoto, where history, nature, and cuisine collide.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Leave ordinary behind as you sail from Bali across the captivating Asia Pacific. Discover the distinctive personality of each destination, from Yokohama, Kyoto, Tokyo, Singapore.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Set sail from Bali for a voyage like no other. From the picturesque landscapes of Sydney to the lively ambiance of Tokyo, this pearlescent cruise will redefine your view of Asia Pacific.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Depart from iconic Bali and traverse the Asia Pacific with visits to Bangkok, Hong Kong. Every day offers fresh discoveries, culinary delights, and moments of pure relaxation.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "This legendary solstice begins in Bali and ventures deep into the heart of Asia Pacific. Wander through colorful markets, historic streets, and serene coastlines at Bangkok, Kyoto, Tokyo.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Sail away from the charming harbor of Bali on this hidden journey across Asia Pacific. Uncover the beauty and history of Melbourne, Shanghai, Singapore, Yokohama with curated excursions, world-class cuisine, and exceptional service.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Set sail from historic Bali for a modern escape into the Asia Pacific. Savor gourmet cuisine, cultural treasures, and beautiful coastlines with stops in Melbourne, Kyoto, Ho Chi Minh City, Yokohama.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Start in the vibrant city of Bali and venture into the iconic Asia Pacific. Discover authentic local cultures, cuisine, and coastal wonders in Ho Chi Minh City, Tokyo.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "An escape like no other begins in Bali, where your oasis launches into the heart of Asia Pacific. Discover the magic of Bangkok, Ho Chi Minh City, Auckland, Kyoto with style and sophistication.",
