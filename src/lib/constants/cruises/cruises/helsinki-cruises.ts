...
export const helsinkiCruises: Cruise[] = [
  {
    ...
    itinerary: {
      ...
      description:
        "Unwind and explore on this oasis through Northern Europe, departing from Helsinki. With every stop—from Berlin to Oslo—you’ll collect memories that last a lifetime.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "This extraordinary eclipse from Helsinki offers the ultimate Northern Europe exploration. Immerse yourself in the rich cultures and stunning landscapes of Stockholm, Copenhagen and London, creating memories that will last a lifetime.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Embark from Helsinki and traverse the Northern Europe in style. Whether it’s the energy of Stockholm or the calm of Tallinn, each destination reveals a new side of paradise.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Your elevation begins in Helsinki, where the spirit of exploration meets modern luxury. From the sun-drenched shores of London to the historic streets of Amsterdam, each stop in the Northern Europe will leave a lasting impression.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Begin a captivating horizon through the Northern Europe, departing Helsinki. With visits to St. Petersburg, Berlin, Dublin, each day brings a new adventure and deeper connection to the region.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Unwind and explore on this eclipse through Northern Europe, departing from Helsinki. With every stop—from Dublin to Tallinn—you’ll collect memories that last a lifetime.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "From the lively departure port of Helsinki, this curated frontier showcases the finest of Northern Europe. With visits to Dublin, Amsterdam, Berlin, Southampton, you’ll experience a tapestry of flavors, sights, and unforgettable moments both onboard and ashore.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Step aboard in Helsinki and begin a captivating journey through the scenic Northern Europe. From historic cities to coastal hideaways like Kiel, Copenhagen, Oslo, Dublin, every day is unforgettable.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Embark on an unforgettable haven from the vibrant port of Helsinki, where you'll discover hidden gems and iconic landmarks across the Northern Europe region. With stops at Copenhagen, Oslo, Kiel, this journey combines cultural immersion with breathtaking scenery.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "This handpicked awakening begins in Helsinki and travels through Northern Europe's iconic waterscapes. Discover St. Petersburg, Oslo, Amsterdam, Copenhagen as each day brings new stories and every night offers elegant repose.",
