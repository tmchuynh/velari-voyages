...
export const skagwayCruises: Cruise[] = [
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Step into a world of elegance and exploration from Skagway. This panorama through the Alaska unveils stunning stops including Seattle, Glacier Bay, all with first-class service.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Unwind and explore on this saga through Alaska, departing from Skagway. With every stop—from Sitka to Seattle—you’ll collect memories that last a lifetime.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Set sail from historic Skagway for a modern escape into the Alaska. Savor gourmet cuisine, cultural treasures, and beautiful coastlines with stops in Victoria, Ketchikan.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "This inspiring panorama departs from Skagway, navigating the diverse landscapes and vibrant cities of Alaska. Must-see stops include Glacier Bay, Vancouver, Sitka.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Let the winds of the Alaska carry you from Skagway to the most stunning ports in the region. With destinations like Glacier Bay, Victoria, Ketchikan, Juneau, this elevation redefines luxury travel.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Unwind and explore on this infinite through Alaska, departing from Skagway. With every stop—from Vancouver to Juneau—you’ll collect memories that last a lifetime.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "From bustling Skagway to serene Alaska shores, this cruise invites you to relax, explore, and indulge. Stops at Victoria, Ketchikan, Juneau, Vancouver deliver a balanced blend of culture and comfort.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Escape into the calm waters of Alaska with this majestic journey from Skagway. Explore vibrant markets, sun-soaked beaches, and architectural marvels at Seattle, Vancouver, Victoria, Glacier Bay.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Leave ordinary behind as you sail from Skagway across the captivating Alaska. Discover the distinctive personality of each destination, from Ketchikan, Glacier Bay, Sitka.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Set course from Skagway for an inspiring sublime journey across Alaska. Whether exploring ancient ruins in Seattle or soaking up coastal views in Glacier Bay, every day offers a perfect mix of discovery and relaxation.",
