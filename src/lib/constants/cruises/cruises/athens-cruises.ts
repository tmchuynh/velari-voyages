...
export const athensCruises: Cruise[] = [
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Let the waves lead you from Athens on this velvet escape. Traverse the iconic waters of Mediterranean and discover the beauty of Dubrovnik, Florence, Rome, Malta.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Let the winds of the Mediterranean carry you from Athens to the most stunning ports in the region. With destinations like Milan, Rome, this elevation redefines luxury travel.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Depart Athens on a relaxing panorama through the Mediterranean region. Highlights include the stunning coastlines of Malta, Barcelona, all while enjoying first-class amenities on board.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Begin your journey in Athens, where tradition meets travel. This immersive whisper reveals the finest of Mediterranean, from the beaches of Barcelona to the streets of Rome.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Step into a world of elegance and exploration from Athens. This discovery through the Mediterranean unveils stunning stops including Florence, Venice, Milan, all with first-class service.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Begin a captivating journey through the Mediterranean, departing Athens. With visits to Dubrovnik, Santorini, Mykonos, Milan, each day brings a new adventure and deeper connection to the region.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "This mesmerizing exploration begins in Athens and ventures deep into the heart of Mediterranean. Wander through colorful markets, historic streets, and serene coastlines at Dubrovnik, Lisbon, Venice, Florence.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "A voyage of contrasts awaits from Athens. Discover the historical and natural richness of Mediterranean as you cruise to spectacular destinations like Venice, Santorini.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Depart from iconic Athens and traverse the Mediterranean with visits to Milan, Barcelona. Every day offers fresh discoveries, culinary delights, and moments of pure relaxation.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Begin a captivating currents through the Mediterranean, departing Athens. With visits to Florence, Mykonos, each day brings a new adventure and deeper connection to the region.",
