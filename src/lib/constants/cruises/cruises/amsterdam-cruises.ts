...
export const amsterdamCruises: Cruise[] = [
  {
    ...
    itinerary: {
      ...
      description:
        "An escape like no other begins in Amsterdam, where your sanctum launches into the heart of Northern Europe. Discover the magic of Helsinki, Tallinn, London with style and sophistication.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Explore a new side of Northern Europe with this immersive reflection starting in Amsterdam. Visit charming ports such as London, Berlin, Dublin, Helsinki, each offering its own unique rhythm.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "An unforgettable mirage awaits as you cruise from Amsterdam across Northern Europe. Dive into history, flavor, and culture with stops including Tallinn, London, Berlin.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Embark on an unforgettable drift from the vibrant port of Amsterdam, where you'll discover hidden gems and iconic landmarks across the Northern Europe region. With stops at Tallinn, Southampton, Oslo, Helsinki, this journey combines cultural immersion with breathtaking scenery.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Depart from iconic Amsterdam and traverse the Northern Europe with visits to Southampton, Berlin, Tallinn. Every day offers fresh discoveries, culinary delights, and moments of pure relaxation.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "From the lively departure port of Amsterdam, this curated requiem showcases the finest of Northern Europe. With visits to Dublin, Copenhagen, Helsinki, you’ll experience a tapestry of flavors, sights, and unforgettable moments both onboard and ashore.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Set sail from Amsterdam on this forbidden zenith through the heart of Northern Europe. Experience the perfect blend of relaxation and adventure as you explore Copenhagen and Berlin, with personalized service and unforgettable experiences awaiting at every port.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Let the waves lead you from Amsterdam on this awe-inspiring exploration. Traverse the iconic waters of Northern Europe and discover the beauty of London, St. Petersburg.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Join us in Amsterdam for a reflection of a lifetime. Sail across the serene waters of Northern Europe, stopping at ports like Southampton, Helsinki, London, Copenhagen where timeless traditions meet modern luxuries.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Savor each moment of this transcendent escape through Northern Europe, starting in Amsterdam. Visit renowned locations like Copenhagen, London, Tallinn, Kiel, where adventure and relaxation intertwine.",
