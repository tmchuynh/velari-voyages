...
export const stPetersburgCruises: Cruise[] = [
  {
    ...
    itinerary: {
      ...
      description:
        "Depart from the iconic port of St Petersburg and sail through the enchanting Northern Europe. Explore vibrant destinations like Southampton, Kiel, each offering its own unique charm and local flair.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Depart St Petersburg on a relaxing oasis through the Northern Europe region. Highlights include the stunning coastlines of Kiel, Stockholm, Dublin, Amsterdam, all while enjoying first-class amenities on board.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Sail from St Petersburg into a world of wonder. The Northern Europe beckons with unforgettable ports like Kiel, Helsinki, where every view is picture-perfect and every moment is priceless.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Set off on a whisper from St Petersburg that captures the essence of Northern Europe. Discover cultural gems and culinary delights across Tallinn, Oslo.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Leave ordinary behind as you sail from St Petersburg across the captivating Northern Europe. Discover the distinctive personality of each destination, from Berlin, St. Petersburg, Tallinn, Kiel.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "This hand-selected starlit cruise offers a true taste of Northern Europe. Depart from St Petersburg and explore ports like London, Oslo, Berlin, each telling a story through food, music, and tradition.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Escape the everyday with this hidden journey through Northern Europe, departing from St Petersburg. You'll visit Dublin, Southampton, where every stop is a new adventure.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Join us in St Petersburg for a elevation of a lifetime. Sail across the serene waters of Northern Europe, stopping at ports like Amsterdam, Berlin, Dublin where timeless traditions meet modern luxuries.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Savor each moment of this heavenly escape through Northern Europe, starting in St Petersburg. Visit renowned locations like St. Petersburg, Amsterdam, Berlin, Dublin, where adventure and relaxation intertwine.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Depart from iconic St Petersburg and traverse the Northern Europe with visits to Kiel, Copenhagen. Every day offers fresh discoveries, culinary delights, and moments of pure relaxation.",
