...
export const montrealCruises: Cruise[] = [
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Your eclipse begins in Montreal, where every sunset on the East Coast Canada horizon promises another day of discovery—from Athens, Mykonos, Lisbon to hidden ports of charm.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "This horizon takes you beyond the ordinary, starting in Montreal. With breathtaking stops in Santorini, Dubrovnik, Milan, your cruise delivers immersive moments and unforgettable vistas.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Sail away from Montreal into the beautiful expanse of East Coast Canada. Along the way, enjoy rich cultural experiences in Malta, Mykonos, Dubrovnik, where history, nature, and cuisine collide.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Experience the elegance of the seas on this majestic renaissance through East Coast Canada, starting from the illustrious port of Montreal. From Mykonos to Athens, each destination offers its own story, culture, and breathtaking views.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Sail away from the charming harbor of Montreal on this starlit journey across East Coast Canada. Uncover the beauty and history of Santorini, Florence, Barcelona, Lisbon with curated excursions, world-class cuisine, and exceptional service.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Depart from iconic Montreal and traverse the East Coast Canada with visits to Venice, Santorini. Every day offers fresh discoveries, culinary delights, and moments of pure relaxation.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Savor each moment of this verdant escape through East Coast Canada, starting in Montreal. Visit renowned locations like Florence, Lisbon, Athens, Milan, where adventure and relaxation intertwine.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Join us in Montreal for a tranquility of a lifetime. Sail across the serene waters of East Coast Canada, stopping at ports like Venice, Athens, Barcelona, Santorini where timeless traditions meet modern luxuries.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "An escape like no other begins in Montreal, where your mirage launches into the heart of East Coast Canada. Discover the magic of Mykonos, Dubrovnik, Milan with style and sophistication.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "This idyllic reflection begins in Montreal and ventures deep into the heart of East Coast Canada. Wander through colorful markets, historic streets, and serene coastlines at Rome, Lisbon.",
