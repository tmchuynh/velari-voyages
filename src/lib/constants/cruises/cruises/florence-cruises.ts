...
export const florenceCruises: Cruise[] = [
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Join us in Florence for a journey of a lifetime. Sail across the serene waters of Mediterranean, stopping at ports like Milan, Malta, Barcelona where timeless traditions meet modern luxuries.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Sail into splendor from Florence on a legendary voyage through Mediterranean. Let each stop—from Malta to Mykonos—reveal the unique flavors and colors of the region.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Cruise into cultural richness aboard this infinite legacy departing Florence. Savor local cuisine and uncover regional beauty from Athens to Malta.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Cruise into cultural richness aboard this awe-inspiring realm departing Florence. Savor local cuisine and uncover regional beauty from Malta to Santorini.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Set sail from historic Florence for a modern escape into the Mediterranean. Savor gourmet cuisine, cultural treasures, and beautiful coastlines with stops in Athens, Mykonos, Barcelona, Dubrovnik.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Enjoy seamless luxury on this midnight awakening beginning in Florence. Visit breathtaking Mediterranean locales such as Athens, Malta, Mykonos on this unforgettable itinerary.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Let the waves lead you from Florence on this verdant saga. Traverse the iconic waters of Mediterranean and discover the beauty of Malta, Milan, Dubrovnik, Venice.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Embark on an unforgettable voyage from the vibrant port of Florence, where you'll discover hidden gems and iconic landmarks across the Mediterranean region. With stops at Rome, Barcelona, Santorini, Dubrovnik, this journey combines cultural immersion with breathtaking scenery.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Leave stress behind with this curated sojourn from Florence. Sail across the best of Mediterranean and explore treasures like Venice, Rome, Mykonos, Barcelona with comfort and style.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "This sanctum takes you beyond the ordinary, starting in Florence. With breathtaking stops in Athens, Barcelona, your cruise delivers immersive moments and unforgettable vistas.",
