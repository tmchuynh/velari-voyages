...
export const miamiCruises: Cruise[] = [
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Embark from Miami and traverse the Caribbean in style. Whether it’s the energy of Fort Lauderdale or the calm of Philipsburg, each destination reveals a new side of paradise.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Explore a new side of Caribbean with this luminous enigma starting in Miami. Visit charming ports such as Bermuda, Nassau, Tampa, each offering its own unique rhythm.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Board in Miami for a hand-crafted mythos through the breathtaking Caribbean. Highlights include sun-drenched beaches, historic ports, and immersive culture in Bermuda, Cozumel, Tampa, Philipsburg.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Begin your journey in Miami, where tradition meets travel. This immersive odyssey reveals the finest of Caribbean, from the beaches of San Juan to the streets of Philipsburg.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Escape the everyday with this opulent journey through Caribbean, departing from Miami. You'll visit Tampa, Nassau, San Juan, where every stop is a new adventure.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "This hand-selected eternal cruise offers a true taste of Caribbean. Depart from Miami and explore ports like Roatán, Nassau, Tampa, each telling a story through food, music, and tradition.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Experience the elegance of the seas on this celestial labyrinth through Caribbean, starting from the illustrious port of Miami. From Tampa, Cozumel to George Town, each destination offers its own story, culture, and breathtaking views.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Depart Miami on a relaxing excursion through the Caribbean region. Highlights include the stunning coastlines of Philipsburg, Bermuda, Nassau, all while enjoying first-class amenities on board.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Cruise into cultural richness aboard this whispering excursion departing Miami. Savor local cuisine and uncover regional beauty from Cozumel to Fort Lauderdale.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Launch into adventure from Miami and sail deep into the heart of the Caribbean. With ports of call like Roatán, St. Thomas, Bermuda, expect a voyage filled with scenic wonders and luxurious comforts.",
