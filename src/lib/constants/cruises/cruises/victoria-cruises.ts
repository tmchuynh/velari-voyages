...
export const victoriaCruises: Cruise[] = [
  {
    ...
    itinerary: {
      ...
      description:
        "Begin a captivating odyssey through the Alaska, departing Victoria. With visits to Sitka, Skagway, Vancouver, Glacier Bay, each day brings a new adventure and deeper connection to the region.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Set sail from Victoria for a voyage like no other. From the picturesque landscapes of Sitka to the lively ambiance of Seattle, this breathtaking cruise will redefine your view of Alaska.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Let the winds of the Alaska carry you from Victoria to the most stunning ports in the region. With destinations like Sitka, Ketchikan, Glacier Bay, Skagway, this mirage redefines luxury travel.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "An escape like no other begins in Victoria, where your eclipse launches into the heart of Alaska. Discover the magic of Ketchikan, Sitka, Skagway, Seattle with style and sophistication.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Begin an epic horizon from Victoria, where the seas meet culture. Visit the remarkable ports of Sitka, Juneau, Glacier Bay while indulging in fine dining, entertainment, and unmatched hospitality.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Join us in Victoria for a mystique of a lifetime. Sail across the serene waters of Alaska, stopping at ports like Glacier Bay, Sitka, Skagway, Vancouver where timeless traditions meet modern luxuries.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Escape to sea from Victoria on a captivating voyage exploring the magic of Alaska. Visit unforgettable locales like Seattle, Sitka, Glacier Bay, Juneau, where each stop inspires awe.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Depart from Victoria on this thoughtfully designed voyage across the Alaska. Savor coastal charm, cultural treasures, and ocean views with stops at Vancouver, Juneau, Seattle, Glacier Bay.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Depart from iconic Victoria and traverse the Alaska with visits to Glacier Bay, Vancouver. Every day offers fresh discoveries, culinary delights, and moments of pure relaxation.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "This mesmerizing reverie begins in Victoria and ventures deep into the heart of Alaska. Wander through colorful markets, historic streets, and serene coastlines at Glacier Bay, Skagway, Ketchikan, Vancouver.",
