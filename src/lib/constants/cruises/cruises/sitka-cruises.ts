...
export const sitkaCruises: Cruise[] = [
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Leave stress behind with this curated mythos from Sitka. Sail across the best of Alaska and explore treasures like Ketchikan, Vancouver, Glacier Bay with comfort and style.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Let the winds of the Alaska carry you from Sitka to the most stunning ports in the region. With destinations like Seattle, Ketchikan, Skagway, Vancouver, this requiem redefines luxury travel.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Embark on an unforgettable odyssey from the vibrant port of Sitka, where you'll discover hidden gems and iconic landmarks across the Alaska region. With stops at Skagway, Vancouver, Juneau, this journey combines cultural immersion with breathtaking scenery.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Let the spirit of exploration guide your tranquil journey from Sitka. This cruise offers a balanced mix of luxury and adventure, visiting stunning locales like Glacier Bay, Vancouver, Seattle.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Cruise into cultural richness aboard this gilded odyssey departing Sitka. Savor local cuisine and uncover regional beauty from Seattle to Skagway.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Set sail from historic Sitka for a modern escape into the Alaska. Savor gourmet cuisine, cultural treasures, and beautiful coastlines with stops in Victoria, Glacier Bay, Seattle.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Begin a captivating saga through the Alaska, departing Sitka. With visits to Glacier Bay, Juneau, Ketchikan, Skagway, each day brings a new adventure and deeper connection to the region.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Depart from Sitka on this thoughtfully designed exploration across the Alaska. Savor coastal charm, cultural treasures, and ocean views with stops at Vancouver, Skagway, Ketchikan, Victoria.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Enjoy seamless luxury on this starlit serenade beginning in Sitka. Visit breathtaking Alaska locales such as Seattle, Ketchikan on this unforgettable itinerary.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "A voyage of contrasts awaits from Sitka. Discover the historical and natural richness of Alaska as you cruise to spectacular destinations like Victoria, Glacier Bay.",
