...
export const bermudaCruises: Cruise[] = [
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Launch into adventure from Bermuda and sail deep into the heart of the Caribbean. With ports of call like San Juan, Roatán, Tampa, expect a voyage filled with scenic wonders and luxurious comforts.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Begin your journey in Bermuda, where tradition meets travel. This immersive adventure reveals the finest of Caribbean, from the beaches of San Juan to the streets of Tampa.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "This inspiring realm departs from Bermuda, navigating the diverse landscapes and vibrant cities of Caribbean. Must-see stops include Miami, Philipsburg, Roatán, George Town.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Escape to sea from Bermuda on a radiant voyage exploring the magic of Caribbean. Visit unforgettable locales like Fort Lauderdale, St. Thomas, San Juan, Tampa, where each stop inspires awe.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Unwind and explore on this pulse through Caribbean, departing from Bermuda. With every stop—from Fort Lauderdale to Cozumel—you’ll collect memories that last a lifetime.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Your journey through the Caribbean begins in Bermuda, where elegance meets adventure. Explore the shores of Tampa, Miami, Fort Lauderdale, with curated excursions and luxurious onboard amenities.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Embark from Bermuda and traverse the Caribbean in style. Whether it’s the energy of Cozumel or the calm of St. Thomas, each destination reveals a new side of paradise.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Escape to sea from Bermuda on a pristine voyage exploring the magic of Caribbean. Visit unforgettable locales like Miami, San Juan, Cozumel, where each stop inspires awe.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Leave ordinary behind as you sail from Bermuda across the captivating Caribbean. Discover the distinctive personality of each destination, from Fort Lauderdale, Cozumel, George Town.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Sail away from Bermuda into the beautiful expanse of Caribbean. Along the way, enjoy rich cultural experiences in Miami, Cozumel, George Town, St. Thomas, where history, nature, and cuisine collide.",
