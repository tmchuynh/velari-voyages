...
export const melbourneCruises: Cruise[] = [
{
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Your sanctuary begins in Melbourne, where every sunset on the Asia Pacific horizon promises another day of discovery—from Ho Chi Minh City, Auckland, Yokohama to hidden ports of charm.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Cruise into cultural richness aboard this lavish passage departing Melbourne. Savor local cuisine and uncover regional beauty from Bali to Ho Chi Minh City.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Begin an epic requiem from Melbourne, where the seas meet culture. Visit the remarkable ports of Yokohama, Ho Chi Minh City while indulging in fine dining, entertainment, and unmatched hospitality.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Your sojourn begins in Melbourne, where the spirit of exploration meets modern luxury. From the sun-drenched shores of Bangkok to the historic streets of Bali, each stop in the Asia Pacific will leave a lasting impression.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Sail from Melbourne into a world of wonder. The Asia Pacific beckons with unforgettable ports like Bali, Bangkok, Kyoto, where every view is picture-perfect and every moment is priceless.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Depart from the iconic port of Melbourne and sail through the enchanting Asia Pacific. Explore vibrant destinations like Bangkok, Ho Chi Minh City, Tokyo, Hong Kong, each offering its own unique charm and local flair.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Set course from Melbourne for an inspiring pearlescent journey across Asia Pacific. Whether exploring ancient ruins in Tokyo or soaking up coastal views in Hong Kong, every day offers a perfect mix of discovery and relaxation.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Savor each moment of this midnight escape through Asia Pacific, starting in Melbourne. Visit renowned locations like Hong Kong, Tokyo, where adventure and relaxation intertwine.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Begin your tranquility in Melbourne, a gateway to the soul of Asia Pacific. Enjoy days spent exploring Singapore, Bali and evenings immersed in onboard luxury, fine dining, and panoramic sea views.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "This inspiring reunion departs from Melbourne, navigating the diverse landscapes and vibrant cities of Asia Pacific. Must-see stops include Tokyo, Kyoto, Ho Chi Minh City, Hong Kong.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Launch into adventure from Melbourne and sail deep into the heart of the Asia Pacific. With ports of call like Bali, Singapore, expect a voyage filled with scenic wonders and luxurious comforts.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Set sail from historic Melbourne for a modern escape into the Asia Pacific. Savor gourmet cuisine, cultural treasures, and beautiful coastlines with stops in Bali, Hong Kong, Bangkok.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "This handpicked eclipse begins in Melbourne and travels through Asia Pacific's iconic waterscapes. Discover Tokyo, Bangkok, Auckland, Kyoto as each day brings new stories and every night offers elegant repose.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Sail away from Melbourne into the beautiful expanse of Asia Pacific. Along the way, enjoy rich cultural experiences in Bali, Hong Kong, where history, nature, and cuisine collide.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Your sanctuary begins in Melbourne, where the spirit of exploration meets modern luxury. From the sun-drenched shores of Hong Kong to the historic streets of Auckland, each stop in the Asia Pacific will leave a lasting impression.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Embark on an unforgettable sanctum from the vibrant port of Melbourne, where you'll discover hidden gems and iconic landmarks across the Asia Pacific region. With stops at Shanghai, Bali, Singapore, this journey combines cultural immersion with breathtaking scenery.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Let the spirit of exploration guide your lavish journey from Melbourne. This cruise offers a balanced mix of luxury and adventure, visiting stunning locales like Yokohama, Hong Kong, Auckland.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Step aboard in Melbourne and begin a tide-washed journey through the scenic Asia Pacific. From historic cities to coastal hideaways like Kyoto, Hong Kong, every day is unforgettable.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "An escape like no other begins in Melbourne, where your haven launches into the heart of Asia Pacific. Discover the magic of Kyoto, Tokyo, Bali with style and sophistication.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Let the winds of the Asia Pacific carry you from Melbourne to the most stunning ports in the region. With destinations like Kyoto, Ho Chi Minh City, Shanghai, this serenade redefines luxury travel.",
