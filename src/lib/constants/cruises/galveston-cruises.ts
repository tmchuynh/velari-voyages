...
export const galvestonCruises: Cruise[] = [
  {
    ...
    itinerary: {
      ...
      description:
        "Start in the vibrant city of Galveston and venture into the iconic Caribbean. Discover authentic local cultures, cuisine, and coastal wonders in Tampa, Nassau.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Embark from Galveston and traverse the Caribbean in style. Whether it’s the energy of Cozumel or the calm of Roatán, each destination reveals a new side of paradise.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Embark on an unforgettable odyssey from the vibrant port of Galveston, where you'll discover hidden gems and iconic landmarks across the Caribbean region. With stops at Miami, Cozumel, Roatán, Philipsburg, this journey combines cultural immersion with breathtaking scenery.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Enjoy seamless luxury on this enchanting currents beginning in Galveston. Visit breathtaking Caribbean locales such as San Juan, Bermuda on this unforgettable itinerary.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Begin an epic serenade from Galveston, where the seas meet culture. Visit the remarkable ports of Philipsburg, Bermuda, Roatán while indulging in fine dining, entertainment, and unmatched hospitality.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Depart from iconic Galveston and traverse the Caribbean with visits to Miami, Cozumel, Fort Lauderdale, San Juan. Every day offers fresh discoveries, culinary delights, and moments of pure relaxation.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Begin your horizon in Galveston, a gateway to the soul of Caribbean. Enjoy days spent exploring Roatán, Bermuda, St. Thomas, Tampa and evenings immersed in onboard luxury, fine dining, and panoramic sea views.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "An unforgettable sanctuary awaits as you cruise from Galveston across Caribbean. Dive into history, flavor, and culture with stops including Cozumel, Roatán, San Juan, Fort Lauderdale.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "From the lively departure port of Galveston, this curated reflection showcases the finest of Caribbean. With visits to Miami, Bermuda, you’ll experience a tapestry of flavors, sights, and unforgettable moments both onboard and ashore.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "From bustling Galveston to serene Caribbean shores, this cruise invites you to relax, explore, and indulge. Stops at Nassau, Cozumel, Fort Lauderdale, Miami deliver a balanced blend of culture and comfort.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Join us in Galveston for a infinite of a lifetime. Sail across the serene waters of Caribbean, stopping at ports like St. Thomas, Fort Lauderdale, Roatán, Miami where timeless traditions meet modern luxuries.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Let the winds of the Caribbean carry you from Galveston to the most stunning ports in the region. With destinations like Fort Lauderdale, Bermuda, Cozumel, this journey redefines luxury travel.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "This luminous cruise from Galveston is your ticket to the captivating charm of the Caribbean. Discover the delights of St. Thomas, George Town with enriching excursions and award-winning service.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "From the lively departure port of Galveston, this curated adventure showcases the finest of Caribbean. With visits to Cozumel, Roatán, George Town, you’ll experience a tapestry of flavors, sights, and unforgettable moments both onboard and ashore.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Escape the everyday with this tide-washed journey through Caribbean, departing from Galveston. You'll visit Fort Lauderdale, Roatán, where every stop is a new adventure.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "This hand-selected radiant cruise offers a true taste of Caribbean. Depart from Galveston and explore ports like Fort Lauderdale, St. Thomas, Tampa, Roatán, each telling a story through food, music, and tradition.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Embark from Galveston and traverse the Caribbean in style. Whether it’s the energy of Tampa or the calm of Cozumel, each destination reveals a new side of paradise.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Step aboard in Galveston and begin a unforgettable journey through the scenic Caribbean. From historic cities to coastal hideaways like San Juan, Nassau, Miami, Philipsburg, every day is unforgettable.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Depart from Galveston on this thoughtfully designed excursion across the Caribbean. Savor coastal charm, cultural treasures, and ocean views with stops at St. Thomas, Tampa, George Town, Roatán.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Let the waves lead you from Galveston on this legendary odyssey. Traverse the iconic waters of Caribbean and discover the beauty of Miami, Tampa.",
