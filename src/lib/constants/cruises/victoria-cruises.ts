...
export const victoriaCruises: Cruise[] = [
  {
    ...
    itinerary: {
      ...
      description:
        "Experience coastal elegance on this serenade from Victoria, where the journey through Alaska includes stops in Seattle, Skagway, each more enchanting than the last.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Unwind and explore on this panorama through Alaska, departing from Victoria. With every stop—from Glacier Bay to Vancouver—you’ll collect memories that last a lifetime.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Escape the everyday with this celestial journey through Alaska, departing from Victoria. You'll visit Vancouver, Skagway, Ketchikan, where every stop is a new adventure.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Begin a captivating legacy through the Alaska, departing Victoria. With visits to Glacier Bay, Skagway, Ketchikan, Vancouver, each day brings a new adventure and deeper connection to the region.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Board in Victoria for a hand-crafted escape through the breathtaking Alaska. Highlights include sun-drenched beaches, historic ports, and immersive culture in Ketchikan, Seattle, Skagway.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Embark on an unforgettable mystique from the vibrant port of Victoria, where you'll discover hidden gems and iconic landmarks across the Alaska region. With stops at Skagway, Ketchikan, this journey combines cultural immersion with breathtaking scenery.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Board in Victoria for a hand-crafted expedition through the breathtaking Alaska. Highlights include sun-drenched beaches, historic ports, and immersive culture in Skagway, Glacier Bay.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Experience the elegance of the seas on this refined tranquility through Alaska, starting from the illustrious port of Victoria. From Ketchikan to Skagway, each destination offers its own story, culture, and breathtaking views.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "This starlit cruise from Victoria is your ticket to the captivating charm of the Alaska. Discover the delights of Vancouver, Ketchikan with enriching excursions and award-winning service.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Start in the vibrant city of Victoria and venture into the iconic Alaska. Discover authentic local cultures, cuisine, and coastal wonders in Skagway, Juneau, Sitka.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Depart from the iconic port of Victoria and sail through the enchanting Alaska. Explore vibrant destinations like Sitka, Skagway, each offering its own unique charm and local flair.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "This alluring cruise from Victoria is your ticket to the captivating charm of the Alaska. Discover the delights of Vancouver, Juneau with enriching excursions and award-winning service.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Your quest begins in Victoria, where every sunset on the Alaska horizon promises another day of discovery—from Juneau, Ketchikan, Seattle to hidden ports of charm.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "This inspiring quest departs from Victoria, navigating the diverse landscapes and vibrant cities of Alaska. Must-see stops include Skagway, Vancouver.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "From the lively departure port of Victoria, this curated expedition showcases the finest of Alaska. With visits to Seattle, Glacier Bay, Sitka, you’ll experience a tapestry of flavors, sights, and unforgettable moments both onboard and ashore.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Depart Victoria on a relaxing whisper through the Alaska region. Highlights include the stunning coastlines of Skagway, Seattle, all while enjoying first-class amenities on board.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Escape to sea from Victoria on a transcendent voyage exploring the magic of Alaska. Visit unforgettable locales like Vancouver, Skagway, Seattle, where each stop inspires awe.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "An unforgettable saga awaits as you cruise from Victoria across Alaska. Dive into history, flavor, and culture with stops including Glacier Bay, Skagway.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Leave stress behind with this curated zenith from Victoria. Sail across the best of Alaska and explore treasures like Glacier Bay, Skagway, Sitka with comfort and style.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Step into a world of elegance and exploration from Victoria. This expedition through the Alaska unveils stunning stops including Glacier Bay, Ketchikan, all with first-class service.",
