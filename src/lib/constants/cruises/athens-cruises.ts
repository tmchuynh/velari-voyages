...
export const athensCruises: Cruise[] = [
  {
    ...
    itinerary: {
      ...
      description:
        "Your arcadia begins in Athens, where the spirit of exploration meets modern luxury. From the sun-drenched shores of Florence to the historic streets of Lisbon, each stop in the Mediterranean will leave a lasting impression.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Sail from Athens into a world of wonder. The Mediterranean beckons with unforgettable ports like Rome, Santorini, Barcelona, Lisbon, where every view is picture-perfect and every moment is priceless.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Your journey through the Mediterranean begins in Athens, where elegance meets adventure. Explore the shores of Mykonos, Rome, with curated excursions and luxurious onboard amenities.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Set sail from Athens on this panoramic haven through the heart of Mediterranean. Experience the perfect blend of relaxation and adventure as you explore Santorini and Mykonos, with personalized service and unforgettable experiences awaiting at every port.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Depart Athens on a relaxing symphony through the Mediterranean region. Highlights include the stunning coastlines of Dubrovnik, Milan, all while enjoying first-class amenities on board.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "From bustling Athens to serene Mediterranean shores, this cruise invites you to relax, explore, and indulge. Stops at Rome, Venice, Milan, Dubrovnik deliver a balanced blend of culture and comfort.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Let this ornate voyage redefine your idea of travel. From Athens, explore the Mediterranean in luxurious comfort, stopping at Lisbon, Barcelona, Venice where every port offers a new chapter.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Enjoy seamless luxury on this idyllic pulse beginning in Athens. Visit breathtaking Mediterranean locales such as Venice, Mykonos on this unforgettable itinerary.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Launch into adventure from Athens and sail deep into the heart of the Mediterranean. With ports of call like Rome, Milan, Dubrovnik, Florence, expect a voyage filled with scenic wonders and luxurious comforts.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Start in the vibrant city of Athens and venture into the iconic Mediterranean. Discover authentic local cultures, cuisine, and coastal wonders in Santorini, Mykonos, Barcelona, Malta.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Step aboard in Athens and begin a mythic journey through the scenic Mediterranean. From historic cities to coastal hideaways like Venice, Mykonos, Rome, every day is unforgettable.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "From the lively departure port of Athens, this curated serenade showcases the finest of Mediterranean. With visits to Milan, Lisbon, Rome, Malta, you’ll experience a tapestry of flavors, sights, and unforgettable moments both onboard and ashore.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "This inspiring sojourn departs from Athens, navigating the diverse landscapes and vibrant cities of Mediterranean. Must-see stops include Mykonos, Dubrovnik.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Cruise into cultural richness aboard this lavish tide departing Athens. Savor local cuisine and uncover regional beauty from Mykonos to Venice.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Set course from Athens for an inspiring starlit journey across Mediterranean. Whether exploring ancient ruins in Florence or soaking up coastal views in Venice, every day offers a perfect mix of discovery and relaxation.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Embark on an unforgettable reflection from the vibrant port of Athens, where you'll discover hidden gems and iconic landmarks across the Mediterranean region. With stops at Rome, Venice, Milan, Malta, this journey combines cultural immersion with breathtaking scenery.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Let this infinite voyage redefine your idea of travel. From Athens, explore the Mediterranean in luxurious comfort, stopping at Santorini, Malta, Rome where every port offers a new chapter.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Begin a captivating enigma through the Mediterranean, departing Athens. With visits to Mykonos, Dubrovnik, Rome, Santorini, each day brings a new adventure and deeper connection to the region.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Experience coastal elegance on this solstice from Athens, where the journey through Mediterranean includes stops in Santorini, Lisbon, each more enchanting than the last.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Leave stress behind with this curated symphony from Athens. Sail across the best of Mediterranean and explore treasures like Dubrovnik, Venice, Rome, Lisbon with comfort and style.",
