...
export const nassauCruises: Cruise[] = [
  {
    ...
    itinerary: {
      ...
      description:
        "Begin your journey in Nassau, where tradition meets travel. This immersive journey reveals the finest of Caribbean, from the beaches of Miami to the streets of Philipsburg.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Experience coastal elegance on this infinite from Nassau, where the journey through Caribbean includes stops in St. Thomas, Philipsburg, each more enchanting than the last.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Set sail from Nassau for a voyage like no other. From the picturesque landscapes of Miami to the lively ambiance of George Town, this legendary cruise will redefine your view of Caribbean.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Depart from iconic Nassau and traverse the Caribbean with visits to Miami, Bermuda, San Juan. Every day offers fresh discoveries, culinary delights, and moments of pure relaxation.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Sail away from the charming harbor of Nassau on this starlit journey across Caribbean. Uncover the beauty and history of St. Thomas, Fort Lauderdale, Bermuda with curated excursions, world-class cuisine, and exceptional service.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Sail away from the charming harbor of Nassau on this azure journey across Caribbean. Uncover the beauty and history of Philipsburg, George Town, Fort Lauderdale with curated excursions, world-class cuisine, and exceptional service.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Board in Nassau for a hand-crafted currents through the breathtaking Caribbean. Highlights include sun-drenched beaches, historic ports, and immersive culture in San Juan, Roatán.",
      distance: "608 nautical miles",
      totalDuration: "9 days",
      timeAtSea: [
        {
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Sail into splendor from Nassau on a floating voyage through Caribbean. Let each stop—from Tampa to Miami—reveal the unique flavors and colors of the region.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "This mirage takes you beyond the ordinary, starting in Nassau. With breathtaking stops in Fort Lauderdale, Bermuda, your cruise delivers immersive moments and unforgettable vistas.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Board in Nassau for a hand-crafted symphony through the breathtaking Caribbean. Highlights include sun-drenched beaches, historic ports, and immersive culture in St. Thomas, Miami.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Leave stress behind with this curated horizon from Nassau. Sail across the best of Caribbean and explore treasures like Philipsburg, Tampa with comfort and style.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Enjoy seamless luxury on this eternal serenade beginning in Nassau. Visit breathtaking Caribbean locales such as Cozumel, Fort Lauderdale, Tampa on this unforgettable itinerary.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Escape the everyday with this secluded journey through Caribbean, departing from Nassau. You'll visit Cozumel, Bermuda, Miami, Fort Lauderdale, where every stop is a new adventure.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Cruise into cultural richness aboard this panoramic realm departing Nassau. Savor local cuisine and uncover regional beauty from Cozumel to San Juan.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Enjoy seamless luxury on this secluded resonance beginning in Nassau. Visit breathtaking Caribbean locales such as Miami, Bermuda on this unforgettable itinerary.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Sail from Nassau into a world of wonder. The Caribbean beckons with unforgettable ports like Roatán, Cozumel, George Town, Bermuda, where every view is picture-perfect and every moment is priceless.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Let the waves lead you from Nassau on this sublime quest. Traverse the iconic waters of Caribbean and discover the beauty of Fort Lauderdale, Miami, San Juan.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Leave stress behind with this curated haven from Nassau. Sail across the best of Caribbean and explore treasures like George Town, Roatán, Philipsburg, San Juan with comfort and style.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Escape into the calm waters of Caribbean with this radiant journey from Nassau. Explore vibrant markets, sun-soaked beaches, and architectural marvels at Philipsburg, St. Thomas, San Juan, Miami.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Start in the vibrant city of Nassau and venture into the iconic Caribbean. Discover authentic local cultures, cuisine, and coastal wonders in Roatán, St. Thomas, George Town.",
