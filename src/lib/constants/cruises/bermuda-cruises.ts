...
export const bermudaCruises: Cruise[] = [
  {
    ...
    itinerary: {
      ...
      description:
        "This mystical resonance begins in Bermuda and ventures deep into the heart of Caribbean. Wander through colorful markets, historic streets, and serene coastlines at San Juan, George Town, Fort Lauderdale.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Set sail from Bermuda for a voyage like no other. From the picturesque landscapes of Cozumel to the lively ambiance of Roatán, this immersive cruise will redefine your view of Caribbean.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Let the waves lead you from Bermuda on this starlit embrace. Traverse the iconic waters of Caribbean and discover the beauty of San Juan, Philipsburg, Miami, George Town.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Savor each moment of this charming escape through Caribbean, starting in Bermuda. Visit renowned locations like San Juan, Philipsburg, Miami, where adventure and relaxation intertwine.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Embark on an unforgettable symphony from the vibrant port of Bermuda, where you'll discover hidden gems and iconic landmarks across the Caribbean region. With stops at Nassau, San Juan, Fort Lauderdale, this journey combines cultural immersion with breathtaking scenery.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Escape to sea from Bermuda on a golden voyage exploring the magic of Caribbean. Visit unforgettable locales like St. Thomas, Tampa, Roatán, Fort Lauderdale, where each stop inspires awe.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Let the spirit of exploration guide your secret journey from Bermuda. This cruise offers a balanced mix of luxury and adventure, visiting stunning locales like San Juan, George Town, Cozumel.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Begin a captivating mythos through the Caribbean, departing Bermuda. With visits to George Town, Fort Lauderdale, each day brings a new adventure and deeper connection to the region.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Set course from Bermuda for an inspiring velvet journey across Caribbean. Whether exploring ancient ruins in Miami or soaking up coastal views in Tampa, every day offers a perfect mix of discovery and relaxation.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Set sail from Bermuda on this lavish horizon through the heart of Caribbean. Experience the perfect blend of relaxation and adventure as you explore Cozumel and San Juan and St. Thomas, with personalized service and unforgettable experiences awaiting at every port.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Let the winds of the Caribbean carry you from Bermuda to the most stunning ports in the region. With destinations like Nassau, Philipsburg, Tampa, Roatán, this mythos redefines luxury travel.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Sail away from the charming harbor of Bermuda on this celestial journey across Caribbean. Uncover the beauty and history of Nassau, Miami, Cozumel with curated excursions, world-class cuisine, and exceptional service.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Unwind and explore on this realm through Caribbean, departing from Bermuda. With every stop—from George Town to Nassau—you’ll collect memories that last a lifetime.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Depart from the iconic port of Bermuda and sail through the enchanting Caribbean. Explore vibrant destinations like San Juan, Tampa, each offering its own unique charm and local flair.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Leave stress behind with this curated zenith from Bermuda. Sail across the best of Caribbean and explore treasures like George Town, Miami, San Juan, Cozumel with comfort and style.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "From bustling Bermuda to serene Caribbean shores, this cruise invites you to relax, explore, and indulge. Stops at San Juan, Miami, George Town deliver a balanced blend of culture and comfort.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "This tide-washed renaissance begins in Bermuda and ventures deep into the heart of Caribbean. Wander through colorful markets, historic streets, and serene coastlines at St. Thomas, George Town, San Juan.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "This transcendent excursion begins in Bermuda and ventures deep into the heart of Caribbean. Wander through colorful markets, historic streets, and serene coastlines at St. Thomas, Philipsburg, San Juan.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Let the waves lead you from Bermuda on this heavenly panorama. Traverse the iconic waters of Caribbean and discover the beauty of St. Thomas, San Juan, George Town, Cozumel.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Embark from Bermuda and traverse the Caribbean in style. Whether it’s the energy of Nassau or the calm of Fort Lauderdale, each destination reveals a new side of paradise.",
