...
export const yokohamaCruises: Cruise[] = [
{
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Set sail from Yokohama for a voyage like no other. From the picturesque landscapes of Tokyo to the lively ambiance of Singapore, this riveting cruise will redefine your view of Asia Pacific.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Experience coastal elegance on this escape from Yokohama, where the journey through Asia Pacific includes stops in Singapore, Melbourne, Tokyo, Ho Chi Minh City, each more enchanting than the last.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Let the waves lead you from Yokohama on this lavish haven. Traverse the iconic waters of Asia Pacific and discover the beauty of Melbourne, Sydney, Ho Chi Minh City, Kyoto.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "This hand-selected luxurious cruise offers a true taste of Asia Pacific. Depart from Yokohama and explore ports like Sydney, Hong Kong, each telling a story through food, music, and tradition.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Escape the everyday with this forbidden journey through Asia Pacific, departing from Yokohama. You'll visit Ho Chi Minh City, Sydney, where every stop is a new adventure.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Cruise into cultural richness aboard this luxurious pulse departing Yokohama. Savor local cuisine and uncover regional beauty from Sydney to Melbourne.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "From bustling Yokohama to serene Asia Pacific shores, this cruise invites you to relax, explore, and indulge. Stops at Auckland, Kyoto, Bali, Tokyo deliver a balanced blend of culture and comfort.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "This gilded cruise from Yokohama is your ticket to the captivating charm of the Asia Pacific. Discover the delights of Singapore, Bali, Shanghai with enriching excursions and award-winning service.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "An escape like no other begins in Yokohama, where your tranquility launches into the heart of Asia Pacific. Discover the magic of Tokyo, Bangkok, Auckland, Shanghai with style and sophistication.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Depart from Yokohama on this thoughtfully designed mystique across the Asia Pacific. Savor coastal charm, cultural treasures, and ocean views with stops at Singapore, Ho Chi Minh City, Hong Kong.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Your oasis begins in Yokohama, where the spirit of exploration meets modern luxury. From the sun-drenched shores of Melbourne to the historic streets of Hong Kong, each stop in the Asia Pacific will leave a lasting impression.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Begin an epic journey from Yokohama, where the seas meet culture. Visit the remarkable ports of Singapore, Shanghai, Hong Kong while indulging in fine dining, entertainment, and unmatched hospitality.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Discover the wonders of Asia Pacific aboard this alluring cruise departing from Yokohama. Journey through crystal waters to explore the treasures of Bali, Singapore, Auckland, Bangkok, where each day brings new adventures and evenings are filled with elegant dining and entertainment.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Depart from Yokohama on this thoughtfully designed reverie across the Asia Pacific. Savor coastal charm, cultural treasures, and ocean views with stops at Hong Kong, Auckland.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Explore a new side of Asia Pacific with this crystalline eclipse starting in Yokohama. Visit charming ports such as Ho Chi Minh City, Bali, Auckland, Kyoto, each offering its own unique rhythm.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Begin your journey in Yokohama, where tradition meets travel. This immersive sojourn reveals the finest of Asia Pacific, from the beaches of Ho Chi Minh City to the streets of Auckland.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Begin your expedition in Yokohama, a gateway to the soul of Asia Pacific. Enjoy days spent exploring Bali, Auckland, Melbourne, Singapore and evenings immersed in onboard luxury, fine dining, and panoramic sea views.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Sail into splendor from Yokohama on a oceanic voyage through Asia Pacific. Let each stop—from Tokyo to Melbourne—reveal the unique flavors and colors of the region.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Your excursion begins in Yokohama, where the spirit of exploration meets modern luxury. From the sun-drenched shores of Ho Chi Minh City to the historic streets of Kyoto, each stop in the Asia Pacific will leave a lasting impression.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Embark from Yokohama and traverse the Asia Pacific in style. Whether it’s the energy of Tokyo or the calm of Melbourne, each destination reveals a new side of paradise.",
