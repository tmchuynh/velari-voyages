...
export const tokyoCruises: Cruise[] = [
  {
    ...
    itinerary: {
      ...
      description:
        "Your journey through the Asia Pacific begins in Tokyo, where elegance meets adventure. Explore the shores of Shanghai, Auckland, Sydney, with curated excursions and luxurious onboard amenities.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Let the spirit of exploration guide your tranquil journey from Tokyo. This cruise offers a balanced mix of luxury and adventure, visiting stunning locales like Shanghai, Kyoto.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "From bustling Tokyo to serene Asia Pacific shores, this cruise invites you to relax, explore, and indulge. Stops at Sydney, Melbourne, Bali, Yokohama deliver a balanced blend of culture and comfort.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Launch into adventure from Tokyo and sail deep into the heart of the Asia Pacific. With ports of call like Melbourne, Yokohama, Auckland, expect a voyage filled with scenic wonders and luxurious comforts.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Depart from iconic Tokyo and traverse the Asia Pacific with visits to Sydney, Singapore. Every day offers fresh discoveries, culinary delights, and moments of pure relaxation.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Escape the everyday with this enchanting journey through Asia Pacific, departing from Tokyo. You'll visit Yokohama, Shanghai, where every stop is a new adventure.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Let the waves lead you from Tokyo on this immersive mirage. Traverse the iconic waters of Asia Pacific and discover the beauty of Shanghai, Bangkok, Auckland.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Escape the everyday with this panoramic journey through Asia Pacific, departing from Tokyo. You'll visit Auckland, Bangkok, Singapore, Sydney, where every stop is a new adventure.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Begin your journey in Tokyo, where tradition meets travel. This immersive infinite reveals the finest of Asia Pacific, from the beaches of Yokohama to the streets of Hong Kong.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Escape to sea from Tokyo on a verdant voyage exploring the magic of Asia Pacific. Visit unforgettable locales like Melbourne, Bangkok, where each stop inspires awe.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "This requiem takes you beyond the ordinary, starting in Tokyo. With breathtaking stops in Hong Kong, Singapore, Shanghai, Sydney, your cruise delivers immersive moments and unforgettable vistas.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Begin an epic sanctuary from Tokyo, where the seas meet culture. Visit the remarkable ports of Shanghai, Auckland, Hong Kong while indulging in fine dining, entertainment, and unmatched hospitality.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Savor each moment of this infinite escape through Asia Pacific, starting in Tokyo. Visit renowned locations like Sydney, Bangkok, Hong Kong, where adventure and relaxation intertwine.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "This hand-selected charming cruise offers a true taste of Asia Pacific. Depart from Tokyo and explore ports like Bali, Yokohama, Auckland, each telling a story through food, music, and tradition.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "This hand-selected mythic cruise offers a true taste of Asia Pacific. Depart from Tokyo and explore ports like Singapore, Bangkok, each telling a story through food, music, and tradition.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "This discovery takes you beyond the ordinary, starting in Tokyo. With breathtaking stops in Auckland, Hong Kong, your cruise delivers immersive moments and unforgettable vistas.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Set course from Tokyo for an inspiring sun-drenched journey across Asia Pacific. Whether exploring ancient ruins in Sydney or soaking up coastal views in Bali, every day offers a perfect mix of discovery and relaxation.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Begin your drift in Tokyo, a gateway to the soul of Asia Pacific. Enjoy days spent exploring Sydney, Auckland, Melbourne, Hong Kong and evenings immersed in onboard luxury, fine dining, and panoramic sea views.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Depart Tokyo on a relaxing mystique through the Asia Pacific region. Highlights include the stunning coastlines of Hong Kong, Yokohama, Bali, Kyoto, all while enjoying first-class amenities on board.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Leave stress behind with this curated zenith from Tokyo. Sail across the best of Asia Pacific and explore treasures like Ho Chi Minh City, Hong Kong with comfort and style.",
