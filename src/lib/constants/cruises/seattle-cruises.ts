...
export const seattleCruises: Cruise[] = [
{
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Experience the elegance of the seas on this charming frontier through Alaska, starting from the illustrious port of Seattle. From Skagway, Glacier Bay to Juneau, each destination offers its own story, culture, and breathtaking views.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Unwind and explore on this currents through Alaska, departing from Seattle. With every stop—from Victoria to Juneau—you’ll collect memories that last a lifetime.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Step into a world of elegance and exploration from Seattle. This voyage through the Alaska unveils stunning stops including Juneau, Victoria, Ketchikan, all with first-class service.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Depart Seattle on a relaxing tranquility through the Alaska region. Highlights include the stunning coastlines of Skagway, Ketchikan, Glacier Bay, all while enjoying first-class amenities on board.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Embark from Seattle and traverse the Alaska in style. Whether it’s the energy of Juneau or the calm of Sitka, each destination reveals a new side of paradise.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Let the spirit of exploration guide your awe-inspiring journey from Seattle. This cruise offers a balanced mix of luxury and adventure, visiting stunning locales like Sitka, Vancouver, Juneau, Skagway.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Begin a captivating exploration through the Alaska, departing Seattle. With visits to Ketchikan, Victoria, Juneau, each day brings a new adventure and deeper connection to the region.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Leave stress behind with this curated exploration from Seattle. Sail across the best of Alaska and explore treasures like Sitka, Juneau, Skagway with comfort and style.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Depart Seattle on a relaxing passage through the Alaska region. Highlights include the stunning coastlines of Ketchikan, Juneau, all while enjoying first-class amenities on board.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "From the lively departure port of Seattle, this curated lullaby showcases the finest of Alaska. With visits to Glacier Bay, Victoria, you’ll experience a tapestry of flavors, sights, and unforgettable moments both onboard and ashore.",
      distance: "1069 nautical miles",
      totalDuration: "8 days",
      timeAtSea: [
  {
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Let the winds of the Alaska carry you from Seattle to the most stunning ports in the region. With destinations like Vancouver, Ketchikan, Skagway, this reunion redefines luxury travel.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "From bustling Seattle to serene Alaska shores, this cruise invites you to relax, explore, and indulge. Stops at Victoria, Ketchikan deliver a balanced blend of culture and comfort.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Start in the vibrant city of Seattle and venture into the iconic Alaska. Discover authentic local cultures, cuisine, and coastal wonders in Skagway, Glacier Bay, Sitka.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Escape into the calm waters of Alaska with this luminous journey from Seattle. Explore vibrant markets, sun-soaked beaches, and architectural marvels at Sitka, Vancouver.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "A voyage of contrasts awaits from Seattle. Discover the historical and natural richness of Alaska as you cruise to spectacular destinations like Victoria, Vancouver.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "This extraordinary whisper from Seattle offers the ultimate Alaska exploration. Immerse yourself in the rich cultures and stunning landscapes of Glacier Bay, Victoria, Sitka and Ketchikan, creating memories that will last a lifetime.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Let the waves lead you from Seattle on this enchanting odyssey. Traverse the iconic waters of Alaska and discover the beauty of Sitka, Glacier Bay, Skagway.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Experience coastal elegance on this passage from Seattle, where the journey through Alaska includes stops in Ketchikan, Juneau, Victoria, each more enchanting than the last.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Cruise into cultural richness aboard this verdant retreat departing Seattle. Savor local cuisine and uncover regional beauty from Glacier Bay to Juneau.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Start in the vibrant city of Seattle and venture into the iconic Alaska. Discover authentic local cultures, cuisine, and coastal wonders in Ketchikan, Victoria, Sitka.",
