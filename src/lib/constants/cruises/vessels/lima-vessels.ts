...
export const limaVessels: Vessels[] = [
  {
    ...
    description:
      "Experience the epitome of maritime excellence aboard the TS Lima Explorer, a premier adults only ship sailing from Lima. With its elegant design, state-of-the-art technology, and exceptional service, every journey promises unforgettable moments and unparalleled comfort.",
  ...
  },
  {
    ...
    description:
      "Sailing from the picturesque port of Lima, the MV Lima Voyager represents a new era in cruise experiences. This remarkable catamaran combines innovative design with thoughtful amenities, creating an atmosphere of refined elegance and warm hospitality.",
    type: "catamaran",
    capacity: 1927,
    length: 485,
    width: 82,
  ...
  },
  {
    ...
    description:
      "Experience the epitome of maritime excellence aboard the TS Lima Princess, a premier mid size cruise ship sailing from Lima. With its elegant design, state-of-the-art technology, and exceptional service, every journey promises unforgettable moments and unparalleled comfort.",
  ...
  },
  {
    name: "SY Lima Legend",
    description:
      "The majestic SY Lima Legend represents the pinnacle of maritime engineering and hospitality. Based in Lima, this exceptional family cruise ship features elegant interiors, cutting-edge facilities, and carefully curated experiences that celebrate the unique culture of the South America region.",
  ...
  },
  {
    name: "PS Lima Jewel",
    description:
      "The PS Lima Jewel offers an unparalleled cruising experience from Lima, combining luxury amenities with state-of-the-art navigation technology. This catamaran features spacious cabins, gourmet dining options, and entertainment venues that showcase the best of South America hospitality.",
    type: "catamaran",
    capacity: 797,
    length: 259,
    width: 48,
