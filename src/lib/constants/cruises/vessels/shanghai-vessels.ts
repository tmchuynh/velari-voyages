...
export const shanghaiVessels: Vessels[] = [
  ...
  },
  {
    ...
    description:
      "The MV Shanghai Voyager offers an unparalleled cruising experience from Shanghai, combining luxury amenities with state-of-the-art navigation technology. This luxury cruise ship features spacious cabins, gourmet dining options, and entertainment venues that showcase the best of Asia Pacific hospitality.",
  ...
  },
  {
    ...
    description:
      "The magnificent MS Shanghai Legend offers a perfect blend of adventure and relaxation for travelers departing from Shanghai. This outstanding party cruise ship features panoramic ocean views, specialized dining experiences, and enriching activities that connect guests with the wonders of the Asia Pacific region.",
  ...
  },
  {
    ...
    description:
      "Combining traditional maritime charm with modern amenities, the SY Shanghai Jewel promises an extraordinary voyage from its home port of Shanghai. This impressive ice class ship offers spacious accommodations, diverse dining options, and engaging activities for travelers of all ages.",
    type: "ice-class-ship",
    capacity: 1080,
    length: 316,
    width: 57,
