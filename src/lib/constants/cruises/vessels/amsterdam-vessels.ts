...
export const amsterdamVessels: Vessels[] = [
  {
    ...
    homePort: {
      city: "Amsterdam",
      country: "Netherlands",
      coordinates: { latitude: 52.377956, longitude: 4.89707 },
    },
    specifications: {
  ...
  },
  {
    ...
    description:
      "Sailing from the picturesque port of Amsterdam, the PS Amsterdam Voyager represents a new era in cruise experiences. This remarkable mainstream cruise ship combines innovative design with thoughtful amenities, creating an atmosphere of refined elegance and warm hospitality.",
  ...
  },
  {
    ...
    description:
      "The MY Amsterdam Princess stands as a testament to luxury and innovation on the high seas. Departing from Amsterdam, this sophisticated expedition ship features immersive entertainment, wellness facilities, and exquisite cuisine prepared by internationally renowned chefs.",
  ...
  },
  {
    ...
    description:
      "The SY Amsterdam Legend offers an unparalleled cruising experience from Amsterdam, combining luxury amenities with state-of-the-art navigation technology. This catamaran features spacious cabins, gourmet dining options, and entertainment venues that showcase the best of Northern Europe hospitality.",
    type: "catamaran",
    capacity: 1018,
    length: 303,
    width: 55,
