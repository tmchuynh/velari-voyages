...
export const miamiVessels: Vessels[] = [
  {
    ...
    description:
      "Sailing from the picturesque port of Miami, the MV Miami Explorer represents a new era in cruise experiences. This remarkable ocean liner combines innovative design with thoughtful amenities, creating an atmosphere of refined elegance and warm hospitality.",
    type: "ocean-liner",
    capacity: 1967,
    length: 493,
    width: 83,
  ...
  },
  {
    ...
    description:
      "Setting sail from the beautiful port of Miami, the RV Miami Voyager is a floating paradise designed for the discerning traveler. This remarkable expedition ship boasts panoramic viewing decks, world-class cuisine, and personalized service that ensures an unforgettable journey.",
  ...
  },
  {
    ...
    description:
      "Setting sail from the beautiful port of Miami, the SY Miami Princess is a floating paradise designed for the discerning traveler. This remarkable adults only ship boasts panoramic viewing decks, world-class cuisine, and personalized service that ensures an unforgettable journey.",
  ...
  },
  {
    ...
    description:
      "The majestic MY Miami Legend represents the pinnacle of maritime engineering and hospitality. Based in Miami, this exceptional river cruise ship features elegant interiors, cutting-edge facilities, and carefully curated experiences that celebrate the unique culture of the Caribbean region.",
  ...
  },
  {
    ...
    description:
      "Sailing from the picturesque port of Miami, the RMS Miami Jewel represents a new era in cruise experiences. This remarkable boutique cruise ship combines innovative design with thoughtful amenities, creating an atmosphere of refined elegance and warm hospitality.",
