...
export const copenhagenCruises: Cruise[] = [
{
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Begin your journey in Copenhagen, where tradition meets travel. This immersive lullaby reveals the finest of Northern Europe, from the beaches of Amsterdam to the streets of Helsinki.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Enjoy seamless luxury on this moonlit legacy beginning in Copenhagen. Visit breathtaking Northern Europe locales such as Tallinn, Oslo, Stockholm on this unforgettable itinerary.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "This handpicked expedition begins in Copenhagen and travels through Northern Europe's iconic waterscapes. Discover Helsinki, Tallinn as each day brings new stories and every night offers elegant repose.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Discover the wonders of Northern Europe aboard this mesmerizing cruise departing from Copenhagen. Journey through crystal waters to explore the treasures of Stockholm, Oslo, where each day brings new adventures and evenings are filled with elegant dining and entertainment.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Your elevation begins in Copenhagen, where every sunset on the Northern Europe horizon promises another day of discovery—from Oslo, Kiel to hidden ports of charm.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "A voyage of contrasts awaits from Copenhagen. Discover the historical and natural richness of Northern Europe as you cruise to spectacular destinations like Stockholm, St. Petersburg, Southampton, London.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Your mirage begins in Copenhagen, where the spirit of exploration meets modern luxury. From the sun-drenched shores of London to the historic streets of Southampton, each stop in the Northern Europe will leave a lasting impression.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Set sail from Copenhagen for a voyage like no other. From the picturesque landscapes of St. Petersburg to the lively ambiance of London, this infinite cruise will redefine your view of Northern Europe.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Begin your pulse in Copenhagen, a gateway to the soul of Northern Europe. Enjoy days spent exploring Southampton, Kiel, Helsinki, Amsterdam and evenings immersed in onboard luxury, fine dining, and panoramic sea views.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Unwind and explore on this discovery through Northern Europe, departing from Copenhagen. With every stop—from Oslo to Amsterdam—you’ll collect memories that last a lifetime.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "This handpicked drift begins in Copenhagen and travels through Northern Europe's iconic waterscapes. Discover Stockholm, St. Petersburg, Berlin as each day brings new stories and every night offers elegant repose.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Escape the everyday with this heavenly journey through Northern Europe, departing from Copenhagen. You'll visit Helsinki, Oslo, Dublin, where every stop is a new adventure.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Depart from iconic Copenhagen and traverse the Northern Europe with visits to Amsterdam, London, Southampton, Tallinn. Every day offers fresh discoveries, culinary delights, and moments of pure relaxation.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Sail away from the charming harbor of Copenhagen on this majestic journey across Northern Europe. Uncover the beauty and history of Helsinki, Berlin, St. Petersburg with curated excursions, world-class cuisine, and exceptional service.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Leave ordinary behind as you sail from Copenhagen across the captivating Northern Europe. Discover the distinctive personality of each destination, from St. Petersburg, Kiel.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Embark on an unforgettable exploration from the vibrant port of Copenhagen, where you'll discover hidden gems and iconic landmarks across the Northern Europe region. With stops at Amsterdam, Southampton, Oslo, St. Petersburg, this journey combines cultural immersion with breathtaking scenery.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Step into a world of elegance and exploration from Copenhagen. This realm through the Northern Europe unveils stunning stops including Oslo, St. Petersburg, all with first-class service.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Sail into splendor from Copenhagen on a secret voyage through Northern Europe. Let each stop—from Stockholm to Kiel—reveal the unique flavors and colors of the region.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Embark from Copenhagen and traverse the Northern Europe in style. Whether it’s the energy of London or the calm of St. Petersburg, each destination reveals a new side of paradise.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Depart from the iconic port of Copenhagen and sail through the enchanting Northern Europe. Explore vibrant destinations like St. Petersburg, London, Dublin, each offering its own unique charm and local flair.",
