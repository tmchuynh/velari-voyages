...
/**
 * Menu data for Melrose Epicurean in los-angeles
 */
export const losAngelesmelroseEpicureanMenu: RestaurantMenu[] = [
  {
    title: "Main Course Menu",
    description: "Our tasty menu celebrating the flavors of Korean cooking",
    category: [
      {
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: "Organic Enticing Sweet Potato Wedges with Smoked Paprika",
            price: 8.19,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "House Special Golden Mashed Potatoes",
            price: 5.24,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Hearty Appetizing Chili Lime Roasted Chickpeas",
            price: 9.94,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Hearty Succulent Grilled Zucchini and Peppers",
            price: 8.39,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Traditional Flaky Warm Buttermilk Dinner Rolls",
            price: 7.78,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
    ...
    category: [
      {
        ...
        items: [
          {
            name: "Premium Marinated Banana Bread",
            price: 6.43,
            isVegetarian: false,
            isVegan: true,
            isGlutenFree: false,
          ...
          {
            name: "Homestyle Delectable Red Velvet Cake",
            price: 10.43,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Deluxe Luscious Fruit Galette",
            price: 10.15,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          {
            name: "Gourmet Delicious Frozen Yogurt",
            price: 10.03,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Classic Sautéed Baked Alaska",
            price: 10.19,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
    ...
    category: [
      {
        ...
        items: [
          {
            name: "Authentic Comforting Margarita",
            price: 10.89,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Homestyle Savory Manhattan",
            price: 12.84,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Handcrafted Golden Negroni",
            price: 13.32,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Gourmet Fried Bloody Mary",
            price: 15.72,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: "Fresh Comforting Champagne/Sparkling Wine",
            price: 8.6,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Homestyle Delectable Viognier",
            price: 13.83,
            isVegetarian: false,
            isVegan: true,
            isGlutenFree: false,
          ...
          {
            name: "Authentic Luscious Grenache",
            price: 8.83,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
