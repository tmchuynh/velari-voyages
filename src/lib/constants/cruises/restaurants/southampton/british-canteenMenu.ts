...
/**
 * Menu data for British Canteen in southampton
 */
export const southamptonbritishCanteenMenu: RestaurantMenu[] = [
  {
    title: "Main Course Menu",
    description:
      "A showcase of simple culinary artistry rooted in British heritage",
    category: [
      {
      ...
      },
      {
        ...
        items: [
          {
            name: "Seasonal Wholesome Mezze Platter",
            price: 9.43,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Homestyle Luscious Chicken Satay",
            price: 14.85,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Authentic Juicy Shrimp Cocktail",
            price: 10.25,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "House Special Tender Baked Brie",
            price: 10.59,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
    ...
    category: [
      {
        ...
        items: [
          {
            name: "Premium Stuffed Berry Tart",
            price: 10.63,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Seasonal Comforting Apple Pie",
            price: 7.3,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          {
            name: "Handcrafted Fried Paletas",
            price: 10.07,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Premium Flavorful Frozen Mousse",
            price: 9,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Organic Hearty Frozen Pudding",
            price: 8.29,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Deluxe Golden Frozen Custard",
            price: 8.92,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
  ...
  },
  {
    title: "Drinks Menu",
    description:
      "British-inspired drinks and classic favorites in our carefully chosen selection",
    category: [
      {
      ...
      },
      {
        ...
        items: [
          {
            name: "Handcrafted Exquisite Syrah/Shiraz",
            price: 9.85,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "House Special Zesty Petit Verdot",
            price: 13.87,
            isVegetarian: false,
            isVegan: true,
            isGlutenFree: false,
          ...
          {
            name: "Deluxe Sautéed Chardonnay",
            price: 9.52,
            isVegetarian: false,
            isVegan: true,
            isGlutenFree: true,
