...
export const southamptonindianPatisserieMenu: RestaurantMenu[] = [
  {
    ...
    description:
      "A thoughtfully curated lineup of delicious Indian dishes to suit every palate",
    category: [
      {
  ...
  {
    title: "Dessert Menu",
    description: "Experience the art of classic desserts with a Indian twist",
    category: [
      {
        name: "Baked Goods",
        description:
  ...
  },
  {
    ...
    category: [
      ...
      },
      {
        ...
        items: [
          {
            name: "Hearty Enticing Cabernet Franc",
            price: 11.26,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Gourmet Satisfying Vermentino",
            price: 10.53,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Deluxe Satisfying Petit Verdot",
            price: 8.93,
            isVegetarian: false,
            isVegan: true,
            isGlutenFree: true,
          ...
          {
            name: "Traditional Sweet Dolcetto",
            price: 11.32,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
