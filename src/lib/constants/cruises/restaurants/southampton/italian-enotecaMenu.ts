...
export const southamptonitalianEnotecaMenu: RestaurantMenu[] = [
  {
    ...
    "description": "Our classic menu celebrating the flavors of Mediterranean cooking",
    "category": [
      {
  ...
  {
    "title": "Drinks Menu",
    "description": "A crisp assortment of libations to accompany your culinary journey",
    "category": [
      {
