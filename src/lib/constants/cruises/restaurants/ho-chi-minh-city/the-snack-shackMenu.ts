...
/**
 * Menu data for The Snack Shack in ho-chi-minh-city
 */
export const hoChiMinhCitytheSnackShackMenu: RestaurantMenu[] = [
  {
    ...
    category: [
      ...
      },
      {
        ...
        items: [
          {
            name: "Handcrafted Flaky Grilled Lobster with Lemon Butter",
            price: 33.6,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Premium Delicious Shrimp Scampi over Linguine",
            price: 34.63,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Homestyle Golden Pan-Seared Scallops with Pea Purée",
            price: 30.77,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Deluxe Mouthwatering Classic British Fish and Chips",
            price: 28.73,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Hearty Wholesome New England Lobster Roll",
            price: 32.58,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
    ...
    category: [
      {
        ...
        items: [
          {
            name: "Seasonal Crispy Berry Tart",
            price: 9.7,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Authentic Hearty Croissants",
            price: 8.85,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
    ...
    category: [
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: "Handcrafted Irresistible Cabernet Franc",
            price: 8.9,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: "Authentic Exquisite Pisco",
            price: 15.28,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Homestyle Satisfying Baileys Irish Cream",
            price: 12.35,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Homestyle Sizzling Amaretto",
            price: 12.25,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
