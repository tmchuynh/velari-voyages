...
/**
 * Menu data for Grand Trattoria in st-petersburg
 */
export const stPetersburggrandTrattoriaMenu: RestaurantMenu[] = [
  {
    title: "Main Course Menu",
    description:
      "Timeless tastes, elevated by our delicious approach to American",
    category: [
      {
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: "Handcrafted Smoked Freshly Harvested Seasonal Creation",
            price: 38.5,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Classic Golden Chef's Tasting Menu Experience",
            price: 33.12,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Authentic Pan-seared Pan-Seared Scallops with Citrus Beurre Blanc",
            price: 32.38,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Authentic Flavorful Tasting of Local Artisanal Cheeses",
            price: 38.55,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: "Homestyle Zesty Linguine with Clam Sauce",
            price: 34.81,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          {
            name: "Organic Delectable Steamed Jasmine Rice",
            price: 9.69,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Gourmet Grilled Grilled Asparagus with Lemon Zest",
            price: 7.07,
            isVegetarian: false,
            isVegan: true,
            isGlutenFree: false,
          ...
          {
            name: "Authentic Smoked French Fries",
            price: 8.82,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Seasonal Sizzling Provencal Ratatouille",
            price: 9.95,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Homestyle Sautéed Green Beans Almondine",
            price: 8.09,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
    ...
    category: [
      {
        ...
        items: [
          ...
          {
            name: "Deluxe Roasted Carrot Cake",
            price: 6.18,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Gourmet Enticing Red Velvet Cake",
            price: 10.54,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Traditional Aromatic Portuguese Custard Tarts",
            price: 8.42,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Handcrafted Grilled Macarons",
            price: 7.76,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
    ...
    category: [
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: "Traditional Baked Sambuca",
            price: 10.17,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Deluxe Roasted Triple Sec",
            price: 10.25,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
