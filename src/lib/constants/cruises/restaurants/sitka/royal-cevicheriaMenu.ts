...
export const sitkaroyalCevicheriaMenu: RestaurantMenu[] = [
  {
    ...
    "description": "Satisfy your cravings with our vibrant, simple take on Mediterranean",
    "category": [
      {
  ...
  {
    "title": "Dessert Menu",
    "description": "A tasty journey through the world of desserts, inspired by Mediterranean",
    "category": [
      {
        "name": "Baked Goods",
