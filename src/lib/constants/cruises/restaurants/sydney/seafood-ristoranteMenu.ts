...
/**
 * Menu data for Seafood Ristorante in sydney
 */
export const sydneyseafoodRistoranteMenu: RestaurantMenu[] = [
  {
    title: "Main Course Menu",
    description: "Modern dining rooted in hearty Australian techniques",
    category: [
      {
        ...
        items: [
          {
            name: "Classic Zesty Flambéed Tableside Specialty",
            price: 34.41,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Classic Delectable Charcoal Grilled Iberico Pork",
            price: 32.32,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Premium Enticing Traditional Family Paella",
            price: 35.93,
            isVegetarian: false,
            isVegan: true,
            isGlutenFree: true,
          ...
          {
            name: "Premium Braised Black Garlic Glazed Beef Tenderloin",
            price: 32.18,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: "Hearty Baked Spinach Artichoke Dip",
            price: 9.53,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Handcrafted Spicy Potato Skins",
            price: 14.39,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Homestyle Savory Mini Quesadillas",
            price: 12.81,
            isVegetarian: false,
            isVegan: true,
            isGlutenFree: false,
          ...
          {
            name: "Premium Luscious Zucchini Fries",
            price: 9.5,
            isVegetarian: true,
            isVegan: true,
            isGlutenFree: false,
      ...
      },
      {
        name: "Soups",
        description:
          "Daily-prepared soups made from seasonal ingredients and traditional Australian methods.",
        items: [
          {
            name: "Seasonal Pan-seared Corn Chowder",
            price: 11.36,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Premium Stuffed French Onion Soup",
            price: 7.49,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Authentic Golden Split Pea Soup",
            price: 12.74,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          {
            name: "Traditional Flavorful Scalloped Potatoes with Thyme",
            price: 9.06,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Hearty Zingy Flaky Cheddar and Chive Biscuits",
            price: 5.19,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Fresh Flavorful Israeli Couscous with Roasted Tomatoes",
            price: 7.75,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Gourmet Delectable Buttered Egg Noodles",
            price: 8.82,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: "Classic Irresistible Milkshake",
            price: 6.79,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Hearty Sweet Hot Chocolate",
            price: 6.11,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
    ...
    category: [
      {
        ...
        items: [
          ...
          {
            name: "Homestyle Luscious Whiskey Sour",
            price: 14.07,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Classic Baked Bloody Mary",
            price: 13.8,
            isVegetarian: true,
            isVegan: true,
            isGlutenFree: false,
