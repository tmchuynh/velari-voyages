...
/**
 * Menu data for Italian Farm Table in sydney
 */
export const sydneyitalianFarmTableMenu: RestaurantMenu[] = [
  {
    title: "Main Course Menu",
    description: "Discover our hearty interpretation of classic Asian recipes",
    category: [
      {
      ...
      },
      {
        name: "Appetizers",
        description:
          "Traditional and reimagined Asian appetizers made for sharing or solo indulgence.",
        items: [
          {
            name: "Nachos",
            price: 14.97,
      ...
      },
      {
        ...
        items: [
          {
            name: "Traditional Golden Clam Chowder",
            price: 8.03,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Deluxe Luscious Broccoli Cheddar Soup",
            price: 11.15,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Premium Golden Tomato Soup",
            price: 9.34,
            isVegetarian: false,
            isVegan: true,
            isGlutenFree: false,
          ...
          {
            name: "Premium Crunchy Egg Drop Soup",
            price: 11.8,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          {
            name: "Fresh Crunchy Beef Wellington",
            price: 25.5,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "House Special Delicious Lamb Chops",
            price: 18.98,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Homestyle Enticing Mac and Cheese",
            price: 28.43,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Homestyle Steamed Burrito",
            price: 18.1,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
    ...
    category: [
      {
        ...
        items: [
          ...
          {
            name: "Seasonal Sautéed Brownies",
            price: 6.2,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Traditional Sweet Croissants",
            price: 9.26,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
    ...
    category: [
      {
        ...
        items: [
          ...
          {
            name: "Seasonal Juicy Whiskey Sour",
            price: 15.63,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Authentic Sizzling Margarita",
            price: 10.86,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          {
            name: "Handcrafted Aromatic Riesling",
            price: 9.85,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Organic Savory Champagne/Sparkling Wine",
            price: 13.89,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Organic Appetizing Chardonnay",
            price: 12.7,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
