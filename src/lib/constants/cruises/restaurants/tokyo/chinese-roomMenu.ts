...
export const tokyochineseRoomMenu: RestaurantMenu[] = [
  {
    ...
    "description": "Your introduction to a world of simple, flavor-rich Japanese meals",
    "category": [
      {
  ...
  {
    "title": "Drinks Menu",
    "description": "A enticing array of beverages specially curated for our guests",
    "category": [
      {
