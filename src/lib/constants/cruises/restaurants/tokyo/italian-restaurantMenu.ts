...
/**
 * Menu data for Italian Restaurant in tokyo
 */
export const tokyoitalianRestaurantMenu: RestaurantMenu[] = [
  {
    title: "Main Course Menu",
    description:
      "From bold spices to subtle notes—our tasty Korean journey awaits",
    category: [
      {
      ...
      },
      {
        ...
        items: [
          {
            name: "Authentic Roasted Signature Spice-Rubbed Protein",
            price: 25.14,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Gourmet Flavorful Tableside Flambé Preparation",
            price: 34.77,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Hearty Crispy Cedar Plank Salmon",
            price: 25.51,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Premium Roasted Gourmet Vegetarian Wellington",
            price: 24.43,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
      ...
      },
      {
        ...
        items: [
          {
            name: "Traditional Sweet Mussels Mariniere in White Wine",
            price: 30.15,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Authentic Delectable Grilled Swordfish with Mango Chutney",
            price: 29.96,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Authentic Creamy Hearty Italian Cioppino",
            price: 35.94,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Fresh Grilled Garlic Butter Shrimp Skillet",
            price: 34.41,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          {
            name: "Deluxe Crunchy Mashed Potatoes",
            price: 8.17,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "House Special Herbed Creamed Spinach with Nutmeg",
            price: 8.16,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Fresh Grilled Chili Lime Roasted Chickpeas",
            price: 8.8,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Hearty Satisfying Crispy Zucchini Fritters",
            price: 9.77,
            isVegetarian: false,
            isVegan: true,
            isGlutenFree: true,
    ...
    category: [
      {
        ...
        items: [
          ...
          {
            name: "Authentic Braised Shortbread",
            price: 7.47,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "House Special Flavorful Cobbler",
            price: 7.57,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
    ...
    category: [
      {
        ...
        items: [
          ...
          {
            name: "Traditional Tender Margarita",
            price: 14.59,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
