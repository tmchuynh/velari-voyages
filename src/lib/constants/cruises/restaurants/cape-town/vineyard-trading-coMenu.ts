...
/**
 * Menu data for Vineyard Trading Co. in cape-town
 */
export const capeTownvineyardTradingCoMenu: RestaurantMenu[] = [
  {
    title: "Main Course Menu",
    description:
      "Our kitchen presents an array of homestyle offerings from across the Seafood spectrum",
    category: [
      {
      ...
      },
      {
        ...
        items: [
          {
            name: "Deluxe Stuffed Braised Short Ribs with Red Wine Sauce",
            price: 24.57,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "House Special Hearty Seasonal Truffle Risotto",
            price: 37.55,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Handcrafted Mouthwatering Sustainable Seafood Tower",
            price: 33.82,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Organic Stuffed Locally Foraged Mushroom Selection",
            price: 27.66,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          {
            name: "Gourmet Spiced Italian Wedding Soup",
            price: 10.59,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Authentic Delicious Tortilla Soup",
            price: 7.3,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: "Traditional Sweet Seafood Platter",
            price: 31.8,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Traditional Spiced Pasta Primavera",
            price: 21.1,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Organic Sautéed Fish and Chips",
            price: 27.43,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: "Gourmet Marinated Herbed Bulgur Wheat with Lemon",
            price: 5.24,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Fresh Luscious Garlic Bread with Herb Butter",
            price: 5.69,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Deluxe Spicy Roasted Brussels Sprouts with Balsamic Glaze",
            price: 6.3,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Organic Savory Sweet Corn and Cheddar Fritters",
            price: 7.18,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
    ...
    category: [
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: "Fresh Herbed Coffee Liqueur",
            price: 15.57,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "House Special Creamy Maraschino",
            price: 14.08,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
