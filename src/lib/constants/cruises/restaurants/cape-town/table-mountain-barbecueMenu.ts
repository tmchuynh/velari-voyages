...
/**
 * Menu data for Table Mountain Barbecue in cape-town
 */
export const capeTowntableMountainBarbecueMenu: RestaurantMenu[] = [
  {
    title: "Main Course Menu",
    description: "Our tasty menu celebrating the flavors of Indian cooking",
    category: [
      {
      ...
      },
      {
        ...
        items: [
          {
            name: "House Special Spiced Tableside Flambé Preparation",
            price: 34.81,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Deluxe Fried Seared Foie Gras with Fig Compote",
            price: 26.63,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Hearty Spiced Truffle-Infused Filet Mignon",
            price: 39.9,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Hearty Smoked Aged and House-Cured Charcuterie Selection",
            price: 30.88,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: "Classic Aromatic Chicken Parmesan",
            price: 25.98,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Handcrafted Braised Steak",
            price: 26.16,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "House Special Crunchy Grilled Chicken",
            price: 25.16,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
    ...
    category: [
      {
        ...
        items: [
          ...
          {
            name: "Deluxe Marinated Cinnamon Rolls",
            price: 9.33,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Traditional Zesty Danish Pastries",
            price: 7.41,
            isVegetarian: false,
            isVegan: true,
            isGlutenFree: false,
  ...
  },
  {
    title: "Drinks Menu",
    description:
      "Indian-inspired drinks and classic favorites in our balanced selection",
    category: [
      {
      ...
      },
      {
        ...
        items: [
          {
            name: "Deluxe Enticing Petit Verdot",
            price: 13.8,
            isVegetarian: true,
            isVegan: true,
            isGlutenFree: true,
          ...
          {
            name: "Homestyle Irresistible Sangiovese",
            price: 8.8,
            isVegetarian: true,
            isVegan: true,
            isGlutenFree: true,
          ...
          {
            name: "Gourmet Roasted Cabernet Franc",
            price: 10.86,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
      ...
      },
      {
        ...
        items: [
          {
            name: "Fresh Wholesome Grand Marnier",
            price: 13.72,
            isVegetarian: false,
            isVegan: true,
            isGlutenFree: true,
          ...
          {
            name: "Organic Delicious Frangelico",
            price: 16.01,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Premium Enticing Galliano",
            price: 13.49,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
