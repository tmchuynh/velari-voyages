...
/**
 * Menu data for Cape Eatery + Bar in cape-town
 */
export const capeTowncapeEateryBarMenu: RestaurantMenu[] = [
  {
    title: "Main Course Menu",
    description:
      "Experience our chef's tasty creations inspired by African tradition",
    category: [
      {
      ...
      },
      {
        ...
        description:
          "A rotating selection of dishes that highlight the chef's creativity and passion for African.",
        items: [
          {
            name: "Organic Juicy Seared Foie Gras with Fig Compote",
            price: 26.4,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Deluxe Savory Heirloom Recipe from Chef's Family",
            price: 35.47,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Classic Stuffed Seared Duck Breast with Cherry Reduction",
            price: 25.92,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Deluxe Stuffed Tableside Flambé Preparation",
            price: 32.77,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
      ...
      },
      {
        name: "Appetizers",
        description:
          "Crafted to excite the palate, our starters are a perfect introduction to the world of African.",
        items: [
          {
            name: "Nachos",
            price: 9.29,
      ...
      },
      {
        name: "Side Dishes",
        description:
          "Crafted to enhance your meal, these sides are a celebration of African flavors.",
        items: [
          {
            name: "Traditional Fried Garlic Bread with Herb Butter",
            price: 7.7,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "House Special Hearty Maple-Glazed Baby Carrots",
            price: 9.45,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Deluxe Crunchy Roasted Root Vegetables",
            price: 5.48,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Traditional Braised Sautéed Garlic Mushrooms",
            price: 5.43,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Deluxe Herbed Creamed Spinach with Nutmeg",
            price: 9.49,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: "Homestyle Flavorful Milkshake",
            price: 7.21,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
    ...
    category: [
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: "Gourmet Smoked Cabernet Franc",
            price: 12.96,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Organic Wholesome Vouvray",
            price: 11.04,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
