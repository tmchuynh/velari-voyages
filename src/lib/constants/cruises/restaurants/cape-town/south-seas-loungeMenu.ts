...
export const capeTownsouthSeasLoungeMenu: RestaurantMenu[] = [
  {
    ...
    "category": [
      ...
      {
        "name": "Appetizers",
        "description": "A selection of Indian starters that blend tradition with modern flair, perfect for sharing or savoring solo.",
        "items": [
          {
  ...
  {
    "title": "Dessert Menu",
    "description": "From rich chocolates to fruity delights – our gooey desserts await",
    "category": [
      {
        "name": "Baked Goods",
