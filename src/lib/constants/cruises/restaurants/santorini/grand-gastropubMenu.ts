...
export const santorinigrandGastropubMenu: RestaurantMenu[] = [
  {
    ...
    description: "A celebration of flavor-forward, fresh French recipes",
    category: [
      {
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: "Handcrafted Creamy Pasta Primavera",
            price: 27.74,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Fresh Herbed Teriyaki Chicken",
            price: 29.66,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Seasonal Exquisite Tagine",
            price: 24.21,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
    ...
    category: [
      {
        ...
        items: [
          {
            name: "Homestyle Roasted Croissants",
            price: 8.92,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Gourmet Succulent Fruit Galette",
            price: 8.86,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Seasonal Sweet Red Velvet Cake",
            price: 9.89,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          {
            name: "Gourmet Baked Baked Alaska",
            price: 8.26,
            isVegetarian: true,
            isVegan: true,
            isGlutenFree: false,
          ...
          {
            name: "Classic Hearty Ice Cream Sandwich",
            price: 11.72,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
  ...
  },
  {
    title: "Drinks Menu",
    description:
      "Our easygoing wine list features carefully chosen bottles from renowned vineyards",
    category: [
      {
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: "Authentic Baked Torrontés",
            price: 10.41,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "House Special Marinated Albariño",
            price: 9.79,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Traditional Luscious Verdicchio",
            price: 13.22,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: "Homestyle Delectable Cognac",
            price: 10.67,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
