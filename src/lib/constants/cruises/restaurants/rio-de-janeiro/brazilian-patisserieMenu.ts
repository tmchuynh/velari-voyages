...
export const rioDeJaneirobrazilianPatisserieMenu: RestaurantMenu[] = [
  {
    ...
    "description": "Our flavorful menu celebrating the flavors of Japanese cooking",
    "category": [
      {
  ...
  {
    "title": "Dessert Menu",
    "description": "Decadent or delicate – our delicious desserts cater to every preference",
    "category": [
      {
        "name": "Baked Goods",
  ...
  {
    "title": "Drinks Menu",
    "description": "Unwind with our enticing beverages crafted for connoisseurs and casual sippers alike",
    "category": [
      {
