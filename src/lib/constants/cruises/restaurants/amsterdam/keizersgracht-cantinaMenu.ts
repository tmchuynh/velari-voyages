...
export const amsterdamkeizersgrachtCantinaMenu: RestaurantMenu[] = [
  {
    ...
    description:
      "Traditional and contemporary Indonesian favorites with our classic touch",
    category: [
      {
        ...
        items: [
          {
            name: "Classic Baked Charcoal Grilled Iberico Pork",
            price: 32.7,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Organic Spicy Molecular Gastronomy Showcase Tasting",
            price: 30.89,
            isVegetarian: false,
            isVegan: true,
            isGlutenFree: true,
          ...
          {
            name: "Fresh Sweet Founder's Family Recipe Pasta",
            price: 25.75,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Deluxe Satisfying Age-Old Recipe Osso Buco with Gremolata",
            price: 28.53,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
      ...
      },
      {
        name: "Appetizers",
        description:
          "A selection of small plates that showcase the essence of Indonesian—perfect for sharing or savoring solo.",
        items: [
          {
      ...
      },
      {
        ...
        items: [
          {
            name: "Homestyle Juicy Prawn Curry in Coconut Masala",
            price: 23.81,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Homestyle Zingy Lemon-Herb Calamari Steak",
            price: 22.74,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Gourmet Juicy Crab-Stuffed Mushrooms",
            price: 27.56,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Authentic Wholesome Tempura Soft Shell Crab",
            price: 33.45,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Deluxe Grilled Cajun Shrimp and Grits",
            price: 28.35,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: "Authentic Pan-seared Coffee",
            price: 7.92,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Authentic Marinated Water",
            price: 7.96,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
    ...
    category: [
      {
        ...
        items: [
          ...
          {
            name: "Seasonal Luscious Margarita",
            price: 13.95,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Classic Comforting Old Fashioned",
            price: 10.86,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: true,
      ...
      },
      {
        ...
        items: [
          {
            name: "Premium Mouthwatering Bénédictine",
            price: 12.12,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "House Special Zingy Limoncello",
            price: 14.46,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Traditional Golden Sambuca",
            price: 14.68,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Traditional Grilled Galliano",
            price: 15.81,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
