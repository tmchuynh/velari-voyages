...
export const amsterdamdutchBistroMenu: RestaurantMenu[] = [
  {
    ...
    "description": "A authentic assortment of specialties showcasing the best of Indonesian cuisine",
    "category": [
      {
        "name": "Signature Dishes",
        "description": "Our chef's pride—carefully selected Indonesian specialties that define our culinary identity, honed through years of experience and passion.",
        "items": [
          {
