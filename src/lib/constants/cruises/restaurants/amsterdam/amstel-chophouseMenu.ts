...
export const amsterdamamstelChophouseMenu: RestaurantMenu[] = [
  {
    ...
    "description": "Taste the depth of Dutch culture through our comforting preparations",
    "category": [
      {
      ...
      {
        "name": "Appetizers",
        "description": "Traditional and reimagined Dutch appetizers made for sharing or solo indulgence.",
        "items": [
          {
      ...
      {
        "name": "Main Courses",
        "description": "Each dish is a culinary journey, showcasing the richness of Dutch traditions.",
        "items": [
          {
