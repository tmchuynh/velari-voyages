...
/**
 * Menu data for Atlantic Buffet in lisbon
 */
export const lisbonatlanticBuffetMenu: RestaurantMenu[] = [
  {
    title: "Main Course Menu",
    description:
      "Every plate tells a story of satisfying Brazilian craftsmanship",
    category: [
      {
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: "Classic Herbed Spring Rolls",
            price: 14.85,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Traditional Zesty Arancini",
            price: 12.12,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Gourmet Creamy Cheese Platter",
            price: 9.47,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Deluxe Grilled Spinach Puffs",
            price: 15.16,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Handcrafted Appetizing Onion Rings",
            price: 14.2,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          {
            name: "Hearty Satisfying Burrito",
            price: 29.13,
            isVegetarian: false,
            isVegan: true,
            isGlutenFree: true,
          ...
          {
            name: "Authentic Aromatic Paella",
            price: 30.86,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Authentic Succulent Grilled Tofu",
            price: 22.39,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Handcrafted Steamed Stuffed Zucchini Boats",
            price: 24.06,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Fresh Flaky Chili con Carne",
            price: 19.4,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
  ...
  },
  {
    title: "Dessert Menu",
    description:
      "A tasty journey through the world of desserts, inspired by Brazilian",
    category: [
      {
        name: "Baked Goods",
        description:
    ...
    category: [
      {
        ...
        items: [
          ...
          {
            name: "Traditional Smoked Negroni",
            price: 12.92,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
