...
/**
 * Menu data for Fado Society in lisbon
 */
export const lisbonfadoSocietyMenu: RestaurantMenu[] = [
  {
    title: "Main Course Menu",
    description: "Our carefully crafted selection of simple Brazilian dishes",
    category: [
      {
      ...
      },
      {
        ...
        items: [
          {
            name: "Fresh Grilled Mini Empanadas",
            price: 14.51,
            isVegetarian: false,
            isVegan: true,
            isGlutenFree: false,
          ...
          {
            name: "Gourmet Marinated Baba Ganoush",
            price: 12.36,
            isVegetarian: false,
            isVegan: true,
            isGlutenFree: true,
          ...
          {
            name: "Deluxe Mouthwatering Prawn Toast",
            price: 12.74,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "House Special Crispy Antipasto Platter",
            price: 8.65,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Classic Comforting Zucchini Fries",
            price: 14.53,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Hearty Succulent Stuffed Mushrooms",
            price: 11.47,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Gourmet Hearty Garlic Knots",
            price: 10.5,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
      ...
      },
      {
        name: "Soups",
        description:
          "Each bowl is a journey through the heart of Brazilian, crafted with care and expertise.",
        items: [
          {
            name: "Homestyle Satisfying Zuppa Toscana",
            price: 12.16,
            isVegetarian: true,
            isVegan: true,
            isGlutenFree: true,
          ...
          {
            name: "House Special Crunchy Italian Wedding Soup",
            price: 10.62,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Organic Grilled Butternut Squash Soup",
            price: 7.12,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: "Fresh Mouthwatering Grilled Tofu",
            price: 21.74,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Handcrafted Tangy Stir-fry",
            price: 31.35,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Authentic Baked Currywurst",
            price: 28.52,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Premium Marinated Seafood Platter",
            price: 19.07,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Organic Roasted Lamb Chops",
            price: 18.07,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
  ...
  },
  {
    ...
    category: [
      ...
      },
      {
        ...
        items: [
          {
            name: "Authentic Delectable Frozen Pudding",
            price: 11.4,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Traditional Satisfying Sorbet",
            price: 10.89,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Fresh Mouthwatering Granita",
            price: 11.65,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Authentic Sizzling Semifreddo",
            price: 7.57,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
