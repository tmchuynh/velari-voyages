...
/**
 * Menu data for Alfama Chocolatier in lisbon
 */
export const lisbonalfamaChocolatierMenu: RestaurantMenu[] = [
  {
    title: "Main Course Menu",
    description: "A flavorful fusion of fresh and authentic Brazilian dishes",
    category: [
      {
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: "Deluxe Zingy Vegetable Stir-Fry",
            price: 19.74,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Fresh Pan-seared Fish and Chips",
            price: 18.62,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Hearty Creamy Stuffed Peppers",
            price: 31.79,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          {
            name: "Handcrafted Smoked Grilled Lobster with Lemon Butter",
            price: 34.88,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Premium Creamy Stuffed Flounder with Crab and Spinach",
            price: 27.74,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Handcrafted Spiced Baked Cod with Lemon Caper Sauce",
            price: 31.93,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Deluxe Comforting Oysters Rockefeller with Pernod Cream",
            price: 23.32,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
    ...
    category: [
      {
        ...
        items: [
          ...
          {
            name: "House Special Wholesome Whiskey Sour",
            price: 11.58,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
