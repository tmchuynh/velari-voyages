...
/**
 * Menu data for Atlantic Farm Table in lisbon
 */
export const lisbonatlanticFarmTableMenu: RestaurantMenu[] = [
  {
    title: "Main Course Menu",
    description:
      "A tasty assortment of specialties showcasing the best of Brazilian cuisine",
    category: [
      {
        ...
        items: [
          ...
          {
            name: "Traditional Savory Captain's Favorite Seafood Tower",
            price: 35.42,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Premium Flaky Dry-Aged Tomahawk Steak",
            price: 31.29,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Handcrafted Sizzling Signature Truffle Pasta with Aged Pecorino",
            price: 30.4,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          {
            name: "Classic Delicious Cedar Plank Salmon",
            price: 33.5,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Organic Delicious Tomahawk Ribeye for Two",
            price: 32.81,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Homestyle Baked Roasted Quail with Truffle Jus",
            price: 27.48,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Deluxe Hearty Chef's Childhood Favorite Reimagined",
            price: 35.04,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          {
            name: "Traditional Grilled Caprese Salad",
            price: 12.12,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Premium Tender Cheese Platter",
            price: 14.26,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "House Special Sizzling Stuffed Peppers",
            price: 15.03,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Seasonal Exquisite Baba Ganoush",
            price: 11.6,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Deluxe Exquisite Spinach Artichoke Dip",
            price: 10.93,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Hearty Crispy Mini Sliders",
            price: 13.52,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
      ...
      },
      {
        name: "Main Courses",
        description:
          "Hearty and refined mains rooted in traditional Brazilian, elevated by modern techniques.",
        items: [
          {
  ...
  },
  {
    title: "Dessert Menu",
    description:
      "Experience the art of comforting desserts with a Brazilian twist",
    category: [
      {
        name: "Baked Goods",
        description:
        ...
        items: [
          ...
          {
            name: "Traditional Delicious Eclairs",
            price: 7.43,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Fresh Exquisite Shortbread",
            price: 7.33,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Hearty Grilled Crumb Cake",
            price: 7.51,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
