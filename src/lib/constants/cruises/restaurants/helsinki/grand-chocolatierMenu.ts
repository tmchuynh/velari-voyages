...
export const helsinkigrandChocolatierMenu: RestaurantMenu[] = [
  {
    ...
    "description": "Delight in our chef's most flavorful takes on traditional Mediterranean flavors",
    "category": [
      {
  ...
  {
    "title": "Drinks Menu",
    "description": "A easygoing cocktail lineup featuring house infusions and classic techniques",
    "category": [
      {
