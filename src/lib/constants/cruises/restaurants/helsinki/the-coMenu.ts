...
export const helsinkitheCoMenu: RestaurantMenu[] = [
  {
    ...
    "description": "A menu designed to highlight the simple essence of Mediterranean",
    "category": [
      {
  ...
  {
    "title": "Drinks Menu",
    "description": "A quality blend of heritage and modern mixology in every glass",
    "category": [
      {
