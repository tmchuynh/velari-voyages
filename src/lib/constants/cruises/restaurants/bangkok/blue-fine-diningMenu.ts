...
export const bangkokblueFineDiningMenu: RestaurantMenu[] = [
  {
    ...
    "description": "From appetizers to main courses: satisfying dishes prepared with passion",
    "category": [
      {
  ...
  {
    "title": "Drinks Menu",
    "description": "Treat yourself to a crowd-pleasing nightcap from our curated selection",
    "category": [
      {
