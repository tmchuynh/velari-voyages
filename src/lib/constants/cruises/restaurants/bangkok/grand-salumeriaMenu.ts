...
export const bangkokgrandSalumeriaMenu: RestaurantMenu[] = [
  {
    ...
    "description": "Delight in our chef's most classic takes on traditional Japanese flavors",
    "category": [
      {
  ...
  {
    "title": "Dessert Menu",
    "description": "A tasty selection of desserts that will leave you wanting more",
    "category": [
      {
        "name": "Baked Goods",
