...
export const bangkokblueTeaHouseMenu: RestaurantMenu[] = [
  {
    ...
    "description": "Where comforting creativity meets timeless Japanese inspiration",
    "category": [
      {
  ...
  {
    "title": "Drinks Menu",
    "description": "A thoughtfully selected drinks program blending innovation with tradition",
    "category": [
      {
