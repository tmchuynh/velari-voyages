...
/**
 * Menu data for The Atelier in bangkok
 */
export const bangkoktheAtelierMenu: RestaurantMenu[] = [
  {
    title: "Main Course Menu",
    description: "A flavorful fusion of simple and authentic American dishes",
    category: [
      {
      ...
      },
      {
        ...
        items: [
          {
            name: "Deluxe Flavorful Dry-Aged Prime Beef Selection",
            price: 35.49,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Traditional Steamed Tomahawk Ribeye for Two",
            price: 34.07,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Deluxe Creamy Chef's Market Inspiration of the Day",
            price: 30.63,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Handcrafted Savory Chef's Childhood Favorite Reimagined",
            price: 24.02,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Premium Tangy Deconstructed Classic with Modern Technique",
            price: 29.67,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
      ...
      },
      {
        ...
        items: [
          {
            name: "House Special Succulent Miso-Marinated Chilean Sea Bass",
            price: 28.38,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Classic Crunchy Blackened Mahi-Mahi with Pineapple Salsa",
            price: 31.5,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
    ...
    category: [
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: "Traditional Sweet Frozen Pudding",
            price: 8.77,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Handcrafted Herbed Frozen Pie",
            price: 9.74,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
    ...
    category: [
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: "Seasonal Marinated Nebbiolo",
            price: 8.18,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Fresh Hearty Sauvignon Blanc",
            price: 12.53,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
