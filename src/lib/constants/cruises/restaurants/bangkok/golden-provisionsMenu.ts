...
export const bangkokgoldenProvisionsMenu: RestaurantMenu[] = [
  {
    ...
    "description": "A journey through French flavors, led by our chef's simple creations",
    "category": [
      {
  ...
  {
    "title": "Drinks Menu",
    "description": "A delightful assortment of libations to accompany your culinary journey",
    "category": [
      {
