...
/**
 * Menu data for Blue Supper Club in bangkok
 */
export const bangkokblueSupperClubMenu: RestaurantMenu[] = [
  {
    ...
    category: [
      ...
      },
      {
        ...
        items: [
          {
            name: "House Special Zingy Peanut Soup (West African)",
            price: 10,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Seasonal Comforting Clam Chowder",
            price: 7.98,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Gourmet Succulent Lobster Bisque",
            price: 7.15,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          {
            name: "Classic Tangy Sautéed Garlic Mushrooms",
            price: 8.84,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Seasonal Appetizing Sweet Corn and Cheddar Fritters",
            price: 6.59,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Organic Creamy Creamed Spinach with Nutmeg",
            price: 7.82,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "House Special Savory Grilled Zucchini and Peppers",
            price: 6.59,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Fresh Grilled Roasted Root Vegetables",
            price: 7.61,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Classic Herbed Warm Buttermilk Dinner Rolls",
            price: 7.58,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
  ...
  {
    title: "Dessert Menu",
    description: "French-inspired gooey confections to delight your senses",
    category: [
      {
        name: "Baked Goods",
        description:
        ...
        items: [
          {
            name: "Organic Exquisite Shortbread",
            price: 10.86,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "House Special Baked Scones",
            price: 8.67,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Fresh Grilled Carrot Cake",
            price: 7.98,
            isVegetarian: false,
            isVegan: true,
            isGlutenFree: false,
    ...
    category: [
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: "Deluxe Sautéed Triple Sec",
            price: 15.05,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
