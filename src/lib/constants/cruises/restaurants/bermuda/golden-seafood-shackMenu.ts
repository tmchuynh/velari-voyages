...
/**
 * Menu data for Golden Seafood Shack in bermuda
 */
export const bermudagoldenSeafoodShackMenu: RestaurantMenu[] = [
  {
    title: "Main Course Menu",
    description:
      "Delight in our chef's most tasty takes on traditional American flavors",
    category: [
      {
      ...
      },
      {
        ...
        items: [
          {
            name: "Fresh Mouthwatering Ceviche",
            price: 8.13,
            isVegetarian: false,
            isVegan: true,
            isGlutenFree: false,
          ...
          {
            name: "Fresh Roasted Lettuce Wraps",
            price: 9.23,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Fresh Roasted Spring Rolls",
            price: 10.61,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Fresh Enticing Mini Crab Cakes",
            price: 8.17,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Hearty Steamed Chicken Wings",
            price: 14.9,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: "House Special Spiced Minestrone",
            price: 11.1,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Organic Roasted Chicken Noodle Soup",
            price: 11.14,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          {
            name: "Gourmet Steamed Katsu Curry",
            price: 19.62,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Deluxe Mouthwatering Vegetable Stir-Fry",
            price: 22.89,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Fresh Sweet Teriyaki Chicken",
            price: 30.47,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Authentic Golden Chili con Carne",
            price: 27.92,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Deluxe Exquisite Pasta Primavera",
            price: 23.67,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          {
            name: "Authentic Flaky Shrimp Scampi over Linguine",
            price: 31.8,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Hearty Zesty Cajun Shrimp and Grits",
            price: 27.5,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Authentic Zesty Valencian Seafood Paella",
            price: 35.47,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Deluxe Sizzling Maryland Style Crab Cakes",
            price: 23.49,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
    ...
    category: [
      {
        ...
        items: [
          {
            name: "Classic Tangy Danish Pastries",
            price: 9.37,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Deluxe Mouthwatering Apple Pie",
            price: 9.43,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Authentic Sweet Lemon Bars",
            price: 10.53,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Fresh Grilled Vanilla Cake",
            price: 7.45,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
    ...
    category: [
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: "Authentic Spicy Gewürztraminer",
            price: 8.98,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Gourmet Creamy Petit Verdot",
            price: 9.88,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: "Gourmet Flavorful Bénédictine",
            price: 14.16,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Authentic Flavorful Chambord",
            price: 14.18,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
