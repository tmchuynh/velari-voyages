...
/**
 * Menu data for Golden Atelier in mykonos
 */
export const mykonosgoldenAtelierMenu: RestaurantMenu[] = [
  {
    ...
    category: [
      ...
      },
      {
        ...
        items: [
          {
            name: "Gourmet Wholesome Deconstructed Classic with Modern Technique",
            price: 33.09,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Hearty Sweet Tableside Flambé Preparation",
            price: 36.46,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Deluxe Delectable Pan-Seared Scallops with Citrus Beurre Blanc",
            price: 37.72,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Hearty Zesty Off-Menu Secret Preparation",
            price: 36.67,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Authentic Crunchy Tomahawk Ribeye for Two",
            price: 35.42,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          {
            name: "House Special Savory Zuppa Toscana",
            price: 8.28,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Authentic Marinated Minestrone",
            price: 9.72,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
      ...
      },
      {
        ...
        items: [
          {
            name: "Classic Delectable Risotto",
            price: 25.54,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Fresh Smoked Vegetable Stir-Fry",
            price: 28.8,
            isVegetarian: true,
            isVegan: true,
            isGlutenFree: false,
          ...
          {
            name: "Seasonal Delectable Eggplant Parmesan",
            price: 27.31,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Handcrafted Comforting Pasta Primavera",
            price: 31.59,
            isVegetarian: true,
            isVegan: true,
            isGlutenFree: false,
  ...
  },
  {
    title: "Dessert Menu",
    description:
      "A homemade selection of desserts to complement your dining experience",
    category: [
      {
        name: "Baked Goods",
        description:
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: "Organic Smoked Ice Cream Cake",
            price: 10.68,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Homestyle Pan-seared Sherbet",
            price: 9.05,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
    ...
    category: [
      {
        ...
        items: [
          ...
          {
            name: "Traditional Creamy Martini",
            price: 13.11,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "House Special Comforting Old Fashioned",
            price: 12.22,
            isVegetarian: false,
            isVegan: true,
            isGlutenFree: false,
