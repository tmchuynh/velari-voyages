...
/**
 * Menu data for Golden Ramen-Ya in mykonos
 */
export const mykonosgoldenRamenYaMenu: RestaurantMenu[] = [
  {
    title: "Main Course Menu",
    description:
      "Your introduction to a world of comforting, flavor-rich French meals",
    category: [
      {
      ...
      },
      {
        ...
        items: [
          {
            name: "Traditional Enticing Clam Chowder",
            price: 8.16,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "House Special Savory Minestrone",
            price: 13.06,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "House Special Smoked Hot and Sour Soup",
            price: 8.73,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          {
            name: "House Special Aromatic Seared Tuna Steak with Sesame Crust",
            price: 31.85,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "House Special Delicious Valencian Seafood Paella",
            price: 33.07,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Authentic Roasted Smoked Salmon Platter with Dill Crème",
            price: 34.43,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Deluxe Wholesome Steamed Littleneck Clams in Garlic Broth",
            price: 33.24,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Deluxe Flaky Miso-Marinated Chilean Sea Bass",
            price: 26.95,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
    ...
    category: [
      {
        ...
        items: [
          {
            name: "Classic Enticing Cupcakes",
            price: 8.68,
            isVegetarian: true,
            isVegan: true,
            isGlutenFree: false,
          ...
          {
            name: "Homestyle Mouthwatering Cobbler",
            price: 9.52,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Authentic Grilled Chocolate Chip Cookies",
            price: 8.9,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Organic Crispy Lemon Bars",
            price: 10.8,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
      ...
      },
      {
        ...
        items: [
          {
            name: "Traditional Crunchy Frozen Banana",
            price: 10.71,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Handcrafted Sizzling Frozen Mousse",
            price: 10.9,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
    ...
    category: [
      {
        ...
        items: [
          ...
          {
            name: "Authentic Fried Whiskey Sour",
            price: 12.24,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Classic Roasted Manhattan",
            price: 11.43,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          {
            name: "Authentic Succulent Gamay",
            price: 11.19,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Homestyle Marinated Viognier",
            price: 12.58,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Seasonal Succulent Sauvignon Blanc",
            price: 13.83,
            isVegetarian: true,
            isVegan: true,
            isGlutenFree: false,
