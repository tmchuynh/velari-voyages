...
/**
 * Menu data for Australian Grand Cafe in melbourne
 */
export const melbourneaustralianGrandCafeMenu: RestaurantMenu[] = [
  {
    title: "Main Course Menu",
    description:
      "Crafted with care, our hearty Greek plates elevate every meal",
    category: [
      {
      ...
      },
      {
        ...
        items: [
          {
            name: "Deluxe Appetizing Clam Chowder",
            price: 12.71,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Authentic Irresistible Seafood Chowder",
            price: 11.49,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
      ...
      },
      {
        name: "Main Courses",
        description:
          "Signature entrées crafted with precision, embodying the core of our Greek vision.",
        items: [
          {
            name: "Fish and Chips",
            price: 19.23,
      ...
      },
      {
        ...
        items: [
          {
            name: "Fresh Delectable Smoked Salmon Platter with Dill Crème",
            price: 22.68,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "House Special Golden Mussels Mariniere in White Wine",
            price: 35.21,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Organic Hearty Lobster Thermidor with Gruyère Crust",
            price: 35.75,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
    ...
    category: [
      {
        ...
        items: [
          {
            name: "Handcrafted Tender Biscotti",
            price: 8.57,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Authentic Succulent Sticky Toffee Pudding",
            price: 10.91,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Traditional Sweet Portuguese Custard Tarts",
            price: 9.43,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          {
            name: "Traditional Juicy Paletas",
            price: 7.98,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Homestyle Exquisite Ice Cream Cake",
            price: 11.45,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Seasonal Sweet Frozen Pudding",
            price: 11.65,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Fresh Braised Frozen Yogurt",
            price: 11.62,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: true,
  ...
  },
  {
    ...
    category: [
      ...
      },
      {
        ...
        items: [
          {
            name: "Homestyle Comforting Cognac",
            price: 16.21,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Homestyle Stuffed Sambuca",
            price: 11.69,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
