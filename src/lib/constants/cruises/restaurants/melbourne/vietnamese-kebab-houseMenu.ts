...
/**
 * Menu data for Vietnamese Kebab House in melbourne
 */
export const melbournevietnameseKebabHouseMenu: RestaurantMenu[] = [
  {
    title: "Main Course Menu",
    description:
      "Enjoy a variety of hearty Italian plates made with seasonal inspiration",
    category: [
      {
      ...
      },
      {
        ...
        items: [
          {
            name: "Gourmet Delicious Turkey and Wild Rice Soup",
            price: 11.53,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Hearty Luscious Chicken Noodle Soup",
            price: 13.01,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Traditional Delicious Gazpacho",
            price: 10.08,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Gourmet Pan-seared French Onion Soup",
            price: 8.93,
            isVegetarian: true,
            isVegan: true,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          {
            name: "Organic Sizzling Cedar Plank Roasted Salmon",
            price: 35.42,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Hearty Wholesome Smoked Salmon Platter with Dill Crème",
            price: 32.02,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Authentic Crispy Lemon-Herb Calamari Steak",
            price: 24.48,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Authentic Roasted Linguine with Clam Sauce",
            price: 27.78,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
    ...
    category: [
      {
        ...
        items: [
          {
            name: "Handcrafted Smoked Cannoli",
            price: 10.21,
            isVegetarian: true,
            isVegan: true,
            isGlutenFree: false,
          ...
          {
            name: "Fresh Mouthwatering Biscotti",
            price: 7.47,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Homestyle Irresistible Apple Pie",
            price: 8.41,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
    ...
    category: [
      {
        ...
        items: [
          ...
          {
            name: "Deluxe Golden Bloody Mary",
            price: 10.4,
            isVegetarian: false,
            isVegan: true,
            isGlutenFree: true,
          ...
          {
            name: "Homestyle Tender Old Fashioned",
            price: 10.22,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Premium Delectable Manhattan",
            price: 12.54,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
