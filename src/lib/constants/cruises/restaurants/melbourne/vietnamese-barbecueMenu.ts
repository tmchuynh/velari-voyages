...
/**
 * Menu data for Vietnamese Barbecue in melbourne
 */
export const melbournevietnameseBarbecueMenu: RestaurantMenu[] = [
  {
    title: "Main Course Menu",
    description:
      "Satisfy your cravings with our vibrant, fresh take on Vietnamese",
    category: [
      {
      ...
      },
      {
        name: "Appetizers",
        description:
          "Traditional and reimagined Vietnamese appetizers made for sharing or solo indulgence.",
        items: [
          {
            name: "Hummus Platter",
            price: 12.15,
      ...
      },
      {
        ...
        items: [
          {
            name: "Handcrafted Sizzling Seafood Chowder",
            price: 10.06,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Authentic Satisfying Split Pea Soup",
            price: 9.35,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Hearty Delectable Egg Drop Soup",
            price: 11.4,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
      ...
      },
      {
        name: "Main Courses",
        description:
          "Signature entrées crafted with precision, embodying the core of our Vietnamese vision.",
        items: [
          {
            name: "Authentic Satisfying Chili con Carne",
            price: 28.94,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Fresh Baked Stuffed Zucchini Boats",
            price: 31.8,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Handcrafted Grilled Fajitas",
            price: 25.71,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: true,
      ...
      },
      {
        ...
        items: [
          {
            name: "Hearty Zesty Chili Lime Roasted Chickpeas",
            price: 7.89,
            isVegetarian: true,
            isVegan: true,
            isGlutenFree: true,
          ...
          {
            name: "Handcrafted Savory Truffle Parmesan Fries",
            price: 8.38,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Fresh Flaky Homestyle Baked Beans",
            price: 7.68,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Fresh Creamy Israeli Couscous with Roasted Tomatoes",
            price: 5.36,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Organic Spicy Roasted Root Vegetables",
            price: 8.47,
            isVegetarian: false,
            isVegan: true,
            isGlutenFree: true,
