...
/**
 * Menu data for Chinese Chocolatier in melbourne
 */
export const melbournechineseChocolatierMenu: RestaurantMenu[] = [
  {
    title: "Main Course Menu",
    description: "Our carefully crafted selection of fresh Chinese dishes",
    category: [
      {
      ...
      },
      {
        ...
        items: [
          {
            name: "Authentic Steamed Heritage Breed Porchetta",
            price: 34.13,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "House Special Flaky Smoked and Slow-Roasted Heritage Meat",
            price: 39.53,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Deluxe Spiced Fusion of Traditional and Modern Techniques",
            price: 37.08,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Seasonal Aromatic Signature Spice-Rubbed Protein",
            price: 25.47,
            isVegetarian: true,
            isVegan: true,
            isGlutenFree: true,
      ...
      },
      {
        ...
        items: [
          {
            name: "Traditional Spicy Cajun Shrimp and Grits",
            price: 34.23,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Homestyle Succulent Valencian Seafood Paella",
            price: 28.55,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Authentic Comforting Blackened Mahi-Mahi with Pineapple Salsa",
            price: 28.26,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Homestyle Stuffed Seared Tuna Steak with Sesame Crust",
            price: 23.87,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Organic Zingy Seafood Alfredo with Spinach Fettuccine",
            price: 32.06,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
      ...
      },
      {
        name: "Side Dishes",
        description:
          "Classic Chinese side dishes with our own unique interpretation.",
        items: [
          {
  ...
  },
  {
    ...
    category: [
      ...
      },
      {
        ...
        items: [
          {
            name: "House Special Aromatic Gelato",
            price: 8.08,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Homestyle Spiced Semifreddo",
            price: 7.92,
            isVegetarian: true,
            isVegan: true,
            isGlutenFree: true,
          ...
          {
            name: "Seasonal Hearty Snow Cone",
            price: 8.64,
            isVegetarian: true,
            isVegan: true,
            isGlutenFree: false,
    ...
    category: [
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: "Deluxe Irresistible Scotch",
            price: 17.29,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
