...
export const melbourneaustralianEnotecaMenu: RestaurantMenu[] = [
  {
    ...
    "description": "Experience our chef's tasty creations inspired by Chinese tradition",
    "category": [
      {
      ...
      {
        "name": "Soups",
        "description": "Daily-prepared soups made from seasonal ingredients and traditional Chinese methods.",
        "items": [
          {
