...
export const melbourneitalianCollectiveMenu: RestaurantMenu[] = [
  {
    ...
    description:
      "An immersive dining experience defined by satisfying Vietnamese cuisine",
    category: [
      {
      ...
      },
      {
        name: "Main Courses",
        description:
          "A selection of mains that reflect the heart and soul of Vietnamese, prepared with care.",
        items: [
          {
            name: "Steak",
            price: 25,
