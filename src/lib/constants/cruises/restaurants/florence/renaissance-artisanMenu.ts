...
/**
 * Menu data for Renaissance Artisan in florence
 */
export const florencerenaissanceArtisanMenu: RestaurantMenu[] = [
  {
    ...
    category: [
      ...
      },
      {
        ...
        items: [
          {
            name: "Deluxe Steamed Collaborative Limited Edition Special",
            price: 35.77,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Hearty Sautéed Chef's Tasting Menu Experience",
            price: 29.05,
            isVegetarian: true,
            isVegan: true,
            isGlutenFree: false,
          ...
          {
            name: "Deluxe Pan-seared Cedar Plank Salmon",
            price: 30.28,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          {
            name: "Premium Delectable Antipasto Platter",
            price: 10.72,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Fresh Pan-seared Cheese Nachos",
            price: 11.96,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Authentic Herbed Prawn Toast",
            price: 12.37,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Gourmet Delectable Mezze Platter",
            price: 10.76,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: "Gourmet Smoked Lobster Thermidor with Gruyère Crust",
            price: 22.65,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Authentic Herbed Grilled Lobster with Lemon Butter",
            price: 26.73,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Handcrafted Spicy Cajun Shrimp and Grits",
            price: 23.24,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Fresh Succulent Seafood Alfredo with Spinach Fettuccine",
            price: 34.66,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: "Homestyle Mouthwatering Truffle Parmesan Fries",
            price: 9.15,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Fresh Succulent Creamy Colcannon (Irish Potato Mash)",
            price: 9.04,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Fresh Pan-seared Creamed Spinach with Nutmeg",
            price: 8.62,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Fresh Crunchy Crispy Zucchini Fritters",
            price: 6.08,
            isVegetarian: true,
            isVegan: true,
            isGlutenFree: false,
  ...
  },
  {
    title: "Dessert Menu",
    description:
      "Sweets reimagined – our classic creations are the perfect ending",
    category: [
      {
        name: "Baked Goods",
        description:
    ...
    category: [
      {
        ...
        items: [
          ...
          {
            name: "Homestyle Pan-seared Old Fashioned",
            price: 11.79,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          {
            name: "Handcrafted Delectable Sambuca",
            price: 14.31,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Authentic Comforting Frangelico",
            price: 11.29,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
