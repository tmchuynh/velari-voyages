...
/**
 * Menu data for Oltrarno Chocolatier in florence
 */
export const florenceoltrarnoChocolatierMenu: RestaurantMenu[] = [
  {
    ...
    category: [
      {
        ...
        items: [
          {
            name: "Authentic Roasted Founder's Family Recipe Pasta",
            price: 28.29,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Authentic Zingy Modernist Foie Gras Sphere with Rhubarb Gel",
            price: 34.77,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Homestyle Wholesome Local Bounty Harvest Plate (Vegetarian)",
            price: 31.19,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Traditional Luscious Chef's Childhood Inspired Creation",
            price: 37.47,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Organic Comforting Legendary Prime Rib",
            price: 30.5,
            isVegetarian: false,
            isVegan: true,
            isGlutenFree: false,
          ...
          {
            name: "House Special Herbed Korean BBQ Short Ribs with Kimchi Rice",
            price: 29.01,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
  ...
  },
  {
    title: "Dessert Menu",
    description:
      "Experience the art of comforting desserts with a French twist",
    category: [
      {
        name: "Baked Goods",
        description:
      ...
      },
      {
        ...
        items: [
          {
            name: "Authentic Satisfying Frozen Pie",
            price: 9.12,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Authentic Succulent Sherbet",
            price: 11.61,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
    ...
    category: [
      {
        ...
        items: [
          ...
          {
            name: "Authentic Zesty Whiskey Sour",
            price: 11.45,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          {
            name: "Seasonal Grilled Grenache",
            price: 13.26,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Gourmet Flavorful Moscato",
            price: 12.1,
            isVegetarian: false,
            isVegan: true,
            isGlutenFree: false,
          ...
          {
            name: "Homestyle Exquisite Pinot Blanc",
            price: 9.71,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Deluxe Pan-seared Chardonnay",
            price: 13.44,
            isVegetarian: true,
            isVegan: true,
            isGlutenFree: true,
