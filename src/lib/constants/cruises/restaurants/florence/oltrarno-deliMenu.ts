...
export const florenceoltrarnoDeliMenu: RestaurantMenu[] = [
  {
    ...
    "description": "Satisfy your cravings with our vibrant, hearty take on Mediterranean",
    "category": [
      {
  ...
  {
    "title": "Dessert Menu",
    "description": "A classic journey through the world of desserts, inspired by Mediterranean",
    "category": [
      {
        "name": "Baked Goods",
  ...
  {
    "title": "Drinks Menu",
    "description": "Unwind with our smooth-drinking beverages crafted for connoisseurs and casual sippers alike",
    "category": [
      {
