...
/**
 * Menu data for Italian Culinary in tampa
 */
export const tampaitalianCulinaryMenu: RestaurantMenu[] = [
  {
    title: "Main Course Menu",
    description:
      "Taste the depth of Spanish culture through our authentic preparations",
    category: [
      {
      ...
      },
      {
        ...
        items: [
          {
            name: "Homestyle Crunchy Mushroom Soup",
            price: 8.06,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Hearty Baked French Onion Soup",
            price: 7.93,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: true,
      ...
      },
      {
        name: "Side Dishes",
        description:
          "Classic Spanish side dishes with our own unique interpretation.",
        items: [
          {
            name: "House Special Flavorful Provencal Ratatouille",
            price: 8.88,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Fresh Tangy Yukon Gold Potato Gratin",
            price: 6.07,
            isVegetarian: false,
            isVegan: true,
            isGlutenFree: true,
          ...
          {
            name: "Authentic Marinated Sautéed Garlic Mushrooms",
            price: 9.89,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
    ...
    category: [
      {
        ...
        items: [
          ...
          {
            name: "Handcrafted Luscious Cannoli",
            price: 6.37,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Authentic Mouthwatering Cheesecake",
            price: 6.92,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
    ...
    category: [
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: "Deluxe Enticing Cabernet Franc",
            price: 9.83,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Classic Enticing Vermentino",
            price: 8.17,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: "Hearty Appetizing Tequila",
            price: 17.5,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Authentic Appetizing Bénédictine",
            price: 10.24,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Authentic Fried Triple Sec",
            price: 13.1,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
