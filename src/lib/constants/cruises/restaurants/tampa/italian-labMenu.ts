...
export const tampaitalianLabMenu: RestaurantMenu[] = [
  {
    ...
    description:
      "Crafted with care, our authentic Cuban plates elevate every meal",
    category: [
      {
      ...
      },
      {
        name: "Appetizers",
        description:
          "A harmonious blend of textures and flavors, our appetizers are a celebration of Cuban culinary artistry.",
        items: [
          {
            name: "Mini Sliders",
            price: 15.43,
