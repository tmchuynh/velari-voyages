...
/**
 * Menu data for Italian Sushi Bar in tampa
 */
export const tampaitalianSushiBarMenu: RestaurantMenu[] = [
  {
    ...
    category: [
      ...
      },
      {
        name: "Main Courses",
        description:
          "From classic to contemporary, our mains are a celebration of Spanish culture.",
        items: [
          {
            name: "Gourmet Satisfying Biryani",
            price: 22.15,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Organic Savory Beef Burger",
            price: 28.11,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Gourmet Roasted Stuffed Zucchini Boats",
            price: 24.08,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Authentic Succulent Chili con Carne",
            price: 21.71,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
    ...
    category: [
      {
        ...
        items: [
          {
            name: "Premium Herbed Danish Pastries",
            price: 9.1,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Gourmet Crunchy Shortbread",
            price: 8.99,
            isVegetarian: false,
            isVegan: true,
            isGlutenFree: false,
          ...
          {
            name: "Authentic Sweet Crumb Cake",
            price: 10.46,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Seasonal Flaky Chocolate Chip Cookies",
            price: 8.23,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
    ...
    category: [
      {
        ...
        items: [
          ...
          {
            name: "Classic Luscious Bloody Mary",
            price: 15.16,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          {
            name: "Handcrafted Sweet Amaretto",
            price: 17.43,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Homestyle Savory Galliano",
            price: 15.59,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
