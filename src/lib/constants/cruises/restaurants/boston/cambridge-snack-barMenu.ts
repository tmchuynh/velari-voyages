...
/**
 * Menu data for Cambridge Snack Bar in boston
 */
export const bostoncambridgeSnackBarMenu: RestaurantMenu[] = [
  {
    ...
    category: [
      {
        ...
        items: [
          {
            name: "Organic Crunchy 24-Hour Braised Short Ribs",
            price: 30.63,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Deluxe Spiced Founder's Family Recipe Pasta",
            price: 28.75,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Fresh Luscious Local Bounty Harvest Plate (Vegetarian)",
            price: 28.58,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Homestyle Crunchy Signature Truffle Pasta with Aged Pecorino",
            price: 37.8,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Homestyle Appetizing Wood-Fired Peking Duck with Plum Sauce",
            price: 28.05,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Authentic Sweet Legendary Prime Rib",
            price: 37.12,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: "Hearty Marinated Clam Chowder",
            price: 12.15,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Handcrafted Comforting Tortilla Soup",
            price: 10.44,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Authentic Roasted Thai Coconut Soup",
            price: 8.83,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: "Homestyle Satisfying Ramen",
            price: 29.18,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Classic Luscious Vegetable Stir-Fry",
            price: 23.57,
            isVegetarian: false,
            isVegan: true,
            isGlutenFree: true,
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: "Traditional Irresistible Hot Chocolate",
            price: 5.22,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
  ...
  },
  {
    title: "Dessert Menu",
    description:
      "A satisfying journey through the world of desserts, inspired by American",
    category: [
      {
        name: "Baked Goods",
        description:
    ...
    category: [
      {
        ...
        items: [
          ...
          {
            name: "Organic Savory Cosmopolitan",
            price: 13.68,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Homestyle Irresistible Manhattan",
            price: 14.78,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: "Deluxe Irresistible Pisco",
            price: 13.28,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
