...
export const bostonfenwayPublicHouseMenu: RestaurantMenu[] = [
  {
    ...
    description: "Our carefully crafted selection of delicious Irish dishes",
    category: [
      {
      ...
      },
      {
        name: "Appetizers",
        description:
          "A delightful array of appetizers that highlight the best of Irish flavors—perfect for sharing or enjoying solo.",
        items: [
          {
            name: "Seasonal Roasted Antipasto Platter",
            price: 15.57,
            isVegetarian: false,
            isVegan: true,
            isGlutenFree: true,
          ...
          {
            name: "Fresh Irresistible Nachos",
            price: 11.21,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Deluxe Spiced Spinach Artichoke Dip",
            price: 14.6,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "House Special Tangy Mini Sliders",
            price: 9.44,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Fresh Smoked Cheese Platter",
            price: 10.85,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Handcrafted Sizzling Stuffed Peppers",
            price: 12.28,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
      ...
      },
      {
        name: "Main Courses",
        description:
          "Hearty and refined mains rooted in traditional Irish, elevated by modern techniques.",
        items: [
          {
            name: "Organic Creamy Beef Burger",
            price: 27.67,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Hearty Spiced Cottage Pie",
            price: 29.99,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Traditional Wholesome Thai Curry",
            price: 21.17,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Handcrafted Pan-seared Roast Duck",
            price: 30.68,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
    ...
    category: [
      {
        ...
        items: [
          ...
          {
            name: "Authentic Aromatic Fruit Galette",
            price: 9.35,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Hearty Succulent Cheesecake",
            price: 8.27,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: "Authentic Marinated Frozen Mousse",
            price: 10.9,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
    ...
    category: [
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: "Seasonal Grilled Triple Sec",
            price: 17.5,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
