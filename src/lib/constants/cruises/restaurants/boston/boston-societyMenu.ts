...
export const bostonbostonSocietyMenu: RestaurantMenu[] = [
  {
    ...
    "description": "Elevated Irish dishes showcasing our most tasty culinary ideas",
    "category": [
      {
        "name": "Signature Dishes",
        "description": "Our chef's pride—carefully selected Irish specialties that define our culinary identity, honed through years of experience and passion.",
        "items": [
          {
  ...
  {
    "title": "Dessert Menu",
    "description": "Handcrafted baked to perfection desserts that celebrate Irish traditions",
    "category": [
      {
        "name": "Baked Goods",
