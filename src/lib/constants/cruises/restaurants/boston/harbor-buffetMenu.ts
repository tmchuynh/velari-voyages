...
/**
 * Menu data for Harbor Buffet in boston
 */
export const bostonharborBuffetMenu: RestaurantMenu[] = [
  {
    title: "Main Course Menu",
    description:
      "A journey through Seafood flavors, led by our chef's homestyle creations",
    category: [
      {
        ...
        items: [
          {
            name: "Homestyle Flaky Caribbean-Style Jerk Duck with Mango Slaw",
            price: 36.72,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Fresh Golden Black Garlic Glazed Beef Tenderloin",
            price: 37.09,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Homestyle Crispy Celebrity Favorite Lobster Dish",
            price: 28.18,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Deluxe Marinated Secret Recipe Bouillabaisse",
            price: 28.91,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          {
            name: "House Special Zesty Heritage Breed Porchetta",
            price: 26.28,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Authentic Fried Fire-Roasted Seasonal Centerpiece",
            price: 34.79,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Deluxe Stuffed Fusion of Traditional and Modern Techniques",
            price: 36.85,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Hearty Spicy Lobster Thermidor",
            price: 24.12,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
