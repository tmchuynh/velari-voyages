...
export const nassaublueCommissaryMenu: RestaurantMenu[] = [
  {
    ...
    "description": "Explore the richness of Japanese cuisine through our simple perspective",
    "category": [
      {
  ...
  {
    "title": "Dessert Menu",
    "description": "Handcrafted crowd-pleasing desserts that celebrate Japanese traditions",
    "category": [
      {
        "name": "Baked Goods",
