...
/**
 * Menu data for Spanish Revival in san-juan
 */
export const sanJuanspanishRevivalMenu: RestaurantMenu[] = [
  {
    title: "Main Course Menu",
    description:
      "Satisfy your cravings with our vibrant, delicious take on Caribbean",
    category: [
      {
      ...
      },
      {
        ...
        description:
          "A rotating selection of dishes that highlight the chef's creativity and passion for Caribbean.",
        items: [
          {
            name: "Organic Herbed Seasonal Farm-to-Table Vegetable Plate",
            price: 29.86,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Homestyle Comforting Special Occasion Celebratory Dish",
            price: 33.3,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Authentic Marinated Charcoal-Grilled Wagyu Beef",
            price: 34.36,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          {
            name: "Authentic Exquisite Truffle Parmesan Fries",
            price: 5.2,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Authentic Comforting Crispy Beer-Battered Onion Rings",
            price: 7.38,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Fresh Satisfying Mashed Potatoes",
            price: 6.99,
            isVegetarian: true,
            isVegan: true,
            isGlutenFree: false,
          ...
          {
            name: "Gourmet Exquisite Creamy Colcannon (Irish Potato Mash)",
            price: 8.06,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Deluxe Herbed Baked Idaho Potato with Sour Cream",
            price: 8.73,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Seasonal Creamy Scalloped Potatoes with Thyme",
            price: 6.94,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: "Traditional Satisfying Milkshake",
            price: 4.16,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
