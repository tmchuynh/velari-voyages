...
export const sanJuancaribbeanRevivalMenu: RestaurantMenu[] = [
  {
    ...
    "description": "A classic assortment of specialties showcasing the best of Caribbean cuisine",
    "category": [
      {
      ...
      {
        "name": "Appetizers",
        "description": "A selection of small plates that showcase the essence of Caribbean—perfect for sharing or savoring solo.",
        "items": [
          {
      ...
      {
        "name": "Soups",
        "description": "Crafted with care, our soups are a celebration of Caribbean flavors and traditions.",
        "items": [
          {
            "name": "Miso Soup",
            "price": 11.83,
