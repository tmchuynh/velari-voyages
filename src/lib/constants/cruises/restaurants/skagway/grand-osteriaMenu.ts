...
/**
 * Menu data for Grand Osteria in skagway
 */
export const skagwaygrandOsteriaMenu: RestaurantMenu[] = [
  {
    title: "Main Course Menu",
    description:
      "A journey through American flavors, led by our chef's hearty creations",
    category: [
      {
      ...
      },
      {
        ...
        items: [
          {
            name: "Authentic Steamed Black Garlic Marinated Octopus",
            price: 33.77,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Fresh Exquisite Tableside Flambé Preparation",
            price: 30.08,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Premium Appetizing Gourmet Vegetarian Wellington",
            price: 24.13,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Organic Comforting House Specialty Pasta Creation",
            price: 36.43,
            isVegetarian: true,
            isVegan: true,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: "Fresh Creamy Fish and Chips",
            price: 18.94,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Hearty Enticing Spaghetti Bolognese",
            price: 30.79,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Authentic Marinated Steak",
            price: 31.82,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Seasonal Wholesome Stuffed Zucchini Boats",
            price: 21.98,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Homestyle Aromatic Gnocchi",
            price: 21.91,
            isVegetarian: false,
            isVegan: true,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: "Gourmet Grilled Lemon-Herb Calamari Steak",
            price: 30.48,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Premium Succulent Prawn Curry in Coconut Masala",
            price: 27.86,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Authentic Appetizing Seafood Risotto with Saffron",
            price: 23.24,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          {
            name: "Fresh Irresistible Hot Chocolate",
            price: 6.44,
            isVegetarian: false,
            isVegan: true,
            isGlutenFree: false,
    ...
    category: [
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: "Authentic Sautéed Sherbet",
            price: 12,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Gourmet Herbed Ice Cream Cake",
            price: 10.26,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
    ...
    category: [
      {
        ...
        items: [
          ...
          {
            name: "Handcrafted Spiced Mai Tai",
            price: 11.06,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: "Authentic Spicy Petit Verdot",
            price: 11.21,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Seasonal Roasted Torrontés",
            price: 12.22,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Hearty Satisfying Viognier",
            price: 8.16,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
