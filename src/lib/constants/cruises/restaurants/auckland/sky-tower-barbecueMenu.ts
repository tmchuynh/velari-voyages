...
/**
 * Menu data for Sky Tower Barbecue in auckland
 */
export const aucklandskyTowerBarbecueMenu: RestaurantMenu[] = [
  {
    title: "Main Course Menu",
    description: "Inspired by tradition, driven by authentic execution",
    category: [
      {
      ...
      },
      {
        ...
        items: [
          {
            name: "House Special Tangy Black Garlic Marinated Octopus",
            price: 29.94,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Authentic Herbed Modern Interpretation of Regional Classic",
            price: 27.12,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Deluxe Braised Dry-Aged Prime Beef Selection",
            price: 37.98,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Fresh Crispy Gourmet Vegetarian Wellington",
            price: 25.42,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Deluxe Mouthwatering Seared Foie Gras with Fig Compote",
            price: 36.81,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          {
            name: "Gourmet Braised Carrot Ginger Soup",
            price: 7.2,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Homestyle Creamy Gazpacho",
            price: 7.52,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          {
            name: "House Special Golden Quiche",
            price: 27.92,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "House Special Creamy Stuffed Peppers",
            price: 23.41,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Hearty Grilled Pulled Pork Sandwich",
            price: 24,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Authentic Luscious Cottage Pie",
            price: 19.19,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Homestyle Grilled Grilled Tofu",
            price: 19.38,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Authentic Grilled Beef Burger",
            price: 31.46,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: "Authentic Herbed Iced Tea",
            price: 6.2,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Handcrafted Appetizing Coffee",
            price: 7.8,
            isVegetarian: false,
            isVegan: true,
            isGlutenFree: true,
    ...
    category: [
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: "Organic Stuffed Ice Cream",
            price: 11.69,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Premium Hearty Frozen Fruit Bars",
            price: 11.39,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
  ...
  },
  {
    title: "Drinks Menu",
    description:
      "Discover our smooth-drinking drinks, perfectly paired with our Maori cuisine",
    category: [
      {
        ...
        items: [
          {
            name: "Authentic Steamed Negroni",
            price: 12.88,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "House Special Crunchy Manhattan",
            price: 12.62,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Traditional Braised Mai Tai",
            price: 15,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
