...
export const glacierBayroyalAtelierMenu: RestaurantMenu[] = [
  {
    ...
    "description": "Explore the richness of Italian cuisine through our tasty perspective",
    "category": [
      {
  ...
  {
    "title": "Drinks Menu",
    "description": "Discover our flavorful drinks, perfectly paired with our Italian cuisine",
    "category": [
      {
