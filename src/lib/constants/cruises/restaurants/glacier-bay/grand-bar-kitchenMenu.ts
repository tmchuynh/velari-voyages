...
export const glacierBaygrandBarKitchenMenu: RestaurantMenu[] = [
  {
    ...
    description:
      "A thoughtfully balanced mix of classic and authentic Mediterranean flavors",
    category: [
      {
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: "House Special Zingy Minestrone",
            price: 9.37,
            isVegetarian: false,
            isVegan: true,
            isGlutenFree: true,
      ...
      },
      {
        ...
        items: [
          {
            name: "Handcrafted Marinated Hearty Italian Cioppino",
            price: 28.47,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Fresh Creamy Oysters Rockefeller with Pernod Cream",
            price: 30.79,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Classic Juicy Maryland Style Crab Cakes",
            price: 34.13,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Hearty Tender Seafood Gumbo with Okra",
            price: 32.59,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Handcrafted Savory Lemon-Herb Calamari Steak",
            price: 22.27,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
      ...
      },
      {
        ...
        items: [
          {
            name: "Fresh Grilled Macaroni and Aged Cheddar",
            price: 9.97,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Homestyle Zesty Sweet Potato Wedges with Smoked Paprika",
            price: 8.55,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Premium Grilled Scalloped Potatoes with Thyme",
            price: 9.85,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Fresh Sizzling Chili Lime Roasted Chickpeas",
            price: 8.68,
            isVegetarian: true,
            isVegan: true,
            isGlutenFree: true,
          ...
          {
            name: "Fresh Enticing Mashed Potatoes",
            price: 5.55,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
  ...
  },
  {
    title: "Drinks Menu",
    description:
      "Discover our balanced drinks, perfectly paired with our Mediterranean cuisine",
    category: [
      {
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: "Homestyle Sizzling Petit Verdot",
            price: 9.9,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Classic Stuffed Zinfandel",
            price: 13.99,
            isVegetarian: true,
            isVegan: true,
            isGlutenFree: true,
          ...
          {
            name: "Homestyle Sizzling Champagne/Sparkling Wine",
            price: 9.66,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: "House Special Marinated Sambuca",
            price: 11.53,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Premium Comforting Maraschino",
            price: 11.22,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "House Special Tangy Cointreau",
            price: 17.37,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
