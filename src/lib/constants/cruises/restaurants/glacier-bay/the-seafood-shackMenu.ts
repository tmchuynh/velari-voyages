...
/**
 * Menu data for The Seafood Shack in glacier-bay
 */
export const glacierBaytheSeafoodShackMenu: RestaurantMenu[] = [
  {
    title: "Main Course Menu",
    description:
      "Taste the depth of French culture through our homestyle preparations",
    category: [
      {
      ...
      },
      {
        ...
        items: [
          {
            name: "Homestyle Roasted Butternut Squash Soup",
            price: 7.62,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Premium Comforting Vegetable Barley Soup",
            price: 10.94,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Homestyle Satisfying Seafood Chowder",
            price: 9.26,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: "Classic Sweet Grilled Chicken",
            price: 22.08,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Classic Luscious Stuffed Peppers",
            price: 28.23,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: "Premium Exquisite Garlic Butter Shrimp Skillet",
            price: 26.69,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Traditional Enticing Oysters Rockefeller with Pernod Cream",
            price: 26.33,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
      ...
      },
      {
        ...
        items: [
          {
            name: "House Special Irresistible Mashed Potatoes",
            price: 8.73,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Organic Satisfying French Fries",
            price: 8.6,
            isVegetarian: false,
            isVegan: true,
            isGlutenFree: false,
          ...
          {
            name: "Organic Tender Crispy Beer-Battered Onion Rings",
            price: 9.07,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Organic Flaky Soft Polenta with Parmesan",
            price: 9.26,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: "Homestyle Roasted Iced Tea",
            price: 5.66,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: true,
    ...
    category: [
      {
        ...
        items: [
          {
            name: "Fresh Herbed Strawberry Shortcake",
            price: 10.55,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Fresh Enticing Berry Tart",
            price: 9.42,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
