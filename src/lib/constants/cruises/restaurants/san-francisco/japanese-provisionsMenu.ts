...
export const sanFranciscojapaneseProvisionsMenu: RestaurantMenu[] = [
  {
    ...
    "description": "Our kitchen presents an array of hearty offerings from across the Italian spectrum",
    "category": [
      {
  ...
  {
    "title": "Dessert Menu",
    "description": "Our baked to perfection dessert offerings crafted with the finest ingredients",
    "category": [
      {
        "name": "Baked Goods",
