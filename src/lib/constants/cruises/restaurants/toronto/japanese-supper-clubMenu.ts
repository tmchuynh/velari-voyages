...
/**
 * Menu data for Japanese Supper Club in toronto
 */
export const torontojapaneseSupperClubMenu: RestaurantMenu[] = [
  {
    title: "Main Course Menu",
    description:
      "A showcase of comforting culinary artistry rooted in Indian heritage",
    category: [
      {
      ...
      },
      {
        ...
        items: [
          {
            name: "House Special Stuffed Spring Rolls",
            price: 13.02,
            isVegetarian: false,
            isVegan: true,
            isGlutenFree: false,
          ...
          {
            name: "Fresh Sweet Stuffed Peppers",
            price: 15.74,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Gourmet Delectable Mini Empanadas",
            price: 15.5,
            isVegetarian: false,
            isVegan: true,
            isGlutenFree: false,
          ...
          {
            name: "Fresh Crispy Garlic Bread",
            price: 10.59,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Seasonal Comforting Arancini",
            price: 14.42,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
      ...
      },
      {
        name: "Soups",
        description:
          "Daily-prepared soups made from seasonal ingredients and traditional Indian methods.",
        items: [
          {
          ...
          {
            name: "Authentic Herbed Broccoli Cheddar Soup",
            price: 13.95,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Hearty Flaky Carrot Ginger Soup",
            price: 12.74,
            isVegetarian: true,
            isVegan: true,
            isGlutenFree: true,
      ...
      },
      {
        ...
        items: [
          {
            name: "Gourmet Juicy Tempura Soft Shell Crab",
            price: 32.01,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Homestyle Grilled Blackened Mahi-Mahi with Pineapple Salsa",
            price: 27.46,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Traditional Aromatic Basa Fillet with Dill Cream Sauce",
            price: 30.77,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Authentic Creamy Seafood Alfredo with Spinach Fettuccine",
            price: 27.11,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Authentic Sweet Classic British Fish and Chips",
            price: 34.67,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: "Homestyle Stuffed Stuffed Bell Peppers with Brown Rice",
            price: 7.49,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "House Special Tangy Corn on the Cob with Chili Lime Butter",
            price: 8.19,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Fresh Luscious Steamed Jasmine Rice",
            price: 8.87,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: true,
  ...
  },
  {
    title: "Drinks Menu",
    description:
      "Discover our balanced drinks, perfectly paired with our Indian cuisine",
    category: [
      {
