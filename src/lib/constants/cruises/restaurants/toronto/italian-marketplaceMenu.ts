...
/**
 * Menu data for Italian Marketplace in toronto
 */
export const torontoitalianMarketplaceMenu: RestaurantMenu[] = [
  {
    title: "Main Course Menu",
    description:
      "Your introduction to a world of authentic, flavor-rich Chinese meals",
    category: [
      {
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: "Classic Zesty Stuffed Mushrooms",
            price: 14.15,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "House Special Wholesome Edamame",
            price: 11.96,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Homestyle Marinated Bruschetta",
            price: 10.67,
            isVegetarian: true,
            isVegan: true,
            isGlutenFree: false,
          ...
          {
            name: "Seasonal Crunchy Chicken Satay",
            price: 13.77,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "House Special Golden Hummus Platter",
            price: 8.45,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          {
            name: "House Special Satisfying Tomato Soup",
            price: 9.81,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Hearty Steamed Italian Wedding Soup",
            price: 10.76,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Seasonal Herbed Clam Chowder",
            price: 11.95,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "House Special Satisfying Gumbo",
            price: 8.72,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
    ...
    category: [
      {
        ...
        items: [
          {
            name: "Homestyle Comforting Danish Pastries",
            price: 6.07,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Traditional Savory Shortbread",
            price: 7.79,
            isVegetarian: false,
            isVegan: true,
            isGlutenFree: false,
  ...
  },
  {
    title: "Drinks Menu",
    description:
      "Discover our delightful drinks, perfectly paired with our Chinese cuisine",
    category: [
      {
        ...
        items: [
          {
            name: "Authentic Fried Bloody Mary",
            price: 10.79,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Classic Pan-seared Negroni",
            price: 11.58,
            isVegetarian: false,
            isVegan: true,
            isGlutenFree: true,
          ...
          {
            name: "Authentic Exquisite Mojito",
            price: 12.67,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Seasonal Flavorful Whiskey Sour",
            price: 12.6,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          {
            name: "Handcrafted Appetizing Sémillon",
            price: 9.24,
            isVegetarian: false,
            isVegan: true,
            isGlutenFree: false,
          ...
          {
            name: "Authentic Crunchy Cabernet Franc",
            price: 12.5,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Seasonal Wholesome Barbera",
            price: 11.8,
            isVegetarian: true,
            isVegan: true,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: "Authentic Sweet Bénédictine",
            price: 15.55,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Deluxe Flavorful Anisette",
            price: 14.5,
            isVegetarian: false,
            isVegan: true,
            isGlutenFree: true,
