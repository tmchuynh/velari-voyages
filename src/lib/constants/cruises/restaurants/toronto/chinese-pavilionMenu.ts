...
export const torontochinesePavilionMenu: RestaurantMenu[] = [
  {
    ...
    "description": "A thoughtfully balanced mix of hearty and authentic Italian flavors",
    "category": [
      {
  ...
  {
    "title": "Dessert Menu",
    "description": "A curated selection of classic desserts, inspired by Italian heritage",
    "category": [
      {
        "name": "Baked Goods",
