...
export const torontoindianOsteriaMenu: RestaurantMenu[] = [
  {
    ...
    description: "Timeless tastes, elevated by our fresh approach to Chinese",
    category: [
      {
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: "Deluxe Delectable Mini Sliders",
            price: 13.84,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Premium Delectable Stuffed Mushrooms",
            price: 9.03,
            isVegetarian: false,
            isVegan: true,
            isGlutenFree: false,
          ...
          {
            name: "House Special Stuffed Mezze Platter",
            price: 12.63,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Organic Exquisite Sweet Potato Fries",
            price: 10.45,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          {
            name: "Seasonal Spiced Chicken Corn Soup",
            price: 7.95,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Classic Spiced Avgolemono (Greek Lemon Soup)",
            price: 11.73,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Authentic Grilled Vegetable Barley Soup",
            price: 9.21,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Premium Hearty Butternut Squash Soup",
            price: 8.07,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: true,
      ...
      },
      {
        ...
        items: [
          {
            name: "Classic Flavorful Lasagna",
            price: 31.69,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Deluxe Herbed Katsu Curry",
            price: 29.84,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Organic Hearty Coq au Vin",
            price: 19.08,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Gourmet Stuffed Cottage Pie",
            price: 26.07,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Handcrafted Grilled Grilled Tofu",
            price: 21.21,
            isVegetarian: true,
            isVegan: true,
            isGlutenFree: false,
          ...
          {
            name: "Fresh Irresistible Biryani",
            price: 30.3,
            isVegetarian: true,
            isVegan: true,
            isGlutenFree: true,
      ...
      },
      {
        ...
        items: [
          {
            name: "Classic Savory Hot Chocolate",
            price: 4.23,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "House Special Marinated Water",
            price: 7.03,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Handcrafted Comforting Smoothie",
            price: 6.79,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
  ...
  {
    title: "Dessert Menu",
    description: "Chinese-inspired homemade confections to delight your senses",
    category: [
      {
        name: "Baked Goods",
        description:
        ...
        items: [
          {
            name: "House Special Grilled Portuguese Custard Tarts",
            price: 9.19,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Authentic Appetizing Baklava",
            price: 7.86,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Handcrafted Baked Apple Pie",
            price: 10,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Deluxe Appetizing Tiramisu",
            price: 10.07,
            isVegetarian: true,
            isVegan: true,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          {
            name: "Organic Sweet Frozen Banana",
            price: 8.94,
            isVegetarian: true,
            isVegan: true,
            isGlutenFree: false,
          ...
          {
            name: "Handcrafted Satisfying Frozen Custard",
            price: 10.02,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
    ...
    category: [
      {
        ...
        items: [
          ...
          {
            name: "Handcrafted Marinated Bloody Mary",
            price: 12.24,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: "Classic Crunchy Pinot Grigio",
            price: 10.42,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Gourmet Delicious Verdicchio",
            price: 12.41,
            isVegetarian: true,
            isVegan: true,
            isGlutenFree: true,
