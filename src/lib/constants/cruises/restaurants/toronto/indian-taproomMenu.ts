...
export const torontoindianTaproomMenu: RestaurantMenu[] = [
  {
    ...
    "description": "Crafted with care, our tasty Indian plates elevate every meal",
    "category": [
      {
      ...
      {
        "name": "Main Courses",
        "description": "Each dish is a culinary journey, showcasing the richness of Indian traditions.",
        "items": [
          {
            "name": "Risotto",
            "price": 30.17,
