...
export const torontocanadianGastropubMenu: RestaurantMenu[] = [
  {
    ...
    description:
      "A showcase of satisfying culinary artistry rooted in Chinese heritage",
    category: [
      {
  ...
  },
  {
    title: "Dessert Menu",
    description:
      "Chinese-inspired delicious confections to delight your senses",
    category: [
      {
        name: "Baked Goods",
        description:
  ...
  },
  {
    title: "Drinks Menu",
    description:
      "A flavorful array of beverages specially selected by our sommeliers",
    category: [
      {
