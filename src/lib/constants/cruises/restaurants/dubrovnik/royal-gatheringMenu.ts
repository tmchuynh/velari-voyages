...
export const dubrovnikroyalGatheringMenu: RestaurantMenu[] = [
  {
    ...
    "description": "From street food classics to refined plates—our delicious take on Italian",
    "category": [
      {
  ...
  {
    "title": "Drinks Menu",
    "description": "Our select wine list features carefully chosen bottles from renowned vineyards",
    "category": [
      {
