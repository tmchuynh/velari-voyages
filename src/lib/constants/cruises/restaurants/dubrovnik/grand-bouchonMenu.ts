...
export const dubrovnikgrandBouchonMenu: RestaurantMenu[] = [
  {
    ...
    description:
      "Satisfy your cravings with our vibrant, comforting take on Mediterranean",
    category: [
      {
      ...
      },
      {
        ...
        items: [
          {
            name: "Hearty Creamy Spring Rolls",
            price: 10.1,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Deluxe Roasted Mozzarella Sticks",
            price: 11.82,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Gourmet Creamy Baked Brie",
            price: 9.94,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Deluxe Herbed Mini Sliders",
            price: 10.71,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Deluxe Spicy Caprese Salad",
            price: 8.15,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Deluxe Mouthwatering Sweet Potato Fries",
            price: 11.82,
            isVegetarian: false,
            isVegan: true,
            isGlutenFree: true,
      ...
      },
      {
        ...
        items: [
          {
            name: "Authentic Comforting Minestrone",
            price: 10.54,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Handcrafted Satisfying Carrot Ginger Soup",
            price: 12.42,
            isVegetarian: true,
            isVegan: true,
            isGlutenFree: true,
      ...
      },
      {
        ...
        items: [
          {
            name: "Classic Steamed Seafood Platter",
            price: 25.32,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Deluxe Baked Shish Kebabs",
            price: 24.51,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Homestyle Luscious Pasta Primavera",
            price: 19.5,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Homestyle Marinated Eggplant Parmesan",
            price: 24.63,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Gourmet Irresistible Fish and Chips",
            price: 22.24,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "House Special Hearty Grilled Tofu",
            price: 30.1,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          {
            name: "Classic Hearty Alaskan King Crab Legs with Drawn Butter",
            price: 25.42,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Traditional Flavorful Cedar Plank Roasted Salmon",
            price: 28.72,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Seasonal Creamy Seared Tuna Steak with Sesame Crust",
            price: 34.17,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Gourmet Creamy Lemon-Herb Calamari Steak",
            price: 25.22,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Premium Smoked Sushi-Grade Sashimi Platter",
            price: 24.75,
            isVegetarian: true,
            isVegan: true,
            isGlutenFree: false,
  ...
  },
  {
    title: "Dessert Menu",
    description:
      "A curated selection of delicious desserts, inspired by Mediterranean heritage",
    category: [
      {
        name: "Baked Goods",
        description:
        ...
        items: [
          {
            name: "Classic Smoked Carrot Cake",
            price: 8.25,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Hearty Flavorful Sticky Toffee Pudding",
            price: 9.72,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: true,
      ...
      },
      {
        ...
        items: [
          {
            name: "Traditional Smoked Ice Cream Cake",
            price: 9.88,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Premium Smoked Ice Cream Sandwich",
            price: 7.13,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Traditional Pan-seared Ice Cream",
            price: 7.1,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Deluxe Stuffed Baked Alaska",
            price: 11.46,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
  ...
  },
  {
    title: "Drinks Menu",
    description:
      "Discover our select drinks, perfectly paired with our Mediterranean cuisine",
    category: [
      {
        ...
        items: [
          {
            name: "Classic Succulent Mai Tai",
            price: 12.94,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Authentic Zesty Margarita",
            price: 12.52,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Handcrafted Zesty Whiskey Sour",
            price: 10.57,
            isVegetarian: true,
            isVegan: true,
            isGlutenFree: true,
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: "Handcrafted Satisfying Scotch",
            price: 16.33,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Traditional Crispy Armagnac",
            price: 17.03,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Deluxe Irresistible Galliano",
            price: 15.01,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
