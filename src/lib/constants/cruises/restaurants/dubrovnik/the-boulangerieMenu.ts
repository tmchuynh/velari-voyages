...
/**
 * Menu data for The Boulangerie in dubrovnik
 */
export const dubrovniktheBoulangerieMenu: RestaurantMenu[] = [
  {
    ...
    category: [
      ...
      },
      {
        ...
        items: [
          {
            name: "Homestyle Juicy Corn Chowder",
            price: 11.27,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Seasonal Crispy Mushroom Soup",
            price: 12.27,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Deluxe Golden Lentil Soup",
            price: 8.76,
            isVegetarian: false,
            isVegan: true,
            isGlutenFree: false,
  ...
  },
  {
    title: "Dessert Menu",
    description:
      "Handcrafted freshly prepared desserts that celebrate American traditions",
    category: [
      {
        name: "Baked Goods",
        description:
        ...
        items: [
          {
            name: "Handcrafted Luscious Sticky Toffee Pudding",
            price: 6.66,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Hearty Succulent Berry Tart",
            price: 7.94,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Traditional Flaky Chocolate Chip Cookies",
            price: 8.79,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
  ...
  },
  {
    ...
    category: [
      ...
      },
      {
        ...
        items: [
          {
            name: "Traditional Enticing Pinot Noir",
            price: 13.47,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Fresh Steamed Sauvignon Blanc",
            price: 13.57,
            isVegetarian: false,
            isVegan: true,
            isGlutenFree: false,
          ...
          {
            name: "Hearty Roasted Syrah/Shiraz",
            price: 9.06,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
