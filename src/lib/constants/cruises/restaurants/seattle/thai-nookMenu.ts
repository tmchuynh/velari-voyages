...
/**
 * Menu data for Thai Nook in seattle
 */
export const seattlethaiNookMenu: RestaurantMenu[] = [
  {
    title: "Main Course Menu",
    description:
      "A showcase of tasty culinary artistry rooted in American heritage",
    category: [
      {
      ...
      },
      {
        ...
        items: [
          {
            name: "Hearty Delectable Caprese Salad",
            price: 9.48,
            isVegetarian: true,
            isVegan: true,
            isGlutenFree: false,
          ...
          {
            name: "Homestyle Creamy Spinach Puffs",
            price: 14.42,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Deluxe Zingy Cheese Nachos",
            price: 10.11,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: "Authentic Appetizing Grilled Chicken",
            price: 23.66,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Handcrafted Satisfying Beef Burger",
            price: 18.82,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Authentic Fried Eggplant Parmesan",
            price: 25.69,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Deluxe Wholesome Chicken Parmesan",
            price: 29.93,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Hearty Marinated Thai Curry",
            price: 22.04,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          {
            name: "House Special Stuffed Seafood Gumbo with Okra",
            price: 34.89,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Organic Smoked Pan-Seared Scallops with Pea Purée",
            price: 32.42,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Authentic Stuffed Mussels Mariniere in White Wine",
            price: 35.47,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Seasonal Spicy Traditional Provençal Bouillabaisse",
            price: 28.01,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Organic Zesty Crab-Stuffed Mushrooms",
            price: 23.98,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
    ...
    category: [
      {
        ...
        items: [
          ...
          {
            name: "Gourmet Delectable Old Fashioned",
            price: 12.22,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
