...
/**
 * Menu data for Caribbean Local in miami
 */
export const miamicaribbeanLocalMenu: RestaurantMenu[] = [
  {
    ...
    category: [
      {
        ...
        description:
          "House favorites that have stood the test of time and showcase our refined approach to Cuban cuisine.",
        items: [
          {
      ...
      },
      {
        name: "Appetizers",
        description:
          "Flavor-forward starters that introduce our approach to Cuban with balance and creativity.",
        items: [
          {
            name: "Garlic Bread",
            price: 15.81,
      ...
      },
      {
        ...
        items: [
          {
            name: "Seasonal Spiced Carrot Ginger Soup",
            price: 10.62,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Authentic Luscious Cabbage Soup",
            price: 12.53,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Fresh Satisfying Minestrone",
            price: 7.26,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: "Gourmet Delicious Pesto Pasta",
            price: 20.68,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Traditional Golden Coq au Vin",
            price: 29.62,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Deluxe Appetizing Burrito",
            price: 19.75,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          {
            name: "Fresh Enticing Crispy Beer-Battered Onion Rings",
            price: 9.98,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Fresh Fried Chili Lime Roasted Chickpeas",
            price: 6.73,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Gourmet Smoked Corn on the Cob with Chili Lime Butter",
            price: 8.02,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Classic Zingy Truffle Parmesan Fries",
            price: 7.57,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
  ...
  },
  {
    ...
    category: [
      ...
      },
      {
        ...
        items: [
          {
            name: "Deluxe Aromatic Pinot Grigio",
            price: 11.78,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Handcrafted Juicy Marsanne",
            price: 10.75,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Hearty Succulent Zinfandel",
            price: 9.42,
            isVegetarian: false,
            isVegan: true,
            isGlutenFree: false,
          ...
          {
            name: "Gourmet Herbed Sauvignon Blanc",
            price: 11.97,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "House Special Golden Moscato",
            price: 8.91,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Organic Hearty Pinot Noir",
            price: 9,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: "Authentic Sizzling Drambuie",
            price: 13.03,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Premium Stuffed Cointreau",
            price: 16.15,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
