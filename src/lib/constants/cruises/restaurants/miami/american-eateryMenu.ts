...
/**
 * Menu data for American Eatery in miami
 */
export const miamiamericanEateryMenu: RestaurantMenu[] = [
  {
    title: "Main Course Menu",
    description:
      "A thoughtfully balanced mix of flavorful and authentic American flavors",
    category: [
      {
      ...
      },
      {
        ...
        items: [
          {
            name: "Authentic Steamed Cheese Platter",
            price: 11.58,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Gourmet Irresistible Samosas",
            price: 15.99,
            isVegetarian: true,
            isVegan: true,
            isGlutenFree: false,
          ...
          {
            name: "Authentic Aromatic Calamari",
            price: 15.83,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Deluxe Savory Mezze Platter",
            price: 12.66,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Gourmet Savory Potstickers",
            price: 12.7,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          {
            name: "Authentic Appetizing Beef Wellington",
            price: 23.65,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Deluxe Comforting Mac and Cheese",
            price: 22.46,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Seasonal Sizzling Roast Duck",
            price: 30.27,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Seasonal Stuffed Chili con Carne",
            price: 22.38,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Deluxe Roasted Spaghetti Bolognese",
            price: 23.87,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          {
            name: "Handcrafted Crispy Sautéed Garlic Mushrooms",
            price: 9.36,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Handcrafted Roasted Flaky Cheddar and Chive Biscuits",
            price: 5.84,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Deluxe Spiced Crispy Zucchini Fritters",
            price: 5.81,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: true,
    ...
    category: [
      {
        ...
        items: [
          {
            name: "Hearty Marinated Apple Pie",
            price: 8.1,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Traditional Zingy Lemon Bars",
            price: 10.9,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Seasonal Enticing Muffins",
            price: 9.16,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
    ...
    category: [
      {
        ...
        items: [
          ...
          {
            name: "Gourmet Exquisite Manhattan",
            price: 14.28,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Deluxe Satisfying Whiskey Sour",
            price: 10.75,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
