...
/**
 * Menu data for Prussian Cafe in berlin
 */
export const berlinprussianCafeMenu: RestaurantMenu[] = [
  {
    title: "Main Course Menu",
    description:
      "An immersive dining experience defined by authentic Turkish cuisine",
    category: [
      {
      ...
      },
      {
        ...
        items: [
          {
            name: "Hearty Luscious Chef's Tasting Menu Experience",
            price: 38.64,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Seasonal Spiced Sous Vide Perfection with Molecular Gastronomy Elements",
            price: 31.58,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Authentic Baked Tasting of Local Artisanal Cheeses",
            price: 33.3,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Classic Tender Special Occasion Celebratory Dish",
            price: 30.99,
            isVegetarian: false,
            isVegan: true,
            isGlutenFree: false,
          ...
          {
            name: "Gourmet Sizzling Lobster and Crab Stuffed Ravioli",
            price: 24.99,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          {
            name: "Traditional Flaky Spring Rolls",
            price: 8.17,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Handcrafted Zesty Mozzarella Sticks",
            price: 14.32,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Premium Stuffed Onion Rings",
            price: 14.24,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Classic Stuffed Garlic Knots",
            price: 13.73,
            isVegetarian: false,
            isVegan: true,
            isGlutenFree: false,
          ...
          {
            name: "Deluxe Smoked Cheese Nachos",
            price: 14.86,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Hearty Steamed Chicken Satay",
            price: 8.72,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Traditional Grilled Spinach Artichoke Dip",
            price: 14.23,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
      ...
      },
      {
        name: "Side Dishes",
        description:
          "Crafted to enhance your meal, these sides are a celebration of Turkish flavors.",
        items: [
          {
  ...
  },
  {
    title: "Dessert Menu",
    description:
      "Turkish-inspired mouthwatering confections to delight your senses",
    category: [
      {
        name: "Baked Goods",
        description:
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: "Homestyle Delectable Frozen Mousse",
            price: 10.56,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Seasonal Fried Baked Alaska",
            price: 7.85,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
    ...
    category: [
      {
        ...
        items: [
          ...
          {
            name: "Handcrafted Baked Old Fashioned",
            price: 10.99,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: "Authentic Creamy Limoncello",
            price: 17.21,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Handcrafted Herbed Cognac",
            price: 13.77,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
