...
export const berlinbavarianPizzeriaMenu: RestaurantMenu[] = [
  {
    ...
    description:
      "A thoughtfully curated lineup of comforting Turkish dishes to suit every palate",
    category: [
      {
      ...
      },
      {
        name: "Soups",
        description:
          "Warm, nourishing soups that reflect the heart of Turkish cooking—perfect for any season.",
        items: [
          {
