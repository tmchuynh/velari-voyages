...
export const berlintiergartenCreperieMenu: RestaurantMenu[] = [
  {
    ...
    "description": "Delight in our chef's most classic takes on traditional Vietnamese flavors",
    "category": [
      {
      ...
      },
      {
        ...
        "description": "A rotating selection of dishes that highlight the chef's creativity and passion for Vietnamese.",
        "items": [
          {
