...
export const cozumelroyalChophouseMenu: RestaurantMenu[] = [
  {
    ...
    "description": "Chef-selected delicious offerings highlighting Italian culinary heritage",
    "category": [
      {
  ...
  {
    "title": "Dessert Menu",
    "description": "Experience the art of crowd-pleasing desserts with a Italian twist",
    "category": [
      {
        "name": "Baked Goods",
  ...
  {
    "title": "Drinks Menu",
    "description": "A easygoing array of beverages specially curated for our guests",
    "category": [
      {
