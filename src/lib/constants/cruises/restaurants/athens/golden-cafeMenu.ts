...
/**
 * Menu data for Golden Cafe in athens
 */
export const athensgoldenCafeMenu: RestaurantMenu[] = [
  {
    title: "Main Course Menu",
    description:
      "Traditional and contemporary French favorites with our fresh touch",
    category: [
      {
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: "Authentic Grilled Freshly Harvested Seasonal Creation",
            price: 36.38,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Seasonal Juicy Slow-Roasted Prime Rib",
            price: 31.28,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Authentic Tender Charcoal-Grilled Wagyu Beef",
            price: 38.01,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Handcrafted Grilled Deconstructed Classic with Modern Technique",
            price: 33.99,
            isVegetarian: false,
            isVegan: true,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          {
            name: "Hearty Exquisite Pesto Pasta",
            price: 18.03,
            isVegetarian: true,
            isVegan: true,
            isGlutenFree: false,
          ...
          {
            name: "House Special Flavorful Stuffed Zucchini Boats",
            price: 21.19,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Fresh Hearty Shish Kebabs",
            price: 27.95,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Deluxe Sweet Grilled Chicken",
            price: 18.77,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Seasonal Tender Roast Duck",
            price: 26.58,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Premium Braised Spaghetti Bolognese",
            price: 18.13,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          {
            name: "Seasonal Smoked Shrimp Scampi over Linguine",
            price: 24.94,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Organic Zingy Miso-Marinated Chilean Sea Bass",
            price: 34.6,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Authentic Flavorful Seared Tuna Steak with Sesame Crust",
            price: 34.2,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Hearty Succulent Tempura Soft Shell Crab",
            price: 32.08,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
  ...
  },
  {
    ...
    category: [
      ...
      },
      {
        ...
        items: [
          {
            name: "Authentic Smoked Ice Cream Sandwich",
            price: 7.02,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Authentic Satisfying Kulfi",
            price: 11.26,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Handcrafted Fried Ice Cream",
            price: 10.43,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
    ...
    category: [
      {
        ...
        items: [
          ...
          {
            name: "Deluxe Sweet Whiskey Sour",
            price: 12.74,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
