...
/**
 * Menu data for American Pavilion in new-york-city
 */
export const newYorkCityamericanPavilionMenu: RestaurantMenu[] = [
  {
    title: "Main Course Menu",
    description:
      "Enjoy a variety of hearty Chinese plates made with seasonal inspiration",
    category: [
      {
        ...
        items: [
          ...
          {
            name: "Seasonal Enticing Award-Winning Seafood Boil",
            price: 35.41,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Premium Stuffed Wood-Fired Peking Duck with Plum Sauce",
            price: 34.24,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          {
            name: "Homestyle Grilled Antipasto Platter",
            price: 13.8,
            isVegetarian: false,
            isVegan: true,
            isGlutenFree: false,
          ...
          {
            name: "Seasonal Marinated Ceviche",
            price: 13.16,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Gourmet Aromatic Mozzarella Sticks",
            price: 10.15,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Seasonal Golden Spring Rolls",
            price: 11.52,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Deluxe Crispy Cheese Platter",
            price: 10.4,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Authentic Hearty Stuffed Peppers",
            price: 13.71,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "House Special Savory Caprese Salad",
            price: 9.51,
            isVegetarian: true,
            isVegan: true,
            isGlutenFree: false,
          ...
          {
            name: "Premium Aromatic Prawn Cocktail",
            price: 12.25,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          {
            name: "Deluxe Smoked Pesto Pasta",
            price: 22.05,
            isVegetarian: true,
            isVegan: true,
            isGlutenFree: false,
          ...
          {
            name: "Organic Stuffed Seafood Platter",
            price: 25.55,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Gourmet Tender Grilled Chicken",
            price: 28.71,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Hearty Aromatic Katsu Curry",
            price: 18.93,
            isVegetarian: true,
            isVegan: true,
            isGlutenFree: false,
          ...
          {
            name: "Premium Fried Cottage Pie",
            price: 20.57,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
    ...
    category: [
      {
        ...
        items: [
          {
            name: "House Special Luscious Donuts",
            price: 7,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Classic Crunchy Custard Tart",
            price: 8.62,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Deluxe Succulent Lemon Bars",
            price: 6.4,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Organic Wholesome Portuguese Custard Tarts",
            price: 9.01,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Traditional Zingy Danish Pastries",
            price: 8.65,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: "Fresh Spicy Ice Cream Cake",
            price: 10.19,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
    ...
    category: [
      {
        ...
        items: [
          {
            name: "Premium Succulent Whiskey Sour",
            price: 14.35,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Handcrafted Savory Bloody Mary",
            price: 11.59,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: "Authentic Savory Anisette",
            price: 12.16,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Premium Mouthwatering Galliano",
            price: 11.27,
            isVegetarian: false,
            isVegan: true,
            isGlutenFree: false,
