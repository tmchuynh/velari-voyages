...
export const quebecCitycanadianSnackBarMenu: RestaurantMenu[] = [
  {
    ...
    "description": "Chef-selected hearty offerings highlighting Italian culinary heritage",
    "category": [
      {
  ...
  {
    "title": "Dessert Menu",
    "description": "A gooey journey through the world of desserts, inspired by Italian",
    "category": [
      {
        "name": "Baked Goods",
