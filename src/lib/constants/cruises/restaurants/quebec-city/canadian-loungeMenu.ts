...
/**
 * Menu data for Canadian Lounge in quebec-city
 */
export const quebecCitycanadianLoungeMenu: RestaurantMenu[] = [
  {
    title: "Main Course Menu",
    description:
      "Where comforting creativity meets timeless Italian inspiration",
    category: [
      {
      ...
      },
      {
        ...
        items: [
          {
            name: "Premium Grilled Crispy Skin Sea Bass",
            price: 30.97,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Authentic Succulent Seasonal Truffle Risotto",
            price: 28.95,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Authentic Delectable Tableside Flambé Preparation",
            price: 27.86,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          {
            name: "Homestyle Crunchy Deviled Eggs",
            price: 15.49,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Handcrafted Fried Bruschetta",
            price: 10.23,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Homestyle Herbed Tuna Tartare",
            price: 12.55,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Classic Stuffed Stuffed Avocado",
            price: 14.08,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          {
            name: "Authentic Comforting Roasted Root Vegetables",
            price: 7.96,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Authentic Spiced Provencal Ratatouille",
            price: 6.3,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Fresh Flavorful Corn on the Cob with Chili Lime Butter",
            price: 8.59,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Seasonal Roasted Yukon Gold Potato Gratin",
            price: 5.42,
            isVegetarian: true,
            isVegan: true,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: "Homestyle Juicy Hot Chocolate",
            price: 7.72,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: true,
  ...
  {
    title: "Dessert Menu",
    description: "Handcrafted gooey desserts that celebrate Italian traditions",
    category: [
      {
        name: "Baked Goods",
        description:
  ...
  },
  {
    ...
    category: [
      ...
      },
      {
        ...
        items: [
          {
            name: "Authentic Tender Dolcetto",
            price: 12.45,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          {
            name: "Hearty Delectable Tequila",
            price: 14.92,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Classic Juicy Baileys Irish Cream",
            price: 15.81,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Deluxe Hearty Coffee Liqueur",
            price: 17.18,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
