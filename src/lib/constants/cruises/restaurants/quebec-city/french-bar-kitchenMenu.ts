...
/**
 * Menu data for French Bar & Kitchen in quebec-city
 */
export const quebecCityfrenchBarKitchenMenu: RestaurantMenu[] = [
  {
    title: "Main Course Menu",
    description:
      "Taste the depth of Italian culture through our tasty preparations",
    category: [
      {
      ...
      },
      {
        ...
        items: [
          {
            name: "Traditional Zingy Charcuterie Board",
            price: 11.8,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Gourmet Pan-seared Nachos",
            price: 12.1,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Classic Hearty Mini Tacos",
            price: 10.96,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Handcrafted Sizzling Cheese Nachos",
            price: 10.98,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: "Authentic Exquisite Iced Tea",
            price: 4.44,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
  ...
  },
  {
    title: "Dessert Menu",
    description:
      "Our classic dessert offerings crafted with the finest ingredients",
    category: [
      {
        name: "Baked Goods",
        description:
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: "Homestyle Comforting Semifreddo",
            price: 7.49,
            isVegetarian: true,
            isVegan: true,
            isGlutenFree: false,
    ...
    category: [
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: "Traditional Appetizing Prosecco",
            price: 11.09,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: "Traditional Delectable Gin",
            price: 17.81,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Authentic Flavorful Galliano",
            price: 14.62,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Deluxe Mouthwatering Aquavit",
            price: 11.25,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
