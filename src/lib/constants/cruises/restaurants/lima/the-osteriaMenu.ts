...
/**
 * Menu data for The Osteria in lima
 */
export const limatheOsteriaMenu: RestaurantMenu[] = [
  {
    ...
    category: [
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: "Traditional Sweet Tableside Flambé Preparation",
            price: 31.74,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Homestyle Creamy Freshly Harvested Seasonal Creation",
            price: 31.08,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Fresh Creamy Roasted Quail with Truffle Jus",
            price: 31.99,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Hearty Creamy Truffle-Infused Filet Mignon",
            price: 27.71,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          {
            name: "Organic Spicy Wild Mushroom Risotto",
            price: 8.51,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Classic Pan-seared Buttered Egg Noodles",
            price: 5.17,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Handcrafted Braised Cauliflower Gratin with Gruyère",
            price: 9.42,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Gourmet Sweet Homestyle Baked Beans",
            price: 6.38,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "House Special Smoked Creamed Spinach with Nutmeg",
            price: 7.16,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Authentic Satisfying Macaroni and Aged Cheddar",
            price: 9.45,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
  ...
  },
  {
    title: "Dessert Menu",
    description:
      "A crowd-pleasing selection of desserts to complement your dining experience",
    category: [
      {
        name: "Baked Goods",
        description:
        ...
        items: [
          {
            name: "Traditional Crispy Scones",
            price: 6.44,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Traditional Herbed Cheesecake",
            price: 10.9,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Gourmet Zesty Sticky Toffee Pudding",
            price: 8.84,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: "Seasonal Enticing Frozen Fruit Bars",
            price: 9.53,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
