...
export const limablueProjectMenu: RestaurantMenu[] = [
  {
    ...
    description:
      "A flavorful fusion of comforting and authentic Japanese dishes",
    category: [
      {
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: "Gourmet Crispy Potato Skins",
            price: 10.42,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Organic Crunchy Shrimp Cocktail",
            price: 13.43,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Handcrafted Herbed Onion Rings",
            price: 15.27,
            isVegetarian: true,
            isVegan: true,
            isGlutenFree: true,
          ...
          {
            name: "Authentic Sautéed Tuna Tartare",
            price: 11.02,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Authentic Spiced Hummus Platter",
            price: 11.19,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Handcrafted Exquisite Antipasto Platter",
            price: 12.6,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: "Deluxe Succulent Vegetable Barley Soup",
            price: 8.05,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Premium Delicious Hot and Sour Soup",
            price: 8.25,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Gourmet Sweet Broccoli Cheddar Soup",
            price: 13.52,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: "Fresh Aromatic Grilled Tofu",
            price: 19.06,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Hearty Sizzling Vegetable Stir-Fry",
            price: 21.81,
            isVegetarian: true,
            isVegan: true,
            isGlutenFree: false,
          ...
          {
            name: "Classic Roasted Thai Curry",
            price: 31,
            isVegetarian: true,
            isVegan: true,
            isGlutenFree: true,
          ...
          {
            name: "Homestyle Exquisite Beef Burger",
            price: 21.68,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Handcrafted Smoked Teriyaki Chicken",
            price: 21,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Fresh Grilled Eggplant Parmesan",
            price: 24.59,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
  ...
  },
  {
    title: "Dessert Menu",
    description:
      "Complete your meal with our baked to perfection dessert selection",
    category: [
      {
        name: "Baked Goods",
        description:
        ...
        items: [
          {
            name: "Gourmet Exquisite Vanilla Cake",
            price: 7.1,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Premium Creamy Treacle Tart",
            price: 8.43,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Authentic Flavorful Biscotti",
            price: 6.5,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: "Deluxe Crispy Frozen Yogurt",
            price: 7.94,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: true,
