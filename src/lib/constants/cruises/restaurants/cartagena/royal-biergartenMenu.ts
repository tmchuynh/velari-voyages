...
export const cartagenaroyalBiergartenMenu: RestaurantMenu[] = [
  {
    ...
    description:
      "Enjoy a variety of homestyle Mediterranean plates made with seasonal inspiration",
    category: [
      {
  ...
  },
  {
    title: "Drinks Menu",
    description:
      "Sip on our enticing cocktails, designed to enhance your dining experience",
    category: [
      {
