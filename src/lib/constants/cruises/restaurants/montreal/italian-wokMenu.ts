...
/**
 * Menu data for Italian Wok in montreal
 */
export const montrealitalianWokMenu: RestaurantMenu[] = [
  {
    title: "Main Course Menu",
    description:
      "From bold spices to subtle notes—our satisfying Italian journey awaits",
    category: [
      {
      ...
      },
      {
        ...
        items: [
          {
            name: "Handcrafted Spicy Hummus Platter",
            price: 10.52,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Deluxe Fried Antipasto Platter",
            price: 14.42,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Seasonal Smoked Lettuce Wraps",
            price: 15.18,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Traditional Golden Chicken Satay",
            price: 13.47,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Authentic Savory Mini Tacos",
            price: 10.94,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: "Traditional Sweet Moussaka",
            price: 25.32,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "House Special Smoked Tacos",
            price: 27.3,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
  ...
  },
  {
    title: "Dessert Menu",
    description:
      "A curated selection of tasty desserts, inspired by Italian heritage",
    category: [
      {
        name: "Baked Goods",
        description:
        ...
        items: [
          {
            name: "Handcrafted Luscious Pain au Chocolat",
            price: 10.96,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Authentic Enticing Shortbread",
            price: 7.49,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Gourmet Flavorful Madeleines",
            price: 9.12,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Homestyle Crunchy Apple Pie",
            price: 6.97,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Classic Spicy Custard Tart",
            price: 6.9,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
    ...
    category: [
      {
        ...
        items: [
          {
            name: "Seasonal Sizzling Martini",
            price: 13.11,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Premium Delectable Margarita",
            price: 15.51,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          {
            name: "Hearty Pan-seared Petit Verdot",
            price: 10.47,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Traditional Tangy Pinot Blanc",
            price: 10.09,
            isVegetarian: true,
            isVegan: true,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          {
            name: "Fresh Delicious Triple Sec",
            price: 15.47,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Gourmet Hearty Limoncello",
            price: 15.05,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
