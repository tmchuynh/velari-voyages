...
/**
 * Menu data for French Mansion in montreal
 */
export const montrealfrenchMansionMenu: RestaurantMenu[] = [
  {
    title: "Main Course Menu",
    description:
      "Explore the richness of Canadian cuisine through our hearty perspective",
    category: [
      {
      ...
      },
      {
        ...
        items: [
          {
            name: "Authentic Mouthwatering Locally Foraged Mushroom Selection",
            price: 29.12,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Fresh Crunchy Heritage Breed Porchetta",
            price: 30.12,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Premium Baked Herb-Crusted Rack of Lamb",
            price: 25.22,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          {
            name: "Homestyle Luscious Garlic Bread",
            price: 15.08,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Fresh Appetizing Caprese Salad",
            price: 13.21,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Classic Crispy Hummus Platter",
            price: 15.27,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Seasonal Roasted Garlic Knots",
            price: 9.54,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          {
            name: "Fresh Hearty Lobster Thermidor with Gruyère Crust",
            price: 29.13,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Traditional Marinated Pan-Seared Scallops with Pea Purée",
            price: 31.11,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
      ...
      },
      {
        name: "Side Dishes",
        description:
          "Classic Canadian side dishes with our own unique interpretation.",
        items: [
          {
    ...
    category: [
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: "Fresh Flavorful Frozen Pudding",
            price: 10.33,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
  ...
  },
  {
    ...
    category: [
      ...
      },
      {
        ...
        items: [
          {
            name: "Hearty Delicious Mourvèdre",
            price: 9.88,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Premium Succulent Albariño",
            price: 9.01,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Seasonal Spiced Chenin Blanc",
            price: 12.17,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Homestyle Irresistible Pinot Grigio",
            price: 8.22,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: true,
