...
export const montrealfrenchCreameryMenu: RestaurantMenu[] = [
  {
    ...
    "description": "Delight in our chef's most comforting takes on traditional American flavors",
    "category": [
      {
  ...
  {
    "title": "Drinks Menu",
    "description": "Sip on our smooth-drinking cocktails, designed to enhance your dining experience",
    "category": [
      {
