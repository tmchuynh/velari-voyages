...
/**
 * Menu data for Island Snack Shack in galveston
 */
export const galvestonislandSnackShackMenu: RestaurantMenu[] = [
  {
    ...
    category: [
      {
        ...
        items: [
          {
            name: "Authentic Delicious Executive Chef's Daily Inspiration Entrée",
            price: 28.5,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Traditional Savory Traditional Family Paella",
            price: 37.08,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Classic Mouthwatering Secret Recipe Bouillabaisse",
            price: 26.49,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Fresh Baked Chef's Special Surf and Turf",
            price: 30.31,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          {
            name: "Handcrafted Roasted Baked Cod with Lemon Caper Sauce",
            price: 28.43,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Hearty Spicy Shrimp Scampi over Linguine",
            price: 26.91,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Gourmet Hearty Seafood Alfredo with Spinach Fettuccine",
            price: 22.85,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
