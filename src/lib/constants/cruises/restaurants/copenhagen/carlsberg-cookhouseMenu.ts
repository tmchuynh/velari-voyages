...
/**
 * Menu data for Carlsberg Cookhouse in copenhagen
 */
export const copenhagencarlsbergCookhouseMenu: RestaurantMenu[] = [
  {
    ...
    category: [
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: "Seasonal Baked Modern Interpretation of Regional Classic",
            price: 28.48,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Homestyle Hearty Cedar Plank Salmon",
            price: 34.49,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Seasonal Satisfying Grilled Venison with Juniper Berry Sauce",
            price: 39.16,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Classic Sautéed Locally Foraged Mushroom Selection",
            price: 28.22,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          {
            name: "Authentic Appetizing Tempura",
            price: 12.05,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Seasonal Mouthwatering Calamari",
            price: 15.73,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Hearty Spiced Mini Sliders",
            price: 10.04,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Authentic Tender Lettuce Wraps",
            price: 13.16,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: "Handcrafted Spicy Seared Tuna Steak with Sesame Crust",
            price: 31.2,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Organic Smoked Grilled Swordfish with Mango Chutney",
            price: 26.81,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Gourmet Creamy Pan-Seared Scallops with Pea Purée",
            price: 26.54,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Fresh Pan-seared Garlic Butter Shrimp Skillet",
            price: 30.64,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
  ...
  },
  {
    title: "Drinks Menu",
    description:
      "Discover our inviting drinks, perfectly paired with our French cuisine",
    category: [
      {
