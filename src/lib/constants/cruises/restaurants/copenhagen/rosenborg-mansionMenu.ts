...
/**
 * Menu data for Rosenborg Mansion in copenhagen
 */
export const copenhagenrosenborgMansionMenu: RestaurantMenu[] = [
  {
    title: "Main Course Menu",
    description:
      "A fresh assortment of specialties showcasing the best of Italian cuisine",
    category: [
      {
      ...
      },
      {
        ...
        items: [
          {
            name: "Classic Flaky Braised Short Ribs with Red Wine Sauce",
            price: 24.07,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Handcrafted Tender Cast Iron Seafood Presentation",
            price: 32.35,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          {
            name: "Homestyle Crunchy Thai Coconut Soup",
            price: 8.73,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Hearty Tangy Avgolemono (Greek Lemon Soup)",
            price: 10.9,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Gourmet Juicy Chicken Noodle Soup",
            price: 12.35,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "House Special Fried Carrot Ginger Soup",
            price: 12.82,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: "Homestyle Delicious Juice",
            price: 5.81,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
  ...
  },
  {
    title: "Drinks Menu",
    description:
      "Toast to the moment with our inviting selection of wines, beers, and signature drinks",
    category: [
      {
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: "Hearty Baked Pinot Grigio",
            price: 10.69,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Authentic Delicious Viognier",
            price: 10.27,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Homestyle Savory Champagne/Sparkling Wine",
            price: 13.09,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Handcrafted Comforting Chardonnay",
            price: 8.5,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: "Traditional Sweet Maraschino",
            price: 13.99,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Deluxe Creamy Baileys Irish Cream",
            price: 17.42,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Handcrafted Mouthwatering Scotch",
            price: 16.37,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
