...
/**
 * Menu data for Frederik Gastropub in copenhagen
 */
export const copenhagenfrederikGastropubMenu: RestaurantMenu[] = [
  {
    title: "Main Course Menu",
    description:
      "Satisfy your cravings with our vibrant, satisfying take on Scandinavian",
    category: [
      {
        name: "Signature Dishes",
        description:
          "House favorites that have stood the test of time and showcase our refined approach to Scandinavian cuisine.",
        items: [
          {
      ...
      },
      {
        ...
        items: [
          {
            name: "Gourmet Succulent Sous Vide Pork Tenderloin",
            price: 33.93,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Deluxe Tangy Chef's Market Inspiration of the Day",
            price: 34.9,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Seasonal Appetizing Smoked and Slow-Roasted Heritage Meat",
            price: 31.85,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Gourmet Enticing Heritage Breed Porchetta",
            price: 33.2,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Homestyle Delicious Fusion of Traditional and Modern Techniques",
            price: 28.39,
            isVegetarian: false,
            isVegan: true,
            isGlutenFree: true,
      ...
      },
      {
        name: "Soups",
        description:
          "Daily-prepared soups made from seasonal ingredients and traditional Scandinavian methods.",
        items: [
          {
      ...
      },
      {
        name: "Main Courses",
        description:
          "A selection of mains that reflect the heart and soul of Scandinavian, prepared with care.",
        items: [
          {
            name: "Salmon",
            price: 25.3,
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: "House Special Baked Coffee",
            price: 4.27,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Traditional Pan-seared Lemonade",
            price: 6.95,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
  ...
  },
  {
    title: "Dessert Menu",
    description:
      "A curated selection of crowd-pleasing desserts, inspired by Scandinavian heritage",
    category: [
      {
        name: "Baked Goods",
        description:
        ...
        items: [
          {
            name: "Premium Spiced Lemon Bars",
            price: 8.49,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Authentic Succulent Pecan Pie",
            price: 6.24,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Authentic Mouthwatering Red Velvet Cake",
            price: 7.63,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Homestyle Grilled Cupcakes",
            price: 9.91,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Classic Exquisite Vanilla Cake",
            price: 6.83,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
