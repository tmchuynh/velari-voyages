...
export const copenhagenchristianiaPhoHouseMenu: RestaurantMenu[] = [
  {
    ...
    "description": "Our kitchen presents an array of fresh offerings from across the French spectrum",
    "category": [
      {
  ...
  {
    "title": "Dessert Menu",
    "description": "French-inspired crowd-pleasing confections to delight your senses",
    "category": [
      {
        "name": "Baked Goods",
