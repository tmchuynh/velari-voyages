...
export const copenhagencinnamonRollEateryBarMenu: RestaurantMenu[] = [
  {
    ...
    "description": "Immerse yourself in homestyle French that balances innovation with authenticity",
    "category": [
      {
  ...
  {
    "title": "Dessert Menu",
    "description": "Handcrafted baked to perfection desserts that celebrate French traditions",
    "category": [
      {
        "name": "Baked Goods",
