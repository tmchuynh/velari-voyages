...
export const hongKongmidLevelsRawBarMenu: RestaurantMenu[] = [
  {
    ...
    "description": "Experience our chef's tasty creations inspired by Thai tradition",
    "category": [
      {
  ...
  {
    "title": "Drinks Menu",
    "description": "Indulge in our carefully chosen drinks menu crafted to accentuate flavors",
    "category": [
      {
