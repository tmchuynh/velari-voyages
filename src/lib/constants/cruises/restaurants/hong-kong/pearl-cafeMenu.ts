...
/**
 * Menu data for Pearl Cafe in hong-kong
 */
export const hongKongpearlCafeMenu: RestaurantMenu[] = [
  {
    title: "Main Course Menu",
    description:
      "Timeless tastes, elevated by our authentic approach to French",
    category: [
      {
      ...
      },
      {
        ...
        items: [
          {
            name: "Traditional Crunchy Wild Mushroom Risotto",
            price: 24.7,
            isVegetarian: false,
            isVegan: true,
            isGlutenFree: false,
          ...
          {
            name: "Authentic Sizzling Sous Vide Pork Tenderloin",
            price: 32.5,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Organic Tender Smoked and Slow-Roasted Heritage Meat",
            price: 33.5,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Fresh Spicy Heritage Breed Porchetta",
            price: 33.5,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: true,
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: "Seasonal Delectable Lettuce Wraps",
            price: 14.09,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Authentic Smoked Hummus Platter",
            price: 9.01,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Gourmet Pan-seared Garlic Knots",
            price: 15.28,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: true,
      ...
      },
      {
        ...
        items: [
          {
            name: "Premium Crunchy Oysters Rockefeller with Pernod Cream",
            price: 33.26,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Traditional Grilled Grilled Spanish Octopus with Smoked Paprika",
            price: 26.75,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Seasonal Sautéed Seafood Gumbo with Okra",
            price: 22.47,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Gourmet Mouthwatering Grilled Swordfish with Mango Chutney",
            price: 25.02,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Classic Sizzling Lemon-Herb Calamari Steak",
            price: 26.63,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
    ...
    category: [
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: "Authentic Hearty Triple Sec",
            price: 15.69,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Deluxe Roasted St-Germain",
            price: 17.88,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
