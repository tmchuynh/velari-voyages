...
/**
 * Menu data for Neon Gallery in hong-kong
 */
export const hongKongneonGalleryMenu: RestaurantMenu[] = [
  {
    ...
    category: [
      {
        ...
        items: [
          {
            name: "Traditional Tangy Chef's Childhood Inspired Creation",
            price: 32.3,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Homestyle Fried Executive Chef's Daily Inspiration Entrée",
            price: 30.49,
            isVegetarian: false,
            isVegan: true,
            isGlutenFree: false,
          ...
          {
            name: "Seasonal Appetizing Secret Recipe Bouillabaisse",
            price: 26.92,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "House Special Smoked Age-Old Recipe Osso Buco with Gremolata",
            price: 27.87,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
      ...
      },
      {
        ...
        items: [
          {
            name: "Hearty Savory Butternut Squash Soup",
            price: 13.7,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Gourmet Flaky French Onion Soup",
            price: 11.32,
            isVegetarian: true,
            isVegan: true,
            isGlutenFree: true,
          ...
          {
            name: "House Special Succulent Peanut Soup (West African)",
            price: 8.25,
            isVegetarian: false,
            isVegan: true,
            isGlutenFree: true,
          ...
          {
            name: "Fresh Fried Vegetable Barley Soup",
            price: 9.1,
            isVegetarian: true,
            isVegan: true,
            isGlutenFree: false,
  ...
  {
    title: "Dessert Menu",
    description: "Experience the art of warm desserts with a Japanese twist",
    category: [
      {
        name: "Baked Goods",
        description:
    ...
    category: [
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: "Gourmet Delectable Zinfandel",
            price: 9.94,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Fresh Hearty Cabernet Sauvignon",
            price: 12.25,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Gourmet Enticing Cabernet Franc",
            price: 13.85,
            isVegetarian: true,
            isVegan: true,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: "House Special Roasted Kahlúa",
            price: 14.85,
            isVegetarian: true,
            isVegan: true,
            isGlutenFree: true,
          ...
          {
            name: "Traditional Mouthwatering Chartreuse",
            price: 12.89,
            isVegetarian: true,
            isVegan: true,
            isGlutenFree: true,
