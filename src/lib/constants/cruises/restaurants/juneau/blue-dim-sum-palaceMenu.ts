...
export const juneaublueDimSumPalaceMenu: RestaurantMenu[] = [
  {
    ...
    "description": "Enjoy a variety of comforting Japanese plates made with seasonal inspiration",
    "category": [
      {
  ...
  {
    "title": "Drinks Menu",
    "description": "Our bar showcases smooth-drinking spirits from around the globe",
    "category": [
      {
