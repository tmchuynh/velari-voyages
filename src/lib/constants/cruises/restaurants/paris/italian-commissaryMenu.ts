...
/**
 * Menu data for Italian Commissary in paris
 */
export const parisitalianCommissaryMenu: RestaurantMenu[] = [
  {
    title: "Main Course Menu",
    description:
      "Satisfy your cravings with our vibrant, tasty take on Italian",
    category: [
      {
      ...
      },
      {
        ...
        items: [
          {
            name: "House Special Braised Seafood Risotto with Saffron",
            price: 29.53,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Authentic Delectable Grilled Lobster with Lemon Butter",
            price: 33.13,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Authentic Smoked Seafood Alfredo with Spinach Fettuccine",
            price: 25.79,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Seasonal Succulent Prawn Curry in Coconut Masala",
            price: 31.02,
            isVegetarian: true,
            isVegan: true,
            isGlutenFree: true,
      ...
      },
      {
        ...
        items: [
          {
            name: "Deluxe Sweet Baked Idaho Potato with Sour Cream",
            price: 7.56,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Deluxe Sautéed Green Beans Almondine",
            price: 8.12,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "House Special Savory Sweet Corn and Cheddar Fritters",
            price: 8.57,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Authentic Delectable Flaky Cheddar and Chive Biscuits",
            price: 5.97,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Homestyle Tender Crispy Zucchini Fritters",
            price: 7.14,
            isVegetarian: false,
            isVegan: true,
            isGlutenFree: false,
  ...
  },
  {
    ...
    category: [
      ...
      },
      {
        ...
        items: [
          {
            name: "Homestyle Tender Baked Alaska",
            price: 9.73,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Traditional Stuffed Ice Cream Sandwich",
            price: 7.14,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Deluxe Crispy Frozen Banana",
            price: 10.03,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
    ...
    category: [
      {
        ...
        items: [
          {
            name: "Gourmet Braised Manhattan",
            price: 14.39,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
