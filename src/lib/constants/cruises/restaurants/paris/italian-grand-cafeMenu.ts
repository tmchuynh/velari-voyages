...
export const parisitalianGrandCafeMenu: RestaurantMenu[] = [
  {
    ...
    "description": "From appetizers to main courses: homestyle dishes prepared with passion",
    "category": [
      {
  ...
  {
    "title": "Drinks Menu",
    "description": "Discover our crowd-pleasing drinks, perfectly paired with our French cuisine",
    "category": [
      {
