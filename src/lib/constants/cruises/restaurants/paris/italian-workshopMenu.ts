...
/**
 * Menu data for Italian Workshop in paris
 */
export const parisitalianWorkshopMenu: RestaurantMenu[] = [
  {
    title: "Main Course Menu",
    description:
      "Our carefully crafted selection of satisfying Middle Eastern dishes",
    category: [
      {
      ...
      },
      {
        name: "Appetizers",
        description:
          "A selection of small plates that showcase the essence of Middle Eastern—perfect for sharing or savoring solo.",
        items: [
          {
      ...
      },
      {
        name: "Soups",
        description:
          "Daily-prepared soups made from seasonal ingredients and traditional Middle Eastern methods.",
        items: [
          {
