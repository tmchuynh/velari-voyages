...
/**
 * Menu data for Beachfront Cerveceria in fort-lauderdale
 */
export const fortLauderdalebeachfrontCerveceriaMenu: RestaurantMenu[] = [
  {
    title: "Main Course Menu",
    description:
      "Tastefully prepared Caribbean dishes with a authentic signature touch",
    category: [
      {
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: "Traditional Marinated Tzatziki with Pita",
            price: 15.63,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Deluxe Zesty Baba Ganoush",
            price: 11.73,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
      ...
      },
      {
        name: "Side Dishes",
        description:
          "Crafted to enhance your meal, these sides are a celebration of Caribbean flavors.",
        items: [
          {
      ...
      },
      {
        ...
        items: [
          {
            name: "Classic Appetizing Smoothie",
            price: 5.03,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
  ...
  },
  {
    ...
    category: [
      ...
      },
      {
        ...
        items: [
          {
            name: "Authentic Roasted Frozen Banana",
            price: 7.47,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Fresh Fried Frozen Fruit Bars",
            price: 9.51,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
  ...
  },
  {
    ...
    category: [
      ...
      },
      {
        ...
        items: [
          {
            name: "Organic Irresistible Limoncello",
            price: 14.11,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Homestyle Delicious Armagnac",
            price: 16.5,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Authentic Spiced St-Germain",
            price: 14.96,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
