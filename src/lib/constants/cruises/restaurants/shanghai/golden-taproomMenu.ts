...
/**
 * Menu data for Golden Taproom in shanghai
 */
export const shanghaigoldenTaproomMenu: RestaurantMenu[] = [
  {
    ...
    category: [
      ...
      },
      {
        ...
        items: [
          {
            name: "Homestyle Stuffed Black Garlic Marinated Octopus",
            price: 37.33,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Homestyle Delicious Smoked and Slow-Roasted Heritage Meat",
            price: 36.31,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Hearty Savory Dry-Aged Prime Beef Selection",
            price: 28.69,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Organic Zingy Seared Duck Breast with Cherry Reduction",
            price: 33.43,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Homestyle Flaky Tableside Flambé Preparation",
            price: 39.41,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: "Traditional Flavorful Seafood Chowder",
            price: 7.95,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Hearty Marinated Tortilla Soup",
            price: 7.16,
            isVegetarian: true,
            isVegan: true,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: "Deluxe Sizzling Shish Kebabs",
            price: 20.54,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Deluxe Juicy Seafood Platter",
            price: 25.15,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
  ...
  },
  {
    title: "Dessert Menu",
    description:
      "A freshly prepared journey through the world of desserts, inspired by French",
    category: [
      {
        name: "Baked Goods",
        description:
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: "House Special Irresistible Sorbet",
            price: 8.39,
            isVegetarian: true,
            isVegan: true,
            isGlutenFree: false,
    ...
    category: [
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: "Authentic Wholesome Campari",
            price: 13.06,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "House Special Savory St-Germain",
            price: 15.16,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
