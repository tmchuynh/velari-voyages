...
/**
 * Menu data for Grand Tavern in shanghai
 */
export const shanghaigrandTavernMenu: RestaurantMenu[] = [
  {
    title: "Main Course Menu",
    description:
      "Chef-selected satisfying offerings highlighting Italian culinary heritage",
    category: [
      {
      ...
      },
      {
        ...
        items: [
          {
            name: "Seasonal Smoked Lobster Thermidor",
            price: 29.77,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Gourmet Tender Slow-Roasted Prime Rib",
            price: 26.89,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Classic Marinated Modern Interpretation of Regional Classic",
            price: 31.98,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Traditional Zingy Herb-Crusted Rack of Lamb",
            price: 35.22,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Authentic Juicy Hand-Selected Wine Pairing Experience",
            price: 36.82,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
    ...
    category: [
      {
        ...
        items: [
          {
            name: "Handcrafted Spiced Manhattan",
            price: 10.77,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
