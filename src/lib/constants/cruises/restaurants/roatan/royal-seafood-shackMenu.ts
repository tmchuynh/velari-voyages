...
/**
 * Menu data for Royal Seafood Shack in roatan
 */
export const roatanroyalSeafoodShackMenu: RestaurantMenu[] = [
  {
    ...
    category: [
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: "Classic Spicy French Onion Soup",
            price: 13.48,
            isVegetarian: false,
            isVegan: true,
            isGlutenFree: false,
          ...
          {
            name: "Authentic Sweet Minestrone",
            price: 7.44,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          {
            name: "Classic Smoked Crispy Beer-Battered Onion Rings",
            price: 6.64,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Homestyle Braised Warm Buttermilk Dinner Rolls",
            price: 5.35,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Organic Spiced Quinoa Pilaf with Herbs",
            price: 8.71,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: "Authentic Sizzling Lemonade",
            price: 5.39,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
  ...
  },
  {
    title: "Dessert Menu",
    description:
      "A homemade journey through the world of desserts, inspired by French",
    category: [
      {
        name: "Baked Goods",
        description:
        ...
        items: [
          {
            name: "Authentic Zingy Croissants",
            price: 8.24,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Organic Satisfying Eclairs",
            price: 6.06,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Authentic Crispy Apple Pie",
            price: 6.91,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Homestyle Creamy Portuguese Custard Tarts",
            price: 10.09,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          {
            name: "Handcrafted Sizzling Snow Cone",
            price: 9.66,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Deluxe Exquisite Frozen Fruit Bars",
            price: 7.18,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: true,
    ...
    category: [
      {
        ...
        items: [
          ...
          {
            name: "Handcrafted Golden Mojito",
            price: 12.9,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
