...
/**
 * Menu data for Grand & Sons in malta
 */
export const maltagrandSonsMenu: RestaurantMenu[] = [
  {
    title: "Main Course Menu",
    description: "Inspired by tradition, driven by classic execution",
    category: [
      {
      ...
      },
      {
        ...
        items: [
          {
            name: "Seasonal Sizzling Whole Animal Butchery Showcase",
            price: 24.78,
            isVegetarian: false,
            isVegan: true,
            isGlutenFree: false,
          ...
          {
            name: "Traditional Appetizing Dry-Aged Prime Beef Selection",
            price: 30.27,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Fresh Roasted Roasted Quail with Truffle Jus",
            price: 36.98,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Fresh Spiced Signature Spice-Rubbed Protein",
            price: 30.4,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          {
            name: "Premium Roasted Meatballs",
            price: 8.99,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Homestyle Pan-seared Stuffed Mushrooms",
            price: 14.37,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Traditional Crispy Potstickers",
            price: 14.71,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Homestyle Hearty Potato Skins",
            price: 10.46,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Deluxe Pan-seared Ceviche",
            price: 13.99,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Premium Smoked Mini Tacos",
            price: 12.98,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
  ...
  },
  {
    ...
    category: [
      ...
      },
      {
        ...
        items: [
          {
            name: "Hearty Grilled Frozen Yogurt",
            price: 9.49,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Authentic Crispy Ice Cream Cake",
            price: 10.26,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
  ...
  },
  {
    ...
    category: [
      ...
      },
      {
        ...
        items: [
          {
            name: "House Special Sizzling Riesling",
            price: 12.27,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Deluxe Hearty Syrah/Shiraz",
            price: 10.67,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Seasonal Tangy Sangiovese",
            price: 11.66,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          {
            name: "Fresh Herbed Baileys Irish Cream",
            price: 13.96,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "House Special Marinated Frangelico",
            price: 17.57,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
