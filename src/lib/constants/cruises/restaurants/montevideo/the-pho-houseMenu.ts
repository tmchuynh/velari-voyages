...
/**
 * Menu data for The Pho House in montevideo
 */
export const montevideothePhoHouseMenu: RestaurantMenu[] = [
  {
    title: "Main Course Menu",
    description:
      "Where comforting creativity meets timeless Mediterranean inspiration",
    category: [
      {
      ...
      },
      {
        ...
        items: [
          {
            name: "Premium Succulent Mushroom Soup",
            price: 13.91,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Gourmet Appetizing Butternut Squash Soup",
            price: 9.29,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Traditional Herbed Minestrone",
            price: 12.2,
            isVegetarian: false,
            isVegan: true,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: "Premium Succulent Lasagna",
            price: 22.49,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Premium Smoked Eggplant Parmesan",
            price: 21.79,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Seasonal Flaky Seafood Platter",
            price: 29.2,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Homestyle Pan-seared Quiche",
            price: 31.96,
            isVegetarian: true,
            isVegan: true,
            isGlutenFree: false,
    ...
    category: [
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: "Homestyle Juicy Frozen Pie",
            price: 9.4,
            isVegetarian: false,
            isVegan: true,
            isGlutenFree: false,
          ...
          {
            name: "Traditional Delectable Snow Cone",
            price: 11.99,
            isVegetarian: false,
            isVegan: true,
            isGlutenFree: false,
          ...
          {
            name: "Premium Tangy Frozen Fruit Bars",
            price: 11.37,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: true,
  ...
  },
  {
    title: "Drinks Menu",
    description:
      "Mediterranean-inspired drinks and classic favorites in our quality selection",
    category: [
      {
      ...
      },
      {
        ...
        items: [
          {
            name: "Handcrafted Wholesome Grand Marnier",
            price: 16.53,
            isVegetarian: true,
            isVegan: true,
            isGlutenFree: false,
          ...
          {
            name: "Seasonal Pan-seared Galliano",
            price: 11.3,
            isVegetarian: true,
            isVegan: true,
            isGlutenFree: false,
