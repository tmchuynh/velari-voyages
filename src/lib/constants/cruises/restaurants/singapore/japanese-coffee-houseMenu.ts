...
/**
 * Menu data for Japanese Coffee House in singapore
 */
export const singaporejapaneseCoffeeHouseMenu: RestaurantMenu[] = [
  {
    title: "Main Course Menu",
    description:
      "Every plate tells a story of homestyle Malaysian craftsmanship",
    category: [
      {
        name: "Signature Dishes",
        description:
          "Our chef's pride—carefully selected Malaysian specialties that define our culinary identity, honed through years of experience and passion.",
        items: [
          {
      ...
      },
      {
        ...
        items: [
          {
            name: "House Special Stuffed Seasonal Truffle Risotto",
            price: 24.25,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Traditional Creamy Cedar Plank Salmon",
            price: 26.44,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Deluxe Pan-seared Herb-Crusted Rack of Lamb",
            price: 27.3,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Handcrafted Crispy Tableside Prepared Tartare",
            price: 36.98,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: "Homestyle Stuffed Steamed Littleneck Clams in Garlic Broth",
            price: 27.41,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Hearty Baked Stuffed Flounder with Crab and Spinach",
            price: 33.26,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Gourmet Flaky Crab-Stuffed Mushrooms",
            price: 26.08,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Deluxe Zesty Baked Cod with Lemon Caper Sauce",
            price: 25.98,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
    ...
    category: [
      {
        ...
        items: [
          {
            name: "Homestyle Baked Red Velvet Cake",
            price: 8.94,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Gourmet Luscious Apple Pie",
            price: 6.86,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Fresh Spicy Strawberry Shortcake",
            price: 10.52,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Authentic Irresistible Soufflé",
            price: 9.2,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Organic Flavorful Cupcakes",
            price: 10.06,
            isVegetarian: false,
            isVegan: true,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          {
            name: "Premium Zesty Baked Alaska",
            price: 7.86,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Authentic Baked Snow Cone",
            price: 9.34,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Traditional Sweet Frozen Yogurt",
            price: 8.88,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Seasonal Crispy Frozen Cheesecake",
            price: 11.78,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
    ...
    category: [
      {
        ...
        items: [
          ...
          {
            name: "Handcrafted Crunchy Margarita",
            price: 12.24,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Handcrafted Succulent Whiskey Sour",
            price: 14.98,
            isVegetarian: false,
            isVegan: true,
            isGlutenFree: false,
