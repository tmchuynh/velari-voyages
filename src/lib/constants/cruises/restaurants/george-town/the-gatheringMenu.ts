...
/**
 * Menu data for The Gathering in george-town
 */
export const georgeTowntheGatheringMenu: RestaurantMenu[] = [
  {
    title: "Main Course Menu",
    description:
      "A simple assortment of specialties showcasing the best of American cuisine",
    category: [
      {
      ...
      },
      {
        ...
        items: [
          {
            name: "Homestyle Stuffed Dry-Aged Prime Beef Selection",
            price: 25.56,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Classic Wholesome Special Occasion Celebratory Dish",
            price: 31.21,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Fresh Flaky Smoked and Slow-Roasted Heritage Meat",
            price: 39.96,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Organic Irresistible Tableside Flambé Preparation",
            price: 35.09,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Classic Crunchy Deconstructed Classic with Modern Technique",
            price: 25.18,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
    ...
    category: [
      {
        ...
        items: [
          ...
          {
            name: "Classic Crunchy Pecan Pie",
            price: 6.94,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Handcrafted Spiced Soufflé",
            price: 6.94,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Authentic Baked Cheesecake",
            price: 10.49,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: "Fresh Pan-seared Snow Cone",
            price: 7.95,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Organic Stuffed Frozen Pudding",
            price: 11.09,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Authentic Flavorful Ice Cream Cake",
            price: 8.62,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
    ...
    category: [
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: "Traditional Baked Albariño",
            price: 9.03,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Classic Exquisite Viognier",
            price: 12.46,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Authentic Hearty Torrontés",
            price: 9.66,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
