...
export const newOrleansamericanCanteenMenu: RestaurantMenu[] = [
  ...
  {
    "title": "Dessert Menu",
    "description": "Our mouthwatering desserts are a celebration of flavor and creativity",
    "category": [
      {
        "name": "Baked Goods",
  ...
  {
    "title": "Drinks Menu",
    "description": "Toast to the moment with our flavorful selection of wines, beers, and signature drinks",
    "category": [
      {
