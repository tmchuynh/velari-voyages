...
export const newOrleansfrenchInnMenu: RestaurantMenu[] = [
  {
    ...
    "category": [
      ...
      {
        "name": "Appetizers",
        "description": "A selection of Cajun starters that blend tradition with modern flair, perfect for sharing or savoring solo.",
        "items": [
          {
      ...
      {
        "name": "Main Courses",
        "description": "Each dish is a culinary journey, showcasing the richness of Cajun traditions.",
        "items": [
          {
      ...
      {
        "name": "Side Dishes",
        "description": "Classic Cajun side dishes with our own unique interpretation.",
        "items": [
          {
