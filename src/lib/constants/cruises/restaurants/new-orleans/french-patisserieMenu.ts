...
/**
 * Menu data for French Patisserie in new-orleans
 */
export const newOrleansfrenchPatisserieMenu: RestaurantMenu[] = [
  {
    ...
    category: [
      {
        ...
        items: [
          ...
          {
            name: "Homestyle Tangy Chef's Special Surf and Turf",
            price: 34.18,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Classic Pan-seared Whole Roasted Heritage Chicken",
            price: 36.37,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Homestyle Zingy Age-Old Recipe Osso Buco with Gremolata",
            price: 30.24,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Homestyle Enticing Crusted Rack of Lamb with Dijon Herb Crust",
            price: 31.77,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Gourmet Savory Seasonal Tasting Menu Experience",
            price: 35.7,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: "Fresh Sautéed Pumpkin Soup",
            price: 8.89,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
  ...
  },
  {
    title: "Drinks Menu",
    description:
      "Italian-inspired drinks and classic favorites in our carefully chosen selection",
    category: [
      {
        ...
        items: [
          ...
          {
            name: "Hearty Wholesome Bloody Mary",
            price: 14.39,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
