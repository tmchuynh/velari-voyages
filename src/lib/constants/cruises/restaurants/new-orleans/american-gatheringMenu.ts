...
/**
 * Menu data for American Gathering in new-orleans
 */
export const newOrleansamericanGatheringMenu: RestaurantMenu[] = [
  {
    title: "Main Course Menu",
    description:
      "Chef-selected simple offerings highlighting Cajun culinary heritage",
    category: [
      {
      ...
      },
      {
        ...
        items: [
          {
            name: "Authentic Creamy Duck Confit with Roasted Root Vegetables",
            price: 37.02,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Authentic Satisfying Wild Mushroom Risotto",
            price: 33.79,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Handcrafted Stuffed Lobster Thermidor",
            price: 39.77,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Hearty Pan-seared Herb-Crusted Rack of Lamb",
            price: 35.63,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          {
            name: "Hearty Comforting Miso Soup",
            price: 12.81,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Deluxe Crunchy Clam Chowder",
            price: 10.61,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Fresh Smoked Seafood Chowder",
            price: 10.53,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Fresh Exquisite Thai Coconut Soup",
            price: 11.07,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          {
            name: "Deluxe Comforting Crab-Stuffed Mushrooms",
            price: 26.7,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Handcrafted Comforting Linguine with Clam Sauce",
            price: 33.61,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Premium Marinated Stuffed Flounder with Crab and Spinach",
            price: 32.83,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Fresh Luscious Seafood Gumbo with Okra",
            price: 30.22,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          {
            name: "Homestyle Flavorful Smoothie",
            price: 6.41,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Deluxe Delectable Hot Chocolate",
            price: 5.54,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
    ...
    category: [
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: "Authentic Mouthwatering Ice Cream Sandwich",
            price: 9.33,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
    ...
    category: [
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: "Fresh Marinated Chenin Blanc",
            price: 13.75,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Homestyle Tangy Zinfandel",
            price: 10.41,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Authentic Enticing Petit Verdot",
            price: 12.01,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
