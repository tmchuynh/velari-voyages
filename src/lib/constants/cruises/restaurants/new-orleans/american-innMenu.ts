...
/**
 * Menu data for American Inn in new-orleans
 */
export const newOrleansamericanInnMenu: RestaurantMenu[] = [
  {
    title: "Main Course Menu",
    description:
      "A journey through Creole flavors, led by our chef's authentic creations",
    category: [
      {
      ...
      },
      {
        ...
        description:
          "A rotating selection of dishes that highlight the chef's creativity and passion for Creole.",
        items: [
          {
      ...
      },
      {
        name: "Appetizers",
        description:
          "A harmonious blend of textures and flavors, our appetizers are a celebration of Creole culinary artistry.",
        items: [
          {
