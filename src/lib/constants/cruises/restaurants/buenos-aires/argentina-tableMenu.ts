...
/**
 * Menu data for Argentina Table in buenos-aires
 */
export const buenosAiresargentinaTableMenu: RestaurantMenu[] = [
  {
    title: "Main Course Menu",
    description:
      "Enjoy a variety of flavorful French plates made with seasonal inspiration",
    category: [
      {
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: "Gourmet Delectable Tagine",
            price: 23.72,
            isVegetarian: false,
            isVegan: true,
            isGlutenFree: false,
          ...
          {
            name: "Traditional Flaky Pesto Pasta",
            price: 28.76,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Seasonal Enticing Stir-fry",
            price: 30.9,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Fresh Aromatic Stuffed Zucchini Boats",
            price: 22.4,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "House Special Smoked Thai Curry",
            price: 18.73,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          {
            name: "Organic Braised Baked Cod with Lemon Caper Sauce",
            price: 34.76,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "House Special Braised Grilled Lobster with Lemon Butter",
            price: 35.24,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Hearty Smoked Seafood Risotto with Saffron",
            price: 25.76,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Authentic Juicy Blackened Mahi-Mahi with Pineapple Salsa",
            price: 29.24,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: "Premium Satisfying Milkshake",
            price: 4.43,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: true,
    ...
    category: [
      {
        ...
        items: [
          ...
          {
            name: "Homestyle Pan-seared Soufflé",
            price: 10.25,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Homestyle Stuffed Carrot Cake",
            price: 9.26,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Classic Smoked Madeleines",
            price: 10.47,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
    ...
    category: [
      {
        ...
        items: [
          ...
          {
            name: "Organic Comforting Mai Tai",
            price: 13.91,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Authentic Tender Old Fashioned",
            price: 10.4,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
