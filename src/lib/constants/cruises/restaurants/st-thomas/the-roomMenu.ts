...
export const stThomastheRoomMenu: RestaurantMenu[] = [
  {
    ...
    description: "Our carefully crafted selection of satisfying French dishes",
    category: [
      {
      ...
      },
      {
        ...
        items: [
          {
            name: "Fresh Satisfying Off-Menu Secret Preparation",
            price: 26.96,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Fresh Herbed Tomahawk Ribeye for Two",
            price: 27.29,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Hearty Appetizing Seared Duck Breast with Cherry Reduction",
            price: 38.18,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          {
            name: "Traditional Tender Vegetable Stir-Fry",
            price: 21.05,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Traditional Sizzling Burrito",
            price: 30.12,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Premium Golden Katsu Curry",
            price: 31.46,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Authentic Stuffed Seafood Platter",
            price: 27.55,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Homestyle Smoked Enchiladas",
            price: 27.4,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "House Special Satisfying Tacos",
            price: 21.96,
            isVegetarian: true,
            isVegan: true,
            isGlutenFree: false,
          ...
          {
            name: "Homestyle Appetizing Biryani",
            price: 28.75,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: true,
  ...
  },
  {
    ...
    category: [
      ...
      },
      {
        ...
        items: [
          {
            name: "Traditional Pan-seared Tequila",
            price: 11.08,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Fresh Smoked Baileys Irish Cream",
            price: 15.37,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Homestyle Exquisite Chartreuse",
            price: 13.95,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Premium Satisfying Kahlúa",
            price: 11.5,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
