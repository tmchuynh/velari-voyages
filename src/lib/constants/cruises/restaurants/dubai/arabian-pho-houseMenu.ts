...
/**
 * Menu data for Arabian Pho House in dubai
 */
export const dubaiarabianPhoHouseMenu: RestaurantMenu[] = [
  {
    title: "Main Course Menu",
    description:
      "Delight in our chef's most comforting takes on traditional Japanese flavors",
    category: [
      {
      ...
      },
      {
        ...
        items: [
          {
            name: "Gourmet Golden Lobster and Crab Stuffed Ravioli",
            price: 37.85,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Authentic Appetizing Chef's Childhood Favorite Reimagined",
            price: 34.29,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: "Organic Golden Mini Sliders",
            price: 10.74,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Fresh Herbed Cheese Platter",
            price: 14.31,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Organic Spiced Stuffed Mushrooms",
            price: 12.24,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Organic Zingy Tzatziki with Pita",
            price: 10.96,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Classic Grilled Spinach Artichoke Dip",
            price: 15.56,
            isVegetarian: false,
            isVegan: true,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          {
            name: "Homestyle Marinated Coffee",
            price: 6.41,
            isVegetarian: true,
            isVegan: true,
            isGlutenFree: true,
          ...
          {
            name: "House Special Grilled Smoothie",
            price: 7.03,
            isVegetarian: true,
            isVegan: true,
            isGlutenFree: false,
    ...
    category: [
      {
        ...
        items: [
          ...
          {
            name: "Seasonal Mouthwatering Muffins",
            price: 8.22,
            isVegetarian: true,
            isVegan: true,
            isGlutenFree: false,
          ...
          {
            name: "Traditional Luscious Berry Tart",
            price: 7.83,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Deluxe Braised Cheesecake",
            price: 9.36,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
  ...
  },
  {
    title: "Drinks Menu",
    description:
      "Treat yourself to a thoughtfully selected nightcap from our curated selection",
    category: [
      {
        ...
        items: [
          ...
          {
            name: "Traditional Baked Manhattan",
            price: 12.08,
            isVegetarian: true,
            isVegan: true,
            isGlutenFree: true,
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: "Authentic Luscious Chenin Blanc",
            price: 11.87,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Organic Pan-seared Syrah/Shiraz",
            price: 10.56,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Organic Sweet Sauvignon Blanc",
            price: 10.22,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: true,
