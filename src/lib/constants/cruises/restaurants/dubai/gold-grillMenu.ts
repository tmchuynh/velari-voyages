...
export const dubaigoldGrillMenu: RestaurantMenu[] = [
  {
    ...
    "description": "Tastefully prepared Japanese dishes with a fresh signature touch",
    "category": [
      {
  ...
  {
    "title": "Drinks Menu",
    "description": "Each drink is a delightful complement to the flavors of our cuisine",
    "category": [
      {
