...
export const dubaicreekSaloonMenu: RestaurantMenu[] = [
  {
    ...
    "description": "Explore the richness of Lebanese cuisine through our hearty perspective",
    "category": [
      {
  ...
  {
    "title": "Dessert Menu",
    "description": "Lebanese-inspired delicious confections to delight your senses",
    "category": [
      {
        "name": "Baked Goods",
