...
export const milanmediterraneanCantinaMenu: RestaurantMenu[] = [
  {
    ...
    "description": "Taste the depth of French culture through our hearty preparations",
    "category": [
      {
  ...
  {
    "title": "Dessert Menu",
    "description": "A curated selection of comforting desserts, inspired by French heritage",
    "category": [
      {
        "name": "Baked Goods",
