...
/**
 * Menu data for Fusion Gourmet in milan
 */
export const milanfusionGourmetMenu: RestaurantMenu[] = [
  {
    "title": "Main Course Menu",
    "description": "A thoughtfully curated lineup of fresh Fusion dishes to suit every palate",
    "category": [
      {
    ...
    "category": [
      {
        ...
        "items": [
          ...
          {
            "name": "Fresh Herbed Danish Pastries",
            "price": 8.26,
            "isVegetarian": true,
            "isVegan": false,
            "isGlutenFree": true,
          ...
          {
            "name": "Seasonal Appetizing Madeleines",
            "price": 8.67,
            "isVegetarian": false,
            "isVegan": false,
            "isGlutenFree": false,
  ...
  {
    "title": "Drinks Menu",
    "description": "Our simple collection of spirits and cocktails to enhance your dining experience",
    "category": [
      {
