...
export const barcelonabarcelonaRamenYaMenu: RestaurantMenu[] = [
  {
    ...
    "description": "Explore bold and simple twists on beloved Mediterranean staples",
    "category": [
      {
  ...
  {
    "title": "Drinks Menu",
    "description": "Mediterranean-inspired drinks and classic favorites in our delightful selection",
    "category": [
      {
