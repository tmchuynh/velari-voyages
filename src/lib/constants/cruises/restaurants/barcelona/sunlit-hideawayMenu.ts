...
export const barcelonasunlitHideawayMenu: RestaurantMenu[] = [
  {
    ...
    "description": "From bold spices to subtle notes—our delicious Spanish journey awaits",
    "category": [
      {
  ...
  {
    "title": "Drinks Menu",
    "description": "Spanish-inspired drinks and classic favorites in our carefully chosen selection",
    "category": [
      {
