...
/**
 * Menu data for The Trading Co. in bali
 */
export const balitheTradingCoMenu: RestaurantMenu[] = [
  {
    title: "Main Course Menu",
    description:
      "Our hearty kitchen reimagines Mediterranean for today’s palate",
    category: [
      {
      ...
      },
      {
        ...
        items: [
          {
            name: "Authentic Golden Off-Menu Secret Preparation",
            price: 38.71,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Authentic Sweet Tasting of Local Artisanal Cheeses",
            price: 29.87,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Classic Zesty Truffle-Infused Filet Mignon",
            price: 26.13,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Authentic Wholesome Seasonal Truffle Risotto",
            price: 38.63,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Gourmet Baked Grilled Venison with Juniper Berry Sauce",
            price: 25.91,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: "Fresh Sweet Split Pea Soup",
            price: 8.25,
            isVegetarian: true,
            isVegan: true,
            isGlutenFree: true,
          ...
          {
            name: "Fresh Mouthwatering Turkey and Wild Rice Soup",
            price: 9.18,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
  ...
  },
  {
    title: "Dessert Menu",
    description:
      "Mediterranean-inspired satisfying confections to delight your senses",
    category: [
      {
        name: "Baked Goods",
        description:
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: "Homestyle Savory Frozen Banana",
            price: 8.71,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
    ...
    category: [
      {
        ...
        items: [
          ...
          {
            name: "Deluxe Pan-seared Old Fashioned",
            price: 10.16,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Gourmet Juicy Whiskey Sour",
            price: 13.4,
            isVegetarian: false,
            isVegan: true,
            isGlutenFree: false,
          ...
          {
            name: "Hearty Satisfying Negroni",
            price: 15.42,
            isVegetarian: false,
            isVegan: true,
            isGlutenFree: true,
      ...
      },
      {
        ...
        items: [
          {
            name: "Classic Crispy Sauvignon Blanc",
            price: 8.72,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Authentic Sweet Roussanne",
            price: 9.69,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Traditional Satisfying Pinot Noir",
            price: 13.74,
            isVegetarian: true,
            isVegan: true,
            isGlutenFree: false,
          ...
          {
            name: "House Special Spicy Vermentino",
            price: 10.63,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: true,
