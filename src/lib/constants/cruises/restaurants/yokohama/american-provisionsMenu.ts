...
/**
 * Menu data for American Provisions in yokohama
 */
export const yokohamaamericanProvisionsMenu: RestaurantMenu[] = [
  {
    ...
    category: [
      ...
      },
      {
        ...
        items: [
          {
            name: "Traditional Grilled Sushi-Grade Sashimi Platter",
            price: 35.62,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Organic Zesty Alaskan King Crab Legs with Drawn Butter",
            price: 32.86,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Fresh Luscious Hearty Italian Cioppino",
            price: 29.19,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Handcrafted Golden Classic British Fish and Chips",
            price: 32.67,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Seasonal Creamy Steamed Littleneck Clams in Garlic Broth",
            price: 35.29,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          {
            name: "Gourmet Crunchy Israeli Couscous with Roasted Tomatoes",
            price: 7.41,
            isVegetarian: true,
            isVegan: true,
            isGlutenFree: false,
          ...
          {
            name: "Deluxe Baked Provencal Ratatouille",
            price: 6.53,
            isVegetarian: false,
            isVegan: true,
            isGlutenFree: false,
          ...
          {
            name: "Classic Zesty Corn on the Cob with Chili Lime Butter",
            price: 5.18,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Homestyle Tangy Green Beans Almondine",
            price: 5.91,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Authentic Marinated Braised Red Cabbage with Apple",
            price: 8.64,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
  ...
  },
  {
    title: "Dessert Menu",
    description:
      "Japanese-inspired homemade confections to delight your senses",
    category: [
      {
        name: "Baked Goods",
        description:
        ...
        items: [
          {
            name: "Seasonal Golden Madeleines",
            price: 7.26,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Homestyle Herbed Cinnamon Rolls",
            price: 6.22,
            isVegetarian: true,
            isVegan: true,
            isGlutenFree: false,
  ...
  },
  {
    ...
    category: [
      ...
      },
      {
        ...
        items: [
          {
            name: "House Special Flaky Limoncello",
            price: 10.89,
            isVegetarian: false,
            isVegan: true,
            isGlutenFree: false,
