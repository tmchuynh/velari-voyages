...
export const yokohamachineseExperienceMenu: RestaurantMenu[] = [
  {
    ...
    "description": "A thoughtfully curated lineup of tasty American dishes to suit every palate",
    "category": [
      {
  ...
  {
    "title": "Drinks Menu",
    "description": "Discover our quality drinks, perfectly paired with our American cuisine",
    "category": [
      {
