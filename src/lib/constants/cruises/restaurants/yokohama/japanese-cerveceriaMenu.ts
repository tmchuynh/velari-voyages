...
/**
 * Menu data for Japanese Cerveceria in yokohama
 */
export const yokohamajapaneseCerveceriaMenu: RestaurantMenu[] = [
  {
    title: "Main Course Menu",
    description:
      "A thoughtfully curated lineup of tasty Chinese dishes to suit every palate",
    category: [
      {
      ...
      },
      {
        ...
        items: [
          {
            name: "Deluxe Aromatic Hand-Selected Wine Pairing Experience",
            price: 38.97,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Premium Spiced Duck Confit with Roasted Root Vegetables",
            price: 38.7,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Gourmet Marinated Seasonal Truffle Risotto",
            price: 27.41,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Organic Marinated Chef's Market Inspiration of the Day",
            price: 35.21,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "House Special Spicy Aged and House-Cured Charcuterie Selection",
            price: 26.8,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
      ...
      },
      {
        ...
        items: [
          {
            name: "Handcrafted Wholesome Tomato Soup",
            price: 11.31,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Homestyle Hearty Broccoli Cheddar Soup",
            price: 7.44,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Homestyle Spicy Zuppa Toscana",
            price: 9.88,
            isVegetarian: false,
            isVegan: true,
            isGlutenFree: false,
  ...
  },
  {
    ...
    category: [
      ...
      },
      {
        ...
        items: [
          {
            name: "Authentic Flavorful Mourvèdre",
            price: 12.23,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Fresh Wholesome Pinot Noir",
            price: 9.67,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
