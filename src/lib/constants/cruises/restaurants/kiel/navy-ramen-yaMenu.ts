...
/**
 * Menu data for Navy Ramen-Ya in kiel
 */
export const kielnavyRamenYaMenu: RestaurantMenu[] = [
  {
    title: "Main Course Menu",
    description:
      "Satisfy your cravings with our vibrant, tasty take on Mediterranean",
    category: [
      {
        ...
        items: [
          {
            name: "Fresh Zingy Legendary Prime Rib",
            price: 25.02,
            isVegetarian: true,
            isVegan: true,
            isGlutenFree: true,
          ...
          {
            name: "Organic Marinated Chef's Childhood Inspired Creation",
            price: 33.95,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Traditional Comforting Secret Recipe Bouillabaisse",
            price: 33.03,
            isVegetarian: true,
            isVegan: true,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          {
            name: "Homestyle Comforting Dry-Aged Prime Beef Selection",
            price: 38.45,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Classic Aromatic Fusion of Traditional and Modern Techniques",
            price: 26.95,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Classic Aromatic Charcoal-Grilled Wagyu Beef",
            price: 31.98,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Hearty Creamy Aged and House-Cured Charcuterie Selection",
            price: 27.57,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
    ...
    category: [
      {
        ...
        items: [
          ...
          {
            name: "Handcrafted Spicy Portuguese Custard Tarts",
            price: 10.45,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Gourmet Creamy Fruit Galette",
            price: 9.68,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Premium Smoked Red Velvet Cake",
            price: 6.64,
            isVegetarian: false,
            isVegan: true,
            isGlutenFree: false,
          ...
          {
            name: "Deluxe Appetizing Cupcakes",
            price: 8.13,
            isVegetarian: true,
            isVegan: true,
            isGlutenFree: false,
  ...
  },
  {
    ...
    category: [
      ...
      },
      {
        ...
        items: [
          {
            name: "Authentic Succulent Whiskey",
            price: 15.92,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
