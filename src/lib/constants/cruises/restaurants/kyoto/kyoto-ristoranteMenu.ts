...
export const kyotokyotoRistoranteMenu: RestaurantMenu[] = [
  {
    ...
    description:
      "From street food classics to refined plates—our comforting take on Japanese",
    category: [
      {
      ...
      },
      {
        ...
        items: [
          {
            name: "Traditional Fried Tableside Prepared Tartare",
            price: 39.01,
            isVegetarian: true,
            isVegan: true,
            isGlutenFree: false,
          ...
          {
            name: "Seasonal Fried Freshly Harvested Seasonal Creation",
            price: 36.53,
            isVegetarian: true,
            isVegan: true,
            isGlutenFree: false,
          ...
          {
            name: "Homestyle Marinated Seasonal Farm-to-Table Vegetable Plate",
            price: 39.77,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Homestyle Zingy Herb-Crusted Rack of Lamb",
            price: 27.35,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Hearty Succulent Locally Foraged Mushroom Selection",
            price: 25.2,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
      ...
      },
      {
        ...
        items: [
          {
            name: "Gourmet Zesty Lemon-Herb Calamari Steak",
            price: 35.12,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Fresh Enticing Stuffed Flounder with Crab and Spinach",
            price: 24.28,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Fresh Fried Garlic Butter Shrimp Skillet",
            price: 32.61,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Fresh Tangy Prawn Curry in Coconut Masala",
            price: 23.44,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: true,
  ...
  },
  {
    title: "Dessert Menu",
    description:
      "Handcrafted homemade desserts that celebrate Japanese traditions",
    category: [
      {
        name: "Baked Goods",
        description:
    ...
    category: [
      {
        ...
        items: [
          {
            name: "Traditional Sweet Bloody Mary",
            price: 15.79,
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: false,
          ...
          {
            name: "Authentic Satisfying Mai Tai",
            price: 12,
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
          ...
          {
            name: "Handcrafted Tangy Old Fashioned",
            price: 14.53,
            isVegetarian: false,
            isVegan: true,
            isGlutenFree: false,
