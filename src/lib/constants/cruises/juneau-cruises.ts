...
export const juneauCruises: Cruise[] = [
{
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Depart from the iconic port of Juneau and sail through the enchanting Alaska. Explore vibrant destinations like Victoria, Seattle, each offering its own unique charm and local flair.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Board in Juneau for a hand-crafted tide through the breathtaking Alaska. Highlights include sun-drenched beaches, historic ports, and immersive culture in Victoria, Seattle.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Escape into the calm waters of Alaska with this legendary journey from Juneau. Explore vibrant markets, sun-soaked beaches, and architectural marvels at Ketchikan, Victoria.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Sail from Juneau into a world of wonder. The Alaska beckons with unforgettable ports like Ketchikan, Skagway, Victoria, where every view is picture-perfect and every moment is priceless.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Set sail from Juneau for a voyage like no other. From the picturesque landscapes of Glacier Bay to the lively ambiance of Vancouver, this horizon-kissed cruise will redefine your view of Alaska.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Sail from Juneau into a world of wonder. The Alaska beckons with unforgettable ports like Ketchikan, Glacier Bay, Seattle, where every view is picture-perfect and every moment is priceless.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "This golden cruise from Juneau is your ticket to the captivating charm of the Alaska. Discover the delights of Victoria, Glacier Bay, Skagway with enriching excursions and award-winning service.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Begin your journey in Juneau, where tradition meets travel. This immersive pulse reveals the finest of Alaska, from the beaches of Victoria to the streets of Glacier Bay.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Explore a new side of Alaska with this enchanting resonance starting in Juneau. Visit charming ports such as Ketchikan, Skagway, Vancouver, each offering its own unique rhythm.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "This hand-selected verdant cruise offers a true taste of Alaska. Depart from Juneau and explore ports like Victoria, Glacier Bay, Sitka, each telling a story through food, music, and tradition.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Begin your labyrinth in Juneau, a gateway to the soul of Alaska. Enjoy days spent exploring Glacier Bay, Ketchikan, Victoria and evenings immersed in onboard luxury, fine dining, and panoramic sea views.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "This handpicked requiem begins in Juneau and travels through Alaska's iconic waterscapes. Discover Vancouver, Skagway, Victoria as each day brings new stories and every night offers elegant repose.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Escape the everyday with this extraordinary journey through Alaska, departing from Juneau. You'll visit Vancouver, Seattle, Skagway, where every stop is a new adventure.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Set course from Juneau for an inspiring lavish journey across Alaska. Whether exploring ancient ruins in Vancouver or soaking up coastal views in Glacier Bay, every day offers a perfect mix of discovery and relaxation.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Escape the everyday with this harmonic journey through Alaska, departing from Juneau. You'll visit Ketchikan, Skagway, where every stop is a new adventure.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Experience coastal elegance on this pulse from Juneau, where the journey through Alaska includes stops in Vancouver, Skagway, Victoria, Sitka, each more enchanting than the last.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Embark from Juneau and traverse the Alaska in style. Whether it’s the energy of Sitka or the calm of Vancouver, each destination reveals a new side of paradise.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Experience the elegance of the seas on this mystical symphony through Alaska, starting from the illustrious port of Juneau. From Vancouver, Seattle to Skagway, each destination offers its own story, culture, and breathtaking views.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Start in the vibrant city of Juneau and venture into the iconic Alaska. Discover authentic local cultures, cuisine, and coastal wonders in Victoria, Sitka, Glacier Bay, Seattle.",
  ...
  },
  {
    ...
    "coordinates": {
      ...
      description: "Sail away from Juneau into the beautiful expanse of Alaska. Along the way, enjoy rich cultural experiences in Seattle, Sitka, where history, nature, and cuisine collide.",
