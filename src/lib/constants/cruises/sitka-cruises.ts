...
export const sitkaCruises: Cruise[] = [
  {
    ...
    itinerary: {
      ...
      description:
        "Your journey through the Alaska begins in Sitka, where elegance meets adventure. Explore the shores of Skagway, Vancouver, Seattle, with curated excursions and luxurious onboard amenities.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Board in Sitka for a hand-crafted sanctuary through the breathtaking Alaska. Highlights include sun-drenched beaches, historic ports, and immersive culture in Vancouver, Seattle, Victoria, Juneau.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Join us in Sitka for a sanctuary of a lifetime. Sail across the serene waters of Alaska, stopping at ports like Glacier Bay, Seattle where timeless traditions meet modern luxuries.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Begin your journey in Sitka, where tradition meets travel. This immersive requiem reveals the finest of Alaska, from the beaches of Vancouver to the streets of Victoria.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "An escape like no other begins in Sitka, where your labyrinth launches into the heart of Alaska. Discover the magic of Glacier Bay, Seattle, Vancouver, Skagway with style and sophistication.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Begin a captivating elevation through the Alaska, departing Sitka. With visits to Victoria, Skagway, Seattle, each day brings a new adventure and deeper connection to the region.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Enjoy seamless luxury on this crystalline arcadia beginning in Sitka. Visit breathtaking Alaska locales such as Victoria, Skagway, Ketchikan, Glacier Bay on this unforgettable itinerary.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Set sail from Sitka on this immersive voyage through the heart of Alaska. Experience the perfect blend of relaxation and adventure as you explore Vancouver and Skagway and Glacier Bay and Victoria, with personalized service and unforgettable experiences awaiting at every port.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "This inspiring journey departs from Sitka, navigating the diverse landscapes and vibrant cities of Alaska. Must-see stops include Juneau, Vancouver.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "A voyage of contrasts awaits from Sitka. Discover the historical and natural richness of Alaska as you cruise to spectacular destinations like Juneau, Ketchikan, Seattle.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Your sojourn begins in Sitka, where every sunset on the Alaska horizon promises another day of discovery—from Skagway, Victoria, Seattle to hidden ports of charm.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Set off on a reflection from Sitka that captures the essence of Alaska. Discover cultural gems and culinary delights across Seattle, Glacier Bay, Ketchikan, Skagway.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Sail from Sitka into a world of wonder. The Alaska beckons with unforgettable ports like Glacier Bay, Seattle, where every view is picture-perfect and every moment is priceless.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Your journey through the Alaska begins in Sitka, where elegance meets adventure. Explore the shores of Vancouver, Glacier Bay, Skagway, Victoria, with curated excursions and luxurious onboard amenities.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Join us in Sitka for a tide of a lifetime. Sail across the serene waters of Alaska, stopping at ports like Juneau, Skagway, Ketchikan, Victoria where timeless traditions meet modern luxuries.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Begin your pulse in Sitka, a gateway to the soul of Alaska. Enjoy days spent exploring Skagway, Ketchikan and evenings immersed in onboard luxury, fine dining, and panoramic sea views.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Depart from the iconic port of Sitka and sail through the enchanting Alaska. Explore vibrant destinations like Ketchikan, Seattle, Victoria, Glacier Bay, each offering its own unique charm and local flair.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "An unforgettable resonance awaits as you cruise from Sitka across Alaska. Dive into history, flavor, and culture with stops including Glacier Bay, Vancouver, Ketchikan, Juneau.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "This oceanic mythos begins in Sitka and ventures deep into the heart of Alaska. Wander through colorful markets, historic streets, and serene coastlines at Glacier Bay, Juneau, Victoria.",
  ...
  },
  {
    ...
    itinerary: {
      ...
      description:
        "Savor each moment of this spectacular escape through Alaska, starting in Sitka. Visit renowned locations like Glacier Bay, Skagway, where adventure and relaxation intertwine.",
