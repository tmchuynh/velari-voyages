// Spa venues data for Milan
// This file contains spa and wellness center information for cruise vessels operating from Milan
...
export const milanSpas: Spa[] = [
  {
    id: "a48d00ed-4a08-47b4-a8ba-edfdfe05bf1e",
    vesselId: "ms--explorer",
    name: "Coastal Waters Spa",
    description: "Experience ultimate relaxation at Coastal Waters Spa, where traditional wellness meets modern luxury. Our expert therapists provide personalized treatments using premium products and techniques inspired by Mediterranean healing traditions.",
  ...
  {
    id: "83732510-c15b-4d27-a37f-0e9639641914",
    vesselId: "ms--explorer",
    name: "Sunset Rejuvenation Center",
    description: "Welcome to Sunset Rejuvenation Center, an oasis of tranquility aboard the MS  Explorer. Our world-class spa offers a comprehensive menu of rejuvenating treatments designed to restore your mind, body, and spirit while sailing the beautiful waters near Milan.",
    imageUrl: "/images/spas/mega-yacht-spa.jpg",
    hours: {
      start: "07:00",
      end: "19:00",
  ...
  {
    id: "fb3285fc-0a22-45b3-8fc7-420ac15db6bd",
  ...
  {
    id: "37f073a6-d510-4309-b678-73cb0bbb00e0",
    vesselId: "ts--of-the-deep",
    name: "Mediterranean Waters Spa",
    description: "Welcome to Mediterranean Waters Spa, an oasis of tranquility aboard the TS  of the Deep. Our world-class spa offers a comprehensive menu of rejuvenating treatments designed to restore your mind, body, and spirit while sailing the beautiful waters near Milan.",
  ...
  {
    id: "7d373537-4b45-45c0-8e90-55c7041c1f7f",
    vesselId: "ms-the--mariner",
    name: "Azure Rejuvenation Center",
    description: "Azure Rejuvenation Center provides a haven of serenity where guests can escape and rejuvenate. Our skilled wellness professionals offer customized treatments in a luxurious setting, ensuring every guest leaves feeling refreshed and renewed.",
  ...
  {
    id: "0efeb2c6-8b56-46a5-9158-5b44f7208d1f",
    vesselId: "ms-the--mariner",
  ...
  {
    id: "7708d4c2-42ac-42e0-a415-b1594a6fb7e3",
    vesselId: "sv--gale",
