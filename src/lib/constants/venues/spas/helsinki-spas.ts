...
export const helsinkiSpas: Spa[] = [
  {
    id: "8afa5f84-d930-4223-9a64-d7c6c9017be7",
    vesselId: "mv--explorer",
    name: "Aurora Spa & Wellness",
    description: "Aurora Spa & Wellness provides a haven of serenity where guests can escape and rejuvenate. Our skilled wellness professionals offer customized treatments in a luxurious setting, ensuring every guest leaves feeling refreshed and renewed.",
  ...
  {
    id: "2c94d4d2-3d5a-488f-9949-1e8daeec6fa9",
    vesselId: "hms-helsinki-voyager",
    name: "Nordic Waters Spa",
    description: "Welcome to Nordic Waters Spa, an oasis of tranquility aboard the HMS Helsinki Voyager. Our world-class spa offers a comprehensive menu of rejuvenating treatments designed to restore your mind, body, and spirit while sailing the beautiful waters near Helsinki.",
  ...
  {
    id: "9a257b61-d76f-4aab-a7da-64c7af1f8cb9",
    vesselId: "hms-helsinki-voyager",
  ...
  {
    id: "25cf67cb-e80e-47ca-8d2d-2922ede873fc",
    vesselId: "ss--of-the-deep",
    name: "SS  of the Deep Glacial Spa",
    description: "Experience ultimate relaxation at SS  of the Deep Glacial Spa, where traditional wellness meets modern luxury. Our expert therapists provide personalized treatments using premium products and techniques inspired by Northern Europe healing traditions.",
  ...
  {
    id: "e46e07d4-b3a3-49dc-a8f2-aaedb7ffbb6e",
    vesselId: "ss--of-the-deep",
    name: "Aurora Rejuvenation Center",
    description: "Aurora Rejuvenation Center provides a haven of serenity where guests can escape and rejuvenate. Our skilled wellness professionals offer customized treatments in a luxurious setting, ensuring every guest leaves feeling refreshed and renewed.",
    imageUrl: "/images/spas/chartered-vessel-spa.jpg",
    hours: {
      start: "09:00",
      end: "21:00",
  ...
  {
    id: "e92cd9bd-4672-4fc2-b00a-634c89303cd7",
    vesselId: "nx-the--mariner",
    name: "Fjord Spa & Wellness",
    description: "Fjord Spa & Wellness provides a haven of serenity where guests can escape and rejuvenate. Our skilled wellness professionals offer customized treatments in a luxurious setting, ensuring every guest leaves feeling refreshed and renewed.",
  ...
  {
    id: "3b6dcb23-e4df-4c4e-9bcf-35f4c13d5936",
    vesselId: "nx-the--mariner",
    name: "NX The  Mariner Aurora Spa",
    description: "Experience ultimate relaxation at NX The  Mariner Aurora Spa, where traditional wellness meets modern luxury. Our expert therapists provide personalized treatments using premium products and techniques inspired by Northern Europe healing traditions.",
    imageUrl: "/images/spas/small-ocean-ship-spa.jpg",
    hours: {
      start: "07:00",
      end: "22:00",
  ...
  {
    id: "5c61f1f3-f355-4525-96b4-3905376b5cd7",
    vesselId: "ms--gale",
    name: "Fjord Spa & Wellness",
    description: "Discover your personal sanctuary at Fjord Spa & Wellness. Our peaceful spa environment features state-of-the-art facilities and offers an extensive range of therapeutic treatments, perfect for unwinding during your maritime journey.",
    imageUrl: "/images/spas/river-cruise-ship-spa.jpg",
    hours: {
      start: "08:00",
      end: "22:00",
