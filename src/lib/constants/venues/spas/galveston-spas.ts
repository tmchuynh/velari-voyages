// Spa venues data for Galveston
// This file contains spa and wellness center information for cruise vessels operating from Galveston
...
export const galvestonSpas: Spa[] = [
  {
    id: "101d0b0c-d17a-41f8-a009-063dec961657",
    vesselId: "nb--explorer",
    name: "Skyline Spa & Wellness",
    description: "Welcome to Skyline Spa & Wellness, an oasis of tranquility aboard the NB  Explorer. Our world-class spa offers a comprehensive menu of rejuvenating treatments designed to restore your mind, body, and spirit while sailing the beautiful waters near Galveston.",
  ...
  {
    id: "7454ecdd-e00e-427f-bc4f-8afc5af05fa2",
  ...
  {
    id: "a713a9f3-3936-4d01-b8a5-3c934c51ab39",
    vesselId: "cs-galveston-voyager",
    name: "Summit Spa & Wellness",
    description: "Discover your personal sanctuary at Summit Spa & Wellness. Our peaceful spa environment features state-of-the-art facilities and offers an extensive range of therapeutic treatments, perfect for unwinding during your maritime journey.",
    imageUrl: "/images/spas/superyacht-spa.jpg",
    hours: {
      start: "08:00",
      end: "22:00",
  ...
  {
    id: "e958a68b-fd41-4fa1-94da-bdcfc4390e1d",
  ...
  {
    id: "1007fe9d-e89c-471b-9f98-99b3f10c85f1",
    vesselId: "ts-the--mariner",
    name: "The Harbor Sanctuary",
    description: "Welcome to The Harbor Sanctuary, an oasis of tranquility aboard the TS The  Mariner. Our world-class spa offers a comprehensive menu of rejuvenating treatments designed to restore your mind, body, and spirit while sailing the beautiful waters near Galveston.",
  ...
  {
    id: "700b5701-53d4-44e0-bfd3-248a608ce6fe",
    vesselId: "ts-the--mariner",
    name: "The Skyline Sanctuary",
    description: "Experience ultimate relaxation at The Skyline Sanctuary, where traditional wellness meets modern luxury. Our expert therapists provide personalized treatments using premium products and techniques inspired by North America healing traditions.",
    imageUrl: "/images/spas/mega-yacht-spa.jpg",
    hours: {
      start: "07:00",
      end: "19:00",
  ...
  {
    id: "f279c4a9-ac03-42d7-8fcb-5381a99c435c",
    vesselId: "nb--gale",
