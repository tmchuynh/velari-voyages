...
export const bermudaSpas: Spa[] = [
  {
    id: "788613c3-09bd-48f7-91ac-2e6134ec705a",
    vesselId: "nx--explorer",
    name: "Tropical Rejuvenation Center",
    description: "Welcome to Tropical Rejuvenation Center, an oasis of tranquility aboard the NX  Explorer. Our world-class spa offers a comprehensive menu of rejuvenating treatments designed to restore your mind, body, and spirit while sailing the beautiful waters near Bermuda.",
  ...
  {
    id: "cf04ea2b-971b-4656-b643-bca2b3ea88ef",
    vesselId: "sv-bermuda-voyager",
    name: "The Tropical Sanctuary",
    description: "Experience ultimate relaxation at The Tropical Sanctuary, where traditional wellness meets modern luxury. Our expert therapists provide personalized treatments using premium products and techniques inspired by Caribbean healing traditions.",
  ...
  {
    id: "b37ac4ff-691b-47fa-aa69-4500f601743e",
    vesselId: "sv-bermuda-voyager",
    name: "Oasis Spa & Wellness",
    description: "Welcome to Oasis Spa & Wellness, an oasis of tranquility aboard the SV Bermuda Voyager. Our world-class spa offers a comprehensive menu of rejuvenating treatments designed to restore your mind, body, and spirit while sailing the beautiful waters near Bermuda.",
    imageUrl: "/images/spas/river-cruise-ship-spa.jpg",
    hours: {
      start: "09:00",
      end: "22:00",
  ...
  {
    id: "bec685dd-7f63-4dda-a605-141572822047",
  ...
  {
    id: "f1d6388c-9b26-49be-9c8b-65b37585094e",
    vesselId: "nx--of-the-deep",
    name: "Island Spa & Wellness",
    description: "Island Spa & Wellness provides a haven of serenity where guests can escape and rejuvenate. Our skilled wellness professionals offer customized treatments in a luxurious setting, ensuring every guest leaves feeling refreshed and renewed.",
    imageUrl: "/images/spas/ocean-liner-spa.jpg",
    hours: {
      start: "09:00",
      end: "22:00",
  ...
  {
    id: "b0872559-ad8c-4c5d-8181-df973740573c",
    vesselId: "sy-the--mariner",
    name: "Oasis Wellness Retreat",
    description: "Experience ultimate relaxation at Oasis Wellness Retreat, where traditional wellness meets modern luxury. Our expert therapists provide personalized treatments using premium products and techniques inspired by Caribbean healing traditions.",
  ...
  {
    id: "cef13cd7-2b69-4b2a-bb30-11ae2ef506f5",
    vesselId: "sy-the--mariner",
    name: "Coral Spa & Wellness",
    description: "Experience ultimate relaxation at Coral Spa & Wellness, where traditional wellness meets modern luxury. Our expert therapists provide personalized treatments using premium products and techniques inspired by Caribbean healing traditions.",
    imageUrl: "/images/spas/resort-style-ship-spa.jpg",
    hours: {
      start: "07:00",
      end: "19:00",
  ...
  {
    id: "cca4fdae-d2c1-484c-abad-ef9e5fc532c0",
    vesselId: "sy--gale",
  ...
  {
    id: "22d16f86-0627-45e4-b708-ff0140c3bd57",
    vesselId: "sy--gale",
    name: "Serenity Paradise Spa",
    description: "Serenity Paradise Spa provides a haven of serenity where guests can escape and rejuvenate. Our skilled wellness professionals offer customized treatments in a luxurious setting, ensuring every guest leaves feeling refreshed and renewed.",
    imageUrl: "/images/spas/boutique-cruise-ship-spa.jpg",
    hours: {
      start: "09:00",
      end: "20:00",
