...
export const barcelonaSpas: Spa[] = [
  {
    id: "b666dffd-1389-449f-8d06-667af4e5f1d0",
    vesselId: "ps--explorer",
    name: "Coastal Wellness Retreat",
    description: "Welcome to Coastal Wellness Retreat, an oasis of tranquility aboard the PS  Explorer. Our world-class spa offers a comprehensive menu of rejuvenating treatments designed to restore your mind, body, and spirit while sailing the beautiful waters near Barcelona.",
  ...
  {
    id: "033611b2-ad01-4aa3-8368-6d3f7d03fad9",
    vesselId: "ps--explorer",
    name: "Mediterranean Waters Spa",
    description: "Mediterranean Waters Spa provides a haven of serenity where guests can escape and rejuvenate. Our skilled wellness professionals offer customized treatments in a luxurious setting, ensuring every guest leaves feeling refreshed and renewed.",
    imageUrl: "/images/spas/polar-expedition-ship-spa.jpg",
    hours: {
      start: "07:00",
      end: "22:00",
  ...
  {
    id: "fc9390c4-e30d-486f-b79e-8f3bc21cb852",
    vesselId: "my-barcelona-voyager",
    name: "MY Barcelona Voyager Mediterranean Spa",
    description: "Discover your personal sanctuary at MY Barcelona Voyager Mediterranean Spa. Our peaceful spa environment features state-of-the-art facilities and offers an extensive range of therapeutic treatments, perfect for unwinding during your maritime journey.",
  ...
  {
    id: "4674e5c2-bbe5-4883-9307-84af7003304c",
    vesselId: "mv--of-the-deep",
    name: "Azure Rejuvenation Center",
    description: "Experience ultimate relaxation at Azure Rejuvenation Center, where traditional wellness meets modern luxury. Our expert therapists provide personalized treatments using premium products and techniques inspired by Mediterranean healing traditions.",
  ...
  {
    id: "be16327e-87b4-4012-a52a-9ea298e93797",
    vesselId: "mv--of-the-deep",
    name: "Azure Spa & Wellness",
    description: "Experience ultimate relaxation at Azure Spa & Wellness, where traditional wellness meets modern luxury. Our expert therapists provide personalized treatments using premium products and techniques inspired by Mediterranean healing traditions.",
    imageUrl: "/images/spas/small-ocean-ship-spa.jpg",
    hours: {
      start: "08:00",
      end: "21:00",
  ...
  {
    id: "aa24b2c9-7bc1-460d-9817-c2678f4b46b6",
  ...
  {
    id: "e17edc9e-603d-492a-b273-abbf7867a720",
    vesselId: "sv--gale",
    name: "Mediterranean Wellness Retreat",
    description: "Mediterranean Wellness Retreat provides a haven of serenity where guests can escape and rejuvenate. Our skilled wellness professionals offer customized treatments in a luxurious setting, ensuring every guest leaves feeling refreshed and renewed.",
  ...
  {
    id: "3cf3d5f3-6645-4df2-a6bd-f44906e09454",
    vesselId: "sv--gale",
    name: "The Riviera Sanctuary",
    description: "Discover your personal sanctuary at The Riviera Sanctuary. Our peaceful spa environment features state-of-the-art facilities and offers an extensive range of therapeutic treatments, perfect for unwinding during your maritime journey.",
    imageUrl: "/images/spas/family-cruise-ship-spa.jpg",
    hours: {
      start: "09:00",
      end: "22:00",
