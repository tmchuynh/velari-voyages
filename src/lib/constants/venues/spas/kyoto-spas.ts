// Spa venues data for Kyoto
// This file contains spa and wellness center information for cruise vessels operating from Kyoto
...
export const kyotoSpas: Spa[] = [
  {
    id: "d5d56548-5445-47b3-917c-5ab60ca3fec6",
    vesselId: "mv--explorer",
    name: "MV  Explorer Zen Spa",
    description: "Welcome to MV  Explorer Zen Spa, an oasis of tranquility aboard the MV  Explorer. Our world-class spa offers a comprehensive menu of rejuvenating treatments designed to restore your mind, body, and spirit while sailing the beautiful waters near Kyoto.",
  ...
  {
    id: "5f5b4a50-58db-4f92-b567-fdf180985108",
    vesselId: "mv--explorer",
    name: "MV  Explorer Zen Spa",
    description: "MV  Explorer Zen Spa provides a haven of serenity where guests can escape and rejuvenate. Our skilled wellness professionals offer customized treatments in a luxurious setting, ensuring every guest leaves feeling refreshed and renewed.",
    imageUrl: "/images/spas/ice-class-ship-spa.jpg",
    hours: {
      start: "07:00",
      end: "21:00",
  ...
  {
    id: "fd674908-34f2-47f6-8e41-b9ff31402e90",
    vesselId: "my-kyoto-voyager",
    name: "Bamboo Spa & Wellness",
    description: "Welcome to Bamboo Spa & Wellness, an oasis of tranquility aboard the MY Kyoto Voyager. Our world-class spa offers a comprehensive menu of rejuvenating treatments designed to restore your mind, body, and spirit while sailing the beautiful waters near Kyoto.",
  ...
  {
    id: "8c0781d3-14e9-40bc-811d-c42fadf081e8",
    vesselId: "my-kyoto-voyager",
    name: "Bamboo Rejuvenation Center",
    description: "Discover your personal sanctuary at Bamboo Rejuvenation Center. Our peaceful spa environment features state-of-the-art facilities and offers an extensive range of therapeutic treatments, perfect for unwinding during your maritime journey.",
    imageUrl: "/images/spas/ultra-luxury-cruise-ship-spa.jpg",
    hours: {
      start: "09:00",
      end: "20:00",
  ...
  {
    id: "93773f9e-1f73-4c2a-8f2a-a9ccc9248695",
    vesselId: "ms--of-the-deep",
    name: "MS  of the Deep Zen Spa",
    description: "MS  of the Deep Zen Spa provides a haven of serenity where guests can escape and rejuvenate. Our skilled wellness professionals offer customized treatments in a luxurious setting, ensuring every guest leaves feeling refreshed and renewed.",
  ...
  {
    id: "dd9ca7e8-1139-4376-a81a-a09cb03c7fe9",
    vesselId: "ms--of-the-deep",
  ...
  {
    id: "c769a848-37b0-4f40-98a0-7765d347ebe5",
    vesselId: "mv-the--mariner",
    name: "The Zen Sanctuary",
    description: "Experience ultimate relaxation at The Zen Sanctuary, where traditional wellness meets modern luxury. Our expert therapists provide personalized treatments using premium products and techniques inspired by Asia Pacific healing traditions.",
  ...
  {
    id: "2f9b8c72-2454-4fa1-88c2-e598927b3890",
    vesselId: "sy--gale",
    name: "Serenity Wellness Retreat",
    description: "Experience ultimate relaxation at Serenity Wellness Retreat, where traditional wellness meets modern luxury. Our expert therapists provide personalized treatments using premium products and techniques inspired by Asia Pacific healing traditions.",
    imageUrl: "/images/spas/ultra-luxury-cruise-ship-spa.jpg",
    hours: {
      start: "09:00",
      end: "21:00",
