...
export const ketchikanSpas: Spa[] = [
  {
    id: "7c038743-086b-4ce2-a497-5f0a25748f73",
    vesselId: "fv--explorer",
    name: "FV  Explorer Harbor Spa",
    description: "Discover your personal sanctuary at FV  Explorer Harbor Spa. Our peaceful spa environment features state-of-the-art facilities and offers an extensive range of therapeutic treatments, perfect for unwinding during your maritime journey.",
  ...
  {
    id: "df6f8b53-c11c-4a73-8486-01cbddcd687b",
    vesselId: "ss-ketchikan-voyager",
    name: "Skyline Waters Spa",
    description: "Skyline Waters Spa provides a haven of serenity where guests can escape and rejuvenate. Our skilled wellness professionals offer customized treatments in a luxurious setting, ensuring every guest leaves feeling refreshed and renewed.",
  ...
  {
    id: "ab2717a5-c4ad-4859-9491-f03573fdcf6b",
    vesselId: "ss-ketchikan-voyager",
  ...
  {
    id: "c1ef336a-253e-4df5-9058-0ca027a495fa",
    vesselId: "nb--of-the-deep",
    name: "Serenity Harbor Spa",
    description: "Experience ultimate relaxation at Serenity Harbor Spa, where traditional wellness meets modern luxury. Our expert therapists provide personalized treatments using premium products and techniques inspired by North America healing traditions.",
  ...
  {
    id: "4364bd07-7e90-46b5-bda1-a807fda07f8f",
    vesselId: "nb--of-the-deep",
    name: "NB  of the Deep Summit Spa",
    description: "Experience ultimate relaxation at NB  of the Deep Summit Spa, where traditional wellness meets modern luxury. Our expert therapists provide personalized treatments using premium products and techniques inspired by North America healing traditions.",
    imageUrl: "/images/spas/river-cruise-ship-spa.jpg",
    hours: {
      start: "09:00",
      end: "22:00",
  ...
  {
    id: "f2b7d8e0-214e-41e5-a9f8-01d7ee35ac14",
    vesselId: "ms-the--mariner",
    name: "Summit Spa & Wellness",
    description: "Experience ultimate relaxation at Summit Spa & Wellness, where traditional wellness meets modern luxury. Our expert therapists provide personalized treatments using premium products and techniques inspired by North America healing traditions.",
  ...
  {
    id: "993b957b-4843-4f31-a737-27f7fec7d8e0",
    vesselId: "ms-the--mariner",
    name: "Coastal Spa & Wellness",
    description: "Coastal Spa & Wellness provides a haven of serenity where guests can escape and rejuvenate. Our skilled wellness professionals offer customized treatments in a luxurious setting, ensuring every guest leaves feeling refreshed and renewed.",
    imageUrl: "/images/spas/mid-size-cruise-ship-spa.jpg",
    hours: {
      start: "07:00",
      end: "21:00",
  ...
  {
    id: "23d1aaa1-fb7d-4b42-ab55-93cdd521173f",
    vesselId: "rv--gale",
    name: "Summit Spa & Wellness",
    description: "Welcome to Summit Spa & Wellness, an oasis of tranquility aboard the RV  Gale. Our world-class spa offers a comprehensive menu of rejuvenating treatments designed to restore your mind, body, and spirit while sailing the beautiful waters near Ketchikan.",
