...
export const sanFranciscoSpas: Spa[] = [
  {
    id: "d206a19b-bead-4c26-a54c-96fc2722a7a3",
    vesselId: "rv--explorer",
    name: "Coastal Rejuvenation Center",
    description: "Coastal Rejuvenation Center provides a haven of serenity where guests can escape and rejuvenate. Our skilled wellness professionals offer customized treatments in a luxurious setting, ensuring every guest leaves feeling refreshed and renewed.",
  ...
  {
    id: "c7bbdf1f-8fdd-4ab1-80b0-57bee81eb287",
    vesselId: "rms-san-francisco-voyager",
    name: "Urban Wellness Retreat",
    description: "Welcome to Urban Wellness Retreat, an oasis of tranquility aboard the RMS San Francisco Voyager. Our world-class spa offers a comprehensive menu of rejuvenating treatments designed to restore your mind, body, and spirit while sailing the beautiful waters near San Francisco.",
  ...
  {
    id: "8d127993-2f04-413e-b3fb-54c200b7575e",
    vesselId: "ts--of-the-deep",
    name: "Serenity Skyline Spa",
    description: "Welcome to Serenity Skyline Spa, an oasis of tranquility aboard the TS  of the Deep. Our world-class spa offers a comprehensive menu of rejuvenating treatments designed to restore your mind, body, and spirit while sailing the beautiful waters near San Francisco.",
  ...
  {
    id: "8910718f-3415-4693-a2ee-2cc2644fe908",
  ...
  {
    id: "e7e50f7d-b1f2-4f18-bd07-c5b4e1f8be4a",
    vesselId: "sy-the--mariner",
    name: "Serenity Harbor Spa",
    description: "Discover your personal sanctuary at Serenity Harbor Spa. Our peaceful spa environment features state-of-the-art facilities and offers an extensive range of therapeutic treatments, perfect for unwinding during your maritime journey.",
    imageUrl: "/images/spas/chartered-vessel-spa.jpg",
    hours: {
      start: "07:00",
      end: "20:00",
  ...
  {
    id: "a8945026-2544-4ae9-b2d2-6389980d1616",
    vesselId: "hms--gale",
    name: "Harbor Waters Spa",
    description: "Welcome to Harbor Waters Spa, an oasis of tranquility aboard the HMS  Gale. Our world-class spa offers a comprehensive menu of rejuvenating treatments designed to restore your mind, body, and spirit while sailing the beautiful waters near San Francisco.",
  ...
  {
    id: "cc205a8b-163d-4fca-b839-ce8dbe28ad00",
    vesselId: "hms--gale",
