...
export const southamptonSpas: Spa[] = [
  {
    id: "f11a347b-006f-4a96-a9e6-c8719695461a",
    vesselId: "ts--explorer",
    name: "Serenity Tea & Thyme Spa",
    description: "Discover your personal sanctuary at Serenity Tea & Thyme Spa. Our peaceful spa environment features state-of-the-art facilities and offers an extensive range of therapeutic treatments, perfect for unwinding during your maritime journey.",
  ...
  {
    id: "24eb0d6c-dbe8-4de4-9a21-50eb3a938933",
    vesselId: "sv-southampton-voyager",
    name: "The Tea & Thyme Sanctuary",
    description: "The Tea & Thyme Sanctuary provides a haven of serenity where guests can escape and rejuvenate. Our skilled wellness professionals offer customized treatments in a luxurious setting, ensuring every guest leaves feeling refreshed and renewed.",
  ...
  {
    id: "3713b375-4e31-4737-b2b8-db9e26d8611f",
    vesselId: "ss--of-the-deep",
    name: "Meadow Bloom Waters Spa",
    description: "Meadow Bloom Waters Spa provides a haven of serenity where guests can escape and rejuvenate. Our skilled wellness professionals offer customized treatments in a luxurious setting, ensuring every guest leaves feeling refreshed and renewed.",
  ...
  {
    id: "775337f2-faf3-4f32-af39-d099e39adefa",
  ...
  {
    id: "39601cde-3281-48fa-ae58-059cc4529679",
    vesselId: "ps--gale",
    name: "PS  Gale Meadow Bloom Spa",
    description: "Welcome to PS  Gale Meadow Bloom Spa, an oasis of tranquility aboard the PS  Gale. Our world-class spa offers a comprehensive menu of rejuvenating treatments designed to restore your mind, body, and spirit while sailing the beautiful waters near Southampton.",
    imageUrl: "/images/spas/superyacht-spa.jpg",
    hours: {
      start: "09:00",
      end: "22:00",
  ...
  {
    id: "4c69ddfc-efeb-4795-bbef-7d6ff80c05a4",
    vesselId: "rv--explorer",
    name: "Cotswold Calm Wellness Retreat",
    description: "Cotswold Calm Wellness Retreat provides a haven of serenity where guests can escape and rejuvenate. Our skilled wellness professionals offer customized treatments in a luxurious setting, ensuring every guest leaves feeling refreshed and renewed.",
    imageUrl: "/images/spas/expedition-ship-spa.jpg",
    hours: {
      start: "08:00",
      end: "20:00",
  ...
  {
    id: "00fe5602-f49f-4f8b-980f-c5dfe4498eb0",
    vesselId: "rv--explorer",
  ...
  {
    id: "ce31b748-45f4-4046-8139-274a3e9f638a",
    vesselId: "rv-southampton-voyager",
    name: "Regent Waters Spa",
    description: "Regent Waters Spa provides a haven of serenity where guests can escape and rejuvenate. Our skilled wellness professionals offer customized treatments in a luxurious setting, ensuring every guest leaves feeling refreshed and renewed.",
  ...
  {
    id: "000bee7a-7ac7-42e1-8f71-fdd74f049769",
    vesselId: "my--of-the-deep",
    name: "Regent Wellness Retreat",
    description: "Experience ultimate relaxation at Regent Wellness Retreat, where traditional wellness meets modern luxury. Our expert therapists provide personalized treatments using premium products and techniques inspired by England healing traditions.",
    imageUrl: "/images/spas/chartered-vessel-spa.jpg",
    hours: {
      start: "08:00",
      end: "19:00",
  ...
  {
    id: "26a3940b-5f6c-4c89-a1f4-6c09eb530ac3",
    vesselId: "sv-the--mariner",
    name: "SV The  Mariner Regent Spa",
    description: "SV The  Mariner Regent Spa provides a haven of serenity where guests can escape and rejuvenate. Our skilled wellness professionals offer customized treatments in a luxurious setting, ensuring every guest leaves feeling refreshed and renewed.",
    imageUrl: "/images/spas/chartered-vessel-spa.jpg",
    hours: {
      start: "07:00",
      end: "19:00",
  ...
  {
    id: "39522f48-033c-4f38-91e2-67b28656201f",
    vesselId: "sv-the--mariner",
    name: "Cotswold Calm Wellness Retreat",
    description: "Experience ultimate relaxation at Cotswold Calm Wellness Retreat, where traditional wellness meets modern luxury. Our expert therapists provide personalized treatments using premium products and techniques inspired by England healing traditions.",
    imageUrl: "/images/spas/chartered-vessel-spa.jpg",
    hours: {
      start: "09:00",
      end: "19:00",
  ...
  {
    id: "d4559b15-a1c1-4a57-b375-d1027a738337",
    vesselId: "rv--gale",
    name: "Meadow Bloom Waters Spa",
