// Spa venues data for Stockholm
// This file contains spa and wellness center information for cruise vessels operating from Stockholm
...
export const stockholmSpas: Spa[] = [
  {
    id: "3aaf2b3e-aa32-4bce-ab36-757f68cb5f9b",
    vesselId: "ss--explorer",
    name: "Serenity Blissful Spa",
    description: "Serenity Blissful Spa provides a haven of serenity where guests can escape and rejuvenate. Our skilled wellness professionals offer customized treatments in a luxurious setting, ensuring every guest leaves feeling refreshed and renewed.",
  ...
  {
    id: "a07161ac-1ed5-4af9-b6f1-788938043c02",
    vesselId: "my-stockholm-voyager",
    name: "Serenity Rejuvenating Spa",
    description: "Welcome to Serenity Rejuvenating Spa, an oasis of tranquility aboard the MY Stockholm Voyager. Our world-class spa offers a comprehensive menu of rejuvenating treatments designed to restore your mind, body, and spirit while sailing the beautiful waters near Stockholm.",
  ...
  {
    id: "0e46fa1b-fb0b-4ac8-9130-ab2d31c248ca",
    vesselId: "my-stockholm-voyager",
    name: "Peaceful Rejuvenation Center",
    description: "Experience ultimate relaxation at Peaceful Rejuvenation Center, where traditional wellness meets modern luxury. Our expert therapists provide personalized treatments using premium products and techniques inspired by Sweden healing traditions.",
    imageUrl: "/images/spas/family-cruise-ship-spa.jpg",
    hours: {
      start: "07:00",
      end: "22:00",
  ...
  {
    id: "0fc3487e-19b0-42ee-b7fd-4d47accc7ae5",
  ...
  {
    id: "d6af5cfd-7437-442d-acf9-d2b6e94237a8",
    vesselId: "rv-the--mariner",
    name: "Blissful Wellness Retreat",
    description: "Discover your personal sanctuary at Blissful Wellness Retreat. Our peaceful spa environment features state-of-the-art facilities and offers an extensive range of therapeutic treatments, perfect for unwinding during your maritime journey.",
  ...
  {
    id: "d47ee4d9-b835-43d6-a869-bfd6d6a6a7fd",
    vesselId: "nb--gale",
    name: "Serene Waters Spa",
    description: "Experience ultimate relaxation at Serene Waters Spa, where traditional wellness meets modern luxury. Our expert therapists provide personalized treatments using premium products and techniques inspired by Sweden healing traditions.",
  ...
  {
    id: "8a520dcf-2a6a-4c23-a1ca-d0851ef52bfb",
    vesselId: "rms--explorer",
    name: "Blissful Waters Spa",
    description: "Experience ultimate relaxation at Blissful Waters Spa, where traditional wellness meets modern luxury. Our expert therapists provide personalized treatments using premium products and techniques inspired by Sweden healing traditions.",
  ...
  {
    id: "25e6bc6c-967f-4dcb-b91c-663eb6f7483d",
  ...
  {
    id: "1ab14cab-d933-46e3-9cc8-48ff2db9d229",
    vesselId: "mv--of-the-deep",
    name: "MV  of the Deep Peaceful Spa",
    description: "MV  of the Deep Peaceful Spa provides a haven of serenity where guests can escape and rejuvenate. Our skilled wellness professionals offer customized treatments in a luxurious setting, ensuring every guest leaves feeling refreshed and renewed.",
    imageUrl: "/images/spas/eco-friendly-hybrid-ship-spa.jpg",
    hours: {
      start: "07:00",
      end: "22:00",
  ...
  {
    id: "13819827-48e7-43d9-b943-e28e638e9747",
    vesselId: "mv--of-the-deep",
    name: "Rejuvenating Spa & Wellness",
    description: "Experience ultimate relaxation at Rejuvenating Spa & Wellness, where traditional wellness meets modern luxury. Our expert therapists provide personalized treatments using premium products and techniques inspired by Sweden healing traditions.",
    imageUrl: "/images/spas/eco-friendly-hybrid-ship-spa.jpg",
    hours: {
      start: "07:00",
      end: "19:00",
  ...
  {
    id: "f6e8d158-82ff-4d94-928d-1309516db189",
    vesselId: "cs-the--mariner",
    name: "Serenity Tranquil Spa",
    description: "Welcome to Serenity Tranquil Spa, an oasis of tranquility aboard the CS The  Mariner. Our world-class spa offers a comprehensive menu of rejuvenating treatments designed to restore your mind, body, and spirit while sailing the beautiful waters near Stockholm.",
    imageUrl: "/images/spas/short-hop-ferry-spa.jpg",
    hours: {
      start: "07:00",
      end: "19:00",
  ...
  {
    id: "3c776c24-f23a-42f8-bf44-5a07391c97d1",
    vesselId: "hms--gale",
    name: "Blissful Spa & Wellness",
    description: "Blissful Spa & Wellness provides a haven of serenity where guests can escape and rejuvenate. Our skilled wellness professionals offer customized treatments in a luxurious setting, ensuring every guest leaves feeling refreshed and renewed.",
  ...
  {
    id: "c28e9f2a-fa73-4e0a-b538-636c713c640c",
    vesselId: "hms--gale",
    name: "Serene Rejuvenation Center",
    description: "Serene Rejuvenation Center provides a haven of serenity where guests can escape and rejuvenate. Our skilled wellness professionals offer customized treatments in a luxurious setting, ensuring every guest leaves feeling refreshed and renewed.",
    imageUrl: "/images/spas/small-ocean-ship-spa.jpg",
    hours: {
      start: "08:00",
      end: "20:00",
