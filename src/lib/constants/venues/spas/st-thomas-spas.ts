...
export const stThomasSpas: Spa[] = [
  {
    id: "48e7df34-ae19-4565-84db-77eb515fa129",
    vesselId: "mv--explorer",
    name: "Tropical Waters Spa",
    description: "Experience ultimate relaxation at Tropical Waters Spa, where traditional wellness meets modern luxury. Our expert therapists provide personalized treatments using premium products and techniques inspired by Caribbean healing traditions.",
  ...
  {
    id: "e185c4f3-05e3-4573-8db9-a42a2819c1a6",
    vesselId: "mv--explorer",
    name: "Oasis Spa & Wellness",
    description: "Welcome to Oasis Spa & Wellness, an oasis of tranquility aboard the MV  Explorer. Our world-class spa offers a comprehensive menu of rejuvenating treatments designed to restore your mind, body, and spirit while sailing the beautiful waters near St Thomas.",
    imageUrl: "/images/spas/mega-yacht-spa.jpg",
    hours: {
      start: "08:00",
      end: "21:00",
  ...
  {
    id: "0ae722d1-a51f-49a4-925c-85eb2660d0fc",
  ...
  {
    id: "21a7336f-5c03-400a-b7a5-e0aa08e9faf5",
    vesselId: "sy-st-thomas-voyager",
    name: "The Island Sanctuary",
    description: "Experience ultimate relaxation at The Island Sanctuary, where traditional wellness meets modern luxury. Our expert therapists provide personalized treatments using premium products and techniques inspired by Caribbean healing traditions.",
    imageUrl: "/images/spas/adults-only-ship-spa.jpg",
    hours: {
      start: "07:00",
      end: "22:00",
  ...
  {
    id: "9d8fc361-85e0-42ca-bb93-7e623ef2b565",
    vesselId: "ts--of-the-deep",
    name: "Paradise Rejuvenation Center",
    description: "Welcome to Paradise Rejuvenation Center, an oasis of tranquility aboard the TS  of the Deep. Our world-class spa offers a comprehensive menu of rejuvenating treatments designed to restore your mind, body, and spirit while sailing the beautiful waters near St Thomas.",
  ...
  {
    id: "6140e42c-12bb-4ef1-9033-4ec43b89eb53",
    vesselId: "nb-the--mariner",
    name: "Paradise Spa & Wellness",
    description: "Discover your personal sanctuary at Paradise Spa & Wellness. Our peaceful spa environment features state-of-the-art facilities and offers an extensive range of therapeutic treatments, perfect for unwinding during your maritime journey.",
  ...
  {
    id: "9f8dc472-b866-46da-919a-12a43b64167d",
    vesselId: "hms--gale",
    name: "HMS  Gale Island Spa",
    description: "Experience ultimate relaxation at HMS  Gale Island Spa, where traditional wellness meets modern luxury. Our expert therapists provide personalized treatments using premium products and techniques inspired by Caribbean healing traditions.",
