...
export const glacierBaySpas: Spa[] = [
  {
    id: "4278b701-801e-4031-8156-2af49b28f1a1",
  ...
  {
    id: "246757be-f05a-459a-8e71-025474ab8f33",
    vesselId: "ly--explorer",
    name: "LY  Explorer Urban Spa",
    description: "Experience ultimate relaxation at LY  Explorer Urban Spa, where traditional wellness meets modern luxury. Our expert therapists provide personalized treatments using premium products and techniques inspired by North America healing traditions.",
    imageUrl: "/images/spas/chartered-vessel-spa.jpg",
    hours: {
      start: "07:00",
      end: "21:00",
  ...
  {
    id: "4f38d794-5f59-48f5-969f-1f13895a4c69",
    vesselId: "ms-glacier-bay-voyager",
    name: "MS Glacier Bay Voyager Summit Spa",
    description: "MS Glacier Bay Voyager Summit Spa provides a haven of serenity where guests can escape and rejuvenate. Our skilled wellness professionals offer customized treatments in a luxurious setting, ensuring every guest leaves feeling refreshed and renewed.",
  ...
  {
    id: "e449dd6f-6efe-4a49-a98c-132cb35a02ec",
    vesselId: "ms-glacier-bay-voyager",
    name: "Harbor Waters Spa",
    description: "Harbor Waters Spa provides a haven of serenity where guests can escape and rejuvenate. Our skilled wellness professionals offer customized treatments in a luxurious setting, ensuring every guest leaves feeling refreshed and renewed.",
    imageUrl: "/images/spas/zodiac-equipped-vessel-spa.jpg",
    hours: {
      start: "09:00",
      end: "22:00",
  ...
  {
    id: "415d08f4-9da9-4274-a2cc-af71603b3b97",
    vesselId: "nb--of-the-deep",
    name: "Serenity Urban Spa",
    description: "Discover your personal sanctuary at Serenity Urban Spa. Our peaceful spa environment features state-of-the-art facilities and offers an extensive range of therapeutic treatments, perfect for unwinding during your maritime journey.",
  ...
  {
    id: "5b55e824-12f8-4fdd-9794-9d9d89eb667d",
    vesselId: "nb--of-the-deep",
  ...
  {
    id: "4ffa2362-73e7-4452-9af8-6cb0e6cb4f7b",
    vesselId: "fv-the--mariner",
    name: "Harbor Spa & Wellness",
    description: "Welcome to Harbor Spa & Wellness, an oasis of tranquility aboard the FV The  Mariner. Our world-class spa offers a comprehensive menu of rejuvenating treatments designed to restore your mind, body, and spirit while sailing the beautiful waters near Glacier Bay.",
    imageUrl: "/images/spas/zodiac-equipped-vessel-spa.jpg",
    hours: {
      start: "07:00",
      end: "21:00",
  ...
  {
    id: "a2b95811-fd00-48f3-9bc1-8d48bf382f75",
    vesselId: "ly--gale",
    name: "Skyline Spa & Wellness",
    description: "Experience ultimate relaxation at Skyline Spa & Wellness, where traditional wellness meets modern luxury. Our expert therapists provide personalized treatments using premium products and techniques inspired by North America healing traditions.",
