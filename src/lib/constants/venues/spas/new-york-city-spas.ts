...
export const newYorkCitySpas: Spa[] = [
  {
    id: "34791fd3-5b0d-437f-88d0-6aefd7e2a63f",
    vesselId: "ms--explorer",
    name: "Summit Spa & Wellness",
    description: "Summit Spa & Wellness provides a haven of serenity where guests can escape and rejuvenate. Our skilled wellness professionals offer customized treatments in a luxurious setting, ensuring every guest leaves feeling refreshed and renewed.",
  ...
  {
    id: "6c195d89-56f9-4843-a5ea-d9786fabec14",
    vesselId: "ms--explorer",
    name: "The Coastal Sanctuary",
    description: "Welcome to The Coastal Sanctuary, an oasis of tranquility aboard the MS  Explorer. Our world-class spa offers a comprehensive menu of rejuvenating treatments designed to restore your mind, body, and spirit while sailing the beautiful waters near New York City.",
    imageUrl: "/images/spas/mid-size-cruise-ship-spa.jpg",
    hours: {
      start: "07:00",
      end: "22:00",
  ...
  {
    id: "dff21bd7-ce81-4824-bde5-5f673f671924",
  ...
  {
    id: "8d997633-8c4c-4a3d-a49a-679b41fb0fab",
  ...
  {
    id: "87c5c850-7706-4436-bc14-edcb9304b637",
    vesselId: "ps-the--mariner",
    name: "Urban Wellness Retreat",
    description: "Urban Wellness Retreat provides a haven of serenity where guests can escape and rejuvenate. Our skilled wellness professionals offer customized treatments in a luxurious setting, ensuring every guest leaves feeling refreshed and renewed.",
  ...
  {
    id: "28103c98-a32b-4b70-a7ee-85a65686164a",
    vesselId: "my--gale",
    name: "Harbor Wellness Retreat",
    description: "Discover your personal sanctuary at Harbor Wellness Retreat. Our peaceful spa environment features state-of-the-art facilities and offers an extensive range of therapeutic treatments, perfect for unwinding during your maritime journey.",
  ...
  {
    id: "06c04628-0deb-485a-a53d-cd6e948ea560",
    vesselId: "my--gale",
