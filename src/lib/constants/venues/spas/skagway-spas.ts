...
export const skagwaySpas: Spa[] = [
  {
    id: "f402b786-f09f-43dc-bdea-47da0c3e49c8",
  ...
  {
    id: "726906d4-45f5-4a95-a075-bafcfaa723e8",
  ...
  {
    id: "2d1f4704-63ac-402f-9265-43a035a2ac7b",
    vesselId: "ps--of-the-deep",
    name: "Serenity Coastal Spa",
    description: "Welcome to Serenity Coastal Spa, an oasis of tranquility aboard the PS  of the Deep. Our world-class spa offers a comprehensive menu of rejuvenating treatments designed to restore your mind, body, and spirit while sailing the beautiful waters near Skagway.",
  ...
  {
    id: "cb3b7a5b-6938-4a88-8fdb-58fcfa06f9f7",
    vesselId: "ps--of-the-deep",
  ...
  {
    id: "e3a4cbf4-de77-4f2a-a963-e93c5c5048bc",
    vesselId: "rms-the--mariner",
    name: "Harbor Spa & Wellness",
    description: "Harbor Spa & Wellness provides a haven of serenity where guests can escape and rejuvenate. Our skilled wellness professionals offer customized treatments in a luxurious setting, ensuring every guest leaves feeling refreshed and renewed.",
  ...
  {
    id: "e97004f5-c5f8-4594-a37e-78d19200d05c",
    vesselId: "sy--gale",
    name: "Serenity Urban Spa",
    description: "Experience ultimate relaxation at Serenity Urban Spa, where traditional wellness meets modern luxury. Our expert therapists provide personalized treatments using premium products and techniques inspired by North America healing traditions.",
